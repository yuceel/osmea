...
//
//     final retrievesListOfCustomersResponse = retrievesListOfCustomersResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieves_list_of_customers_response.freezed.dart';
part 'retrieves_list_of_customers_response.g.dart';

RetrievesListOfCustomersResponse retrievesListOfCustomersResponseFromJson(String str) => RetrievesListOfCustomersResponse.fromJson(json.decode(str));

String retrievesListOfCustomersResponseToJson(RetrievesListOfCustomersResponse data) => json.encode(data.toJson());

@freezed
class RetrievesListOfCustomersResponse with _$RetrievesListOfCustomersResponse {
    const factory RetrievesListOfCustomersResponse({
        @JsonKey(name: "customers")
        List<Customer>? customers,
    }) = _RetrievesListOfCustomersResponse;

    factory RetrievesListOfCustomersResponse.fromJson(Map<String, dynamic> json) => _$RetrievesListOfCustomersResponseFromJson(json);
}
