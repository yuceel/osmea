...
part 'create_price_rule_free_item_response.freezed.dart';
part 'create_price_rule_free_item_response.g.dart';

CreatePriceRuleFreeItemResponse createPriceRuleFreeItemResponseFromJson(
        String str) =>
    CreatePriceRuleFreeItemResponse.fromJson(json.decode(str));

String createPriceRuleFreeItemResponseToJson(
        CreatePriceRuleFreeItemResponse data) =>
    json.encode(data.toJson());

@freezed
class CreatePriceRuleFreeItemResponse with _$CreatePriceRuleFreeItemResponse {
  const factory CreatePriceRuleFreeItemResponse({
    @JsonKey(name: "price_rule") PriceRule? priceRule,
  }) = _CreatePriceRuleFreeItemResponse;

  factory CreatePriceRuleFreeItemResponse.fromJson(Map<String, dynamic> json) =>
      _$CreatePriceRuleFreeItemResponseFromJson(json);
}
