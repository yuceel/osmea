...
part 'create_price_rule_discount_order_response.freezed.dart';
part 'create_price_rule_discount_order_response.g.dart';

CreatePriceRuleDiscountOrderResponse
    createPriceRuleDiscountOrderResponseFromJson(String str) =>
        CreatePriceRuleDiscountOrderResponse.fromJson(json.decode(str));

String createPriceRuleDiscountOrderResponseToJson(
        CreatePriceRuleDiscountOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class CreatePriceRuleDiscountOrderResponse
    with _$CreatePriceRuleDiscountOrderResponse {
  const factory CreatePriceRuleDiscountOrderResponse({
    @JsonKey(name: "price_rule") PriceRule? priceRule,
  }) = _CreatePriceRuleDiscountOrderResponse;

  factory CreatePriceRuleDiscountOrderResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreatePriceRuleDiscountOrderResponseFromJson(json);
}
