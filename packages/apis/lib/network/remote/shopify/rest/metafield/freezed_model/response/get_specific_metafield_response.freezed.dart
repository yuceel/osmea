...
GetSpecificMetafieldResponse _$GetSpecificMetafieldResponseFromJson(
    Map<String, dynamic> json) {
  return _GetSpecificMetafieldResponse.fromJson(json);
}

/// @nodoc
mixin _$GetSpecificMetafieldResponse {
  @JsonKey(name: "metafield")
  Metafield? get metafield => throw _privateConstructorUsedError;

  /// Serializes this GetSpecificMetafieldResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetSpecificMetafieldResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetSpecificMetafieldResponseCopyWith<GetSpecificMetafieldResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetSpecificMetafieldResponseCopyWith<$Res> {
  factory $GetSpecificMetafieldResponseCopyWith(
          GetSpecificMetafieldResponse value,
          $Res Function(GetSpecificMetafieldResponse) then) =
      _$GetSpecificMetafieldResponseCopyWithImpl<$Res,
          GetSpecificMetafieldResponse>;
  @useResult
...
/// @nodoc
class _$GetSpecificMetafieldResponseCopyWithImpl<$Res,
        $Val extends GetSpecificMetafieldResponse>
    implements $GetSpecificMetafieldResponseCopyWith<$Res> {
  _$GetSpecificMetafieldResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetSpecificMetafieldResponseImplCopyWith<$Res>
    implements $GetSpecificMetafieldResponseCopyWith<$Res> {
  factory _$$GetSpecificMetafieldResponseImplCopyWith(
          _$GetSpecificMetafieldResponseImpl value,
          $Res Function(_$GetSpecificMetafieldResponseImpl) then) =
      __$$GetSpecificMetafieldResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "metafield") Metafield? metafield});
...
/// @nodoc
class __$$GetSpecificMetafieldResponseImplCopyWithImpl<$Res>
    extends _$GetSpecificMetafieldResponseCopyWithImpl<$Res,
        _$GetSpecificMetafieldResponseImpl>
    implements _$$GetSpecificMetafieldResponseImplCopyWith<$Res> {
  __$$GetSpecificMetafieldResponseImplCopyWithImpl(
      _$GetSpecificMetafieldResponseImpl _value,
      $Res Function(_$GetSpecificMetafieldResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetSpecificMetafieldResponseImpl(
      metafield: freezed == metafield
          ? _value.metafield
          : metafield // ignore: cast_nullable_to_non_nullable
              as Metafield?,
...
/// @nodoc
@JsonSerializable()
class _$GetSpecificMetafieldResponseImpl
    implements _GetSpecificMetafieldResponse {
  const _$GetSpecificMetafieldResponseImpl(
      {@JsonKey(name: "metafield") this.metafield});

  factory _$GetSpecificMetafieldResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GetSpecificMetafieldResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetSpecificMetafieldResponse(metafield: $metafield)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetSpecificMetafieldResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetSpecificMetafieldResponseImplCopyWith<
          _$GetSpecificMetafieldResponseImpl>
      get copyWith => __$$GetSpecificMetafieldResponseImplCopyWithImpl<
          _$GetSpecificMetafieldResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetSpecificMetafieldResponseImplToJson(
      this,
    );
  }
}

abstract class _GetSpecificMetafieldResponse
    implements GetSpecificMetafieldResponse {
  const factory _GetSpecificMetafieldResponse(
          {@JsonKey(name: "metafield") final Metafield? metafield}) =
      _$GetSpecificMetafieldResponseImpl;

  factory _GetSpecificMetafieldResponse.fromJson(Map<String, dynamic> json) =
      _$GetSpecificMetafieldResponseImpl.fromJson;
