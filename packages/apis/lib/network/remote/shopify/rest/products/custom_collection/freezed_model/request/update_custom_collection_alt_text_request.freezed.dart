...
UpdateCustomCollectionAltTextRequest
    _$UpdateCustomCollectionAltTextRequestFromJson(Map<String, dynamic> json) {
  return _UpdateCustomCollectionAltTextRequest.fromJson(json);
}

/// @nodoc
mixin _$UpdateCustomCollectionAltTextRequest {
...
/// @nodoc
abstract class $UpdateCustomCollectionAltTextRequestCopyWith<$Res> {
  factory $UpdateCustomCollectionAltTextRequestCopyWith(
          UpdateCustomCollectionAltTextRequest value,
          $Res Function(UpdateCustomCollectionAltTextRequest) then) =
      _$UpdateCustomCollectionAltTextRequestCopyWithImpl<$Res,
          UpdateCustomCollectionAltTextRequest>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateCustomCollectionAltTextRequestCopyWithImpl<$Res,
        $Val extends UpdateCustomCollectionAltTextRequest>
    implements $UpdateCustomCollectionAltTextRequestCopyWith<$Res> {
  _$UpdateCustomCollectionAltTextRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateCustomCollectionAltTextRequestImplCopyWith<$Res>
    implements $UpdateCustomCollectionAltTextRequestCopyWith<$Res> {
  factory _$$UpdateCustomCollectionAltTextRequestImplCopyWith(
          _$UpdateCustomCollectionAltTextRequestImpl value,
          $Res Function(_$UpdateCustomCollectionAltTextRequestImpl) then) =
      __$$UpdateCustomCollectionAltTextRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection});
...
/// @nodoc
class __$$UpdateCustomCollectionAltTextRequestImplCopyWithImpl<$Res>
    extends _$UpdateCustomCollectionAltTextRequestCopyWithImpl<$Res,
        _$UpdateCustomCollectionAltTextRequestImpl>
    implements _$$UpdateCustomCollectionAltTextRequestImplCopyWith<$Res> {
  __$$UpdateCustomCollectionAltTextRequestImplCopyWithImpl(
      _$UpdateCustomCollectionAltTextRequestImpl _value,
  ...
  $Res call({
    ...
    return _then(_$UpdateCustomCollectionAltTextRequestImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateCustomCollectionAltTextRequestImpl
    implements _UpdateCustomCollectionAltTextRequest {
  const _$UpdateCustomCollectionAltTextRequestImpl(
      {@JsonKey(name: "custom_collection") this.customCollection});

  factory _$UpdateCustomCollectionAltTextRequestImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateCustomCollectionAltTextRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateCustomCollectionAltTextRequest(customCollection: $customCollection)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateCustomCollectionAltTextRequestImpl &&
  ...
  _$$UpdateCustomCollectionAltTextRequestImplCopyWith<
          _$UpdateCustomCollectionAltTextRequestImpl>
      get copyWith => __$$UpdateCustomCollectionAltTextRequestImplCopyWithImpl<
          _$UpdateCustomCollectionAltTextRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateCustomCollectionAltTextRequestImplToJson(
      this,
    );
  }
}

abstract class _UpdateCustomCollectionAltTextRequest
    implements UpdateCustomCollectionAltTextRequest {
  const factory _UpdateCustomCollectionAltTextRequest(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection}) =
      _$UpdateCustomCollectionAltTextRequestImpl;

  factory _UpdateCustomCollectionAltTextRequest.fromJson(
          Map<String, dynamic> json) =
      _$UpdateCustomCollectionAltTextRequestImpl.fromJson;
...
abstract class $ImageCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "alt") String? alt});
}
...
class _$ImageImpl implements _Image {
  const _$ImageImpl({@JsonKey(name: "alt") this.alt});
...
abstract class _Image implements Image {
  const factory _Image({@JsonKey(name: "alt") final String? alt}) = _$ImageImpl;
