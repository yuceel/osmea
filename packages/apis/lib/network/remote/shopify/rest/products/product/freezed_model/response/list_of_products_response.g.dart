...
_$ListOfProductsResponseImpl _$$ListOfProductsResponseImplFromJson(
...
Map<String, dynamic> _$$ListOfProductsResponseImplToJson(
        _$ListOfProductsResponseImpl instance) =>
    <String, dynamic>{
...
_$ProductImpl _$$ProductImplFromJson(Map<String, dynamic> json) =>
    _$ProductImpl(
      ...
      images: (json['images'] as List<dynamic>?)
          ?.map((e) => ImageElement.fromJson(e as Map<String, dynamic>))
          .toList(),
      image: json['image'] == null
          ? null
          : PurpleImage.fromJson(json['image'] as Map<String, dynamic>),
    );
...
_$PurpleImageImpl _$$PurpleImageImplFromJson(Map<String, dynamic> json) =>
    _$PurpleImageImpl(
      id: (json['id'] as num?)?.toInt(),
...
Map<String, dynamic> _$$PurpleImageImplToJson(_$PurpleImageImpl instance) =>
    <String, dynamic>{
      if (instance.id case final value?) 'id': value,
