...
part of 'create_custom_collection_base_image_response.dart';
...
CreateCustomCollectionBaseImageResponse
    _$CreateCustomCollectionBaseImageResponseFromJson(
        Map<String, dynamic> json) {
  return _CreateCustomCollectionBaseImageResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCustomCollectionBaseImageResponse {
...
/// @nodoc
abstract class $CreateCustomCollectionBaseImageResponseCopyWith<$Res> {
  factory $CreateCustomCollectionBaseImageResponseCopyWith(
          CreateCustomCollectionBaseImageResponse value,
          $Res Function(CreateCustomCollectionBaseImageResponse) then) =
      _$CreateCustomCollectionBaseImageResponseCopyWithImpl<$Res,
          CreateCustomCollectionBaseImageResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateCustomCollectionBaseImageResponseCopyWithImpl<$Res,
        $Val extends CreateCustomCollectionBaseImageResponse>
    implements $CreateCustomCollectionBaseImageResponseCopyWith<$Res> {
  _$CreateCustomCollectionBaseImageResponseCopyWithImpl(
...
/// @nodoc
abstract class _$$CreateCustomCollectionBaseImageResponseImplCopyWith<$Res>
    implements $CreateCustomCollectionBaseImageResponseCopyWith<$Res> {
  factory _$$CreateCustomCollectionBaseImageResponseImplCopyWith(
          _$CreateCustomCollectionBaseImageResponseImpl value,
          $Res Function(_$CreateCustomCollectionBaseImageResponseImpl) then) =
      __$$CreateCustomCollectionBaseImageResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection,
...
/// @nodoc
class __$$CreateCustomCollectionBaseImageResponseImplCopyWithImpl<$Res>
    extends _$CreateCustomCollectionBaseImageResponseCopyWithImpl<$Res,
        _$CreateCustomCollectionBaseImageResponseImpl>
    implements _$$CreateCustomCollectionBaseImageResponseImplCopyWith<$Res> {
  __$$CreateCustomCollectionBaseImageResponseImplCopyWithImpl(
      _$CreateCustomCollectionBaseImageResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CreateCustomCollectionBaseImageResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCustomCollectionBaseImageResponseImpl
    implements _CreateCustomCollectionBaseImageResponse {
  const _$CreateCustomCollectionBaseImageResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateCustomCollectionBaseImageResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateCustomCollectionBaseImageResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCustomCollectionBaseImageResponse(customCollection: $customCollection, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCustomCollectionBaseImageResponseImpl &&
  ...
  _$$CreateCustomCollectionBaseImageResponseImplCopyWith<
      ...
      get copyWith =>
          __$$CreateCustomCollectionBaseImageResponseImplCopyWithImpl<
              _$CreateCustomCollectionBaseImageResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCustomCollectionBaseImageResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateCustomCollectionBaseImageResponse
    implements CreateCustomCollectionBaseImageResponse {
  const factory _CreateCustomCollectionBaseImageResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateCustomCollectionBaseImageResponseImpl;

  factory _CreateCustomCollectionBaseImageResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateCustomCollectionBaseImageResponseImpl.fromJson;
