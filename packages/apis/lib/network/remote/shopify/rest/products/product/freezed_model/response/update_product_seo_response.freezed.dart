...
part of 'update_product_seo_response.dart';
...
UpdateProductSeoResponse _$UpdateProductSeoResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductSeoResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductSeoResponse {
  @JsonKey(name: "product")
  Product? get product => throw _privateConstructorUsedError;

  /// Serializes this UpdateProductSeoResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductSeoResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductSeoResponseCopyWith<UpdateProductSeoResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductSeoResponseCopyWith<$Res> {
  factory $UpdateProductSeoResponseCopyWith(UpdateProductSeoResponse value,
          $Res Function(UpdateProductSeoResponse) then) =
      _$UpdateProductSeoResponseCopyWithImpl<$Res, UpdateProductSeoResponse>;
  @useResult
...
/// @nodoc
class _$UpdateProductSeoResponseCopyWithImpl<$Res,
        $Val extends UpdateProductSeoResponse>
    implements $UpdateProductSeoResponseCopyWith<$Res> {
  _$UpdateProductSeoResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductSeoResponseImplCopyWith<$Res>
    implements $UpdateProductSeoResponseCopyWith<$Res> {
  factory _$$UpdateProductSeoResponseImplCopyWith(
          _$UpdateProductSeoResponseImpl value,
          $Res Function(_$UpdateProductSeoResponseImpl) then) =
      __$$UpdateProductSeoResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "product") Product? product});
...
/// @nodoc
class __$$UpdateProductSeoResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductSeoResponseCopyWithImpl<$Res,
        _$UpdateProductSeoResponseImpl>
    implements _$$UpdateProductSeoResponseImplCopyWith<$Res> {
  __$$UpdateProductSeoResponseImplCopyWithImpl(
      _$UpdateProductSeoResponseImpl _value,
      $Res Function(_$UpdateProductSeoResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductSeoResponseImpl(
      product: freezed == product
          ? _value.product
          : product // ignore: cast_nullable_to_non_nullable
              as Product?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductSeoResponseImpl implements _UpdateProductSeoResponse {
  const _$UpdateProductSeoResponseImpl(
      {@JsonKey(name: "product") this.product});

  factory _$UpdateProductSeoResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateProductSeoResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductSeoResponse(product: $product)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductSeoResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductSeoResponseImplCopyWith<_$UpdateProductSeoResponseImpl>
      get copyWith => __$$UpdateProductSeoResponseImplCopyWithImpl<
          _$UpdateProductSeoResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductSeoResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductSeoResponse implements UpdateProductSeoResponse {
  const factory _UpdateProductSeoResponse(
          {@JsonKey(name: "product") final Product? product}) =
      _$UpdateProductSeoResponseImpl;

  factory _UpdateProductSeoResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductSeoResponseImpl.fromJson;
