import 'package:apis/network/remote/shopify/rest/products/collect/freezed_model/request/create_collect_request.dart';
import 'package:apis/network/remote/shopify/rest/products/collect/freezed_model/response/get_collects_response.dart';
import 'package:apis/network/remote/shopify/rest/products/collect/freezed_model/response/get_single_collect_response.dart';
import 'package:apis/network/remote/shopify/rest/products/collect/freezed_model/response/get_collects_count_response.dart';
import 'package:apis/network/remote/shopify/rest/products/collect/freezed_model/response/create_collect_response.dart';
