...
UpdateCustomCollectionNewImageResponse
    _$UpdateCustomCollectionNewImageResponseFromJson(
        Map<String, dynamic> json) {
  return _UpdateCustomCollectionNewImageResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateCustomCollectionNewImageResponse {
  @JsonKey(name: "custom_collection")
  CustomCollection? get customCollection => throw _privateConstructorUsedError;

  /// Serializes this UpdateCustomCollectionNewImageResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateCustomCollectionNewImageResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateCustomCollectionNewImageResponseCopyWith<
          UpdateCustomCollectionNewImageResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateCustomCollectionNewImageResponseCopyWith<$Res> {
  factory $UpdateCustomCollectionNewImageResponseCopyWith(
          UpdateCustomCollectionNewImageResponse value,
          $Res Function(UpdateCustomCollectionNewImageResponse) then) =
      _$UpdateCustomCollectionNewImageResponseCopyWithImpl<$Res,
          UpdateCustomCollectionNewImageResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateCustomCollectionNewImageResponseCopyWithImpl<$Res,
        $Val extends UpdateCustomCollectionNewImageResponse>
    implements $UpdateCustomCollectionNewImageResponseCopyWith<$Res> {
  _$UpdateCustomCollectionNewImageResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateCustomCollectionNewImageResponseImplCopyWith<$Res>
    implements $UpdateCustomCollectionNewImageResponseCopyWith<$Res> {
  factory _$$UpdateCustomCollectionNewImageResponseImplCopyWith(
          _$UpdateCustomCollectionNewImageResponseImpl value,
          $Res Function(_$UpdateCustomCollectionNewImageResponseImpl) then) =
      __$$UpdateCustomCollectionNewImageResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection});
...
/// @nodoc
class __$$UpdateCustomCollectionNewImageResponseImplCopyWithImpl<$Res>
    extends _$UpdateCustomCollectionNewImageResponseCopyWithImpl<$Res,
        _$UpdateCustomCollectionNewImageResponseImpl>
    implements _$$UpdateCustomCollectionNewImageResponseImplCopyWith<$Res> {
  __$$UpdateCustomCollectionNewImageResponseImplCopyWithImpl(
      _$UpdateCustomCollectionNewImageResponseImpl _value,
      $Res Function(_$UpdateCustomCollectionNewImageResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateCustomCollectionNewImageResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateCustomCollectionNewImageResponseImpl
    implements _UpdateCustomCollectionNewImageResponse {
  const _$UpdateCustomCollectionNewImageResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection});

  factory _$UpdateCustomCollectionNewImageResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateCustomCollectionNewImageResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateCustomCollectionNewImageResponse(customCollection: $customCollection)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateCustomCollectionNewImageResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateCustomCollectionNewImageResponseImplCopyWith<
          _$UpdateCustomCollectionNewImageResponseImpl>
      get copyWith =>
          __$$UpdateCustomCollectionNewImageResponseImplCopyWithImpl<
              _$UpdateCustomCollectionNewImageResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateCustomCollectionNewImageResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateCustomCollectionNewImageResponse
    implements UpdateCustomCollectionNewImageResponse {
  const factory _UpdateCustomCollectionNewImageResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection}) =
      _$UpdateCustomCollectionNewImageResponseImpl;

  factory _UpdateCustomCollectionNewImageResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdateCustomCollectionNewImageResponseImpl.fromJson;
