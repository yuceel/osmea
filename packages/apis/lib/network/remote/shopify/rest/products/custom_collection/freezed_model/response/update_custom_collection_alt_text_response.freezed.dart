...
part of 'update_custom_collection_alt_text_response.dart';
...
UpdateCustomCollectionAltTextResponse
    _$UpdateCustomCollectionAltTextResponseFromJson(Map<String, dynamic> json) {
  return _UpdateCustomCollectionAltTextResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateCustomCollectionAltTextResponse {
  @JsonKey(name: "custom_collection")
  CustomCollection? get customCollection => throw _privateConstructorUsedError;

  /// Serializes this UpdateCustomCollectionAltTextResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateCustomCollectionAltTextResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateCustomCollectionAltTextResponseCopyWith<
          UpdateCustomCollectionAltTextResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateCustomCollectionAltTextResponseCopyWith<$Res> {
  factory $UpdateCustomCollectionAltTextResponseCopyWith(
          UpdateCustomCollectionAltTextResponse value,
          $Res Function(UpdateCustomCollectionAltTextResponse) then) =
      _$UpdateCustomCollectionAltTextResponseCopyWithImpl<$Res,
          UpdateCustomCollectionAltTextResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateCustomCollectionAltTextResponseCopyWithImpl<$Res,
        $Val extends UpdateCustomCollectionAltTextResponse>
    implements $UpdateCustomCollectionAltTextResponseCopyWith<$Res> {
  _$UpdateCustomCollectionAltTextResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateCustomCollectionAltTextResponseImplCopyWith<$Res>
    implements $UpdateCustomCollectionAltTextResponseCopyWith<$Res> {
  factory _$$UpdateCustomCollectionAltTextResponseImplCopyWith(
          _$UpdateCustomCollectionAltTextResponseImpl value,
          $Res Function(_$UpdateCustomCollectionAltTextResponseImpl) then) =
      __$$UpdateCustomCollectionAltTextResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection});
...
/// @nodoc
class __$$UpdateCustomCollectionAltTextResponseImplCopyWithImpl<$Res>
    extends _$UpdateCustomCollectionAltTextResponseCopyWithImpl<$Res,
        _$UpdateCustomCollectionAltTextResponseImpl>
    implements _$$UpdateCustomCollectionAltTextResponseImplCopyWith<$Res> {
  __$$UpdateCustomCollectionAltTextResponseImplCopyWithImpl(
      _$UpdateCustomCollectionAltTextResponseImpl _value,
      $Res Function(_$UpdateCustomCollectionAltTextResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateCustomCollectionAltTextResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateCustomCollectionAltTextResponseImpl
    implements _UpdateCustomCollectionAltTextResponse {
  const _$UpdateCustomCollectionAltTextResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection});

  factory _$UpdateCustomCollectionAltTextResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateCustomCollectionAltTextResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateCustomCollectionAltTextResponse(customCollection: $customCollection)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateCustomCollectionAltTextResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateCustomCollectionAltTextResponseImplCopyWith<
          _$UpdateCustomCollectionAltTextResponseImpl>
      get copyWith => __$$UpdateCustomCollectionAltTextResponseImplCopyWithImpl<
          _$UpdateCustomCollectionAltTextResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateCustomCollectionAltTextResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateCustomCollectionAltTextResponse
    implements UpdateCustomCollectionAltTextResponse {
  const factory _UpdateCustomCollectionAltTextResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection}) =
      _$UpdateCustomCollectionAltTextResponseImpl;

  factory _UpdateCustomCollectionAltTextResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdateCustomCollectionAltTextResponseImpl.fromJson;
...
class _$CustomCollectionImpl implements _CustomCollection {
  ...
  @override
  String toString() {
    return 'CustomCollection(updatedAt: $updatedAt, id: $id, handle: $handle, title: $title, bodyHtml: $bodyHtml, publishedAt: $publishedAt, sortOrder: $sortOrder, templateSuffix: $templateSuffix, publishedScope: $publishedScope, adminGraphqlApiId: $adminGraphqlApiId, image: $image)';
  }
...
class _$ImageImpl implements _Image {
  ...
  @override
  String toString() {
    return 'Image(alt: $alt, createdAt: $createdAt, width: $width, height: $height, src: $src)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, alt, createdAt, width, height, src);
