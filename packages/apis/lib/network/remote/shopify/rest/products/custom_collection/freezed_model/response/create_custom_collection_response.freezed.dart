...
part of 'create_custom_collection_response.dart';
...
CreateCustomCollectionResponse _$CreateCustomCollectionResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateCustomCollectionResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCustomCollectionResponse {
  ...
  /// Serializes this CreateCustomCollectionResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCustomCollectionResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCustomCollectionResponseCopyWith<CreateCustomCollectionResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCustomCollectionResponseCopyWith<$Res> {
  factory $CreateCustomCollectionResponseCopyWith(
          CreateCustomCollectionResponse value,
          $Res Function(CreateCustomCollectionResponse) then) =
      _$CreateCustomCollectionResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateCustomCollectionResponseCopyWithImpl<$Res,
        $Val extends CreateCustomCollectionResponse>
    implements $CreateCustomCollectionResponseCopyWith<$Res> {
  _$CreateCustomCollectionResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCustomCollectionResponseImplCopyWith<$Res>
    implements $CreateCustomCollectionResponseCopyWith<$Res> {
  factory _$$CreateCustomCollectionResponseImplCopyWith(
          _$CreateCustomCollectionResponseImpl value,
          $Res Function(_$CreateCustomCollectionResponseImpl) then) =
      __$$CreateCustomCollectionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection,
...
/// @nodoc
class __$$CreateCustomCollectionResponseImplCopyWithImpl<$Res>
    extends _$CreateCustomCollectionResponseCopyWithImpl<$Res,
        _$CreateCustomCollectionResponseImpl>
    implements _$$CreateCustomCollectionResponseImplCopyWith<$Res> {
  __$$CreateCustomCollectionResponseImplCopyWithImpl(
      _$CreateCustomCollectionResponseImpl _value,
      $Res Function(_$CreateCustomCollectionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCustomCollectionResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCustomCollectionResponseImpl
    implements _CreateCustomCollectionResponse {
  const _$CreateCustomCollectionResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateCustomCollectionResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateCustomCollectionResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCustomCollectionResponse(customCollection: $customCollection, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCustomCollectionResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCustomCollectionResponseImplCopyWith<
          _$CreateCustomCollectionResponseImpl>
      get copyWith => __$$CreateCustomCollectionResponseImplCopyWithImpl<
          _$CreateCustomCollectionResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCustomCollectionResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateCustomCollectionResponse
    implements CreateCustomCollectionResponse {
  const factory _CreateCustomCollectionResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateCustomCollectionResponseImpl;

  factory _CreateCustomCollectionResponse.fromJson(Map<String, dynamic> json) =
      _$CreateCustomCollectionResponseImpl.fromJson;
