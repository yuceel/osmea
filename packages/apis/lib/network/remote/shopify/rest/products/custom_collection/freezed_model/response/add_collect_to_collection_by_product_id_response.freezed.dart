...
AddCollectToCollectionByProductIdResponse
    _$AddCollectToCollectionByProductIdResponseFromJson(
        Map<String, dynamic> json) {
  return _AddCollectToCollectionByProductIdResponse.fromJson(json);
}

/// @nodoc
mixin _$AddCollectToCollectionByProductIdResponse {
  @JsonKey(name: "custom_collection")
  CustomCollection? get customCollection => throw _privateConstructorUsedError;

  /// Serializes this AddCollectToCollectionByProductIdResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of AddCollectToCollectionByProductIdResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $AddCollectToCollectionByProductIdResponseCopyWith<
          AddCollectToCollectionByProductIdResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AddCollectToCollectionByProductIdResponseCopyWith<$Res> {
  factory $AddCollectToCollectionByProductIdResponseCopyWith(
          AddCollectToCollectionByProductIdResponse value,
          $Res Function(AddCollectToCollectionByProductIdResponse) then) =
      _$AddCollectToCollectionByProductIdResponseCopyWithImpl<$Res,
          AddCollectToCollectionByProductIdResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AddCollectToCollectionByProductIdResponseCopyWithImpl<$Res,
        $Val extends AddCollectToCollectionByProductIdResponse>
    implements $AddCollectToCollectionByProductIdResponseCopyWith<$Res> {
  _$AddCollectToCollectionByProductIdResponseCopyWithImpl(
...
/// @nodoc
abstract class _$$AddCollectToCollectionByProductIdResponseImplCopyWith<$Res>
    implements $AddCollectToCollectionByProductIdResponseCopyWith<$Res> {
  factory _$$AddCollectToCollectionByProductIdResponseImplCopyWith(
          _$AddCollectToCollectionByProductIdResponseImpl value,
          $Res Function(_$AddCollectToCollectionByProductIdResponseImpl) then) =
      __$$AddCollectToCollectionByProductIdResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection});
...
/// @nodoc
class __$$AddCollectToCollectionByProductIdResponseImplCopyWithImpl<$Res>
    extends _$AddCollectToCollectionByProductIdResponseCopyWithImpl<$Res,
        _$AddCollectToCollectionByProductIdResponseImpl>
    implements _$$AddCollectToCollectionByProductIdResponseImplCopyWith<$Res> {
  __$$AddCollectToCollectionByProductIdResponseImplCopyWithImpl(
      _$AddCollectToCollectionByProductIdResponseImpl _value,
      $Res Function(_$AddCollectToCollectionByProductIdResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AddCollectToCollectionByProductIdResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$AddCollectToCollectionByProductIdResponseImpl
    implements _AddCollectToCollectionByProductIdResponse {
  const _$AddCollectToCollectionByProductIdResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection});

  factory _$AddCollectToCollectionByProductIdResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$AddCollectToCollectionByProductIdResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'AddCollectToCollectionByProductIdResponse(customCollection: $customCollection)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AddCollectToCollectionByProductIdResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AddCollectToCollectionByProductIdResponseImplCopyWith<
          _$AddCollectToCollectionByProductIdResponseImpl>
      get copyWith =>
          __$$AddCollectToCollectionByProductIdResponseImplCopyWithImpl<
                  _$AddCollectToCollectionByProductIdResponseImpl>(
  ...
  Map<String, dynamic> toJson() {
    return _$$AddCollectToCollectionByProductIdResponseImplToJson(
      this,
    );
  }
}

abstract class _AddCollectToCollectionByProductIdResponse
    implements AddCollectToCollectionByProductIdResponse {
  const factory _AddCollectToCollectionByProductIdResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection}) =
      _$AddCollectToCollectionByProductIdResponseImpl;

  factory _AddCollectToCollectionByProductIdResponse.fromJson(
          Map<String, dynamic> json) =
      _$AddCollectToCollectionByProductIdResponseImpl.fromJson;
