...
SingleProductResponse _$SingleProductResponseFromJson(
  ...
  return _SingleProductResponse.fromJson(json);
}

/// @nodoc
mixin _$SingleProductResponse {
  @JsonKey(name: "product")
  Product? get product => throw _privateConstructorUsedError;

  /// Serializes this SingleProductResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SingleProductResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $SingleProductResponseCopyWith<SingleProductResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SingleProductResponseCopyWith<$Res> {
  factory $SingleProductResponseCopyWith(SingleProductResponse value,
          $Res Function(SingleProductResponse) then) =
      _$SingleProductResponseCopyWithImpl<$Res, SingleProductResponse>;
  @useResult
...
/// @nodoc
class _$SingleProductResponseCopyWithImpl<$Res,
        $Val extends SingleProductResponse>
    implements $SingleProductResponseCopyWith<$Res> {
  _$SingleProductResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SingleProductResponseImplCopyWith<$Res>
    implements $SingleProductResponseCopyWith<$Res> {
  factory _$$SingleProductResponseImplCopyWith(
          _$SingleProductResponseImpl value,
          $Res Function(_$SingleProductResponseImpl) then) =
      __$$SingleProductResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "product") Product? product});
...
/// @nodoc
class __$$SingleProductResponseImplCopyWithImpl<$Res>
    extends _$SingleProductResponseCopyWithImpl<$Res,
        _$SingleProductResponseImpl>
    implements _$$SingleProductResponseImplCopyWith<$Res> {
  __$$SingleProductResponseImplCopyWithImpl(_$SingleProductResponseImpl _value,
      $Res Function(_$SingleProductResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SingleProductResponseImpl(
      product: freezed == product
          ? _value.product
          : product // ignore: cast_nullable_to_non_nullable
              as Product?,
...
/// @nodoc
@JsonSerializable()
class _$SingleProductResponseImpl implements _SingleProductResponse {
  const _$SingleProductResponseImpl({@JsonKey(name: "product") this.product});

  factory _$SingleProductResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$SingleProductResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SingleProductResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SingleProductResponseImplCopyWith<_$SingleProductResponseImpl>
      get copyWith => __$$SingleProductResponseImplCopyWithImpl<
          _$SingleProductResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SingleProductResponseImplToJson(
      this,
    );
  }
}

abstract class _SingleProductResponse implements SingleProductResponse {
  const factory _SingleProductResponse(
          {@JsonKey(name: "product") final Product? product}) =
      _$SingleProductResponseImpl;

  factory _SingleProductResponse.fromJson(Map<String, dynamic> json) =
      _$SingleProductResponseImpl.fromJson;
