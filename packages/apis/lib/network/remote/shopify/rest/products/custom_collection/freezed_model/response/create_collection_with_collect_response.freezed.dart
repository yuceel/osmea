...
CreateCollectionWithCollectResponse
    _$CreateCollectionWithCollectResponseFromJson(Map<String, dynamic> json) {
  return _CreateCollectionWithCollectResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCollectionWithCollectResponse {
  ...
  /// Serializes this CreateCollectionWithCollectResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCollectionWithCollectResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCollectionWithCollectResponseCopyWith<
          CreateCollectionWithCollectResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCollectionWithCollectResponseCopyWith<$Res> {
  factory $CreateCollectionWithCollectResponseCopyWith(
          CreateCollectionWithCollectResponse value,
          $Res Function(CreateCollectionWithCollectResponse) then) =
      _$CreateCollectionWithCollectResponseCopyWithImpl<$Res,
          CreateCollectionWithCollectResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateCollectionWithCollectResponseCopyWithImpl<$Res,
        $Val extends CreateCollectionWithCollectResponse>
    implements $CreateCollectionWithCollectResponseCopyWith<$Res> {
  _$CreateCollectionWithCollectResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCollectionWithCollectResponseImplCopyWith<$Res>
    implements $CreateCollectionWithCollectResponseCopyWith<$Res> {
  factory _$$CreateCollectionWithCollectResponseImplCopyWith(
          _$CreateCollectionWithCollectResponseImpl value,
          $Res Function(_$CreateCollectionWithCollectResponseImpl) then) =
      __$$CreateCollectionWithCollectResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection,
...
/// @nodoc
class __$$CreateCollectionWithCollectResponseImplCopyWithImpl<$Res>
    extends _$CreateCollectionWithCollectResponseCopyWithImpl<$Res,
        _$CreateCollectionWithCollectResponseImpl>
    implements _$$CreateCollectionWithCollectResponseImplCopyWith<$Res> {
  __$$CreateCollectionWithCollectResponseImplCopyWithImpl(
      _$CreateCollectionWithCollectResponseImpl _value,
      $Res Function(_$CreateCollectionWithCollectResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCollectionWithCollectResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCollectionWithCollectResponseImpl
    implements _CreateCollectionWithCollectResponse {
  const _$CreateCollectionWithCollectResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateCollectionWithCollectResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateCollectionWithCollectResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCollectionWithCollectResponse(customCollection: $customCollection, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCollectionWithCollectResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCollectionWithCollectResponseImplCopyWith<
          _$CreateCollectionWithCollectResponseImpl>
      get copyWith => __$$CreateCollectionWithCollectResponseImplCopyWithImpl<
          _$CreateCollectionWithCollectResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCollectionWithCollectResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateCollectionWithCollectResponse
    implements CreateCollectionWithCollectResponse {
  const factory _CreateCollectionWithCollectResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateCollectionWithCollectResponseImpl;

  factory _CreateCollectionWithCollectResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateCollectionWithCollectResponseImpl.fromJson;
