...
_$CreateCustomCollectionResponseImpl
    _$$CreateCustomCollectionResponseImplFromJson(Map<String, dynamic> json) =>
        _$CreateCustomCollectionResponseImpl(
...
Map<String, dynamic> _$$CreateCustomCollectionResponseImplToJson(
        _$CreateCustomCollectionResponseImpl instance) =>
    <String, dynamic>{
