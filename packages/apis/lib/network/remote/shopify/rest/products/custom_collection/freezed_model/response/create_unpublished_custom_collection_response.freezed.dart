...
CreateUnpublishedCustomCollectionResponse
    _$CreateUnpublishedCustomCollectionResponseFromJson(
        Map<String, dynamic> json) {
  return _CreateUnpublishedCustomCollectionResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateUnpublishedCustomCollectionResponse {
  ...
  /// Serializes this CreateUnpublishedCustomCollectionResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateUnpublishedCustomCollectionResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateUnpublishedCustomCollectionResponseCopyWith<
          CreateUnpublishedCustomCollectionResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateUnpublishedCustomCollectionResponseCopyWith<$Res> {
  factory $CreateUnpublishedCustomCollectionResponseCopyWith(
          CreateUnpublishedCustomCollectionResponse value,
          $Res Function(CreateUnpublishedCustomCollectionResponse) then) =
      _$CreateUnpublishedCustomCollectionResponseCopyWithImpl<$Res,
          CreateUnpublishedCustomCollectionResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateUnpublishedCustomCollectionResponseCopyWithImpl<$Res,
        $Val extends CreateUnpublishedCustomCollectionResponse>
    implements $CreateUnpublishedCustomCollectionResponseCopyWith<$Res> {
  _$CreateUnpublishedCustomCollectionResponseCopyWithImpl(
...
/// @nodoc
abstract class _$$CreateUnpublishedCustomCollectionResponseImplCopyWith<$Res>
    implements $CreateUnpublishedCustomCollectionResponseCopyWith<$Res> {
  factory _$$CreateUnpublishedCustomCollectionResponseImplCopyWith(
          _$CreateUnpublishedCustomCollectionResponseImpl value,
          $Res Function(_$CreateUnpublishedCustomCollectionResponseImpl) then) =
      __$$CreateUnpublishedCustomCollectionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "custom_collection") CustomCollection? customCollection,
...
/// @nodoc
class __$$CreateUnpublishedCustomCollectionResponseImplCopyWithImpl<$Res>
    extends _$CreateUnpublishedCustomCollectionResponseCopyWithImpl<$Res,
        _$CreateUnpublishedCustomCollectionResponseImpl>
    implements _$$CreateUnpublishedCustomCollectionResponseImplCopyWith<$Res> {
  __$$CreateUnpublishedCustomCollectionResponseImplCopyWithImpl(
      _$CreateUnpublishedCustomCollectionResponseImpl _value,
      $Res Function(_$CreateUnpublishedCustomCollectionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateUnpublishedCustomCollectionResponseImpl(
      customCollection: freezed == customCollection
          ? _value.customCollection
          : customCollection // ignore: cast_nullable_to_non_nullable
              as CustomCollection?,
...
/// @nodoc
@JsonSerializable()
class _$CreateUnpublishedCustomCollectionResponseImpl
    implements _CreateUnpublishedCustomCollectionResponse {
  const _$CreateUnpublishedCustomCollectionResponseImpl(
      {@JsonKey(name: "custom_collection") this.customCollection,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateUnpublishedCustomCollectionResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateUnpublishedCustomCollectionResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateUnpublishedCustomCollectionResponse(customCollection: $customCollection, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateUnpublishedCustomCollectionResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateUnpublishedCustomCollectionResponseImplCopyWith<
          _$CreateUnpublishedCustomCollectionResponseImpl>
      get copyWith =>
          __$$CreateUnpublishedCustomCollectionResponseImplCopyWithImpl<
                  _$CreateUnpublishedCustomCollectionResponseImpl>(
  ...
  Map<String, dynamic> toJson() {
    return _$$CreateUnpublishedCustomCollectionResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateUnpublishedCustomCollectionResponse
    implements CreateUnpublishedCustomCollectionResponse {
  const factory _CreateUnpublishedCustomCollectionResponse(
          {@JsonKey(name: "custom_collection")
          final CustomCollection? customCollection,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateUnpublishedCustomCollectionResponseImpl;

  factory _CreateUnpublishedCustomCollectionResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateUnpublishedCustomCollectionResponseImpl.fromJson;
