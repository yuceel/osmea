...
_$UpdateProductVariantResponseImpl _$$UpdateProductVariantResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$UpdateProductVariantResponseImpl(
      variant: json['variant'] == null
          ? null
          : UpdatedProductVariantResponse.fromJson(
    ...
    _$$UpdatedProductVariantResponseImplFromJson(Map<String, dynamic> json) =>
        _$UpdatedProductVariantResponseImpl(
          ...
          presentmentPrices: (json['presentment_prices'] as List<dynamic>?)
              ?.map((e) => UpdatedPresentmentPriceResponse.fromJson(
