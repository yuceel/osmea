...
_$RetrievesListOfProductVariantsResponseImpl
    _$$RetrievesListOfProductVariantsResponseImplFromJson(
...
Map<String, dynamic> _$$RetrievesListOfProductVariantsResponseImplToJson(
        _$RetrievesListOfProductVariantsResponseImpl instance) =>
    <String, dynamic>{
      if (instance.variants?.map((e) => e.toJson()).toList() case final value?)
        'variants': value,
    };

_$ProductVariantResponseImpl _$$ProductVariantResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$ProductVariantResponseImpl(
      ...
      presentmentPrices: (json['presentment_prices'] as List<dynamic>?)
          ?.map((e) =>
              PresentmentPriceResponse.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$ProductVariantResponseImplToJson(
        _$ProductVariantResponseImpl instance) =>
    <String, dynamic>{
...
_$PresentmentPriceResponseImpl _$$PresentmentPriceResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$PresentmentPriceResponseImpl(
      ...
      compareAtPrice: json['compare_at_price'] == null
          ? null
          : MoneyResponse.fromJson(
              json['compare_at_price'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$$PresentmentPriceResponseImplToJson(
        _$PresentmentPriceResponseImpl instance) =>
    <String, dynamic>{
...
_$MoneyResponseImpl _$$MoneyResponseImplFromJson(Map<String, dynamic> json) =>
    _$MoneyResponseImpl(
      amount: json['amount'] as String?,
      currencyCode: json['currency_code'] as String?,
    );

Map<String, dynamic> _$$MoneyResponseImplToJson(_$MoneyResponseImpl instance) =>
    <String, dynamic>{
