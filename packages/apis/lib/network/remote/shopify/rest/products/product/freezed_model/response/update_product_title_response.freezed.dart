...
part of 'update_product_title_response.dart';
...
UpdateProductTitleResponse _$UpdateProductTitleResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductTitleResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductTitleResponse {
  @JsonKey(name: "product")
  Product? get product => throw _privateConstructorUsedError;

  /// Serializes this UpdateProductTitleResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductTitleResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductTitleResponseCopyWith<UpdateProductTitleResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductTitleResponseCopyWith<$Res> {
  factory $UpdateProductTitleResponseCopyWith(UpdateProductTitleResponse value,
          $Res Function(UpdateProductTitleResponse) then) =
      _$UpdateProductTitleResponseCopyWithImpl<$Res,
          UpdateProductTitleResponse>;
  @useResult
...
/// @nodoc
class _$UpdateProductTitleResponseCopyWithImpl<$Res,
        $Val extends UpdateProductTitleResponse>
    implements $UpdateProductTitleResponseCopyWith<$Res> {
  _$UpdateProductTitleResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductTitleResponseImplCopyWith<$Res>
    implements $UpdateProductTitleResponseCopyWith<$Res> {
  factory _$$UpdateProductTitleResponseImplCopyWith(
          _$UpdateProductTitleResponseImpl value,
          $Res Function(_$UpdateProductTitleResponseImpl) then) =
      __$$UpdateProductTitleResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "product") Product? product});
...
/// @nodoc
class __$$UpdateProductTitleResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductTitleResponseCopyWithImpl<$Res,
        _$UpdateProductTitleResponseImpl>
    implements _$$UpdateProductTitleResponseImplCopyWith<$Res> {
  __$$UpdateProductTitleResponseImplCopyWithImpl(
      _$UpdateProductTitleResponseImpl _value,
      $Res Function(_$UpdateProductTitleResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductTitleResponseImpl(
      product: freezed == product
          ? _value.product
          : product // ignore: cast_nullable_to_non_nullable
              as Product?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductTitleResponseImpl implements _UpdateProductTitleResponse {
  const _$UpdateProductTitleResponseImpl(
      {@JsonKey(name: "product") this.product});

  factory _$UpdateProductTitleResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductTitleResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductTitleResponse(product: $product)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductTitleResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductTitleResponseImplCopyWith<_$UpdateProductTitleResponseImpl>
      get copyWith => __$$UpdateProductTitleResponseImplCopyWithImpl<
          _$UpdateProductTitleResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductTitleResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductTitleResponse
    implements UpdateProductTitleResponse {
  const factory _UpdateProductTitleResponse(
          {@JsonKey(name: "product") final Product? product}) =
      _$UpdateProductTitleResponseImpl;

  factory _UpdateProductTitleResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductTitleResponseImpl.fromJson;
