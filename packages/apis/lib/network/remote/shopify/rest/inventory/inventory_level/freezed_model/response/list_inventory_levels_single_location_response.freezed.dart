...
ListInventoryLevelsSingleLocationResponse
    _$ListInventoryLevelsSingleLocationResponseFromJson(
        Map<String, dynamic> json) {
  return _ListInventoryLevelsSingleLocationResponse.fromJson(json);
}

/// @nodoc
mixin _$ListInventoryLevelsSingleLocationResponse {
  @JsonKey(name: "inventory_levels")
  List<InventoryLevel>? get inventoryLevels =>
      throw _privateConstructorUsedError;

  /// Serializes this ListInventoryLevelsSingleLocationResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListInventoryLevelsSingleLocationResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListInventoryLevelsSingleLocationResponseCopyWith<
          ListInventoryLevelsSingleLocationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListInventoryLevelsSingleLocationResponseCopyWith<$Res> {
  factory $ListInventoryLevelsSingleLocationResponseCopyWith(
          ListInventoryLevelsSingleLocationResponse value,
          $Res Function(ListInventoryLevelsSingleLocationResponse) then) =
      _$ListInventoryLevelsSingleLocationResponseCopyWithImpl<$Res,
          ListInventoryLevelsSingleLocationResponse>;
  @useResult
  $Res call(
      {@JsonKey(name: "inventory_levels")
...
/// @nodoc
class _$ListInventoryLevelsSingleLocationResponseCopyWithImpl<$Res,
        $Val extends ListInventoryLevelsSingleLocationResponse>
    implements $ListInventoryLevelsSingleLocationResponseCopyWith<$Res> {
  _$ListInventoryLevelsSingleLocationResponseCopyWithImpl(
...
/// @nodoc
abstract class _$$ListInventoryLevelsSingleLocationResponseImplCopyWith<$Res>
    implements $ListInventoryLevelsSingleLocationResponseCopyWith<$Res> {
  factory _$$ListInventoryLevelsSingleLocationResponseImplCopyWith(
          _$ListInventoryLevelsSingleLocationResponseImpl value,
          $Res Function(_$ListInventoryLevelsSingleLocationResponseImpl) then) =
      __$$ListInventoryLevelsSingleLocationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "inventory_levels")
...
/// @nodoc
class __$$ListInventoryLevelsSingleLocationResponseImplCopyWithImpl<$Res>
    extends _$ListInventoryLevelsSingleLocationResponseCopyWithImpl<$Res,
        _$ListInventoryLevelsSingleLocationResponseImpl>
    implements _$$ListInventoryLevelsSingleLocationResponseImplCopyWith<$Res> {
  __$$ListInventoryLevelsSingleLocationResponseImplCopyWithImpl(
      _$ListInventoryLevelsSingleLocationResponseImpl _value,
      $Res Function(_$ListInventoryLevelsSingleLocationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListInventoryLevelsSingleLocationResponseImpl(
      inventoryLevels: freezed == inventoryLevels
...
/// @nodoc
@JsonSerializable()
class _$ListInventoryLevelsSingleLocationResponseImpl
    implements _ListInventoryLevelsSingleLocationResponse {
  const _$ListInventoryLevelsSingleLocationResponseImpl(
      {@JsonKey(name: "inventory_levels")
      final List<InventoryLevel>? inventoryLevels})
      : _inventoryLevels = inventoryLevels;

  factory _$ListInventoryLevelsSingleLocationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListInventoryLevelsSingleLocationResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListInventoryLevelsSingleLocationResponse(inventoryLevels: $inventoryLevels)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListInventoryLevelsSingleLocationResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListInventoryLevelsSingleLocationResponseImplCopyWith<
          _$ListInventoryLevelsSingleLocationResponseImpl>
      get copyWith =>
          __$$ListInventoryLevelsSingleLocationResponseImplCopyWithImpl<
                  _$ListInventoryLevelsSingleLocationResponseImpl>(
  ...
  Map<String, dynamic> toJson() {
    return _$$ListInventoryLevelsSingleLocationResponseImplToJson(
      this,
    );
  }
}

abstract class _ListInventoryLevelsSingleLocationResponse
    implements ListInventoryLevelsSingleLocationResponse {
  const factory _ListInventoryLevelsSingleLocationResponse(
          {@JsonKey(name: "inventory_levels")
          final List<InventoryLevel>? inventoryLevels}) =
      _$ListInventoryLevelsSingleLocationResponseImpl;

  factory _ListInventoryLevelsSingleLocationResponse.fromJson(
          Map<String, dynamic> json) =
      _$ListInventoryLevelsSingleLocationResponseImpl.fromJson;
