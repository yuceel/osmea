...
part of 'set_inventory_location_response.dart';
...
SetInventoryLocationResponse _$SetInventoryLocationResponseFromJson(
    Map<String, dynamic> json) {
  return _SetInventoryLocationResponse.fromJson(json);
}

/// @nodoc
mixin _$SetInventoryLocationResponse {
  @JsonKey(name: "inventory_level")
  InventoryLevel? get inventoryLevel => throw _privateConstructorUsedError;
  @JsonKey(name: "errors")
  List<String>? get errors => throw _privateConstructorUsedError;

  /// Serializes this SetInventoryLocationResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SetInventoryLocationResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $SetInventoryLocationResponseCopyWith<SetInventoryLocationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SetInventoryLocationResponseCopyWith<$Res> {
  factory $SetInventoryLocationResponseCopyWith(
          SetInventoryLocationResponse value,
          $Res Function(SetInventoryLocationResponse) then) =
      _$SetInventoryLocationResponseCopyWithImpl<$Res,
          SetInventoryLocationResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SetInventoryLocationResponseCopyWithImpl<$Res,
        $Val extends SetInventoryLocationResponse>
    implements $SetInventoryLocationResponseCopyWith<$Res> {
  _$SetInventoryLocationResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SetInventoryLocationResponseImplCopyWith<$Res>
    implements $SetInventoryLocationResponseCopyWith<$Res> {
  factory _$$SetInventoryLocationResponseImplCopyWith(
          _$SetInventoryLocationResponseImpl value,
          $Res Function(_$SetInventoryLocationResponseImpl) then) =
      __$$SetInventoryLocationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "inventory_level") InventoryLevel? inventoryLevel,
...
/// @nodoc
class __$$SetInventoryLocationResponseImplCopyWithImpl<$Res>
    extends _$SetInventoryLocationResponseCopyWithImpl<$Res,
        _$SetInventoryLocationResponseImpl>
    implements _$$SetInventoryLocationResponseImplCopyWith<$Res> {
  __$$SetInventoryLocationResponseImplCopyWithImpl(
      _$SetInventoryLocationResponseImpl _value,
      $Res Function(_$SetInventoryLocationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SetInventoryLocationResponseImpl(
      inventoryLevel: freezed == inventoryLevel
          ? _value.inventoryLevel
          : inventoryLevel // ignore: cast_nullable_to_non_nullable
              as InventoryLevel?,
...
/// @nodoc
@JsonSerializable()
class _$SetInventoryLocationResponseImpl
    implements _SetInventoryLocationResponse {
  const _$SetInventoryLocationResponseImpl(
      {@JsonKey(name: "inventory_level") this.inventoryLevel,
      @JsonKey(name: "errors") final List<String>? errors})
      : _errors = errors;

  factory _$SetInventoryLocationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$SetInventoryLocationResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'SetInventoryLocationResponse(inventoryLevel: $inventoryLevel, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SetInventoryLocationResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SetInventoryLocationResponseImplCopyWith<
          _$SetInventoryLocationResponseImpl>
      get copyWith => __$$SetInventoryLocationResponseImplCopyWithImpl<
          _$SetInventoryLocationResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SetInventoryLocationResponseImplToJson(
      this,
    );
  }
}

abstract class _SetInventoryLocationResponse
    implements SetInventoryLocationResponse {
  const factory _SetInventoryLocationResponse(
      {@JsonKey(name: "inventory_level") final InventoryLevel? inventoryLevel,
      @JsonKey(name: "errors")
      final List<String>? errors}) = _$SetInventoryLocationResponseImpl;

  factory _SetInventoryLocationResponse.fromJson(Map<String, dynamic> json) =
      _$SetInventoryLocationResponseImpl.fromJson;
