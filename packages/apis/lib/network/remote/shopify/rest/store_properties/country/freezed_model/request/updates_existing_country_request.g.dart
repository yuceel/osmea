...
_$UpdatesExistingCountryRequestImpl
    _$$UpdatesExistingCountryRequestImplFromJson(Map<String, dynamic> json) =>
        _$UpdatesExistingCountryRequestImpl(
          country: Country.fromJson(json['country'] as Map<String, dynamic>),
        );

Map<String, dynamic> _$$UpdatesExistingCountryRequestImplToJson(
        _$UpdatesExistingCountryRequestImpl instance) =>
    <String, dynamic>{
