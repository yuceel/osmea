...
part of 'retrieves_single_customer_response.dart';
...
RetrievesSingleCustomerResponse _$RetrievesSingleCustomerResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrievesSingleCustomerResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrievesSingleCustomerResponse {
...
/// @nodoc
abstract class $RetrievesSingleCustomerResponseCopyWith<$Res> {
  factory $RetrievesSingleCustomerResponseCopyWith(
          RetrievesSingleCustomerResponse value,
          $Res Function(RetrievesSingleCustomerResponse) then) =
      _$RetrievesSingleCustomerResponseCopyWithImpl<$Res,
          RetrievesSingleCustomerResponse>;
  @useResult
...
/// @nodoc
class _$RetrievesSingleCustomerResponseCopyWithImpl<$Res,
        $Val extends RetrievesSingleCustomerResponse>
    implements $RetrievesSingleCustomerResponseCopyWith<$Res> {
  _$RetrievesSingleCustomerResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrievesSingleCustomerResponseImplCopyWith<$Res>
    implements $RetrievesSingleCustomerResponseCopyWith<$Res> {
  factory _$$RetrievesSingleCustomerResponseImplCopyWith(
          _$RetrievesSingleCustomerResponseImpl value,
          $Res Function(_$RetrievesSingleCustomerResponseImpl) then) =
      __$$RetrievesSingleCustomerResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "customer") Customer? customer});
...
/// @nodoc
class __$$RetrievesSingleCustomerResponseImplCopyWithImpl<$Res>
    extends _$RetrievesSingleCustomerResponseCopyWithImpl<$Res,
        _$RetrievesSingleCustomerResponseImpl>
    implements _$$RetrievesSingleCustomerResponseImplCopyWith<$Res> {
  __$$RetrievesSingleCustomerResponseImplCopyWithImpl(
      _$RetrievesSingleCustomerResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$RetrievesSingleCustomerResponseImpl(
      customer: freezed == customer
          ? _value.customer
          : customer // ignore: cast_nullable_to_non_nullable
              as Customer?,
...
/// @nodoc
@JsonSerializable()
class _$RetrievesSingleCustomerResponseImpl
    implements _RetrievesSingleCustomerResponse {
  const _$RetrievesSingleCustomerResponseImpl(
      {@JsonKey(name: "customer") this.customer});

  factory _$RetrievesSingleCustomerResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrievesSingleCustomerResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrievesSingleCustomerResponse(customer: $customer)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrievesSingleCustomerResponseImpl &&
  ...
  _$$RetrievesSingleCustomerResponseImplCopyWith<
          _$RetrievesSingleCustomerResponseImpl>
      get copyWith => __$$RetrievesSingleCustomerResponseImplCopyWithImpl<
          _$RetrievesSingleCustomerResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrievesSingleCustomerResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrievesSingleCustomerResponse
    implements RetrievesSingleCustomerResponse {
  const factory _RetrievesSingleCustomerResponse(
          {@JsonKey(name: "customer") final Customer? customer}) =
      _$RetrievesSingleCustomerResponseImpl;

  factory _RetrievesSingleCustomerResponse.fromJson(Map<String, dynamic> json) =
      _$RetrievesSingleCustomerResponseImpl.fromJson;
