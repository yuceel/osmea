...
CreateNewCustomerRecordResponse _$CreateNewCustomerRecordResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateNewCustomerRecordResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateNewCustomerRecordResponse {
  @JsonKey(name: "customer")
  Customer? get customer => throw _privateConstructorUsedError;

  /// Serializes this CreateNewCustomerRecordResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateNewCustomerRecordResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateNewCustomerRecordResponseCopyWith<CreateNewCustomerRecordResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateNewCustomerRecordResponseCopyWith<$Res> {
  factory $CreateNewCustomerRecordResponseCopyWith(
          CreateNewCustomerRecordResponse value,
          $Res Function(CreateNewCustomerRecordResponse) then) =
      _$CreateNewCustomerRecordResponseCopyWithImpl<$Res,
          CreateNewCustomerRecordResponse>;
  @useResult
...
/// @nodoc
class _$CreateNewCustomerRecordResponseCopyWithImpl<$Res,
        $Val extends CreateNewCustomerRecordResponse>
    implements $CreateNewCustomerRecordResponseCopyWith<$Res> {
  _$CreateNewCustomerRecordResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateNewCustomerRecordResponseImplCopyWith<$Res>
    implements $CreateNewCustomerRecordResponseCopyWith<$Res> {
  factory _$$CreateNewCustomerRecordResponseImplCopyWith(
          _$CreateNewCustomerRecordResponseImpl value,
          $Res Function(_$CreateNewCustomerRecordResponseImpl) then) =
      __$$CreateNewCustomerRecordResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "customer") Customer? customer});
...
/// @nodoc
class __$$CreateNewCustomerRecordResponseImplCopyWithImpl<$Res>
    extends _$CreateNewCustomerRecordResponseCopyWithImpl<$Res,
        _$CreateNewCustomerRecordResponseImpl>
    implements _$$CreateNewCustomerRecordResponseImplCopyWith<$Res> {
  __$$CreateNewCustomerRecordResponseImplCopyWithImpl(
      _$CreateNewCustomerRecordResponseImpl _value,
      $Res Function(_$CreateNewCustomerRecordResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateNewCustomerRecordResponseImpl(
      customer: freezed == customer
          ? _value.customer
          : customer // ignore: cast_nullable_to_non_nullable
              as Customer?,
...
/// @nodoc
@JsonSerializable()
class _$CreateNewCustomerRecordResponseImpl
    implements _CreateNewCustomerRecordResponse {
  const _$CreateNewCustomerRecordResponseImpl(
      {@JsonKey(name: "customer") this.customer});

  factory _$CreateNewCustomerRecordResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateNewCustomerRecordResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateNewCustomerRecordResponse(customer: $customer)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateNewCustomerRecordResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateNewCustomerRecordResponseImplCopyWith<
          _$CreateNewCustomerRecordResponseImpl>
      get copyWith => __$$CreateNewCustomerRecordResponseImplCopyWithImpl<
          _$CreateNewCustomerRecordResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateNewCustomerRecordResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateNewCustomerRecordResponse
    implements CreateNewCustomerRecordResponse {
  const factory _CreateNewCustomerRecordResponse(
          {@JsonKey(name: "customer") final Customer? customer}) =
      _$CreateNewCustomerRecordResponseImpl;

  factory _CreateNewCustomerRecordResponse.fromJson(Map<String, dynamic> json) =
      _$CreateNewCustomerRecordResponseImpl.fromJson;
...
abstract class _Address implements Address {
  const factory _Address(
      ...
      @JsonKey(name: "address2") final dynamic address2,
