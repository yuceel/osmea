...
RetrievesDetailsForSingleCustomerAddressResponse
    _$RetrievesDetailsForSingleCustomerAddressResponseFromJson(
        Map<String, dynamic> json) {
  return _RetrievesDetailsForSingleCustomerAddressResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrievesDetailsForSingleCustomerAddressResponse {
  @JsonKey(name: "customer_address")
  CustomerAddress? get customerAddress => throw _privateConstructorUsedError;

  /// Serializes this RetrievesDetailsForSingleCustomerAddressResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrievesDetailsForSingleCustomerAddressResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrievesDetailsForSingleCustomerAddressResponseCopyWith<
          RetrievesDetailsForSingleCustomerAddressResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrievesDetailsForSingleCustomerAddressResponseCopyWith<$Res> {
  factory $RetrievesDetailsForSingleCustomerAddressResponseCopyWith(
          RetrievesDetailsForSingleCustomerAddressResponse value,
          $Res Function(RetrievesDetailsForSingleCustomerAddressResponse)
              then) =
      _$RetrievesDetailsForSingleCustomerAddressResponseCopyWithImpl<$Res,
          RetrievesDetailsForSingleCustomerAddressResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrievesDetailsForSingleCustomerAddressResponseCopyWithImpl<$Res,
        $Val extends RetrievesDetailsForSingleCustomerAddressResponse>
    implements $RetrievesDetailsForSingleCustomerAddressResponseCopyWith<$Res> {
  _$RetrievesDetailsForSingleCustomerAddressResponseCopyWithImpl(
...
/// @nodoc
abstract class _$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWith<
        $Res>
    implements $RetrievesDetailsForSingleCustomerAddressResponseCopyWith<$Res> {
  factory _$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWith(
          _$RetrievesDetailsForSingleCustomerAddressResponseImpl value,
          $Res Function(_$RetrievesDetailsForSingleCustomerAddressResponseImpl)
              then) =
      __$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWithImpl<
          $Res>;
  @override
  @useResult
  $Res call(
...
/// @nodoc
class __$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWithImpl<$Res>
    extends _$RetrievesDetailsForSingleCustomerAddressResponseCopyWithImpl<$Res,
        _$RetrievesDetailsForSingleCustomerAddressResponseImpl>
    implements
        _$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWith<$Res> {
  __$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWithImpl(
      _$RetrievesDetailsForSingleCustomerAddressResponseImpl _value,
      $Res Function(_$RetrievesDetailsForSingleCustomerAddressResponseImpl)
          _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrievesDetailsForSingleCustomerAddressResponseImpl(
      customerAddress: freezed == customerAddress
          ? _value.customerAddress
          : customerAddress // ignore: cast_nullable_to_non_nullable
              as CustomerAddress?,
...
/// @nodoc
@JsonSerializable()
class _$RetrievesDetailsForSingleCustomerAddressResponseImpl
    implements _RetrievesDetailsForSingleCustomerAddressResponse {
  const _$RetrievesDetailsForSingleCustomerAddressResponseImpl(
      {@JsonKey(name: "customer_address") this.customerAddress});

  factory _$RetrievesDetailsForSingleCustomerAddressResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrievesDetailsForSingleCustomerAddressResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrievesDetailsForSingleCustomerAddressResponse(customerAddress: $customerAddress)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrievesDetailsForSingleCustomerAddressResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWith<
          _$RetrievesDetailsForSingleCustomerAddressResponseImpl>
      get copyWith =>
          __$$RetrievesDetailsForSingleCustomerAddressResponseImplCopyWithImpl<
                  _$RetrievesDetailsForSingleCustomerAddressResponseImpl>(
  ...
  Map<String, dynamic> toJson() {
    return _$$RetrievesDetailsForSingleCustomerAddressResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrievesDetailsForSingleCustomerAddressResponse
    implements RetrievesDetailsForSingleCustomerAddressResponse {
  const factory _RetrievesDetailsForSingleCustomerAddressResponse(
          {@JsonKey(name: "customer_address")
          final CustomerAddress? customerAddress}) =
      _$RetrievesDetailsForSingleCustomerAddressResponseImpl;

  factory _RetrievesDetailsForSingleCustomerAddressResponse.fromJson(
          Map<String, dynamic> json) =
      _$RetrievesDetailsForSingleCustomerAddressResponseImpl.fromJson;
