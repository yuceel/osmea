...
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/create_new_customer_record_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/creates_account_activation_url_for_customer_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/retrieves_all_orders_belonging_to_customer_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/retrieves_count_of_customers_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/retrieves_list_of_customers_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/retrieves_single_customer_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/searches_for_customers_that_match_supplied_query_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/sends_account_invite_to_customer_response.dart';
import 'package:apis/network/remote/shopify/rest/customers/customer/freezed_model/response/updates_customer_response.dart';
