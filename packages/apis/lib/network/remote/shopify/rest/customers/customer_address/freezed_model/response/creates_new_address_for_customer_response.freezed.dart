...
CreatesNewAddressForCustomerResponse
    _$CreatesNewAddressForCustomerResponseFromJson(Map<String, dynamic> json) {
  return _CreatesNewAddressForCustomerResponse.fromJson(json);
}

/// @nodoc
mixin _$CreatesNewAddressForCustomerResponse {
  @JsonKey(name: "customer_address")
  CustomerAddress? get customerAddress => throw _privateConstructorUsedError;

  /// Serializes this CreatesNewAddressForCustomerResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreatesNewAddressForCustomerResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreatesNewAddressForCustomerResponseCopyWith<
          CreatesNewAddressForCustomerResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreatesNewAddressForCustomerResponseCopyWith<$Res> {
  factory $CreatesNewAddressForCustomerResponseCopyWith(
          CreatesNewAddressForCustomerResponse value,
          $Res Function(CreatesNewAddressForCustomerResponse) then) =
      _$CreatesNewAddressForCustomerResponseCopyWithImpl<$Res,
          CreatesNewAddressForCustomerResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreatesNewAddressForCustomerResponseCopyWithImpl<$Res,
        $Val extends CreatesNewAddressForCustomerResponse>
    implements $CreatesNewAddressForCustomerResponseCopyWith<$Res> {
  _$CreatesNewAddressForCustomerResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreatesNewAddressForCustomerResponseImplCopyWith<$Res>
    implements $CreatesNewAddressForCustomerResponseCopyWith<$Res> {
  factory _$$CreatesNewAddressForCustomerResponseImplCopyWith(
          _$CreatesNewAddressForCustomerResponseImpl value,
          $Res Function(_$CreatesNewAddressForCustomerResponseImpl) then) =
      __$$CreatesNewAddressForCustomerResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "customer_address") CustomerAddress? customerAddress});
...
/// @nodoc
class __$$CreatesNewAddressForCustomerResponseImplCopyWithImpl<$Res>
    extends _$CreatesNewAddressForCustomerResponseCopyWithImpl<$Res,
        _$CreatesNewAddressForCustomerResponseImpl>
    implements _$$CreatesNewAddressForCustomerResponseImplCopyWith<$Res> {
  __$$CreatesNewAddressForCustomerResponseImplCopyWithImpl(
      _$CreatesNewAddressForCustomerResponseImpl _value,
      $Res Function(_$CreatesNewAddressForCustomerResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreatesNewAddressForCustomerResponseImpl(
      customerAddress: freezed == customerAddress
          ? _value.customerAddress
          : customerAddress // ignore: cast_nullable_to_non_nullable
              as CustomerAddress?,
...
/// @nodoc
@JsonSerializable()
class _$CreatesNewAddressForCustomerResponseImpl
    implements _CreatesNewAddressForCustomerResponse {
  const _$CreatesNewAddressForCustomerResponseImpl(
      {@JsonKey(name: "customer_address") this.customerAddress});

  factory _$CreatesNewAddressForCustomerResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreatesNewAddressForCustomerResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreatesNewAddressForCustomerResponse(customerAddress: $customerAddress)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreatesNewAddressForCustomerResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreatesNewAddressForCustomerResponseImplCopyWith<
          _$CreatesNewAddressForCustomerResponseImpl>
      get copyWith => __$$CreatesNewAddressForCustomerResponseImplCopyWithImpl<
          _$CreatesNewAddressForCustomerResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreatesNewAddressForCustomerResponseImplToJson(
      this,
    );
  }
}

abstract class _CreatesNewAddressForCustomerResponse
    implements CreatesNewAddressForCustomerResponse {
  const factory _CreatesNewAddressForCustomerResponse(
          {@JsonKey(name: "customer_address")
          final CustomerAddress? customerAddress}) =
      _$CreatesNewAddressForCustomerResponseImpl;

  factory _CreatesNewAddressForCustomerResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreatesNewAddressForCustomerResponseImpl.fromJson;
