...
RetrievesSingleGiftCardResponse _$RetrievesSingleGiftCardResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrievesSingleGiftCardResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrievesSingleGiftCardResponse {
  @JsonKey(name: "gift_card")
  GiftCard? get giftCard => throw _privateConstructorUsedError;

  /// Serializes this RetrievesSingleGiftCardResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrievesSingleGiftCardResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrievesSingleGiftCardResponseCopyWith<RetrievesSingleGiftCardResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrievesSingleGiftCardResponseCopyWith<$Res> {
  factory $RetrievesSingleGiftCardResponseCopyWith(
          RetrievesSingleGiftCardResponse value,
          $Res Function(RetrievesSingleGiftCardResponse) then) =
      _$RetrievesSingleGiftCardResponseCopyWithImpl<$Res,
          RetrievesSingleGiftCardResponse>;
  @useResult
...
/// @nodoc
class _$RetrievesSingleGiftCardResponseCopyWithImpl<$Res,
        $Val extends RetrievesSingleGiftCardResponse>
    implements $RetrievesSingleGiftCardResponseCopyWith<$Res> {
  _$RetrievesSingleGiftCardResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrievesSingleGiftCardResponseImplCopyWith<$Res>
    implements $RetrievesSingleGiftCardResponseCopyWith<$Res> {
  factory _$$RetrievesSingleGiftCardResponseImplCopyWith(
          _$RetrievesSingleGiftCardResponseImpl value,
          $Res Function(_$RetrievesSingleGiftCardResponseImpl) then) =
      __$$RetrievesSingleGiftCardResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "gift_card") GiftCard? giftCard});
...
/// @nodoc
class __$$RetrievesSingleGiftCardResponseImplCopyWithImpl<$Res>
    extends _$RetrievesSingleGiftCardResponseCopyWithImpl<$Res,
        _$RetrievesSingleGiftCardResponseImpl>
    implements _$$RetrievesSingleGiftCardResponseImplCopyWith<$Res> {
  __$$RetrievesSingleGiftCardResponseImplCopyWithImpl(
      _$RetrievesSingleGiftCardResponseImpl _value,
      $Res Function(_$RetrievesSingleGiftCardResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrievesSingleGiftCardResponseImpl(
      giftCard: freezed == giftCard
          ? _value.giftCard
          : giftCard // ignore: cast_nullable_to_non_nullable
              as GiftCard?,
...
/// @nodoc
@JsonSerializable()
class _$RetrievesSingleGiftCardResponseImpl
    implements _RetrievesSingleGiftCardResponse {
  const _$RetrievesSingleGiftCardResponseImpl(
      {@JsonKey(name: "gift_card") this.giftCard});

  factory _$RetrievesSingleGiftCardResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrievesSingleGiftCardResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrievesSingleGiftCardResponse(giftCard: $giftCard)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrievesSingleGiftCardResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrievesSingleGiftCardResponseImplCopyWith<
          _$RetrievesSingleGiftCardResponseImpl>
      get copyWith => __$$RetrievesSingleGiftCardResponseImplCopyWithImpl<
          _$RetrievesSingleGiftCardResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrievesSingleGiftCardResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrievesSingleGiftCardResponse
    implements RetrievesSingleGiftCardResponse {
  const factory _RetrievesSingleGiftCardResponse(
          {@JsonKey(name: "gift_card") final GiftCard? giftCard}) =
      _$RetrievesSingleGiftCardResponseImpl;

  factory _RetrievesSingleGiftCardResponse.fromJson(Map<String, dynamic> json) =
      _$RetrievesSingleGiftCardResponseImpl.fromJson;
