...
RetrievesListOfGiftCardResponse _$RetrievesListOfGiftCardResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrievesListOfGiftCardResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrievesListOfGiftCardResponse {
  @JsonKey(name: "gift_cards")
  List<GiftCard>? get giftCards => throw _privateConstructorUsedError;

  /// Serializes this RetrievesListOfGiftCardResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrievesListOfGiftCardResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrievesListOfGiftCardResponseCopyWith<RetrievesListOfGiftCardResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrievesListOfGiftCardResponseCopyWith<$Res> {
  factory $RetrievesListOfGiftCardResponseCopyWith(
          RetrievesListOfGiftCardResponse value,
          $Res Function(RetrievesListOfGiftCardResponse) then) =
      _$RetrievesListOfGiftCardResponseCopyWithImpl<$Res,
          RetrievesListOfGiftCardResponse>;
  @useResult
  $Res call({@JsonKey(name: "gift_cards") List<GiftCard>? giftCards});
}

/// @nodoc
class _$RetrievesListOfGiftCardResponseCopyWithImpl<$Res,
        $Val extends RetrievesListOfGiftCardResponse>
    implements $RetrievesListOfGiftCardResponseCopyWith<$Res> {
  _$RetrievesListOfGiftCardResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrievesListOfGiftCardResponseImplCopyWith<$Res>
    implements $RetrievesListOfGiftCardResponseCopyWith<$Res> {
  factory _$$RetrievesListOfGiftCardResponseImplCopyWith(
          _$RetrievesListOfGiftCardResponseImpl value,
          $Res Function(_$RetrievesListOfGiftCardResponseImpl) then) =
      __$$RetrievesListOfGiftCardResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "gift_cards") List<GiftCard>? giftCards});
}
...
/// @nodoc
class __$$RetrievesListOfGiftCardResponseImplCopyWithImpl<$Res>
    extends _$RetrievesListOfGiftCardResponseCopyWithImpl<$Res,
        _$RetrievesListOfGiftCardResponseImpl>
    implements _$$RetrievesListOfGiftCardResponseImplCopyWith<$Res> {
  __$$RetrievesListOfGiftCardResponseImplCopyWithImpl(
      _$RetrievesListOfGiftCardResponseImpl _value,
      $Res Function(_$RetrievesListOfGiftCardResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrievesListOfGiftCardResponseImpl(
      giftCards: freezed == giftCards
          ? _value._giftCards
          : giftCards // ignore: cast_nullable_to_non_nullable
              as List<GiftCard>?,
...
/// @nodoc
@JsonSerializable()
class _$RetrievesListOfGiftCardResponseImpl
    implements _RetrievesListOfGiftCardResponse {
  const _$RetrievesListOfGiftCardResponseImpl(
      {@JsonKey(name: "gift_cards") final List<GiftCard>? giftCards})
      : _giftCards = giftCards;

  factory _$RetrievesListOfGiftCardResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrievesListOfGiftCardResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrievesListOfGiftCardResponse(giftCards: $giftCards)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrievesListOfGiftCardResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrievesListOfGiftCardResponseImplCopyWith<
          _$RetrievesListOfGiftCardResponseImpl>
      get copyWith => __$$RetrievesListOfGiftCardResponseImplCopyWithImpl<
          _$RetrievesListOfGiftCardResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrievesListOfGiftCardResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrievesListOfGiftCardResponse
    implements RetrievesListOfGiftCardResponse {
  const factory _RetrievesListOfGiftCardResponse(
          {@JsonKey(name: "gift_cards") final List<GiftCard>? giftCards}) =
      _$RetrievesListOfGiftCardResponseImpl;

  factory _RetrievesListOfGiftCardResponse.fromJson(Map<String, dynamic> json) =
      _$RetrievesListOfGiftCardResponseImpl.fromJson;
