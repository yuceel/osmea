import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/request/automatically_create_gift_card_request.dart';
...
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/create_new_gift_card_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/create_gift_card_with_custom_code_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/automatically_create_gift_card_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/disable_gift_card_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/retrieves_count_of_gift_card_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/retrieves_list_of_gift_cards_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/retrieves_single_gift_card_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/searches_for_gift_cards_response.dart';
import 'package:apis/network/remote/shopify/rest/gift_card/freezed_model/response/updates_gift_card_response.dart';
