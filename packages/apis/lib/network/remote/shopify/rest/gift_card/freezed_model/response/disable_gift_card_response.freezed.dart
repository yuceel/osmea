...
DisableGiftCardResponse _$DisableGiftCardResponseFromJson(
    Map<String, dynamic> json) {
  return _DisableGiftCardResponse.fromJson(json);
}

/// @nodoc
mixin _$DisableGiftCardResponse {
  @JsonKey(name: "gift_card")
  GiftCard? get giftCard => throw _privateConstructorUsedError;

  /// Serializes this DisableGiftCardResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DisableGiftCardResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DisableGiftCardResponseCopyWith<DisableGiftCardResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DisableGiftCardResponseCopyWith<$Res> {
  factory $DisableGiftCardResponseCopyWith(DisableGiftCardResponse value,
          $Res Function(DisableGiftCardResponse) then) =
      _$DisableGiftCardResponseCopyWithImpl<$Res, DisableGiftCardResponse>;
  @useResult
...
/// @nodoc
class _$DisableGiftCardResponseCopyWithImpl<$Res,
        $Val extends DisableGiftCardResponse>
    implements $DisableGiftCardResponseCopyWith<$Res> {
  _$DisableGiftCardResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DisableGiftCardResponseImplCopyWith<$Res>
    implements $DisableGiftCardResponseCopyWith<$Res> {
  factory _$$DisableGiftCardResponseImplCopyWith(
          _$DisableGiftCardResponseImpl value,
          $Res Function(_$DisableGiftCardResponseImpl) then) =
      __$$DisableGiftCardResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "gift_card") GiftCard? giftCard});
...
/// @nodoc
class __$$DisableGiftCardResponseImplCopyWithImpl<$Res>
    extends _$DisableGiftCardResponseCopyWithImpl<$Res,
        _$DisableGiftCardResponseImpl>
    implements _$$DisableGiftCardResponseImplCopyWith<$Res> {
  __$$DisableGiftCardResponseImplCopyWithImpl(
      _$DisableGiftCardResponseImpl _value,
      $Res Function(_$DisableGiftCardResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DisableGiftCardResponseImpl(
      giftCard: freezed == giftCard
          ? _value.giftCard
          : giftCard // ignore: cast_nullable_to_non_nullable
              as GiftCard?,
...
/// @nodoc
@JsonSerializable()
class _$DisableGiftCardResponseImpl implements _DisableGiftCardResponse {
  const _$DisableGiftCardResponseImpl(
      {@JsonKey(name: "gift_card") this.giftCard});

  factory _$DisableGiftCardResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DisableGiftCardResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DisableGiftCardResponse(giftCard: $giftCard)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DisableGiftCardResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DisableGiftCardResponseImplCopyWith<_$DisableGiftCardResponseImpl>
      get copyWith => __$$DisableGiftCardResponseImplCopyWithImpl<
          _$DisableGiftCardResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DisableGiftCardResponseImplToJson(
      this,
    );
  }
}

abstract class _DisableGiftCardResponse implements DisableGiftCardResponse {
  const factory _DisableGiftCardResponse(
          {@JsonKey(name: "gift_card") final GiftCard? giftCard}) =
      _$DisableGiftCardResponseImpl;

  factory _DisableGiftCardResponse.fromJson(Map<String, dynamic> json) =
      _$DisableGiftCardResponseImpl.fromJson;
...
mixin _$GiftCard {
  ...
  dynamic get apiClientId => throw _privateConstructorUsedError;
...
class _$GiftCardImpl implements _GiftCard {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.apiClientId, apiClientId) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(apiClientId),
...
abstract class _GiftCard implements GiftCard {
  const factory _GiftCard(
      ...
      @JsonKey(name: "api_client_id") final dynamic apiClientId,
