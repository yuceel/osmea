...
CreateArticleHtmlMarkupResponse _$CreateArticleHtmlMarkupResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateArticleHtmlMarkupResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateArticleHtmlMarkupResponse {
  @JsonKey(name: "article")
  Article? get article => throw _privateConstructorUsedError;

  /// Serializes this CreateArticleHtmlMarkupResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateArticleHtmlMarkupResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateArticleHtmlMarkupResponseCopyWith<CreateArticleHtmlMarkupResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateArticleHtmlMarkupResponseCopyWith<$Res> {
  factory $CreateArticleHtmlMarkupResponseCopyWith(
          CreateArticleHtmlMarkupResponse value,
          $Res Function(CreateArticleHtmlMarkupResponse) then) =
      _$CreateArticleHtmlMarkupResponseCopyWithImpl<$Res,
          CreateArticleHtmlMarkupResponse>;
  @useResult
...
/// @nodoc
class _$CreateArticleHtmlMarkupResponseCopyWithImpl<$Res,
        $Val extends CreateArticleHtmlMarkupResponse>
    implements $CreateArticleHtmlMarkupResponseCopyWith<$Res> {
  _$CreateArticleHtmlMarkupResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateArticleHtmlMarkupResponseImplCopyWith<$Res>
    implements $CreateArticleHtmlMarkupResponseCopyWith<$Res> {
  factory _$$CreateArticleHtmlMarkupResponseImplCopyWith(
          _$CreateArticleHtmlMarkupResponseImpl value,
          $Res Function(_$CreateArticleHtmlMarkupResponseImpl) then) =
      __$$CreateArticleHtmlMarkupResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "article") Article? article});
...
/// @nodoc
class __$$CreateArticleHtmlMarkupResponseImplCopyWithImpl<$Res>
    extends _$CreateArticleHtmlMarkupResponseCopyWithImpl<$Res,
        _$CreateArticleHtmlMarkupResponseImpl>
    implements _$$CreateArticleHtmlMarkupResponseImplCopyWith<$Res> {
  __$$CreateArticleHtmlMarkupResponseImplCopyWithImpl(
      _$CreateArticleHtmlMarkupResponseImpl _value,
      $Res Function(_$CreateArticleHtmlMarkupResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateArticleHtmlMarkupResponseImpl(
      article: freezed == article
          ? _value.article
          : article // ignore: cast_nullable_to_non_nullable
              as Article?,
...
/// @nodoc
@JsonSerializable()
class _$CreateArticleHtmlMarkupResponseImpl
    implements _CreateArticleHtmlMarkupResponse {
  const _$CreateArticleHtmlMarkupResponseImpl(
      {@JsonKey(name: "article") this.article});

  factory _$CreateArticleHtmlMarkupResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateArticleHtmlMarkupResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateArticleHtmlMarkupResponse(article: $article)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateArticleHtmlMarkupResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateArticleHtmlMarkupResponseImplCopyWith<
          _$CreateArticleHtmlMarkupResponseImpl>
      get copyWith => __$$CreateArticleHtmlMarkupResponseImplCopyWithImpl<
          _$CreateArticleHtmlMarkupResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateArticleHtmlMarkupResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateArticleHtmlMarkupResponse
    implements CreateArticleHtmlMarkupResponse {
  const factory _CreateArticleHtmlMarkupResponse(
          {@JsonKey(name: "article") final Article? article}) =
      _$CreateArticleHtmlMarkupResponseImpl;

  factory _CreateArticleHtmlMarkupResponse.fromJson(Map<String, dynamic> json) =
      _$CreateArticleHtmlMarkupResponseImpl.fromJson;
