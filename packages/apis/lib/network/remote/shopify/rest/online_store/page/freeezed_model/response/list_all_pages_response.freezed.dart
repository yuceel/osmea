...
ListAllPagesResponse _$ListAllPagesResponseFromJson(Map<String, dynamic> json) {
  return _ListAllPagesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllPagesResponse {
  @JsonKey(name: "pages")
...
/// @nodoc
abstract class $ListAllPagesResponseCopyWith<$Res> {
  factory $ListAllPagesResponseCopyWith(ListAllPagesResponse value,
          $Res Function(ListAllPagesResponse) then) =
      _$ListAllPagesResponseCopyWithImpl<$Res, ListAllPagesResponse>;
  @useResult
  $Res call({@JsonKey(name: "pages") List<Page>? pages});
}

/// @nodoc
class _$ListAllPagesResponseCopyWithImpl<$Res,
        $Val extends ListAllPagesResponse>
    implements $ListAllPagesResponseCopyWith<$Res> {
  _$ListAllPagesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllPagesResponseImplCopyWith<$Res>
    implements $ListAllPagesResponseCopyWith<$Res> {
  factory _$$ListAllPagesResponseImplCopyWith(_$ListAllPagesResponseImpl value,
          $Res Function(_$ListAllPagesResponseImpl) then) =
      __$$ListAllPagesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "pages") List<Page>? pages});
}
...
/// @nodoc
class __$$ListAllPagesResponseImplCopyWithImpl<$Res>
    extends _$ListAllPagesResponseCopyWithImpl<$Res, _$ListAllPagesResponseImpl>
    implements _$$ListAllPagesResponseImplCopyWith<$Res> {
  __$$ListAllPagesResponseImplCopyWithImpl(_$ListAllPagesResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$ListAllPagesResponseImpl(
      pages: freezed == pages
          ? _value._pages
          : pages // ignore: cast_nullable_to_non_nullable
              as List<Page>?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllPagesResponseImpl implements _ListAllPagesResponse {
  const _$ListAllPagesResponseImpl(
      {@JsonKey(name: "pages") final List<Page>? pages})
      : _pages = pages;

  factory _$ListAllPagesResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllPagesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllPagesResponse(pages: $pages)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllPagesResponseImpl &&
  ...
  _$$ListAllPagesResponseImplCopyWith<_$ListAllPagesResponseImpl>
      get copyWith =>
          __$$ListAllPagesResponseImplCopyWithImpl<_$ListAllPagesResponseImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllPagesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllPagesResponse implements ListAllPagesResponse {
  const factory _ListAllPagesResponse(
          {@JsonKey(name: "pages") final List<Page>? pages}) =
      _$ListAllPagesResponseImpl;

  factory _ListAllPagesResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllPagesResponseImpl.fromJson;
