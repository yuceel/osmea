...
part of 'create_article_with_image_response.dart';
...
CreateArticleWithImageResponse _$CreateArticleWithImageResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateArticleWithImageResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateArticleWithImageResponse {
  @JsonKey(name: "article")
  Article? get article => throw _privateConstructorUsedError;
  @JsonKey(name: "errors")
  Errors? get errors => throw _privateConstructorUsedError;

  /// Serializes this CreateArticleWithImageResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateArticleWithImageResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateArticleWithImageResponseCopyWith<CreateArticleWithImageResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateArticleWithImageResponseCopyWith<$Res> {
  factory $CreateArticleWithImageResponseCopyWith(
          CreateArticleWithImageResponse value,
          $Res Function(CreateArticleWithImageResponse) then) =
      _$CreateArticleWithImageResponseCopyWithImpl<$Res,
          CreateArticleWithImageResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateArticleWithImageResponseCopyWithImpl<$Res,
        $Val extends CreateArticleWithImageResponse>
    implements $CreateArticleWithImageResponseCopyWith<$Res> {
  _$CreateArticleWithImageResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateArticleWithImageResponseImplCopyWith<$Res>
    implements $CreateArticleWithImageResponseCopyWith<$Res> {
  factory _$$CreateArticleWithImageResponseImplCopyWith(
          _$CreateArticleWithImageResponseImpl value,
          $Res Function(_$CreateArticleWithImageResponseImpl) then) =
      __$$CreateArticleWithImageResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "article") Article? article,
...
/// @nodoc
class __$$CreateArticleWithImageResponseImplCopyWithImpl<$Res>
    extends _$CreateArticleWithImageResponseCopyWithImpl<$Res,
        _$CreateArticleWithImageResponseImpl>
    implements _$$CreateArticleWithImageResponseImplCopyWith<$Res> {
  __$$CreateArticleWithImageResponseImplCopyWithImpl(
      _$CreateArticleWithImageResponseImpl _value,
      $Res Function(_$CreateArticleWithImageResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateArticleWithImageResponseImpl(
      article: freezed == article
          ? _value.article
          : article // ignore: cast_nullable_to_non_nullable
              as Article?,
...
/// @nodoc
@JsonSerializable()
class _$CreateArticleWithImageResponseImpl
    implements _CreateArticleWithImageResponse {
  const _$CreateArticleWithImageResponseImpl(
      {@JsonKey(name: "article") this.article,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateArticleWithImageResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateArticleWithImageResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateArticleWithImageResponse(article: $article, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateArticleWithImageResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateArticleWithImageResponseImplCopyWith<
          _$CreateArticleWithImageResponseImpl>
      get copyWith => __$$CreateArticleWithImageResponseImplCopyWithImpl<
          _$CreateArticleWithImageResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateArticleWithImageResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateArticleWithImageResponse
    implements CreateArticleWithImageResponse {
  const factory _CreateArticleWithImageResponse(
          {@JsonKey(name: "article") final Article? article,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateArticleWithImageResponseImpl;

  factory _CreateArticleWithImageResponse.fromJson(Map<String, dynamic> json) =
      _$CreateArticleWithImageResponseImpl.fromJson;
