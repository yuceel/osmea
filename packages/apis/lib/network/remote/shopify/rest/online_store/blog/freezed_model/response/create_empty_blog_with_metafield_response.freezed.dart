...
CreateEmptyBlogWithMetafieldResponse
    _$CreateEmptyBlogWithMetafieldResponseFromJson(Map<String, dynamic> json) {
  return _CreateEmptyBlogWithMetafieldResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateEmptyBlogWithMetafieldResponse {
  @JsonKey(name: "blog")
  Blog? get blog => throw _privateConstructorUsedError;
  @JsonKey(name: "errors")
  Errors? get errors => throw _privateConstructorUsedError;

  /// Serializes this CreateEmptyBlogWithMetafieldResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateEmptyBlogWithMetafieldResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateEmptyBlogWithMetafieldResponseCopyWith<
          CreateEmptyBlogWithMetafieldResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateEmptyBlogWithMetafieldResponseCopyWith<$Res> {
  factory $CreateEmptyBlogWithMetafieldResponseCopyWith(
          CreateEmptyBlogWithMetafieldResponse value,
          $Res Function(CreateEmptyBlogWithMetafieldResponse) then) =
      _$CreateEmptyBlogWithMetafieldResponseCopyWithImpl<$Res,
          CreateEmptyBlogWithMetafieldResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateEmptyBlogWithMetafieldResponseCopyWithImpl<$Res,
        $Val extends CreateEmptyBlogWithMetafieldResponse>
    implements $CreateEmptyBlogWithMetafieldResponseCopyWith<$Res> {
  _$CreateEmptyBlogWithMetafieldResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateEmptyBlogWithMetafieldResponseImplCopyWith<$Res>
    implements $CreateEmptyBlogWithMetafieldResponseCopyWith<$Res> {
  factory _$$CreateEmptyBlogWithMetafieldResponseImplCopyWith(
          _$CreateEmptyBlogWithMetafieldResponseImpl value,
          $Res Function(_$CreateEmptyBlogWithMetafieldResponseImpl) then) =
      __$$CreateEmptyBlogWithMetafieldResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "blog") Blog? blog,
...
/// @nodoc
class __$$CreateEmptyBlogWithMetafieldResponseImplCopyWithImpl<$Res>
    extends _$CreateEmptyBlogWithMetafieldResponseCopyWithImpl<$Res,
        _$CreateEmptyBlogWithMetafieldResponseImpl>
    implements _$$CreateEmptyBlogWithMetafieldResponseImplCopyWith<$Res> {
  __$$CreateEmptyBlogWithMetafieldResponseImplCopyWithImpl(
      _$CreateEmptyBlogWithMetafieldResponseImpl _value,
      $Res Function(_$CreateEmptyBlogWithMetafieldResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateEmptyBlogWithMetafieldResponseImpl(
      blog: freezed == blog
          ? _value.blog
          : blog // ignore: cast_nullable_to_non_nullable
              as Blog?,
...
/// @nodoc
@JsonSerializable()
class _$CreateEmptyBlogWithMetafieldResponseImpl
    implements _CreateEmptyBlogWithMetafieldResponse {
  const _$CreateEmptyBlogWithMetafieldResponseImpl(
      {@JsonKey(name: "blog") this.blog, @JsonKey(name: "errors") this.errors});

  factory _$CreateEmptyBlogWithMetafieldResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateEmptyBlogWithMetafieldResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateEmptyBlogWithMetafieldResponse(blog: $blog, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateEmptyBlogWithMetafieldResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateEmptyBlogWithMetafieldResponseImplCopyWith<
          _$CreateEmptyBlogWithMetafieldResponseImpl>
      get copyWith => __$$CreateEmptyBlogWithMetafieldResponseImplCopyWithImpl<
          _$CreateEmptyBlogWithMetafieldResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateEmptyBlogWithMetafieldResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateEmptyBlogWithMetafieldResponse
    implements CreateEmptyBlogWithMetafieldResponse {
  const factory _CreateEmptyBlogWithMetafieldResponse(
          {@JsonKey(name: "blog") final Blog? blog,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateEmptyBlogWithMetafieldResponseImpl;

  factory _CreateEmptyBlogWithMetafieldResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateEmptyBlogWithMetafieldResponseImpl.fromJson;
