...
CreateArticleWithMetafieldResponse _$CreateArticleWithMetafieldResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateArticleWithMetafieldResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateArticleWithMetafieldResponse {
  @JsonKey(name: "article")
  Article? get article => throw _privateConstructorUsedError;
  @JsonKey(name: "errors")
  Errors? get errors => throw _privateConstructorUsedError;

  /// Serializes this CreateArticleWithMetafieldResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateArticleWithMetafieldResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateArticleWithMetafieldResponseCopyWith<
          CreateArticleWithMetafieldResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateArticleWithMetafieldResponseCopyWith<$Res> {
  factory $CreateArticleWithMetafieldResponseCopyWith(
          CreateArticleWithMetafieldResponse value,
          $Res Function(CreateArticleWithMetafieldResponse) then) =
      _$CreateArticleWithMetafieldResponseCopyWithImpl<$Res,
          CreateArticleWithMetafieldResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateArticleWithMetafieldResponseCopyWithImpl<$Res,
        $Val extends CreateArticleWithMetafieldResponse>
    implements $CreateArticleWithMetafieldResponseCopyWith<$Res> {
  _$CreateArticleWithMetafieldResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateArticleWithMetafieldResponseImplCopyWith<$Res>
    implements $CreateArticleWithMetafieldResponseCopyWith<$Res> {
  factory _$$CreateArticleWithMetafieldResponseImplCopyWith(
          _$CreateArticleWithMetafieldResponseImpl value,
          $Res Function(_$CreateArticleWithMetafieldResponseImpl) then) =
      __$$CreateArticleWithMetafieldResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "article") Article? article,
...
/// @nodoc
class __$$CreateArticleWithMetafieldResponseImplCopyWithImpl<$Res>
    extends _$CreateArticleWithMetafieldResponseCopyWithImpl<$Res,
        _$CreateArticleWithMetafieldResponseImpl>
    implements _$$CreateArticleWithMetafieldResponseImplCopyWith<$Res> {
  __$$CreateArticleWithMetafieldResponseImplCopyWithImpl(
      _$CreateArticleWithMetafieldResponseImpl _value,
      $Res Function(_$CreateArticleWithMetafieldResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateArticleWithMetafieldResponseImpl(
      article: freezed == article
          ? _value.article
          : article // ignore: cast_nullable_to_non_nullable
              as Article?,
...
/// @nodoc
@JsonSerializable()
class _$CreateArticleWithMetafieldResponseImpl
    implements _CreateArticleWithMetafieldResponse {
  const _$CreateArticleWithMetafieldResponseImpl(
      {@JsonKey(name: "article") this.article,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateArticleWithMetafieldResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateArticleWithMetafieldResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateArticleWithMetafieldResponse(article: $article, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateArticleWithMetafieldResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateArticleWithMetafieldResponseImplCopyWith<
          _$CreateArticleWithMetafieldResponseImpl>
      get copyWith => __$$CreateArticleWithMetafieldResponseImplCopyWithImpl<
          _$CreateArticleWithMetafieldResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateArticleWithMetafieldResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateArticleWithMetafieldResponse
    implements CreateArticleWithMetafieldResponse {
  const factory _CreateArticleWithMetafieldResponse(
          {@JsonKey(name: "article") final Article? article,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateArticleWithMetafieldResponseImpl;

  factory _CreateArticleWithMetafieldResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateArticleWithMetafieldResponseImpl.fromJson;
