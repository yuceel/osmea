...
part of 'create_article_base_image_response.dart';
...
CreateArticleBaseImageResponse _$CreateArticleBaseImageResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateArticleBaseImageResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateArticleBaseImageResponse {
  @JsonKey(name: "article")
  Article? get article => throw _privateConstructorUsedError;
  @JsonKey(name: "errors")
  Errors? get errors => throw _privateConstructorUsedError;

  /// Serializes this CreateArticleBaseImageResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateArticleBaseImageResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateArticleBaseImageResponseCopyWith<CreateArticleBaseImageResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateArticleBaseImageResponseCopyWith<$Res> {
  factory $CreateArticleBaseImageResponseCopyWith(
          CreateArticleBaseImageResponse value,
          $Res Function(CreateArticleBaseImageResponse) then) =
      _$CreateArticleBaseImageResponseCopyWithImpl<$Res,
          CreateArticleBaseImageResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateArticleBaseImageResponseCopyWithImpl<$Res,
        $Val extends CreateArticleBaseImageResponse>
    implements $CreateArticleBaseImageResponseCopyWith<$Res> {
  _$CreateArticleBaseImageResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateArticleBaseImageResponseImplCopyWith<$Res>
    implements $CreateArticleBaseImageResponseCopyWith<$Res> {
  factory _$$CreateArticleBaseImageResponseImplCopyWith(
          _$CreateArticleBaseImageResponseImpl value,
          $Res Function(_$CreateArticleBaseImageResponseImpl) then) =
      __$$CreateArticleBaseImageResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "article") Article? article,
...
/// @nodoc
class __$$CreateArticleBaseImageResponseImplCopyWithImpl<$Res>
    extends _$CreateArticleBaseImageResponseCopyWithImpl<$Res,
        _$CreateArticleBaseImageResponseImpl>
    implements _$$CreateArticleBaseImageResponseImplCopyWith<$Res> {
  __$$CreateArticleBaseImageResponseImplCopyWithImpl(
      _$CreateArticleBaseImageResponseImpl _value,
      $Res Function(_$CreateArticleBaseImageResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateArticleBaseImageResponseImpl(
      article: freezed == article
          ? _value.article
          : article // ignore: cast_nullable_to_non_nullable
              as Article?,
...
/// @nodoc
@JsonSerializable()
class _$CreateArticleBaseImageResponseImpl
    implements _CreateArticleBaseImageResponse {
  const _$CreateArticleBaseImageResponseImpl(
      {@JsonKey(name: "article") this.article,
      @JsonKey(name: "errors") this.errors});

  factory _$CreateArticleBaseImageResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateArticleBaseImageResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateArticleBaseImageResponse(article: $article, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateArticleBaseImageResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateArticleBaseImageResponseImplCopyWith<
          _$CreateArticleBaseImageResponseImpl>
      get copyWith => __$$CreateArticleBaseImageResponseImplCopyWithImpl<
          _$CreateArticleBaseImageResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateArticleBaseImageResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateArticleBaseImageResponse
    implements CreateArticleBaseImageResponse {
  const factory _CreateArticleBaseImageResponse(
          {@JsonKey(name: "article") final Article? article,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateArticleBaseImageResponseImpl;

  factory _CreateArticleBaseImageResponse.fromJson(Map<String, dynamic> json) =
      _$CreateArticleBaseImageResponseImpl.fromJson;
