...
UpdateBlogTitleResponse _$UpdateBlogTitleResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateBlogTitleResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateBlogTitleResponse {
  @JsonKey(name: "blog")
  Blog? get blog => throw _privateConstructorUsedError;

  /// Serializes this UpdateBlogTitleResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateBlogTitleResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateBlogTitleResponseCopyWith<UpdateBlogTitleResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateBlogTitleResponseCopyWith<$Res> {
  factory $UpdateBlogTitleResponseCopyWith(UpdateBlogTitleResponse value,
          $Res Function(UpdateBlogTitleResponse) then) =
      _$UpdateBlogTitleResponseCopyWithImpl<$Res, UpdateBlogTitleResponse>;
  @useResult
...
/// @nodoc
class _$UpdateBlogTitleResponseCopyWithImpl<$Res,
        $Val extends UpdateBlogTitleResponse>
    implements $UpdateBlogTitleResponseCopyWith<$Res> {
  _$UpdateBlogTitleResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateBlogTitleResponseImplCopyWith<$Res>
    implements $UpdateBlogTitleResponseCopyWith<$Res> {
  factory _$$UpdateBlogTitleResponseImplCopyWith(
          _$UpdateBlogTitleResponseImpl value,
          $Res Function(_$UpdateBlogTitleResponseImpl) then) =
      __$$UpdateBlogTitleResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "blog") Blog? blog});
...
/// @nodoc
class __$$UpdateBlogTitleResponseImplCopyWithImpl<$Res>
    extends _$UpdateBlogTitleResponseCopyWithImpl<$Res,
        _$UpdateBlogTitleResponseImpl>
    implements _$$UpdateBlogTitleResponseImplCopyWith<$Res> {
  __$$UpdateBlogTitleResponseImplCopyWithImpl(
      _$UpdateBlogTitleResponseImpl _value,
      $Res Function(_$UpdateBlogTitleResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateBlogTitleResponseImpl(
      blog: freezed == blog
          ? _value.blog
          : blog // ignore: cast_nullable_to_non_nullable
              as Blog?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateBlogTitleResponseImpl implements _UpdateBlogTitleResponse {
  const _$UpdateBlogTitleResponseImpl({@JsonKey(name: "blog") this.blog});

  factory _$UpdateBlogTitleResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateBlogTitleResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateBlogTitleResponse(blog: $blog)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateBlogTitleResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateBlogTitleResponseImplCopyWith<_$UpdateBlogTitleResponseImpl>
      get copyWith => __$$UpdateBlogTitleResponseImplCopyWithImpl<
          _$UpdateBlogTitleResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateBlogTitleResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateBlogTitleResponse implements UpdateBlogTitleResponse {
  const factory _UpdateBlogTitleResponse(
          {@JsonKey(name: "blog") final Blog? blog}) =
      _$UpdateBlogTitleResponseImpl;

  factory _UpdateBlogTitleResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateBlogTitleResponseImpl.fromJson;
