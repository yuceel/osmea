...
GetSingleThemeResponse _$GetSingleThemeResponseFromJson(
    Map<String, dynamic> json) {
  return _GetSingleThemeResponse.fromJson(json);
}

/// @nodoc
mixin _$GetSingleThemeResponse {
  @JsonKey(name: "theme")
  Theme? get theme => throw _privateConstructorUsedError;

  /// Serializes this GetSingleThemeResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetSingleThemeResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetSingleThemeResponseCopyWith<GetSingleThemeResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetSingleThemeResponseCopyWith<$Res> {
  factory $GetSingleThemeResponseCopyWith(GetSingleThemeResponse value,
          $Res Function(GetSingleThemeResponse) then) =
      _$GetSingleThemeResponseCopyWithImpl<$Res, GetSingleThemeResponse>;
  @useResult
...
/// @nodoc
class _$GetSingleThemeResponseCopyWithImpl<$Res,
        $Val extends GetSingleThemeResponse>
    implements $GetSingleThemeResponseCopyWith<$Res> {
  _$GetSingleThemeResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetSingleThemeResponseImplCopyWith<$Res>
    implements $GetSingleThemeResponseCopyWith<$Res> {
  factory _$$GetSingleThemeResponseImplCopyWith(
          _$GetSingleThemeResponseImpl value,
          $Res Function(_$GetSingleThemeResponseImpl) then) =
      __$$GetSingleThemeResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "theme") Theme? theme});
...
/// @nodoc
class __$$GetSingleThemeResponseImplCopyWithImpl<$Res>
    extends _$GetSingleThemeResponseCopyWithImpl<$Res,
        _$GetSingleThemeResponseImpl>
    implements _$$GetSingleThemeResponseImplCopyWith<$Res> {
  __$$GetSingleThemeResponseImplCopyWithImpl(
      _$GetSingleThemeResponseImpl _value,
      $Res Function(_$GetSingleThemeResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetSingleThemeResponseImpl(
      theme: freezed == theme
          ? _value.theme
          : theme // ignore: cast_nullable_to_non_nullable
              as Theme?,
...
/// @nodoc
@JsonSerializable()
class _$GetSingleThemeResponseImpl implements _GetSingleThemeResponse {
  const _$GetSingleThemeResponseImpl({@JsonKey(name: "theme") this.theme});

  factory _$GetSingleThemeResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetSingleThemeResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetSingleThemeResponse(theme: $theme)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetSingleThemeResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetSingleThemeResponseImplCopyWith<_$GetSingleThemeResponseImpl>
      get copyWith => __$$GetSingleThemeResponseImplCopyWithImpl<
          _$GetSingleThemeResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetSingleThemeResponseImplToJson(
      this,
    );
  }
}

abstract class _GetSingleThemeResponse implements GetSingleThemeResponse {
  const factory _GetSingleThemeResponse(
          {@JsonKey(name: "theme") final Theme? theme}) =
      _$GetSingleThemeResponseImpl;

  factory _GetSingleThemeResponse.fromJson(Map<String, dynamic> json) =
      _$GetSingleThemeResponseImpl.fromJson;
