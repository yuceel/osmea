...
CreateUnpublishedPageResponse _$CreateUnpublishedPageResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateUnpublishedPageResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateUnpublishedPageResponse {
  @JsonKey(name: "page")
  Page? get page => throw _privateConstructorUsedError;
  @JsonKey(name: "errors")
  Errors? get errors => throw _privateConstructorUsedError;

  /// Serializes this CreateUnpublishedPageResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateUnpublishedPageResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateUnpublishedPageResponseCopyWith<CreateUnpublishedPageResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateUnpublishedPageResponseCopyWith<$Res> {
  factory $CreateUnpublishedPageResponseCopyWith(
          CreateUnpublishedPageResponse value,
          $Res Function(CreateUnpublishedPageResponse) then) =
      _$CreateUnpublishedPageResponseCopyWithImpl<$Res,
          CreateUnpublishedPageResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateUnpublishedPageResponseCopyWithImpl<$Res,
        $Val extends CreateUnpublishedPageResponse>
    implements $CreateUnpublishedPageResponseCopyWith<$Res> {
  _$CreateUnpublishedPageResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateUnpublishedPageResponseImplCopyWith<$Res>
    implements $CreateUnpublishedPageResponseCopyWith<$Res> {
  factory _$$CreateUnpublishedPageResponseImplCopyWith(
          _$CreateUnpublishedPageResponseImpl value,
          $Res Function(_$CreateUnpublishedPageResponseImpl) then) =
      __$$CreateUnpublishedPageResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "page") Page? page,
...
/// @nodoc
class __$$CreateUnpublishedPageResponseImplCopyWithImpl<$Res>
    extends _$CreateUnpublishedPageResponseCopyWithImpl<$Res,
        _$CreateUnpublishedPageResponseImpl>
    implements _$$CreateUnpublishedPageResponseImplCopyWith<$Res> {
  __$$CreateUnpublishedPageResponseImplCopyWithImpl(
      _$CreateUnpublishedPageResponseImpl _value,
      $Res Function(_$CreateUnpublishedPageResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateUnpublishedPageResponseImpl(
      page: freezed == page
          ? _value.page
          : page // ignore: cast_nullable_to_non_nullable
              as Page?,
...
/// @nodoc
@JsonSerializable()
class _$CreateUnpublishedPageResponseImpl
    implements _CreateUnpublishedPageResponse {
  const _$CreateUnpublishedPageResponseImpl(
      {@JsonKey(name: "page") this.page, @JsonKey(name: "errors") this.errors});

  factory _$CreateUnpublishedPageResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateUnpublishedPageResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateUnpublishedPageResponse(page: $page, errors: $errors)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateUnpublishedPageResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateUnpublishedPageResponseImplCopyWith<
          _$CreateUnpublishedPageResponseImpl>
      get copyWith => __$$CreateUnpublishedPageResponseImplCopyWithImpl<
          _$CreateUnpublishedPageResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateUnpublishedPageResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateUnpublishedPageResponse
    implements CreateUnpublishedPageResponse {
  const factory _CreateUnpublishedPageResponse(
          {@JsonKey(name: "page") final Page? page,
          @JsonKey(name: "errors") final Errors? errors}) =
      _$CreateUnpublishedPageResponseImpl;

  factory _CreateUnpublishedPageResponse.fromJson(Map<String, dynamic> json) =
      _$CreateUnpublishedPageResponseImpl.fromJson;
