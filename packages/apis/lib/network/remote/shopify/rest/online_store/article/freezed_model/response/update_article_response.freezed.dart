...
UpdateArticleResponse _$UpdateArticleResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateArticleResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateArticleResponse {
  @JsonKey(name: "article")
  Article? get article => throw _privateConstructorUsedError;

  /// Serializes this UpdateArticleResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateArticleResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateArticleResponseCopyWith<UpdateArticleResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateArticleResponseCopyWith<$Res> {
  factory $UpdateArticleResponseCopyWith(UpdateArticleResponse value,
          $Res Function(UpdateArticleResponse) then) =
      _$UpdateArticleResponseCopyWithImpl<$Res, UpdateArticleResponse>;
  @useResult
...
/// @nodoc
class _$UpdateArticleResponseCopyWithImpl<$Res,
        $Val extends UpdateArticleResponse>
    implements $UpdateArticleResponseCopyWith<$Res> {
  _$UpdateArticleResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateArticleResponseImplCopyWith<$Res>
    implements $UpdateArticleResponseCopyWith<$Res> {
  factory _$$UpdateArticleResponseImplCopyWith(
          _$UpdateArticleResponseImpl value,
          $Res Function(_$UpdateArticleResponseImpl) then) =
      __$$UpdateArticleResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "article") Article? article});
...
/// @nodoc
class __$$UpdateArticleResponseImplCopyWithImpl<$Res>
    extends _$UpdateArticleResponseCopyWithImpl<$Res,
        _$UpdateArticleResponseImpl>
    implements _$$UpdateArticleResponseImplCopyWith<$Res> {
  __$$UpdateArticleResponseImplCopyWithImpl(_$UpdateArticleResponseImpl _value,
      $Res Function(_$UpdateArticleResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateArticleResponseImpl(
      article: freezed == article
          ? _value.article
          : article // ignore: cast_nullable_to_non_nullable
              as Article?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateArticleResponseImpl implements _UpdateArticleResponse {
  const _$UpdateArticleResponseImpl({@JsonKey(name: "article") this.article});

  factory _$UpdateArticleResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateArticleResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateArticleResponse(article: $article)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateArticleResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateArticleResponseImplCopyWith<_$UpdateArticleResponseImpl>
      get copyWith => __$$UpdateArticleResponseImplCopyWithImpl<
          _$UpdateArticleResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateArticleResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateArticleResponse implements UpdateArticleResponse {
  const factory _UpdateArticleResponse(
          {@JsonKey(name: "article") final Article? article}) =
      _$UpdateArticleResponseImpl;

  factory _UpdateArticleResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateArticleResponseImpl.fromJson;
...
class _$ArticleImpl implements _Article {
  ...
  @override
  String toString() {
    return 'Article(blogId: $blogId, title: $title, handle: $handle, bodyHtml: $bodyHtml, author: $author, id: $id, createdAt: $createdAt, userId: $userId, publishedAt: $publishedAt, updatedAt: $updatedAt, summaryHtml: $summaryHtml, templateSuffix: $templateSuffix, tags: $tags, adminGraphqlApiId: $adminGraphqlApiId, image: $image)';
  }
