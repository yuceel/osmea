...
GetSingleScriptResponse _$GetSingleScriptResponseFromJson(
    Map<String, dynamic> json) {
  return _GetSingleScriptResponse.fromJson(json);
}

/// @nodoc
mixin _$GetSingleScriptResponse {
  @JsonKey(name: "script_tag")
  ScriptTag? get scriptTag => throw _privateConstructorUsedError;

  /// Serializes this GetSingleScriptResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetSingleScriptResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetSingleScriptResponseCopyWith<GetSingleScriptResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetSingleScriptResponseCopyWith<$Res> {
  factory $GetSingleScriptResponseCopyWith(GetSingleScriptResponse value,
          $Res Function(GetSingleScriptResponse) then) =
      _$GetSingleScriptResponseCopyWithImpl<$Res, GetSingleScriptResponse>;
  @useResult
...
/// @nodoc
class _$GetSingleScriptResponseCopyWithImpl<$Res,
        $Val extends GetSingleScriptResponse>
    implements $GetSingleScriptResponseCopyWith<$Res> {
  _$GetSingleScriptResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetSingleScriptResponseImplCopyWith<$Res>
    implements $GetSingleScriptResponseCopyWith<$Res> {
  factory _$$GetSingleScriptResponseImplCopyWith(
          _$GetSingleScriptResponseImpl value,
          $Res Function(_$GetSingleScriptResponseImpl) then) =
      __$$GetSingleScriptResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "script_tag") ScriptTag? scriptTag});
...
/// @nodoc
class __$$GetSingleScriptResponseImplCopyWithImpl<$Res>
    extends _$GetSingleScriptResponseCopyWithImpl<$Res,
        _$GetSingleScriptResponseImpl>
    implements _$$GetSingleScriptResponseImplCopyWith<$Res> {
  __$$GetSingleScriptResponseImplCopyWithImpl(
      _$GetSingleScriptResponseImpl _value,
      $Res Function(_$GetSingleScriptResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetSingleScriptResponseImpl(
      scriptTag: freezed == scriptTag
          ? _value.scriptTag
          : scriptTag // ignore: cast_nullable_to_non_nullable
              as ScriptTag?,
...
/// @nodoc
@JsonSerializable()
class _$GetSingleScriptResponseImpl implements _GetSingleScriptResponse {
  const _$GetSingleScriptResponseImpl(
      {@JsonKey(name: "script_tag") this.scriptTag});

  factory _$GetSingleScriptResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetSingleScriptResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetSingleScriptResponse(scriptTag: $scriptTag)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetSingleScriptResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetSingleScriptResponseImplCopyWith<_$GetSingleScriptResponseImpl>
      get copyWith => __$$GetSingleScriptResponseImplCopyWithImpl<
          _$GetSingleScriptResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetSingleScriptResponseImplToJson(
      this,
    );
  }
}

abstract class _GetSingleScriptResponse implements GetSingleScriptResponse {
  const factory _GetSingleScriptResponse(
          {@JsonKey(name: "script_tag") final ScriptTag? scriptTag}) =
      _$GetSingleScriptResponseImpl;

  factory _GetSingleScriptResponse.fromJson(Map<String, dynamic> json) =
      _$GetSingleScriptResponseImpl.fromJson;
