...
part of 'create_price_rules_request.dart';
...
CreatePriceRulesRequest _$CreatePriceRulesRequestFromJson(
    Map<String, dynamic> json) {
  return _CreatePriceRulesRequest.fromJson(json);
}

/// @nodoc
mixin _$CreatePriceRulesRequest {
  @JsonKey(name: "price_rule")
  PriceRule? get priceRule => throw _privateConstructorUsedError;

  /// Serializes this CreatePriceRulesRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreatePriceRulesRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreatePriceRulesRequestCopyWith<CreatePriceRulesRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreatePriceRulesRequestCopyWith<$Res> {
  factory $CreatePriceRulesRequestCopyWith(CreatePriceRulesRequest value,
          $Res Function(CreatePriceRulesRequest) then) =
      _$CreatePriceRulesRequestCopyWithImpl<$Res, CreatePriceRulesRequest>;
  @useResult
...
/// @nodoc
class _$CreatePriceRulesRequestCopyWithImpl<$Res,
        $Val extends CreatePriceRulesRequest>
    implements $CreatePriceRulesRequestCopyWith<$Res> {
  _$CreatePriceRulesRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreatePriceRulesRequestImplCopyWith<$Res>
    implements $CreatePriceRulesRequestCopyWith<$Res> {
  factory _$$CreatePriceRulesRequestImplCopyWith(
          _$CreatePriceRulesRequestImpl value,
          $Res Function(_$CreatePriceRulesRequestImpl) then) =
      __$$CreatePriceRulesRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "price_rule") PriceRule? priceRule});
...
/// @nodoc
class __$$CreatePriceRulesRequestImplCopyWithImpl<$Res>
    extends _$CreatePriceRulesRequestCopyWithImpl<$Res,
        _$CreatePriceRulesRequestImpl>
    implements _$$CreatePriceRulesRequestImplCopyWith<$Res> {
  __$$CreatePriceRulesRequestImplCopyWithImpl(
      _$CreatePriceRulesRequestImpl _value,
      $Res Function(_$CreatePriceRulesRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreatePriceRulesRequestImpl(
      priceRule: freezed == priceRule
          ? _value.priceRule
          : priceRule // ignore: cast_nullable_to_non_nullable
              as PriceRule?,
...
/// @nodoc
@JsonSerializable()
class _$CreatePriceRulesRequestImpl implements _CreatePriceRulesRequest {
  const _$CreatePriceRulesRequestImpl(
      {@JsonKey(name: "price_rule") this.priceRule});

  factory _$CreatePriceRulesRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreatePriceRulesRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreatePriceRulesRequest(priceRule: $priceRule)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreatePriceRulesRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreatePriceRulesRequestImplCopyWith<_$CreatePriceRulesRequestImpl>
      get copyWith => __$$CreatePriceRulesRequestImplCopyWithImpl<
          _$CreatePriceRulesRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreatePriceRulesRequestImplToJson(
      this,
    );
  }
}

abstract class _CreatePriceRulesRequest implements CreatePriceRulesRequest {
  const factory _CreatePriceRulesRequest(
          {@JsonKey(name: "price_rule") final PriceRule? priceRule}) =
      _$CreatePriceRulesRequestImpl;

  factory _CreatePriceRulesRequest.fromJson(Map<String, dynamic> json) =
      _$CreatePriceRulesRequestImpl.fromJson;
...
abstract class _PriceRule implements PriceRule {
  const factory _PriceRule(
      ...
      final PrerequisiteToEntitlementPurchase?
          prerequisiteToEntitlementPurchase,
      @JsonKey(name: "title") final String? title}) = _$PriceRuleImpl;
