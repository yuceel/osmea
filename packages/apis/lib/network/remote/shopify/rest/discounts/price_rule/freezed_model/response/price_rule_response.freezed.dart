...
PriceRuleResponse _$PriceRuleResponseFromJson(Map<String, dynamic> json) {
  return _PriceRuleResponse.fromJson(json);
}

/// @nodoc
mixin _$PriceRuleResponse {
  @JsonKey(name: "price_rule")
  PriceRule? get priceRule => throw _privateConstructorUsedError;

  /// Serializes this PriceRuleResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of PriceRuleResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $PriceRuleResponseCopyWith<PriceRuleResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PriceRuleResponseCopyWith<$Res> {
  factory $PriceRuleResponseCopyWith(
          PriceRuleResponse value, $Res Function(PriceRuleResponse) then) =
      _$PriceRuleResponseCopyWithImpl<$Res, PriceRuleResponse>;
  @useResult
...
/// @nodoc
class _$PriceRuleResponseCopyWithImpl<$Res, $Val extends PriceRuleResponse>
    implements $PriceRuleResponseCopyWith<$Res> {
  _$PriceRuleResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$PriceRuleResponseImplCopyWith<$Res>
    implements $PriceRuleResponseCopyWith<$Res> {
  factory _$$PriceRuleResponseImplCopyWith(_$PriceRuleResponseImpl value,
          $Res Function(_$PriceRuleResponseImpl) then) =
      __$$PriceRuleResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "price_rule") PriceRule? priceRule});
...
/// @nodoc
class __$$PriceRuleResponseImplCopyWithImpl<$Res>
    extends _$PriceRuleResponseCopyWithImpl<$Res, _$PriceRuleResponseImpl>
    implements _$$PriceRuleResponseImplCopyWith<$Res> {
  __$$PriceRuleResponseImplCopyWithImpl(_$PriceRuleResponseImpl _value,
      $Res Function(_$PriceRuleResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$PriceRuleResponseImpl(
      priceRule: freezed == priceRule
          ? _value.priceRule
          : priceRule // ignore: cast_nullable_to_non_nullable
              as PriceRule?,
...
/// @nodoc
@JsonSerializable()
class _$PriceRuleResponseImpl implements _PriceRuleResponse {
  const _$PriceRuleResponseImpl({@JsonKey(name: "price_rule") this.priceRule});

  factory _$PriceRuleResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$PriceRuleResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'PriceRuleResponse(priceRule: $priceRule)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PriceRuleResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$PriceRuleResponseImplCopyWith<_$PriceRuleResponseImpl> get copyWith =>
      __$$PriceRuleResponseImplCopyWithImpl<_$PriceRuleResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PriceRuleResponseImplToJson(
      this,
    );
  }
}

abstract class _PriceRuleResponse implements PriceRuleResponse {
  const factory _PriceRuleResponse(
          {@JsonKey(name: "price_rule") final PriceRule? priceRule}) =
      _$PriceRuleResponseImpl;

  factory _PriceRuleResponse.fromJson(Map<String, dynamic> json) =
      _$PriceRuleResponseImpl.fromJson;
