...
part of 'price_rule_list_response.dart';
...
PriceRuleListResponse _$PriceRuleListResponseFromJson(
    Map<String, dynamic> json) {
  return _PriceRuleListResponse.fromJson(json);
}

/// @nodoc
mixin _$PriceRuleListResponse {
...
/// @nodoc
abstract class $PriceRuleListResponseCopyWith<$Res> {
  factory $PriceRuleListResponseCopyWith(PriceRuleListResponse value,
          $Res Function(PriceRuleListResponse) then) =
      _$PriceRuleListResponseCopyWithImpl<$Res, PriceRuleListResponse>;
  @useResult
  $Res call({@JsonKey(name: "price_rules") List<PriceRule>? priceRules});
}

/// @nodoc
class _$PriceRuleListResponseCopyWithImpl<$Res,
        $Val extends PriceRuleListResponse>
    implements $PriceRuleListResponseCopyWith<$Res> {
  _$PriceRuleListResponseCopyWithImpl(this._value, this._then);
  ...
  @override
  $Res call({
    Object? priceRules = freezed,
  }) {
    return _then(_value.copyWith(
      priceRules: freezed == priceRules
          ? _value.priceRules
          : priceRules // ignore: cast_nullable_to_non_nullable
              as List<PriceRule>?,
    ) as $Val);
  }
}
...
/// @nodoc
abstract class _$$PriceRuleListResponseImplCopyWith<$Res>
    implements $PriceRuleListResponseCopyWith<$Res> {
  factory _$$PriceRuleListResponseImplCopyWith(
          _$PriceRuleListResponseImpl value,
          $Res Function(_$PriceRuleListResponseImpl) then) =
      __$$PriceRuleListResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "price_rules") List<PriceRule>? priceRules});
}
...
/// @nodoc
class __$$PriceRuleListResponseImplCopyWithImpl<$Res>
    extends _$PriceRuleListResponseCopyWithImpl<$Res,
        _$PriceRuleListResponseImpl>
    implements _$$PriceRuleListResponseImplCopyWith<$Res> {
  __$$PriceRuleListResponseImplCopyWithImpl(_$PriceRuleListResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$PriceRuleListResponseImpl(
      priceRules: freezed == priceRules
          ? _value._priceRules
          : priceRules // ignore: cast_nullable_to_non_nullable
              as List<PriceRule>?,
...
/// @nodoc
@JsonSerializable()
class _$PriceRuleListResponseImpl implements _PriceRuleListResponse {
  const _$PriceRuleListResponseImpl(
      {@JsonKey(name: "price_rules") final List<PriceRule>? priceRules})
      : _priceRules = priceRules;

  factory _$PriceRuleListResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$PriceRuleListResponseImplFromJson(json);

  final List<PriceRule>? _priceRules;
  @override
  @JsonKey(name: "price_rules")
  List<PriceRule>? get priceRules {
    final value = _priceRules;
  ...
  @override
  String toString() {
    return 'PriceRuleListResponse(priceRules: $priceRules)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PriceRuleListResponseImpl &&
  ...
  _$$PriceRuleListResponseImplCopyWith<_$PriceRuleListResponseImpl>
      get copyWith => __$$PriceRuleListResponseImplCopyWithImpl<
          _$PriceRuleListResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PriceRuleListResponseImplToJson(
      this,
    );
  }
}

abstract class _PriceRuleListResponse implements PriceRuleListResponse {
  const factory _PriceRuleListResponse(
          {@JsonKey(name: "price_rules") final List<PriceRule>? priceRules}) =
      _$PriceRuleListResponseImpl;

  factory _PriceRuleListResponse.fromJson(Map<String, dynamic> json) =
      _$PriceRuleListResponseImpl.fromJson;
