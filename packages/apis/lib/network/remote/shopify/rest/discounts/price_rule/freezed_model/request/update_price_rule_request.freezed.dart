...
part of 'update_price_rule_request.dart';
...
UpdatePriceRuleRequest _$UpdatePriceRuleRequestFromJson(
    Map<String, dynamic> json) {
  return _UpdatePriceRuleRequest.fromJson(json);
}

/// @nodoc
mixin _$UpdatePriceRuleRequest {
  @JsonKey(name: "price_rule")
  PriceRule? get priceRule => throw _privateConstructorUsedError;

  /// Serializes this UpdatePriceRuleRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdatePriceRuleRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdatePriceRuleRequestCopyWith<UpdatePriceRuleRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdatePriceRuleRequestCopyWith<$Res> {
  factory $UpdatePriceRuleRequestCopyWith(UpdatePriceRuleRequest value,
          $Res Function(UpdatePriceRuleRequest) then) =
      _$UpdatePriceRuleRequestCopyWithImpl<$Res, UpdatePriceRuleRequest>;
  @useResult
...
/// @nodoc
class _$UpdatePriceRuleRequestCopyWithImpl<$Res,
        $Val extends UpdatePriceRuleRequest>
    implements $UpdatePriceRuleRequestCopyWith<$Res> {
  _$UpdatePriceRuleRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdatePriceRuleRequestImplCopyWith<$Res>
    implements $UpdatePriceRuleRequestCopyWith<$Res> {
  factory _$$UpdatePriceRuleRequestImplCopyWith(
          _$UpdatePriceRuleRequestImpl value,
          $Res Function(_$UpdatePriceRuleRequestImpl) then) =
      __$$UpdatePriceRuleRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "price_rule") PriceRule? priceRule});
...
/// @nodoc
class __$$UpdatePriceRuleRequestImplCopyWithImpl<$Res>
    extends _$UpdatePriceRuleRequestCopyWithImpl<$Res,
        _$UpdatePriceRuleRequestImpl>
    implements _$$UpdatePriceRuleRequestImplCopyWith<$Res> {
  __$$UpdatePriceRuleRequestImplCopyWithImpl(
      _$UpdatePriceRuleRequestImpl _value,
      $Res Function(_$UpdatePriceRuleRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdatePriceRuleRequestImpl(
      priceRule: freezed == priceRule
          ? _value.priceRule
          : priceRule // ignore: cast_nullable_to_non_nullable
              as PriceRule?,
...
/// @nodoc
@JsonSerializable()
class _$UpdatePriceRuleRequestImpl implements _UpdatePriceRuleRequest {
  const _$UpdatePriceRuleRequestImpl(
      {@JsonKey(name: "price_rule") this.priceRule});

  factory _$UpdatePriceRuleRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdatePriceRuleRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdatePriceRuleRequest(priceRule: $priceRule)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdatePriceRuleRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdatePriceRuleRequestImplCopyWith<_$UpdatePriceRuleRequestImpl>
      get copyWith => __$$UpdatePriceRuleRequestImplCopyWithImpl<
          _$UpdatePriceRuleRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdatePriceRuleRequestImplToJson(
      this,
    );
  }
}

abstract class _UpdatePriceRuleRequest implements UpdatePriceRuleRequest {
  const factory _UpdatePriceRuleRequest(
          {@JsonKey(name: "price_rule") final PriceRule? priceRule}) =
      _$UpdatePriceRuleRequestImpl;

  factory _UpdatePriceRuleRequest.fromJson(Map<String, dynamic> json) =
      _$UpdatePriceRuleRequestImpl.fromJson;
