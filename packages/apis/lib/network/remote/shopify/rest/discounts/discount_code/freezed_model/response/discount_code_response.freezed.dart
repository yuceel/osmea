...
DiscountCodeResponse _$DiscountCodeResponseFromJson(Map<String, dynamic> json) {
  return _DiscountCodeResponse.fromJson(json);
}

/// @nodoc
mixin _$DiscountCodeResponse {
  @JsonKey(name: "discount_code")
  DiscountCode? get discountCode => throw _privateConstructorUsedError;

  /// Serializes this DiscountCodeResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DiscountCodeResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DiscountCodeResponseCopyWith<DiscountCodeResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DiscountCodeResponseCopyWith<$Res> {
  factory $DiscountCodeResponseCopyWith(DiscountCodeResponse value,
          $Res Function(DiscountCodeResponse) then) =
      _$DiscountCodeResponseCopyWithImpl<$Res, DiscountCodeResponse>;
  @useResult
...
/// @nodoc
class _$DiscountCodeResponseCopyWithImpl<$Res,
        $Val extends DiscountCodeResponse>
    implements $DiscountCodeResponseCopyWith<$Res> {
  _$DiscountCodeResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DiscountCodeResponseImplCopyWith<$Res>
    implements $DiscountCodeResponseCopyWith<$Res> {
  factory _$$DiscountCodeResponseImplCopyWith(_$DiscountCodeResponseImpl value,
          $Res Function(_$DiscountCodeResponseImpl) then) =
      __$$DiscountCodeResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "discount_code") DiscountCode? discountCode});
...
/// @nodoc
class __$$DiscountCodeResponseImplCopyWithImpl<$Res>
    extends _$DiscountCodeResponseCopyWithImpl<$Res, _$DiscountCodeResponseImpl>
    implements _$$DiscountCodeResponseImplCopyWith<$Res> {
  __$$DiscountCodeResponseImplCopyWithImpl(_$DiscountCodeResponseImpl _value,
      $Res Function(_$DiscountCodeResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DiscountCodeResponseImpl(
      discountCode: freezed == discountCode
          ? _value.discountCode
          : discountCode // ignore: cast_nullable_to_non_nullable
              as DiscountCode?,
...
/// @nodoc
@JsonSerializable()
class _$DiscountCodeResponseImpl implements _DiscountCodeResponse {
  const _$DiscountCodeResponseImpl(
      {@JsonKey(name: "discount_code") this.discountCode});

  factory _$DiscountCodeResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DiscountCodeResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DiscountCodeResponse(discountCode: $discountCode)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DiscountCodeResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DiscountCodeResponseImplCopyWith<_$DiscountCodeResponseImpl>
      get copyWith =>
          __$$DiscountCodeResponseImplCopyWithImpl<_$DiscountCodeResponseImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DiscountCodeResponseImplToJson(
      this,
    );
  }
}

abstract class _DiscountCodeResponse implements DiscountCodeResponse {
  const factory _DiscountCodeResponse(
          {@JsonKey(name: "discount_code") final DiscountCode? discountCode}) =
      _$DiscountCodeResponseImpl;

  factory _DiscountCodeResponse.fromJson(Map<String, dynamic> json) =
      _$DiscountCodeResponseImpl.fromJson;
