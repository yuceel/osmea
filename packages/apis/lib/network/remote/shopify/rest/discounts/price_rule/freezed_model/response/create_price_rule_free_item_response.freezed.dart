...
CreatePriceRuleFreeItemResponse _$CreatePriceRuleFreeItemResponseFromJson(
    Map<String, dynamic> json) {
  return _CreatePriceRuleFreeItemResponse.fromJson(json);
}

/// @nodoc
mixin _$CreatePriceRuleFreeItemResponse {
  @JsonKey(name: "price_rule")
  PriceRule? get priceRule => throw _privateConstructorUsedError;

  /// Serializes this CreatePriceRuleFreeItemResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreatePriceRuleFreeItemResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreatePriceRuleFreeItemResponseCopyWith<CreatePriceRuleFreeItemResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreatePriceRuleFreeItemResponseCopyWith<$Res> {
  factory $CreatePriceRuleFreeItemResponseCopyWith(
          CreatePriceRuleFreeItemResponse value,
          $Res Function(CreatePriceRuleFreeItemResponse) then) =
      _$CreatePriceRuleFreeItemResponseCopyWithImpl<$Res,
          CreatePriceRuleFreeItemResponse>;
  @useResult
...
/// @nodoc
class _$CreatePriceRuleFreeItemResponseCopyWithImpl<$Res,
        $Val extends CreatePriceRuleFreeItemResponse>
    implements $CreatePriceRuleFreeItemResponseCopyWith<$Res> {
  _$CreatePriceRuleFreeItemResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreatePriceRuleFreeItemResponseImplCopyWith<$Res>
    implements $CreatePriceRuleFreeItemResponseCopyWith<$Res> {
  factory _$$CreatePriceRuleFreeItemResponseImplCopyWith(
          _$CreatePriceRuleFreeItemResponseImpl value,
          $Res Function(_$CreatePriceRuleFreeItemResponseImpl) then) =
      __$$CreatePriceRuleFreeItemResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "price_rule") PriceRule? priceRule});
...
/// @nodoc
class __$$CreatePriceRuleFreeItemResponseImplCopyWithImpl<$Res>
    extends _$CreatePriceRuleFreeItemResponseCopyWithImpl<$Res,
        _$CreatePriceRuleFreeItemResponseImpl>
    implements _$$CreatePriceRuleFreeItemResponseImplCopyWith<$Res> {
  __$$CreatePriceRuleFreeItemResponseImplCopyWithImpl(
      _$CreatePriceRuleFreeItemResponseImpl _value,
      $Res Function(_$CreatePriceRuleFreeItemResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreatePriceRuleFreeItemResponseImpl(
      priceRule: freezed == priceRule
          ? _value.priceRule
          : priceRule // ignore: cast_nullable_to_non_nullable
              as PriceRule?,
...
/// @nodoc
@JsonSerializable()
class _$CreatePriceRuleFreeItemResponseImpl
    implements _CreatePriceRuleFreeItemResponse {
  const _$CreatePriceRuleFreeItemResponseImpl(
      {@JsonKey(name: "price_rule") this.priceRule});

  factory _$CreatePriceRuleFreeItemResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreatePriceRuleFreeItemResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreatePriceRuleFreeItemResponse(priceRule: $priceRule)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreatePriceRuleFreeItemResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreatePriceRuleFreeItemResponseImplCopyWith<
          _$CreatePriceRuleFreeItemResponseImpl>
      get copyWith => __$$CreatePriceRuleFreeItemResponseImplCopyWithImpl<
          _$CreatePriceRuleFreeItemResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreatePriceRuleFreeItemResponseImplToJson(
      this,
    );
  }
}

abstract class _CreatePriceRuleFreeItemResponse
    implements CreatePriceRuleFreeItemResponse {
  const factory _CreatePriceRuleFreeItemResponse(
          {@JsonKey(name: "price_rule") final PriceRule? priceRule}) =
      _$CreatePriceRuleFreeItemResponseImpl;

  factory _CreatePriceRuleFreeItemResponse.fromJson(Map<String, dynamic> json) =
      _$CreatePriceRuleFreeItemResponseImpl.fromJson;
