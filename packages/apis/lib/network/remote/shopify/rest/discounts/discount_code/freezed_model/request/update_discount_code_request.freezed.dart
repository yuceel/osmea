...
UpdateDiscountCodeRequest _$UpdateDiscountCodeRequestFromJson(
    Map<String, dynamic> json) {
  return _UpdateDiscountCodeRequest.fromJson(json);
}

/// @nodoc
mixin _$UpdateDiscountCodeRequest {
  @JsonKey(name: "discount_code")
  DiscountCode? get discountCode => throw _privateConstructorUsedError;

  /// Serializes this UpdateDiscountCodeRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateDiscountCodeRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateDiscountCodeRequestCopyWith<UpdateDiscountCodeRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateDiscountCodeRequestCopyWith<$Res> {
  factory $UpdateDiscountCodeRequestCopyWith(UpdateDiscountCodeRequest value,
          $Res Function(UpdateDiscountCodeRequest) then) =
      _$UpdateDiscountCodeRequestCopyWithImpl<$Res, UpdateDiscountCodeRequest>;
  @useResult
...
/// @nodoc
class _$UpdateDiscountCodeRequestCopyWithImpl<$Res,
        $Val extends UpdateDiscountCodeRequest>
    implements $UpdateDiscountCodeRequestCopyWith<$Res> {
  _$UpdateDiscountCodeRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateDiscountCodeRequestImplCopyWith<$Res>
    implements $UpdateDiscountCodeRequestCopyWith<$Res> {
  factory _$$UpdateDiscountCodeRequestImplCopyWith(
          _$UpdateDiscountCodeRequestImpl value,
          $Res Function(_$UpdateDiscountCodeRequestImpl) then) =
      __$$UpdateDiscountCodeRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "discount_code") DiscountCode? discountCode});
...
/// @nodoc
class __$$UpdateDiscountCodeRequestImplCopyWithImpl<$Res>
    extends _$UpdateDiscountCodeRequestCopyWithImpl<$Res,
        _$UpdateDiscountCodeRequestImpl>
    implements _$$UpdateDiscountCodeRequestImplCopyWith<$Res> {
  __$$UpdateDiscountCodeRequestImplCopyWithImpl(
      _$UpdateDiscountCodeRequestImpl _value,
      $Res Function(_$UpdateDiscountCodeRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateDiscountCodeRequestImpl(
      discountCode: freezed == discountCode
          ? _value.discountCode
          : discountCode // ignore: cast_nullable_to_non_nullable
              as DiscountCode?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateDiscountCodeRequestImpl implements _UpdateDiscountCodeRequest {
  const _$UpdateDiscountCodeRequestImpl(
      {@JsonKey(name: "discount_code") this.discountCode});

  factory _$UpdateDiscountCodeRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateDiscountCodeRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateDiscountCodeRequest(discountCode: $discountCode)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateDiscountCodeRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateDiscountCodeRequestImplCopyWith<_$UpdateDiscountCodeRequestImpl>
      get copyWith => __$$UpdateDiscountCodeRequestImplCopyWithImpl<
          _$UpdateDiscountCodeRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateDiscountCodeRequestImplToJson(
      this,
    );
  }
}

abstract class _UpdateDiscountCodeRequest implements UpdateDiscountCodeRequest {
  const factory _UpdateDiscountCodeRequest(
          {@JsonKey(name: "discount_code") final DiscountCode? discountCode}) =
      _$UpdateDiscountCodeRequestImpl;

  factory _UpdateDiscountCodeRequest.fromJson(Map<String, dynamic> json) =
      _$UpdateDiscountCodeRequestImpl.fromJson;
