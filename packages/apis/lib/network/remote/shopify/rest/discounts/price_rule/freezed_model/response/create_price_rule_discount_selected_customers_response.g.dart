...
_$CreatePriceRuleDiscountSelectedCustomersResponseImpl
    _$$CreatePriceRuleDiscountSelectedCustomersResponseImplFromJson(
...
Map<String, dynamic>
    _$$CreatePriceRuleDiscountSelectedCustomersResponseImplToJson(
            _$CreatePriceRuleDiscountSelectedCustomersResponseImpl instance) =>
        <String, dynamic>{
          if (instance.priceRule?.toJson() case final value?)
            'price_rule': value,
        };
