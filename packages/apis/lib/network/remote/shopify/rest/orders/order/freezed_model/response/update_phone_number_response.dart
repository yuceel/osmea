...
part 'update_phone_number_response.freezed.dart';
part 'update_phone_number_response.g.dart';

UpdatePhoneNumberResponse updatePhoneNumberResponseFromJson(String str) =>
    UpdatePhoneNumberResponse.fromJson(json.decode(str));

String updatePhoneNumberResponseToJson(UpdatePhoneNumberResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdatePhoneNumberResponse with _$UpdatePhoneNumberResponse {
  const factory UpdatePhoneNumberResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdatePhoneNumberResponse;
