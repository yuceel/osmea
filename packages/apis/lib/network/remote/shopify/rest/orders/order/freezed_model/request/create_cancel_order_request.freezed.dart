...
part of 'create_cancel_order_request.dart';
...
CreateCancelOrderRequest _$CreateCancelOrderRequestFromJson(
    Map<String, dynamic> json) {
  return _CreateCancelOrderRequest.fromJson(json);
}

/// @nodoc
mixin _$CreateCancelOrderRequest {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;
  @JsonKey(name: "error")
  String? get error => throw _privateConstructorUsedError;

  /// Serializes this CreateCancelOrderRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCancelOrderRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCancelOrderRequestCopyWith<CreateCancelOrderRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCancelOrderRequestCopyWith<$Res> {
  factory $CreateCancelOrderRequestCopyWith(CreateCancelOrderRequest value,
          $Res Function(CreateCancelOrderRequest) then) =
      _$CreateCancelOrderRequestCopyWithImpl<$Res, CreateCancelOrderRequest>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateCancelOrderRequestCopyWithImpl<$Res,
        $Val extends CreateCancelOrderRequest>
    implements $CreateCancelOrderRequestCopyWith<$Res> {
  _$CreateCancelOrderRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCancelOrderRequestImplCopyWith<$Res>
    implements $CreateCancelOrderRequestCopyWith<$Res> {
  factory _$$CreateCancelOrderRequestImplCopyWith(
          _$CreateCancelOrderRequestImpl value,
          $Res Function(_$CreateCancelOrderRequestImpl) then) =
      __$$CreateCancelOrderRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "order") Order? order,
...
/// @nodoc
class __$$CreateCancelOrderRequestImplCopyWithImpl<$Res>
    extends _$CreateCancelOrderRequestCopyWithImpl<$Res,
        _$CreateCancelOrderRequestImpl>
    implements _$$CreateCancelOrderRequestImplCopyWith<$Res> {
  __$$CreateCancelOrderRequestImplCopyWithImpl(
      _$CreateCancelOrderRequestImpl _value,
      $Res Function(_$CreateCancelOrderRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCancelOrderRequestImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCancelOrderRequestImpl implements _CreateCancelOrderRequest {
  const _$CreateCancelOrderRequestImpl(
      {@JsonKey(name: "order") this.order, @JsonKey(name: "error") this.error});

  factory _$CreateCancelOrderRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateCancelOrderRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCancelOrderRequest(order: $order, error: $error)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCancelOrderRequestImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, order, error);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCancelOrderRequestImplCopyWith<_$CreateCancelOrderRequestImpl>
      get copyWith => __$$CreateCancelOrderRequestImplCopyWithImpl<
          _$CreateCancelOrderRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCancelOrderRequestImplToJson(
      this,
    );
  }
}

abstract class _CreateCancelOrderRequest implements CreateCancelOrderRequest {
  const factory _CreateCancelOrderRequest(
          {@JsonKey(name: "order") final Order? order,
          @JsonKey(name: "error") final String? error}) =
      _$CreateCancelOrderRequestImpl;

  factory _CreateCancelOrderRequest.fromJson(Map<String, dynamic> json) =
      _$CreateCancelOrderRequestImpl.fromJson;
