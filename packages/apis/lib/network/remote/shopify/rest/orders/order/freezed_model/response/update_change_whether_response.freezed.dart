...
part of 'update_change_whether_response.dart';
...
UpdateChangeWhetherResponse _$UpdateChangeWhetherResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateChangeWhetherResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateChangeWhetherResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this UpdateChangeWhetherResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateChangeWhetherResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateChangeWhetherResponseCopyWith<UpdateChangeWhetherResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateChangeWhetherResponseCopyWith<$Res> {
  factory $UpdateChangeWhetherResponseCopyWith(
          UpdateChangeWhetherResponse value,
          $Res Function(UpdateChangeWhetherResponse) then) =
      _$UpdateChangeWhetherResponseCopyWithImpl<$Res,
          UpdateChangeWhetherResponse>;
  @useResult
...
/// @nodoc
class _$UpdateChangeWhetherResponseCopyWithImpl<$Res,
        $Val extends UpdateChangeWhetherResponse>
    implements $UpdateChangeWhetherResponseCopyWith<$Res> {
  _$UpdateChangeWhetherResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateChangeWhetherResponseImplCopyWith<$Res>
    implements $UpdateChangeWhetherResponseCopyWith<$Res> {
  factory _$$UpdateChangeWhetherResponseImplCopyWith(
          _$UpdateChangeWhetherResponseImpl value,
          $Res Function(_$UpdateChangeWhetherResponseImpl) then) =
      __$$UpdateChangeWhetherResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$UpdateChangeWhetherResponseImplCopyWithImpl<$Res>
    extends _$UpdateChangeWhetherResponseCopyWithImpl<$Res,
        _$UpdateChangeWhetherResponseImpl>
    implements _$$UpdateChangeWhetherResponseImplCopyWith<$Res> {
  __$$UpdateChangeWhetherResponseImplCopyWithImpl(
      _$UpdateChangeWhetherResponseImpl _value,
      $Res Function(_$UpdateChangeWhetherResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateChangeWhetherResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateChangeWhetherResponseImpl
    implements _UpdateChangeWhetherResponse {
  const _$UpdateChangeWhetherResponseImpl({@JsonKey(name: "order") this.order});

  factory _$UpdateChangeWhetherResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateChangeWhetherResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateChangeWhetherResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateChangeWhetherResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateChangeWhetherResponseImplCopyWith<_$UpdateChangeWhetherResponseImpl>
      get copyWith => __$$UpdateChangeWhetherResponseImplCopyWithImpl<
          _$UpdateChangeWhetherResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateChangeWhetherResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateChangeWhetherResponse
    implements UpdateChangeWhetherResponse {
  const factory _UpdateChangeWhetherResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$UpdateChangeWhetherResponseImpl;

  factory _UpdateChangeWhetherResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateChangeWhetherResponseImpl.fromJson;
