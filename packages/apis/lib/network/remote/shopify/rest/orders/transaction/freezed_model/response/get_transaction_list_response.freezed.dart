...
GetTransactionListResponse _$GetTransactionListResponseFromJson(
    Map<String, dynamic> json) {
  return _GetTransactionListResponse.fromJson(json);
}

/// @nodoc
mixin _$GetTransactionListResponse {
  @JsonKey(name: "transactions")
  List<Transaction>? get transactions => throw _privateConstructorUsedError;

  /// Serializes this GetTransactionListResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetTransactionListResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetTransactionListResponseCopyWith<GetTransactionListResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetTransactionListResponseCopyWith<$Res> {
  factory $GetTransactionListResponseCopyWith(GetTransactionListResponse value,
          $Res Function(GetTransactionListResponse) then) =
      _$GetTransactionListResponseCopyWithImpl<$Res,
          GetTransactionListResponse>;
  @useResult
  $Res call({@JsonKey(name: "transactions") List<Transaction>? transactions});
}

/// @nodoc
class _$GetTransactionListResponseCopyWithImpl<$Res,
        $Val extends GetTransactionListResponse>
    implements $GetTransactionListResponseCopyWith<$Res> {
  _$GetTransactionListResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetTransactionListResponseImplCopyWith<$Res>
    implements $GetTransactionListResponseCopyWith<$Res> {
  factory _$$GetTransactionListResponseImplCopyWith(
          _$GetTransactionListResponseImpl value,
          $Res Function(_$GetTransactionListResponseImpl) then) =
      __$$GetTransactionListResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "transactions") List<Transaction>? transactions});
}
...
/// @nodoc
class __$$GetTransactionListResponseImplCopyWithImpl<$Res>
    extends _$GetTransactionListResponseCopyWithImpl<$Res,
        _$GetTransactionListResponseImpl>
    implements _$$GetTransactionListResponseImplCopyWith<$Res> {
  __$$GetTransactionListResponseImplCopyWithImpl(
      _$GetTransactionListResponseImpl _value,
      $Res Function(_$GetTransactionListResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetTransactionListResponseImpl(
      transactions: freezed == transactions
...
/// @nodoc
@JsonSerializable()
class _$GetTransactionListResponseImpl implements _GetTransactionListResponse {
  const _$GetTransactionListResponseImpl(
      {@JsonKey(name: "transactions") final List<Transaction>? transactions})
      : _transactions = transactions;

  factory _$GetTransactionListResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GetTransactionListResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetTransactionListResponse(transactions: $transactions)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetTransactionListResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetTransactionListResponseImplCopyWith<_$GetTransactionListResponseImpl>
      get copyWith => __$$GetTransactionListResponseImplCopyWithImpl<
          _$GetTransactionListResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetTransactionListResponseImplToJson(
      this,
    );
  }
}

abstract class _GetTransactionListResponse
    implements GetTransactionListResponse {
  const factory _GetTransactionListResponse(
          {@JsonKey(name: "transactions")
          final List<Transaction>? transactions}) =
      _$GetTransactionListResponseImpl;

  factory _GetTransactionListResponse.fromJson(Map<String, dynamic> json) =
      _$GetTransactionListResponseImpl.fromJson;
