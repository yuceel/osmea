...
part of 'update_add_note_response.dart';
...
UpdateAddNoteResponse _$UpdateAddNoteResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateAddNoteResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateAddNoteResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this UpdateAddNoteResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateAddNoteResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateAddNoteResponseCopyWith<UpdateAddNoteResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateAddNoteResponseCopyWith<$Res> {
  factory $UpdateAddNoteResponseCopyWith(UpdateAddNoteResponse value,
          $Res Function(UpdateAddNoteResponse) then) =
      _$UpdateAddNoteResponseCopyWithImpl<$Res, UpdateAddNoteResponse>;
  @useResult
...
/// @nodoc
class _$UpdateAddNoteResponseCopyWithImpl<$Res,
        $Val extends UpdateAddNoteResponse>
    implements $UpdateAddNoteResponseCopyWith<$Res> {
  _$UpdateAddNoteResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateAddNoteResponseImplCopyWith<$Res>
    implements $UpdateAddNoteResponseCopyWith<$Res> {
  factory _$$UpdateAddNoteResponseImplCopyWith(
          _$UpdateAddNoteResponseImpl value,
          $Res Function(_$UpdateAddNoteResponseImpl) then) =
      __$$UpdateAddNoteResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$UpdateAddNoteResponseImplCopyWithImpl<$Res>
    extends _$UpdateAddNoteResponseCopyWithImpl<$Res,
        _$UpdateAddNoteResponseImpl>
    implements _$$UpdateAddNoteResponseImplCopyWith<$Res> {
  __$$UpdateAddNoteResponseImplCopyWithImpl(_$UpdateAddNoteResponseImpl _value,
      $Res Function(_$UpdateAddNoteResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateAddNoteResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateAddNoteResponseImpl implements _UpdateAddNoteResponse {
  const _$UpdateAddNoteResponseImpl({@JsonKey(name: "order") this.order});

  factory _$UpdateAddNoteResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateAddNoteResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateAddNoteResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateAddNoteResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateAddNoteResponseImplCopyWith<_$UpdateAddNoteResponseImpl>
      get copyWith => __$$UpdateAddNoteResponseImplCopyWithImpl<
          _$UpdateAddNoteResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateAddNoteResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateAddNoteResponse implements UpdateAddNoteResponse {
  const factory _UpdateAddNoteResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$UpdateAddNoteResponseImpl;

  factory _UpdateAddNoteResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateAddNoteResponseImpl.fromJson;
