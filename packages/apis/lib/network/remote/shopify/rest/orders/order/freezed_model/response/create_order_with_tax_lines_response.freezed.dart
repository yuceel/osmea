...
part of 'create_order_with_tax_lines_response.dart';
...
CreateOrderWithTaxLinesResponse _$CreateOrderWithTaxLinesResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderWithTaxLinesResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderWithTaxLinesResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this CreateOrderWithTaxLinesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderWithTaxLinesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderWithTaxLinesResponseCopyWith<CreateOrderWithTaxLinesResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderWithTaxLinesResponseCopyWith<$Res> {
  factory $CreateOrderWithTaxLinesResponseCopyWith(
          CreateOrderWithTaxLinesResponse value,
          $Res Function(CreateOrderWithTaxLinesResponse) then) =
      _$CreateOrderWithTaxLinesResponseCopyWithImpl<$Res,
          CreateOrderWithTaxLinesResponse>;
  @useResult
...
/// @nodoc
class _$CreateOrderWithTaxLinesResponseCopyWithImpl<$Res,
        $Val extends CreateOrderWithTaxLinesResponse>
    implements $CreateOrderWithTaxLinesResponseCopyWith<$Res> {
  _$CreateOrderWithTaxLinesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderWithTaxLinesResponseImplCopyWith<$Res>
    implements $CreateOrderWithTaxLinesResponseCopyWith<$Res> {
  factory _$$CreateOrderWithTaxLinesResponseImplCopyWith(
          _$CreateOrderWithTaxLinesResponseImpl value,
          $Res Function(_$CreateOrderWithTaxLinesResponseImpl) then) =
      __$$CreateOrderWithTaxLinesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$CreateOrderWithTaxLinesResponseImplCopyWithImpl<$Res>
    extends _$CreateOrderWithTaxLinesResponseCopyWithImpl<$Res,
        _$CreateOrderWithTaxLinesResponseImpl>
    implements _$$CreateOrderWithTaxLinesResponseImplCopyWith<$Res> {
  __$$CreateOrderWithTaxLinesResponseImplCopyWithImpl(
      _$CreateOrderWithTaxLinesResponseImpl _value,
      $Res Function(_$CreateOrderWithTaxLinesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderWithTaxLinesResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderWithTaxLinesResponseImpl
    implements _CreateOrderWithTaxLinesResponse {
  const _$CreateOrderWithTaxLinesResponseImpl(
      {@JsonKey(name: "order") this.order});

  factory _$CreateOrderWithTaxLinesResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateOrderWithTaxLinesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderWithTaxLinesResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderWithTaxLinesResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderWithTaxLinesResponseImplCopyWith<
          _$CreateOrderWithTaxLinesResponseImpl>
      get copyWith => __$$CreateOrderWithTaxLinesResponseImplCopyWithImpl<
          _$CreateOrderWithTaxLinesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderWithTaxLinesResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderWithTaxLinesResponse
    implements CreateOrderWithTaxLinesResponse {
  const factory _CreateOrderWithTaxLinesResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$CreateOrderWithTaxLinesResponseImpl;

  factory _CreateOrderWithTaxLinesResponse.fromJson(Map<String, dynamic> json) =
      _$CreateOrderWithTaxLinesResponseImpl.fromJson;
