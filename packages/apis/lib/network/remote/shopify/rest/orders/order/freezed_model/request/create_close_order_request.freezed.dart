...
CreateCloseOrderRequest _$CreateCloseOrderRequestFromJson(
    Map<String, dynamic> json) {
  return _CreateCloseOrderRequest.fromJson(json);
}

/// @nodoc
mixin _$CreateCloseOrderRequest {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this CreateCloseOrderRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCloseOrderRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCloseOrderRequestCopyWith<CreateCloseOrderRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCloseOrderRequestCopyWith<$Res> {
  factory $CreateCloseOrderRequestCopyWith(CreateCloseOrderRequest value,
          $Res Function(CreateCloseOrderRequest) then) =
      _$CreateCloseOrderRequestCopyWithImpl<$Res, CreateCloseOrderRequest>;
  @useResult
...
/// @nodoc
class _$CreateCloseOrderRequestCopyWithImpl<$Res,
        $Val extends CreateCloseOrderRequest>
    implements $CreateCloseOrderRequestCopyWith<$Res> {
  _$CreateCloseOrderRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCloseOrderRequestImplCopyWith<$Res>
    implements $CreateCloseOrderRequestCopyWith<$Res> {
  factory _$$CreateCloseOrderRequestImplCopyWith(
          _$CreateCloseOrderRequestImpl value,
          $Res Function(_$CreateCloseOrderRequestImpl) then) =
      __$$CreateCloseOrderRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$CreateCloseOrderRequestImplCopyWithImpl<$Res>
    extends _$CreateCloseOrderRequestCopyWithImpl<$Res,
        _$CreateCloseOrderRequestImpl>
    implements _$$CreateCloseOrderRequestImplCopyWith<$Res> {
  __$$CreateCloseOrderRequestImplCopyWithImpl(
      _$CreateCloseOrderRequestImpl _value,
      $Res Function(_$CreateCloseOrderRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCloseOrderRequestImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCloseOrderRequestImpl implements _CreateCloseOrderRequest {
  const _$CreateCloseOrderRequestImpl({@JsonKey(name: "order") this.order});

  factory _$CreateCloseOrderRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateCloseOrderRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCloseOrderRequest(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCloseOrderRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCloseOrderRequestImplCopyWith<_$CreateCloseOrderRequestImpl>
      get copyWith => __$$CreateCloseOrderRequestImplCopyWithImpl<
          _$CreateCloseOrderRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCloseOrderRequestImplToJson(
      this,
    );
  }
}

abstract class _CreateCloseOrderRequest implements CreateCloseOrderRequest {
  const factory _CreateCloseOrderRequest(
          {@JsonKey(name: "order") final Order? order}) =
      _$CreateCloseOrderRequestImpl;

  factory _CreateCloseOrderRequest.fromJson(Map<String, dynamic> json) =
      _$CreateCloseOrderRequestImpl.fromJson;
