...
part 'update_change_whether_response.freezed.dart';
part 'update_change_whether_response.g.dart';

UpdateChangeWhetherResponse updateChangeWhetherResponseFromJson(String str) =>
    UpdateChangeWhetherResponse.fromJson(json.decode(str));

String updateChangeWhetherResponseToJson(UpdateChangeWhetherResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateChangeWhetherResponse with _$UpdateChangeWhetherResponse {
  const factory UpdateChangeWhetherResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateChangeWhetherResponse;

  factory UpdateChangeWhetherResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateChangeWhetherResponseFromJson(json);
}
