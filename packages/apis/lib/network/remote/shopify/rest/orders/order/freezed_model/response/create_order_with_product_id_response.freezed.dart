...
part of 'create_order_with_product_id_response.dart';
...
CreateOrderWithProductIdResponse _$CreateOrderWithProductIdResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderWithProductIdResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderWithProductIdResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this CreateOrderWithProductIdResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderWithProductIdResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderWithProductIdResponseCopyWith<CreateOrderWithProductIdResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderWithProductIdResponseCopyWith<$Res> {
  factory $CreateOrderWithProductIdResponseCopyWith(
          CreateOrderWithProductIdResponse value,
          $Res Function(CreateOrderWithProductIdResponse) then) =
      _$CreateOrderWithProductIdResponseCopyWithImpl<$Res,
          CreateOrderWithProductIdResponse>;
  @useResult
...
/// @nodoc
class _$CreateOrderWithProductIdResponseCopyWithImpl<$Res,
        $Val extends CreateOrderWithProductIdResponse>
    implements $CreateOrderWithProductIdResponseCopyWith<$Res> {
  _$CreateOrderWithProductIdResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderWithProductIdResponseImplCopyWith<$Res>
    implements $CreateOrderWithProductIdResponseCopyWith<$Res> {
  factory _$$CreateOrderWithProductIdResponseImplCopyWith(
          _$CreateOrderWithProductIdResponseImpl value,
          $Res Function(_$CreateOrderWithProductIdResponseImpl) then) =
      __$$CreateOrderWithProductIdResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$CreateOrderWithProductIdResponseImplCopyWithImpl<$Res>
    extends _$CreateOrderWithProductIdResponseCopyWithImpl<$Res,
        _$CreateOrderWithProductIdResponseImpl>
    implements _$$CreateOrderWithProductIdResponseImplCopyWith<$Res> {
  __$$CreateOrderWithProductIdResponseImplCopyWithImpl(
      _$CreateOrderWithProductIdResponseImpl _value,
      $Res Function(_$CreateOrderWithProductIdResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderWithProductIdResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderWithProductIdResponseImpl
    implements _CreateOrderWithProductIdResponse {
  const _$CreateOrderWithProductIdResponseImpl(
      {@JsonKey(name: "order") this.order});

  factory _$CreateOrderWithProductIdResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateOrderWithProductIdResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderWithProductIdResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderWithProductIdResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderWithProductIdResponseImplCopyWith<
          _$CreateOrderWithProductIdResponseImpl>
      get copyWith => __$$CreateOrderWithProductIdResponseImplCopyWithImpl<
          _$CreateOrderWithProductIdResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderWithProductIdResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderWithProductIdResponse
    implements CreateOrderWithProductIdResponse {
  const factory _CreateOrderWithProductIdResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$CreateOrderWithProductIdResponseImpl;

  factory _CreateOrderWithProductIdResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateOrderWithProductIdResponseImpl.fromJson;
