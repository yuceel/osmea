...
_$UpdateDraftOrderCompleteResponseImpl
    _$$UpdateDraftOrderCompleteResponseImplFromJson(
...
Map<String, dynamic> _$$UpdateDraftOrderCompleteResponseImplToJson(
        _$UpdateDraftOrderCompleteResponseImpl instance) =>
    <String, dynamic>{
...
_$DraftOrderImpl _$$DraftOrderImplFromJson(Map<String, dynamic> json) =>
    _$DraftOrderImpl(
      ...
      totalAdditionalFeesSet: json['total_additional_fees_set'],
      totalDutiesSet: json['total_duties_set'],
...
Map<String, dynamic> _$$DraftOrderImplToJson(_$DraftOrderImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.totalAdditionalFeesSet case final value?)
        'total_additional_fees_set': value,
      if (instance.totalDutiesSet case final value?) 'total_duties_set': value,
