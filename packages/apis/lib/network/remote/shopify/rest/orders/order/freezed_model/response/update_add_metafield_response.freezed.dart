...
part of 'update_add_metafield_response.dart';
...
UpdateAddMetafieldResponse _$UpdateAddMetafieldResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateAddMetafieldResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateAddMetafieldResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this UpdateAddMetafieldResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateAddMetafieldResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateAddMetafieldResponseCopyWith<UpdateAddMetafieldResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateAddMetafieldResponseCopyWith<$Res> {
  factory $UpdateAddMetafieldResponseCopyWith(UpdateAddMetafieldResponse value,
          $Res Function(UpdateAddMetafieldResponse) then) =
      _$UpdateAddMetafieldResponseCopyWithImpl<$Res,
          UpdateAddMetafieldResponse>;
  @useResult
...
/// @nodoc
class _$UpdateAddMetafieldResponseCopyWithImpl<$Res,
        $Val extends UpdateAddMetafieldResponse>
    implements $UpdateAddMetafieldResponseCopyWith<$Res> {
  _$UpdateAddMetafieldResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateAddMetafieldResponseImplCopyWith<$Res>
    implements $UpdateAddMetafieldResponseCopyWith<$Res> {
  factory _$$UpdateAddMetafieldResponseImplCopyWith(
          _$UpdateAddMetafieldResponseImpl value,
          $Res Function(_$UpdateAddMetafieldResponseImpl) then) =
      __$$UpdateAddMetafieldResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$UpdateAddMetafieldResponseImplCopyWithImpl<$Res>
    extends _$UpdateAddMetafieldResponseCopyWithImpl<$Res,
        _$UpdateAddMetafieldResponseImpl>
    implements _$$UpdateAddMetafieldResponseImplCopyWith<$Res> {
  __$$UpdateAddMetafieldResponseImplCopyWithImpl(
      _$UpdateAddMetafieldResponseImpl _value,
      $Res Function(_$UpdateAddMetafieldResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateAddMetafieldResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateAddMetafieldResponseImpl implements _UpdateAddMetafieldResponse {
  const _$UpdateAddMetafieldResponseImpl({@JsonKey(name: "order") this.order});

  factory _$UpdateAddMetafieldResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateAddMetafieldResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateAddMetafieldResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateAddMetafieldResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateAddMetafieldResponseImplCopyWith<_$UpdateAddMetafieldResponseImpl>
      get copyWith => __$$UpdateAddMetafieldResponseImplCopyWithImpl<
          _$UpdateAddMetafieldResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateAddMetafieldResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateAddMetafieldResponse
    implements UpdateAddMetafieldResponse {
  const factory _UpdateAddMetafieldResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$UpdateAddMetafieldResponseImpl;

  factory _UpdateAddMetafieldResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateAddMetafieldResponseImpl.fromJson;
