...
CreateInvoiceDefaultResponse _$CreateInvoiceDefaultResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateInvoiceDefaultResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateInvoiceDefaultResponse {
  @JsonKey(name: "draft_order_invoice")
  DraftOrderInvoice? get draftOrderInvoice =>
      throw _privateConstructorUsedError;

  /// Serializes this CreateInvoiceDefaultResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateInvoiceDefaultResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateInvoiceDefaultResponseCopyWith<CreateInvoiceDefaultResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateInvoiceDefaultResponseCopyWith<$Res> {
  factory $CreateInvoiceDefaultResponseCopyWith(
          CreateInvoiceDefaultResponse value,
          $Res Function(CreateInvoiceDefaultResponse) then) =
      _$CreateInvoiceDefaultResponseCopyWithImpl<$Res,
          CreateInvoiceDefaultResponse>;
  @useResult
  $Res call(
      {@JsonKey(name: "draft_order_invoice")
...
/// @nodoc
class _$CreateInvoiceDefaultResponseCopyWithImpl<$Res,
        $Val extends CreateInvoiceDefaultResponse>
    implements $CreateInvoiceDefaultResponseCopyWith<$Res> {
  _$CreateInvoiceDefaultResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateInvoiceDefaultResponseImplCopyWith<$Res>
    implements $CreateInvoiceDefaultResponseCopyWith<$Res> {
  factory _$$CreateInvoiceDefaultResponseImplCopyWith(
          _$CreateInvoiceDefaultResponseImpl value,
          $Res Function(_$CreateInvoiceDefaultResponseImpl) then) =
      __$$CreateInvoiceDefaultResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "draft_order_invoice")
...
/// @nodoc
class __$$CreateInvoiceDefaultResponseImplCopyWithImpl<$Res>
    extends _$CreateInvoiceDefaultResponseCopyWithImpl<$Res,
        _$CreateInvoiceDefaultResponseImpl>
    implements _$$CreateInvoiceDefaultResponseImplCopyWith<$Res> {
  __$$CreateInvoiceDefaultResponseImplCopyWithImpl(
      _$CreateInvoiceDefaultResponseImpl _value,
      $Res Function(_$CreateInvoiceDefaultResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateInvoiceDefaultResponseImpl(
      draftOrderInvoice: freezed == draftOrderInvoice
          ? _value.draftOrderInvoice
          : draftOrderInvoice // ignore: cast_nullable_to_non_nullable
              as DraftOrderInvoice?,
...
/// @nodoc
@JsonSerializable()
class _$CreateInvoiceDefaultResponseImpl
    implements _CreateInvoiceDefaultResponse {
  const _$CreateInvoiceDefaultResponseImpl(
      {@JsonKey(name: "draft_order_invoice") this.draftOrderInvoice});

  factory _$CreateInvoiceDefaultResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateInvoiceDefaultResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateInvoiceDefaultResponse(draftOrderInvoice: $draftOrderInvoice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateInvoiceDefaultResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateInvoiceDefaultResponseImplCopyWith<
          _$CreateInvoiceDefaultResponseImpl>
      get copyWith => __$$CreateInvoiceDefaultResponseImplCopyWithImpl<
          _$CreateInvoiceDefaultResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateInvoiceDefaultResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateInvoiceDefaultResponse
    implements CreateInvoiceDefaultResponse {
  const factory _CreateInvoiceDefaultResponse(
          {@JsonKey(name: "draft_order_invoice")
          final DraftOrderInvoice? draftOrderInvoice}) =
      _$CreateInvoiceDefaultResponseImpl;

  factory _CreateInvoiceDefaultResponse.fromJson(Map<String, dynamic> json) =
      _$CreateInvoiceDefaultResponseImpl.fromJson;
