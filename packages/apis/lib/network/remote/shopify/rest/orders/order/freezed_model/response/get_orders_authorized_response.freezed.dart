...
part of 'get_orders_authorized_response.dart';
...
GetOrdersAuthorizedResponse _$GetOrdersAuthorizedResponseFromJson(
    Map<String, dynamic> json) {
  return _GetOrdersAuthorizedResponse.fromJson(json);
}

/// @nodoc
mixin _$GetOrdersAuthorizedResponse {
  @JsonKey(name: "orders")
  List<Order>? get orders => throw _privateConstructorUsedError;

  /// Serializes this GetOrdersAuthorizedResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetOrdersAuthorizedResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetOrdersAuthorizedResponseCopyWith<GetOrdersAuthorizedResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetOrdersAuthorizedResponseCopyWith<$Res> {
  factory $GetOrdersAuthorizedResponseCopyWith(
          GetOrdersAuthorizedResponse value,
          $Res Function(GetOrdersAuthorizedResponse) then) =
      _$GetOrdersAuthorizedResponseCopyWithImpl<$Res,
          GetOrdersAuthorizedResponse>;
  @useResult
  $Res call({@JsonKey(name: "orders") List<Order>? orders});
}

/// @nodoc
class _$GetOrdersAuthorizedResponseCopyWithImpl<$Res,
        $Val extends GetOrdersAuthorizedResponse>
    implements $GetOrdersAuthorizedResponseCopyWith<$Res> {
  _$GetOrdersAuthorizedResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetOrdersAuthorizedResponseImplCopyWith<$Res>
    implements $GetOrdersAuthorizedResponseCopyWith<$Res> {
  factory _$$GetOrdersAuthorizedResponseImplCopyWith(
          _$GetOrdersAuthorizedResponseImpl value,
          $Res Function(_$GetOrdersAuthorizedResponseImpl) then) =
      __$$GetOrdersAuthorizedResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "orders") List<Order>? orders});
}
...
/// @nodoc
class __$$GetOrdersAuthorizedResponseImplCopyWithImpl<$Res>
    extends _$GetOrdersAuthorizedResponseCopyWithImpl<$Res,
        _$GetOrdersAuthorizedResponseImpl>
    implements _$$GetOrdersAuthorizedResponseImplCopyWith<$Res> {
  __$$GetOrdersAuthorizedResponseImplCopyWithImpl(
      _$GetOrdersAuthorizedResponseImpl _value,
      $Res Function(_$GetOrdersAuthorizedResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetOrdersAuthorizedResponseImpl(
      orders: freezed == orders
          ? _value._orders
          : orders // ignore: cast_nullable_to_non_nullable
              as List<Order>?,
...
/// @nodoc
@JsonSerializable()
class _$GetOrdersAuthorizedResponseImpl
    implements _GetOrdersAuthorizedResponse {
  const _$GetOrdersAuthorizedResponseImpl(
      {@JsonKey(name: "orders") final List<Order>? orders})
      : _orders = orders;

  factory _$GetOrdersAuthorizedResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GetOrdersAuthorizedResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetOrdersAuthorizedResponse(orders: $orders)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetOrdersAuthorizedResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetOrdersAuthorizedResponseImplCopyWith<_$GetOrdersAuthorizedResponseImpl>
      get copyWith => __$$GetOrdersAuthorizedResponseImplCopyWithImpl<
          _$GetOrdersAuthorizedResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetOrdersAuthorizedResponseImplToJson(
      this,
    );
  }
}

abstract class _GetOrdersAuthorizedResponse
    implements GetOrdersAuthorizedResponse {
  const factory _GetOrdersAuthorizedResponse(
          {@JsonKey(name: "orders") final List<Order>? orders}) =
      _$GetOrdersAuthorizedResponseImpl;

  factory _GetOrdersAuthorizedResponse.fromJson(Map<String, dynamic> json) =
      _$GetOrdersAuthorizedResponseImpl.fromJson;
