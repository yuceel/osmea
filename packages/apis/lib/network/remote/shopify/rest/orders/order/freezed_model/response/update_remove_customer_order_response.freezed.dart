...
part of 'update_remove_customer_order_response.dart';
...
UpdateRemoveCustomerOrderResponse _$UpdateRemoveCustomerOrderResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateRemoveCustomerOrderResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateRemoveCustomerOrderResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this UpdateRemoveCustomerOrderResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateRemoveCustomerOrderResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateRemoveCustomerOrderResponseCopyWith<UpdateRemoveCustomerOrderResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateRemoveCustomerOrderResponseCopyWith<$Res> {
  factory $UpdateRemoveCustomerOrderResponseCopyWith(
          UpdateRemoveCustomerOrderResponse value,
          $Res Function(UpdateRemoveCustomerOrderResponse) then) =
      _$UpdateRemoveCustomerOrderResponseCopyWithImpl<$Res,
          UpdateRemoveCustomerOrderResponse>;
  @useResult
...
/// @nodoc
class _$UpdateRemoveCustomerOrderResponseCopyWithImpl<$Res,
        $Val extends UpdateRemoveCustomerOrderResponse>
    implements $UpdateRemoveCustomerOrderResponseCopyWith<$Res> {
  _$UpdateRemoveCustomerOrderResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateRemoveCustomerOrderResponseImplCopyWith<$Res>
    implements $UpdateRemoveCustomerOrderResponseCopyWith<$Res> {
  factory _$$UpdateRemoveCustomerOrderResponseImplCopyWith(
          _$UpdateRemoveCustomerOrderResponseImpl value,
          $Res Function(_$UpdateRemoveCustomerOrderResponseImpl) then) =
      __$$UpdateRemoveCustomerOrderResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$UpdateRemoveCustomerOrderResponseImplCopyWithImpl<$Res>
    extends _$UpdateRemoveCustomerOrderResponseCopyWithImpl<$Res,
        _$UpdateRemoveCustomerOrderResponseImpl>
    implements _$$UpdateRemoveCustomerOrderResponseImplCopyWith<$Res> {
  __$$UpdateRemoveCustomerOrderResponseImplCopyWithImpl(
      _$UpdateRemoveCustomerOrderResponseImpl _value,
      $Res Function(_$UpdateRemoveCustomerOrderResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateRemoveCustomerOrderResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateRemoveCustomerOrderResponseImpl
    implements _UpdateRemoveCustomerOrderResponse {
  const _$UpdateRemoveCustomerOrderResponseImpl(
      {@JsonKey(name: "order") this.order});

  factory _$UpdateRemoveCustomerOrderResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateRemoveCustomerOrderResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateRemoveCustomerOrderResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateRemoveCustomerOrderResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateRemoveCustomerOrderResponseImplCopyWith<
          _$UpdateRemoveCustomerOrderResponseImpl>
      get copyWith => __$$UpdateRemoveCustomerOrderResponseImplCopyWithImpl<
          _$UpdateRemoveCustomerOrderResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateRemoveCustomerOrderResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateRemoveCustomerOrderResponse
    implements UpdateRemoveCustomerOrderResponse {
  const factory _UpdateRemoveCustomerOrderResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$UpdateRemoveCustomerOrderResponseImpl;

  factory _UpdateRemoveCustomerOrderResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdateRemoveCustomerOrderResponseImpl.fromJson;
