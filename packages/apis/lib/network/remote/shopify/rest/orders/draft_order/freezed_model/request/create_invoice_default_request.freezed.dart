...
CreateInvoiceDefaultRequest _$CreateInvoiceDefaultRequestFromJson(
    Map<String, dynamic> json) {
  return _CreateInvoiceDefaultRequest.fromJson(json);
}

/// @nodoc
mixin _$CreateInvoiceDefaultRequest {
...
/// @nodoc
abstract class $CreateInvoiceDefaultRequestCopyWith<$Res> {
  factory $CreateInvoiceDefaultRequestCopyWith(
          CreateInvoiceDefaultRequest value,
          $Res Function(CreateInvoiceDefaultRequest) then) =
      _$CreateInvoiceDefaultRequestCopyWithImpl<$Res,
          CreateInvoiceDefaultRequest>;
  @useResult
  $Res call(
      {@JsonKey(name: "draft_order_invoice")
...
/// @nodoc
class _$CreateInvoiceDefaultRequestCopyWithImpl<$Res,
        $Val extends CreateInvoiceDefaultRequest>
    implements $CreateInvoiceDefaultRequestCopyWith<$Res> {
  _$CreateInvoiceDefaultRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateInvoiceDefaultRequestImplCopyWith<$Res>
    implements $CreateInvoiceDefaultRequestCopyWith<$Res> {
  factory _$$CreateInvoiceDefaultRequestImplCopyWith(
          _$CreateInvoiceDefaultRequestImpl value,
          $Res Function(_$CreateInvoiceDefaultRequestImpl) then) =
      __$$CreateInvoiceDefaultRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "draft_order_invoice")
...
/// @nodoc
class __$$CreateInvoiceDefaultRequestImplCopyWithImpl<$Res>
    extends _$CreateInvoiceDefaultRequestCopyWithImpl<$Res,
        _$CreateInvoiceDefaultRequestImpl>
    implements _$$CreateInvoiceDefaultRequestImplCopyWith<$Res> {
  __$$CreateInvoiceDefaultRequestImplCopyWithImpl(
      _$CreateInvoiceDefaultRequestImpl _value,
  ...
  $Res call({
    ...
    return _then(_$CreateInvoiceDefaultRequestImpl(
      draftOrderInvoice: freezed == draftOrderInvoice
          ? _value.draftOrderInvoice
          : draftOrderInvoice // ignore: cast_nullable_to_non_nullable
              as DraftOrderInvoice?,
...
/// @nodoc
@JsonSerializable()
class _$CreateInvoiceDefaultRequestImpl
    implements _CreateInvoiceDefaultRequest {
  const _$CreateInvoiceDefaultRequestImpl(
      {@JsonKey(name: "draft_order_invoice") this.draftOrderInvoice});

  factory _$CreateInvoiceDefaultRequestImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateInvoiceDefaultRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateInvoiceDefaultRequest(draftOrderInvoice: $draftOrderInvoice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateInvoiceDefaultRequestImpl &&
  ...
  _$$CreateInvoiceDefaultRequestImplCopyWith<_$CreateInvoiceDefaultRequestImpl>
      get copyWith => __$$CreateInvoiceDefaultRequestImplCopyWithImpl<
          _$CreateInvoiceDefaultRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateInvoiceDefaultRequestImplToJson(
      this,
    );
  }
}

abstract class _CreateInvoiceDefaultRequest
    implements CreateInvoiceDefaultRequest {
  const factory _CreateInvoiceDefaultRequest(
          {@JsonKey(name: "draft_order_invoice")
          final DraftOrderInvoice? draftOrderInvoice}) =
      _$CreateInvoiceDefaultRequestImpl;

  factory _CreateInvoiceDefaultRequest.fromJson(Map<String, dynamic> json) =
      _$CreateInvoiceDefaultRequestImpl.fromJson;
