...
part 'get_single_refund_response.freezed.dart';
part 'get_single_refund_response.g.dart';

GetSingleRefundResponse getSingleRefundResponseFromJson(String str) =>
    GetSingleRefundResponse.fromJson(json.decode(str));

String getSingleRefundResponseToJson(GetSingleRefundResponse data) =>
    json.encode(data.toJson());

@freezed
class GetSingleRefundResponse with _$GetSingleRefundResponse {
  const factory GetSingleRefundResponse({
    @JsonKey(name: "refund") Refund? refund,
  }) = _GetSingleRefundResponse;

  factory GetSingleRefundResponse.fromJson(Map<String, dynamic> json) =>
      _$GetSingleRefundResponseFromJson(json);
}
