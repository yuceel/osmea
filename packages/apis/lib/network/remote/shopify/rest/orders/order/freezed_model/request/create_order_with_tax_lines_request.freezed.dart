...
CreateOrderWithTaxLinesRequest _$CreateOrderWithTaxLinesRequestFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderWithTaxLinesRequest.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderWithTaxLinesRequest {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this CreateOrderWithTaxLinesRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderWithTaxLinesRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderWithTaxLinesRequestCopyWith<CreateOrderWithTaxLinesRequest>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderWithTaxLinesRequestCopyWith<$Res> {
  factory $CreateOrderWithTaxLinesRequestCopyWith(
          CreateOrderWithTaxLinesRequest value,
          $Res Function(CreateOrderWithTaxLinesRequest) then) =
      _$CreateOrderWithTaxLinesRequestCopyWithImpl<$Res,
          CreateOrderWithTaxLinesRequest>;
  @useResult
...
/// @nodoc
class _$CreateOrderWithTaxLinesRequestCopyWithImpl<$Res,
        $Val extends CreateOrderWithTaxLinesRequest>
    implements $CreateOrderWithTaxLinesRequestCopyWith<$Res> {
  _$CreateOrderWithTaxLinesRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderWithTaxLinesRequestImplCopyWith<$Res>
    implements $CreateOrderWithTaxLinesRequestCopyWith<$Res> {
  factory _$$CreateOrderWithTaxLinesRequestImplCopyWith(
          _$CreateOrderWithTaxLinesRequestImpl value,
          $Res Function(_$CreateOrderWithTaxLinesRequestImpl) then) =
      __$$CreateOrderWithTaxLinesRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$CreateOrderWithTaxLinesRequestImplCopyWithImpl<$Res>
    extends _$CreateOrderWithTaxLinesRequestCopyWithImpl<$Res,
        _$CreateOrderWithTaxLinesRequestImpl>
    implements _$$CreateOrderWithTaxLinesRequestImplCopyWith<$Res> {
  __$$CreateOrderWithTaxLinesRequestImplCopyWithImpl(
      _$CreateOrderWithTaxLinesRequestImpl _value,
      $Res Function(_$CreateOrderWithTaxLinesRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderWithTaxLinesRequestImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderWithTaxLinesRequestImpl
    implements _CreateOrderWithTaxLinesRequest {
  const _$CreateOrderWithTaxLinesRequestImpl(
      {@JsonKey(name: "order") this.order});

  factory _$CreateOrderWithTaxLinesRequestImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateOrderWithTaxLinesRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderWithTaxLinesRequest(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderWithTaxLinesRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderWithTaxLinesRequestImplCopyWith<
          _$CreateOrderWithTaxLinesRequestImpl>
      get copyWith => __$$CreateOrderWithTaxLinesRequestImplCopyWithImpl<
          _$CreateOrderWithTaxLinesRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderWithTaxLinesRequestImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderWithTaxLinesRequest
    implements CreateOrderWithTaxLinesRequest {
  const factory _CreateOrderWithTaxLinesRequest(
          {@JsonKey(name: "order") final Order? order}) =
      _$CreateOrderWithTaxLinesRequestImpl;

  factory _CreateOrderWithTaxLinesRequest.fromJson(Map<String, dynamic> json) =
      _$CreateOrderWithTaxLinesRequestImpl.fromJson;
...
class _$OrderImpl implements _Order {
  ...
  @override
  String toString() {
    return 'Order(lineItems: $lineItems, taxLines: $taxLines)';
  }
...
abstract class _Order implements Order {
  const factory _Order(
      {@JsonKey(name: "line_items") final List<LineItem>? lineItems,
      @JsonKey(name: "tax_lines") final List<TaxLine>? taxLines}) = _$OrderImpl;
...
class _$LineItemImpl implements _LineItem {
  ...
  @override
  String toString() {
    return 'LineItem(title: $title, price: $price, grams: $grams, quantity: $quantity)';
  }
