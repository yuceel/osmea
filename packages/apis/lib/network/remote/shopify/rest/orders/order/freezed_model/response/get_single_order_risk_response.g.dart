...
_$GetSingleOrderRiskResponseImpl _$$GetSingleOrderRiskResponseImplFromJson(
...
Map<String, dynamic> _$$GetSingleOrderRiskResponseImplToJson(
        _$GetSingleOrderRiskResponseImpl instance) =>
    <String, dynamic>{
