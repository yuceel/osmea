...
_$CreateCancelOrderResponseImpl _$$CreateCancelOrderResponseImplFromJson(
...
Map<String, dynamic> _$$CreateCancelOrderResponseImplToJson(
        _$CreateCancelOrderResponseImpl instance) =>
    <String, dynamic>{
      if (instance.order?.toJson() case final value?) 'order': value,
      if (instance.notice case final value?) 'notice': value,
    };
