...
GetListRefundResponse _$GetListRefundResponseFromJson(
    Map<String, dynamic> json) {
  return _GetListRefundResponse.fromJson(json);
}

/// @nodoc
mixin _$GetListRefundResponse {
  @JsonKey(name: "refunds")
  List<Refund>? get refunds => throw _privateConstructorUsedError;

  /// Serializes this GetListRefundResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetListRefundResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetListRefundResponseCopyWith<GetListRefundResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetListRefundResponseCopyWith<$Res> {
  factory $GetListRefundResponseCopyWith(GetListRefundResponse value,
          $Res Function(GetListRefundResponse) then) =
      _$GetListRefundResponseCopyWithImpl<$Res, GetListRefundResponse>;
  @useResult
  $Res call({@JsonKey(name: "refunds") List<Refund>? refunds});
}

/// @nodoc
class _$GetListRefundResponseCopyWithImpl<$Res,
        $Val extends GetListRefundResponse>
    implements $GetListRefundResponseCopyWith<$Res> {
  _$GetListRefundResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetListRefundResponseImplCopyWith<$Res>
    implements $GetListRefundResponseCopyWith<$Res> {
  factory _$$GetListRefundResponseImplCopyWith(
          _$GetListRefundResponseImpl value,
          $Res Function(_$GetListRefundResponseImpl) then) =
      __$$GetListRefundResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "refunds") List<Refund>? refunds});
}
...
/// @nodoc
class __$$GetListRefundResponseImplCopyWithImpl<$Res>
    extends _$GetListRefundResponseCopyWithImpl<$Res,
        _$GetListRefundResponseImpl>
    implements _$$GetListRefundResponseImplCopyWith<$Res> {
  __$$GetListRefundResponseImplCopyWithImpl(_$GetListRefundResponseImpl _value,
      $Res Function(_$GetListRefundResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetListRefundResponseImpl(
      refunds: freezed == refunds
          ? _value._refunds
          : refunds // ignore: cast_nullable_to_non_nullable
              as List<Refund>?,
...
/// @nodoc
@JsonSerializable()
class _$GetListRefundResponseImpl implements _GetListRefundResponse {
  const _$GetListRefundResponseImpl(
      {@JsonKey(name: "refunds") final List<Refund>? refunds})
      : _refunds = refunds;

  factory _$GetListRefundResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetListRefundResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetListRefundResponse(refunds: $refunds)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetListRefundResponseImpl &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_refunds));
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetListRefundResponseImplCopyWith<_$GetListRefundResponseImpl>
      get copyWith => __$$GetListRefundResponseImplCopyWithImpl<
          _$GetListRefundResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetListRefundResponseImplToJson(
      this,
    );
  }
}

abstract class _GetListRefundResponse implements GetListRefundResponse {
  const factory _GetListRefundResponse(
          {@JsonKey(name: "refunds") final List<Refund>? refunds}) =
      _$GetListRefundResponseImpl;

  factory _GetListRefundResponse.fromJson(Map<String, dynamic> json) =
      _$GetListRefundResponseImpl.fromJson;
