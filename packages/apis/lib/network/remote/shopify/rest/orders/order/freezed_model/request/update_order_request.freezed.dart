...
class _$UpdateOrderRequestImpl implements _UpdateOrderRequest {
  const _$UpdateOrderRequestImpl({@JsonKey(name: "order") this.order});
  ...
  @override
  String toString() {
    return 'UpdateOrderRequest(order: $order)';
  }
...
abstract class _UpdateOrderRequest implements UpdateOrderRequest {
  const factory _UpdateOrderRequest(
      {@JsonKey(name: "order") final Order? order}) = _$UpdateOrderRequestImpl;
