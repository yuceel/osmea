...
part of 'create_order_partially_paid_response.dart';
...
CreateOrderPartiallyPaidResponse _$CreateOrderPartiallyPaidResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderPartiallyPaidResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderPartiallyPaidResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this CreateOrderPartiallyPaidResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderPartiallyPaidResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderPartiallyPaidResponseCopyWith<CreateOrderPartiallyPaidResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderPartiallyPaidResponseCopyWith<$Res> {
  factory $CreateOrderPartiallyPaidResponseCopyWith(
          CreateOrderPartiallyPaidResponse value,
          $Res Function(CreateOrderPartiallyPaidResponse) then) =
      _$CreateOrderPartiallyPaidResponseCopyWithImpl<$Res,
          CreateOrderPartiallyPaidResponse>;
  @useResult
...
/// @nodoc
class _$CreateOrderPartiallyPaidResponseCopyWithImpl<$Res,
        $Val extends CreateOrderPartiallyPaidResponse>
    implements $CreateOrderPartiallyPaidResponseCopyWith<$Res> {
  _$CreateOrderPartiallyPaidResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderPartiallyPaidResponseImplCopyWith<$Res>
    implements $CreateOrderPartiallyPaidResponseCopyWith<$Res> {
  factory _$$CreateOrderPartiallyPaidResponseImplCopyWith(
          _$CreateOrderPartiallyPaidResponseImpl value,
          $Res Function(_$CreateOrderPartiallyPaidResponseImpl) then) =
      __$$CreateOrderPartiallyPaidResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$CreateOrderPartiallyPaidResponseImplCopyWithImpl<$Res>
    extends _$CreateOrderPartiallyPaidResponseCopyWithImpl<$Res,
        _$CreateOrderPartiallyPaidResponseImpl>
    implements _$$CreateOrderPartiallyPaidResponseImplCopyWith<$Res> {
  __$$CreateOrderPartiallyPaidResponseImplCopyWithImpl(
      _$CreateOrderPartiallyPaidResponseImpl _value,
      $Res Function(_$CreateOrderPartiallyPaidResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderPartiallyPaidResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderPartiallyPaidResponseImpl
    implements _CreateOrderPartiallyPaidResponse {
  const _$CreateOrderPartiallyPaidResponseImpl(
      {@JsonKey(name: "order") this.order});

  factory _$CreateOrderPartiallyPaidResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateOrderPartiallyPaidResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderPartiallyPaidResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderPartiallyPaidResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderPartiallyPaidResponseImplCopyWith<
          _$CreateOrderPartiallyPaidResponseImpl>
      get copyWith => __$$CreateOrderPartiallyPaidResponseImplCopyWithImpl<
          _$CreateOrderPartiallyPaidResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderPartiallyPaidResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderPartiallyPaidResponse
    implements CreateOrderPartiallyPaidResponse {
  const factory _CreateOrderPartiallyPaidResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$CreateOrderPartiallyPaidResponseImpl;

  factory _CreateOrderPartiallyPaidResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateOrderPartiallyPaidResponseImpl.fromJson;
