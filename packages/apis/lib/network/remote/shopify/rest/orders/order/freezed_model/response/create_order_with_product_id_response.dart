...
part 'create_order_with_product_id_response.freezed.dart';
part 'create_order_with_product_id_response.g.dart';

CreateOrderWithProductIdResponse createOrderWithProductIdResponseFromJson(
        String str) =>
    CreateOrderWithProductIdResponse.fromJson(json.decode(str));

String createOrderWithProductIdResponseToJson(
        CreateOrderWithProductIdResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderWithProductIdResponse with _$CreateOrderWithProductIdResponse {
  const factory CreateOrderWithProductIdResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderWithProductIdResponse;

  factory CreateOrderWithProductIdResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateOrderWithProductIdResponseFromJson(json);
}
