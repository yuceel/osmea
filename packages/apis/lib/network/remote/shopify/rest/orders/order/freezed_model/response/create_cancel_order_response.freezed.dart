...
part of 'create_cancel_order_response.dart';
...
CreateCancelOrderResponse _$CreateCancelOrderResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateCancelOrderResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCancelOrderResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;
  @JsonKey(name: "notice")
  String? get notice => throw _privateConstructorUsedError;

  /// Serializes this CreateCancelOrderResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCancelOrderResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCancelOrderResponseCopyWith<CreateCancelOrderResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCancelOrderResponseCopyWith<$Res> {
  factory $CreateCancelOrderResponseCopyWith(CreateCancelOrderResponse value,
          $Res Function(CreateCancelOrderResponse) then) =
      _$CreateCancelOrderResponseCopyWithImpl<$Res, CreateCancelOrderResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateCancelOrderResponseCopyWithImpl<$Res,
        $Val extends CreateCancelOrderResponse>
    implements $CreateCancelOrderResponseCopyWith<$Res> {
  _$CreateCancelOrderResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCancelOrderResponseImplCopyWith<$Res>
    implements $CreateCancelOrderResponseCopyWith<$Res> {
  factory _$$CreateCancelOrderResponseImplCopyWith(
          _$CreateCancelOrderResponseImpl value,
          $Res Function(_$CreateCancelOrderResponseImpl) then) =
      __$$CreateCancelOrderResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "order") Order? order,
...
/// @nodoc
class __$$CreateCancelOrderResponseImplCopyWithImpl<$Res>
    extends _$CreateCancelOrderResponseCopyWithImpl<$Res,
        _$CreateCancelOrderResponseImpl>
    implements _$$CreateCancelOrderResponseImplCopyWith<$Res> {
  __$$CreateCancelOrderResponseImplCopyWithImpl(
      _$CreateCancelOrderResponseImpl _value,
      $Res Function(_$CreateCancelOrderResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCancelOrderResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCancelOrderResponseImpl implements _CreateCancelOrderResponse {
  const _$CreateCancelOrderResponseImpl(
      {@JsonKey(name: "order") this.order,
      @JsonKey(name: "notice") this.notice});

  factory _$CreateCancelOrderResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateCancelOrderResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateCancelOrderResponse(order: $order, notice: $notice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCancelOrderResponseImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, order, notice);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCancelOrderResponseImplCopyWith<_$CreateCancelOrderResponseImpl>
      get copyWith => __$$CreateCancelOrderResponseImplCopyWithImpl<
          _$CreateCancelOrderResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCancelOrderResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateCancelOrderResponse implements CreateCancelOrderResponse {
  const factory _CreateCancelOrderResponse(
          {@JsonKey(name: "order") final Order? order,
          @JsonKey(name: "notice") final String? notice}) =
      _$CreateCancelOrderResponseImpl;

  factory _CreateCancelOrderResponse.fromJson(Map<String, dynamic> json) =
      _$CreateCancelOrderResponseImpl.fromJson;
