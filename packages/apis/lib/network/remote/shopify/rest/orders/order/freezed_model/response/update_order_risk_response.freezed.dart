...
UpdateOrderRiskResponse _$UpdateOrderRiskResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateOrderRiskResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateOrderRiskResponse {
  @JsonKey(name: "risk")
...
/// @nodoc
abstract class $UpdateOrderRiskResponseCopyWith<$Res> {
  factory $UpdateOrderRiskResponseCopyWith(UpdateOrderRiskResponse value,
          $Res Function(UpdateOrderRiskResponse) then) =
      _$UpdateOrderRiskResponseCopyWithImpl<$Res, UpdateOrderRiskResponse>;
  @useResult
...
/// @nodoc
class _$UpdateOrderRiskResponseCopyWithImpl<$Res,
        $Val extends UpdateOrderRiskResponse>
    implements $UpdateOrderRiskResponseCopyWith<$Res> {
  _$UpdateOrderRiskResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateOrderRiskResponseImplCopyWith<$Res>
    implements $UpdateOrderRiskResponseCopyWith<$Res> {
  factory _$$UpdateOrderRiskResponseImplCopyWith(
          _$UpdateOrderRiskResponseImpl value,
          $Res Function(_$UpdateOrderRiskResponseImpl) then) =
      __$$UpdateOrderRiskResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "risk") Risk? risk});
...
/// @nodoc
class __$$UpdateOrderRiskResponseImplCopyWithImpl<$Res>
    extends _$UpdateOrderRiskResponseCopyWithImpl<$Res,
        _$UpdateOrderRiskResponseImpl>
    implements _$$UpdateOrderRiskResponseImplCopyWith<$Res> {
  __$$UpdateOrderRiskResponseImplCopyWithImpl(
      _$UpdateOrderRiskResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$UpdateOrderRiskResponseImpl(
      risk: freezed == risk
          ? _value.risk
          : risk // ignore: cast_nullable_to_non_nullable
              as Risk?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateOrderRiskResponseImpl implements _UpdateOrderRiskResponse {
  const _$UpdateOrderRiskResponseImpl({@JsonKey(name: "risk") this.risk});

  factory _$UpdateOrderRiskResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateOrderRiskResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateOrderRiskResponse(risk: $risk)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateOrderRiskResponseImpl &&
  ...
  _$$UpdateOrderRiskResponseImplCopyWith<_$UpdateOrderRiskResponseImpl>
      get copyWith => __$$UpdateOrderRiskResponseImplCopyWithImpl<
          _$UpdateOrderRiskResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateOrderRiskResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateOrderRiskResponse implements UpdateOrderRiskResponse {
  const factory _UpdateOrderRiskResponse(
          {@JsonKey(name: "risk") final Risk? risk}) =
      _$UpdateOrderRiskResponseImpl;

  factory _UpdateOrderRiskResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateOrderRiskResponseImpl.fromJson;
