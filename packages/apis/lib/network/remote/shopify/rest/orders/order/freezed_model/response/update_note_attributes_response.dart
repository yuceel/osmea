...
part 'update_note_attributes_response.freezed.dart';
part 'update_note_attributes_response.g.dart';

UpdateNoteAttributesResponse updateNoteAttributesResponseFromJson(String str) =>
    UpdateNoteAttributesResponse.fromJson(json.decode(str));

String updateNoteAttributesResponseToJson(UpdateNoteAttributesResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateNoteAttributesResponse with _$UpdateNoteAttributesResponse {
  const factory UpdateNoteAttributesResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateNoteAttributesResponse;

  factory UpdateNoteAttributesResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateNoteAttributesResponseFromJson(json);
}
