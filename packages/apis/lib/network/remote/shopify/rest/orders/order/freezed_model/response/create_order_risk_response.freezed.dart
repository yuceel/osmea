...
CreateOrderRiskResponse _$CreateOrderRiskResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderRiskResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderRiskResponse {
  @JsonKey(name: "risk")
  Risk? get risk => throw _privateConstructorUsedError;

  /// Serializes this CreateOrderRiskResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderRiskResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderRiskResponseCopyWith<CreateOrderRiskResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderRiskResponseCopyWith<$Res> {
  factory $CreateOrderRiskResponseCopyWith(CreateOrderRiskResponse value,
          $Res Function(CreateOrderRiskResponse) then) =
      _$CreateOrderRiskResponseCopyWithImpl<$Res, CreateOrderRiskResponse>;
  @useResult
...
/// @nodoc
class _$CreateOrderRiskResponseCopyWithImpl<$Res,
        $Val extends CreateOrderRiskResponse>
    implements $CreateOrderRiskResponseCopyWith<$Res> {
  _$CreateOrderRiskResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderRiskResponseImplCopyWith<$Res>
    implements $CreateOrderRiskResponseCopyWith<$Res> {
  factory _$$CreateOrderRiskResponseImplCopyWith(
          _$CreateOrderRiskResponseImpl value,
          $Res Function(_$CreateOrderRiskResponseImpl) then) =
      __$$CreateOrderRiskResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "risk") Risk? risk});
...
/// @nodoc
class __$$CreateOrderRiskResponseImplCopyWithImpl<$Res>
    extends _$CreateOrderRiskResponseCopyWithImpl<$Res,
        _$CreateOrderRiskResponseImpl>
    implements _$$CreateOrderRiskResponseImplCopyWith<$Res> {
  __$$CreateOrderRiskResponseImplCopyWithImpl(
      _$CreateOrderRiskResponseImpl _value,
      $Res Function(_$CreateOrderRiskResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderRiskResponseImpl(
      risk: freezed == risk
          ? _value.risk
          : risk // ignore: cast_nullable_to_non_nullable
              as Risk?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderRiskResponseImpl implements _CreateOrderRiskResponse {
  const _$CreateOrderRiskResponseImpl({@JsonKey(name: "risk") this.risk});

  factory _$CreateOrderRiskResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateOrderRiskResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderRiskResponse(risk: $risk)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderRiskResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderRiskResponseImplCopyWith<_$CreateOrderRiskResponseImpl>
      get copyWith => __$$CreateOrderRiskResponseImplCopyWithImpl<
          _$CreateOrderRiskResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderRiskResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderRiskResponse implements CreateOrderRiskResponse {
  const factory _CreateOrderRiskResponse(
          {@JsonKey(name: "risk") final Risk? risk}) =
      _$CreateOrderRiskResponseImpl;

  factory _CreateOrderRiskResponse.fromJson(Map<String, dynamic> json) =
      _$CreateOrderRiskResponseImpl.fromJson;
