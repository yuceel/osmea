...
part of 'update_draft_order_complete_response.dart';
...
UpdateDraftOrderCompleteResponse _$UpdateDraftOrderCompleteResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateDraftOrderCompleteResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateDraftOrderCompleteResponse {
  @JsonKey(name: "draft_order")
  DraftOrder? get draftOrder => throw _privateConstructorUsedError;

  /// Serializes this UpdateDraftOrderCompleteResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateDraftOrderCompleteResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateDraftOrderCompleteResponseCopyWith<UpdateDraftOrderCompleteResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateDraftOrderCompleteResponseCopyWith<$Res> {
  factory $UpdateDraftOrderCompleteResponseCopyWith(
          UpdateDraftOrderCompleteResponse value,
          $Res Function(UpdateDraftOrderCompleteResponse) then) =
      _$UpdateDraftOrderCompleteResponseCopyWithImpl<$Res,
          UpdateDraftOrderCompleteResponse>;
  @useResult
...
/// @nodoc
class _$UpdateDraftOrderCompleteResponseCopyWithImpl<$Res,
        $Val extends UpdateDraftOrderCompleteResponse>
    implements $UpdateDraftOrderCompleteResponseCopyWith<$Res> {
  _$UpdateDraftOrderCompleteResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateDraftOrderCompleteResponseImplCopyWith<$Res>
    implements $UpdateDraftOrderCompleteResponseCopyWith<$Res> {
  factory _$$UpdateDraftOrderCompleteResponseImplCopyWith(
          _$UpdateDraftOrderCompleteResponseImpl value,
          $Res Function(_$UpdateDraftOrderCompleteResponseImpl) then) =
      __$$UpdateDraftOrderCompleteResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "draft_order") DraftOrder? draftOrder});
...
/// @nodoc
class __$$UpdateDraftOrderCompleteResponseImplCopyWithImpl<$Res>
    extends _$UpdateDraftOrderCompleteResponseCopyWithImpl<$Res,
        _$UpdateDraftOrderCompleteResponseImpl>
    implements _$$UpdateDraftOrderCompleteResponseImplCopyWith<$Res> {
  __$$UpdateDraftOrderCompleteResponseImplCopyWithImpl(
      _$UpdateDraftOrderCompleteResponseImpl _value,
      $Res Function(_$UpdateDraftOrderCompleteResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateDraftOrderCompleteResponseImpl(
      draftOrder: freezed == draftOrder
          ? _value.draftOrder
          : draftOrder // ignore: cast_nullable_to_non_nullable
              as DraftOrder?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateDraftOrderCompleteResponseImpl
    implements _UpdateDraftOrderCompleteResponse {
  const _$UpdateDraftOrderCompleteResponseImpl(
      {@JsonKey(name: "draft_order") this.draftOrder});

  factory _$UpdateDraftOrderCompleteResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateDraftOrderCompleteResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateDraftOrderCompleteResponse(draftOrder: $draftOrder)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateDraftOrderCompleteResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateDraftOrderCompleteResponseImplCopyWith<
          _$UpdateDraftOrderCompleteResponseImpl>
      get copyWith => __$$UpdateDraftOrderCompleteResponseImplCopyWithImpl<
          _$UpdateDraftOrderCompleteResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateDraftOrderCompleteResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateDraftOrderCompleteResponse
    implements UpdateDraftOrderCompleteResponse {
  const factory _UpdateDraftOrderCompleteResponse(
          {@JsonKey(name: "draft_order") final DraftOrder? draftOrder}) =
      _$UpdateDraftOrderCompleteResponseImpl;

  factory _UpdateDraftOrderCompleteResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdateDraftOrderCompleteResponseImpl.fromJson;
...
mixin _$DraftOrder {
  ...
  dynamic get totalAdditionalFeesSet => throw _privateConstructorUsedError;
  @JsonKey(name: "total_duties_set")
  dynamic get totalDutiesSet => throw _privateConstructorUsedError;
...
abstract class $DraftOrderCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "total_additional_fees_set")
      dynamic totalAdditionalFeesSet,
...
class _$DraftOrderImpl implements _DraftOrder {
  ...
  @override
  @JsonKey(name: "total_additional_fees_set")
  final dynamic totalAdditionalFeesSet;
  @override
  @JsonKey(name: "total_duties_set")
  final dynamic totalDutiesSet;
  @override
  @JsonKey(name: "amount_due_now_set")
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.totalAdditionalFeesSet, totalAdditionalFeesSet) &&
            const DeepCollectionEquality()
                .equals(other.totalDutiesSet, totalDutiesSet) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(totalAdditionalFeesSet),
        const DeepCollectionEquality().hash(totalDutiesSet),
        amountDueNowSet,
        amountDueLaterSet,
        adminGraphqlApiId,
        customer
...
abstract class _DraftOrder implements DraftOrder {
  const factory _DraftOrder(
      ...
      @JsonKey(name: "total_additional_fees_set")
      final dynamic totalAdditionalFeesSet,
      @JsonKey(name: "total_duties_set") final dynamic totalDutiesSet,
  ...
  @override
  @JsonKey(name: "total_additional_fees_set")
  dynamic get totalAdditionalFeesSet;
  @override
  @JsonKey(name: "total_duties_set")
  dynamic get totalDutiesSet;
  @override
  @JsonKey(name: "amount_due_now_set")
...
class _$CustomerImpl implements _Customer {
  ...
  @override
  String toString() {
    return 'Customer(id: $id, email: $email, createdAt: $createdAt, updatedAt: $updatedAt, firstName: $firstName, lastName: $lastName, state: $state, note: $note, verifiedEmail: $verifiedEmail, multipassIdentifier: $multipassIdentifier, taxExempt: $taxExempt, currency: $currency, phone: $phone, taxExemptions: $taxExemptions, adminGraphqlApiId: $adminGraphqlApiId, defaultAddress: $defaultAddress)';
  }
