...
GetDraftOrderSingleResponse _$GetDraftOrderSingleResponseFromJson(
    Map<String, dynamic> json) {
  return _GetDraftOrderSingleResponse.fromJson(json);
}

/// @nodoc
mixin _$GetDraftOrderSingleResponse {
  @JsonKey(name: "draft_order")
  DraftOrder? get draftOrder => throw _privateConstructorUsedError;

  /// Serializes this GetDraftOrderSingleResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetDraftOrderSingleResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetDraftOrderSingleResponseCopyWith<GetDraftOrderSingleResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetDraftOrderSingleResponseCopyWith<$Res> {
  factory $GetDraftOrderSingleResponseCopyWith(
          GetDraftOrderSingleResponse value,
          $Res Function(GetDraftOrderSingleResponse) then) =
      _$GetDraftOrderSingleResponseCopyWithImpl<$Res,
          GetDraftOrderSingleResponse>;
  @useResult
...
/// @nodoc
class _$GetDraftOrderSingleResponseCopyWithImpl<$Res,
        $Val extends GetDraftOrderSingleResponse>
    implements $GetDraftOrderSingleResponseCopyWith<$Res> {
  _$GetDraftOrderSingleResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetDraftOrderSingleResponseImplCopyWith<$Res>
    implements $GetDraftOrderSingleResponseCopyWith<$Res> {
  factory _$$GetDraftOrderSingleResponseImplCopyWith(
          _$GetDraftOrderSingleResponseImpl value,
          $Res Function(_$GetDraftOrderSingleResponseImpl) then) =
      __$$GetDraftOrderSingleResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "draft_order") DraftOrder? draftOrder});
...
/// @nodoc
class __$$GetDraftOrderSingleResponseImplCopyWithImpl<$Res>
    extends _$GetDraftOrderSingleResponseCopyWithImpl<$Res,
        _$GetDraftOrderSingleResponseImpl>
    implements _$$GetDraftOrderSingleResponseImplCopyWith<$Res> {
  __$$GetDraftOrderSingleResponseImplCopyWithImpl(
      _$GetDraftOrderSingleResponseImpl _value,
      $Res Function(_$GetDraftOrderSingleResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetDraftOrderSingleResponseImpl(
      draftOrder: freezed == draftOrder
          ? _value.draftOrder
          : draftOrder // ignore: cast_nullable_to_non_nullable
              as DraftOrder?,
...
/// @nodoc
@JsonSerializable()
class _$GetDraftOrderSingleResponseImpl
    implements _GetDraftOrderSingleResponse {
  const _$GetDraftOrderSingleResponseImpl(
      {@JsonKey(name: "draft_order") this.draftOrder});

  factory _$GetDraftOrderSingleResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GetDraftOrderSingleResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetDraftOrderSingleResponse(draftOrder: $draftOrder)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetDraftOrderSingleResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetDraftOrderSingleResponseImplCopyWith<_$GetDraftOrderSingleResponseImpl>
      get copyWith => __$$GetDraftOrderSingleResponseImplCopyWithImpl<
          _$GetDraftOrderSingleResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetDraftOrderSingleResponseImplToJson(
      this,
    );
  }
}

abstract class _GetDraftOrderSingleResponse
    implements GetDraftOrderSingleResponse {
  const factory _GetDraftOrderSingleResponse(
          {@JsonKey(name: "draft_order") final DraftOrder? draftOrder}) =
      _$GetDraftOrderSingleResponseImpl;

  factory _GetDraftOrderSingleResponse.fromJson(Map<String, dynamic> json) =
      _$GetDraftOrderSingleResponseImpl.fromJson;
