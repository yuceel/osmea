...
part of 'update_order_tag_response.dart';
...
UpdateOrderTagResponse _$UpdateOrderTagResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateOrderTagResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateOrderTagResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this UpdateOrderTagResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateOrderTagResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateOrderTagResponseCopyWith<UpdateOrderTagResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateOrderTagResponseCopyWith<$Res> {
  factory $UpdateOrderTagResponseCopyWith(UpdateOrderTagResponse value,
          $Res Function(UpdateOrderTagResponse) then) =
      _$UpdateOrderTagResponseCopyWithImpl<$Res, UpdateOrderTagResponse>;
  @useResult
...
/// @nodoc
class _$UpdateOrderTagResponseCopyWithImpl<$Res,
        $Val extends UpdateOrderTagResponse>
    implements $UpdateOrderTagResponseCopyWith<$Res> {
  _$UpdateOrderTagResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateOrderTagResponseImplCopyWith<$Res>
    implements $UpdateOrderTagResponseCopyWith<$Res> {
  factory _$$UpdateOrderTagResponseImplCopyWith(
          _$UpdateOrderTagResponseImpl value,
          $Res Function(_$UpdateOrderTagResponseImpl) then) =
      __$$UpdateOrderTagResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$UpdateOrderTagResponseImplCopyWithImpl<$Res>
    extends _$UpdateOrderTagResponseCopyWithImpl<$Res,
        _$UpdateOrderTagResponseImpl>
    implements _$$UpdateOrderTagResponseImplCopyWith<$Res> {
  __$$UpdateOrderTagResponseImplCopyWithImpl(
      _$UpdateOrderTagResponseImpl _value,
      $Res Function(_$UpdateOrderTagResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateOrderTagResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateOrderTagResponseImpl implements _UpdateOrderTagResponse {
  const _$UpdateOrderTagResponseImpl({@JsonKey(name: "order") this.order});

  factory _$UpdateOrderTagResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateOrderTagResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateOrderTagResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateOrderTagResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateOrderTagResponseImplCopyWith<_$UpdateOrderTagResponseImpl>
      get copyWith => __$$UpdateOrderTagResponseImplCopyWithImpl<
          _$UpdateOrderTagResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateOrderTagResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateOrderTagResponse implements UpdateOrderTagResponse {
  const factory _UpdateOrderTagResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$UpdateOrderTagResponseImpl;

  factory _UpdateOrderTagResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateOrderTagResponseImpl.fromJson;
