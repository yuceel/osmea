...
CreateDraftOrderWithDiscountResponse
    _$CreateDraftOrderWithDiscountResponseFromJson(Map<String, dynamic> json) {
  return _CreateDraftOrderWithDiscountResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateDraftOrderWithDiscountResponse {
  @JsonKey(name: "draft_order")
  DraftOrder? get draftOrder => throw _privateConstructorUsedError;

  /// Serializes this CreateDraftOrderWithDiscountResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateDraftOrderWithDiscountResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateDraftOrderWithDiscountResponseCopyWith<
          CreateDraftOrderWithDiscountResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateDraftOrderWithDiscountResponseCopyWith<$Res> {
  factory $CreateDraftOrderWithDiscountResponseCopyWith(
          CreateDraftOrderWithDiscountResponse value,
          $Res Function(CreateDraftOrderWithDiscountResponse) then) =
      _$CreateDraftOrderWithDiscountResponseCopyWithImpl<$Res,
          CreateDraftOrderWithDiscountResponse>;
  @useResult
...
/// @nodoc
class _$CreateDraftOrderWithDiscountResponseCopyWithImpl<$Res,
        $Val extends CreateDraftOrderWithDiscountResponse>
    implements $CreateDraftOrderWithDiscountResponseCopyWith<$Res> {
  _$CreateDraftOrderWithDiscountResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateDraftOrderWithDiscountResponseImplCopyWith<$Res>
    implements $CreateDraftOrderWithDiscountResponseCopyWith<$Res> {
  factory _$$CreateDraftOrderWithDiscountResponseImplCopyWith(
          _$CreateDraftOrderWithDiscountResponseImpl value,
          $Res Function(_$CreateDraftOrderWithDiscountResponseImpl) then) =
      __$$CreateDraftOrderWithDiscountResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "draft_order") DraftOrder? draftOrder});
...
/// @nodoc
class __$$CreateDraftOrderWithDiscountResponseImplCopyWithImpl<$Res>
    extends _$CreateDraftOrderWithDiscountResponseCopyWithImpl<$Res,
        _$CreateDraftOrderWithDiscountResponseImpl>
    implements _$$CreateDraftOrderWithDiscountResponseImplCopyWith<$Res> {
  __$$CreateDraftOrderWithDiscountResponseImplCopyWithImpl(
      _$CreateDraftOrderWithDiscountResponseImpl _value,
      $Res Function(_$CreateDraftOrderWithDiscountResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateDraftOrderWithDiscountResponseImpl(
      draftOrder: freezed == draftOrder
          ? _value.draftOrder
          : draftOrder // ignore: cast_nullable_to_non_nullable
              as DraftOrder?,
...
/// @nodoc
@JsonSerializable()
class _$CreateDraftOrderWithDiscountResponseImpl
    implements _CreateDraftOrderWithDiscountResponse {
  const _$CreateDraftOrderWithDiscountResponseImpl(
      {@JsonKey(name: "draft_order") this.draftOrder});

  factory _$CreateDraftOrderWithDiscountResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateDraftOrderWithDiscountResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateDraftOrderWithDiscountResponse(draftOrder: $draftOrder)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateDraftOrderWithDiscountResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateDraftOrderWithDiscountResponseImplCopyWith<
          _$CreateDraftOrderWithDiscountResponseImpl>
      get copyWith => __$$CreateDraftOrderWithDiscountResponseImplCopyWithImpl<
          _$CreateDraftOrderWithDiscountResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateDraftOrderWithDiscountResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateDraftOrderWithDiscountResponse
    implements CreateDraftOrderWithDiscountResponse {
  const factory _CreateDraftOrderWithDiscountResponse(
          {@JsonKey(name: "draft_order") final DraftOrder? draftOrder}) =
      _$CreateDraftOrderWithDiscountResponseImpl;

  factory _CreateDraftOrderWithDiscountResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateDraftOrderWithDiscountResponseImpl.fromJson;
