...
UpdatePhoneNumberResponse _$UpdatePhoneNumberResponseFromJson(
  ...
  return _UpdatePhoneNumberResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdatePhoneNumberResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this UpdatePhoneNumberResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdatePhoneNumberResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdatePhoneNumberResponseCopyWith<UpdatePhoneNumberResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdatePhoneNumberResponseCopyWith<$Res> {
  factory $UpdatePhoneNumberResponseCopyWith(UpdatePhoneNumberResponse value,
          $Res Function(UpdatePhoneNumberResponse) then) =
      _$UpdatePhoneNumberResponseCopyWithImpl<$Res, UpdatePhoneNumberResponse>;
  @useResult
...
/// @nodoc
class _$UpdatePhoneNumberResponseCopyWithImpl<$Res,
        $Val extends UpdatePhoneNumberResponse>
    implements $UpdatePhoneNumberResponseCopyWith<$Res> {
  _$UpdatePhoneNumberResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdatePhoneNumberResponseImplCopyWith<$Res>
    implements $UpdatePhoneNumberResponseCopyWith<$Res> {
  factory _$$UpdatePhoneNumberResponseImplCopyWith(
          _$UpdatePhoneNumberResponseImpl value,
          $Res Function(_$UpdatePhoneNumberResponseImpl) then) =
      __$$UpdatePhoneNumberResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$UpdatePhoneNumberResponseImplCopyWithImpl<$Res>
    extends _$UpdatePhoneNumberResponseCopyWithImpl<$Res,
        _$UpdatePhoneNumberResponseImpl>
    implements _$$UpdatePhoneNumberResponseImplCopyWith<$Res> {
  __$$UpdatePhoneNumberResponseImplCopyWithImpl(
      _$UpdatePhoneNumberResponseImpl _value,
      $Res Function(_$UpdatePhoneNumberResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdatePhoneNumberResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$UpdatePhoneNumberResponseImpl implements _UpdatePhoneNumberResponse {
  const _$UpdatePhoneNumberResponseImpl({@JsonKey(name: "order") this.order});

  factory _$UpdatePhoneNumberResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdatePhoneNumberResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdatePhoneNumberResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdatePhoneNumberResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdatePhoneNumberResponseImplCopyWith<_$UpdatePhoneNumberResponseImpl>
      get copyWith => __$$UpdatePhoneNumberResponseImplCopyWithImpl<
          _$UpdatePhoneNumberResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdatePhoneNumberResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdatePhoneNumberResponse implements UpdatePhoneNumberResponse {
  const factory _UpdatePhoneNumberResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$UpdatePhoneNumberResponseImpl;

  factory _UpdatePhoneNumberResponse.fromJson(Map<String, dynamic> json) =
      _$UpdatePhoneNumberResponseImpl.fromJson;
