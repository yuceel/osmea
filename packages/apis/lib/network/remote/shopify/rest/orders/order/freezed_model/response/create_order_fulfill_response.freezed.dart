...
part of 'create_order_fulfill_response.dart';
...
CreateOrderFulfillResponse _$CreateOrderFulfillResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderFulfillResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderFulfillResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this CreateOrderFulfillResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderFulfillResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderFulfillResponseCopyWith<CreateOrderFulfillResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderFulfillResponseCopyWith<$Res> {
  factory $CreateOrderFulfillResponseCopyWith(CreateOrderFulfillResponse value,
          $Res Function(CreateOrderFulfillResponse) then) =
      _$CreateOrderFulfillResponseCopyWithImpl<$Res,
          CreateOrderFulfillResponse>;
  @useResult
...
/// @nodoc
class _$CreateOrderFulfillResponseCopyWithImpl<$Res,
        $Val extends CreateOrderFulfillResponse>
    implements $CreateOrderFulfillResponseCopyWith<$Res> {
  _$CreateOrderFulfillResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderFulfillResponseImplCopyWith<$Res>
    implements $CreateOrderFulfillResponseCopyWith<$Res> {
  factory _$$CreateOrderFulfillResponseImplCopyWith(
          _$CreateOrderFulfillResponseImpl value,
          $Res Function(_$CreateOrderFulfillResponseImpl) then) =
      __$$CreateOrderFulfillResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$CreateOrderFulfillResponseImplCopyWithImpl<$Res>
    extends _$CreateOrderFulfillResponseCopyWithImpl<$Res,
        _$CreateOrderFulfillResponseImpl>
    implements _$$CreateOrderFulfillResponseImplCopyWith<$Res> {
  __$$CreateOrderFulfillResponseImplCopyWithImpl(
      _$CreateOrderFulfillResponseImpl _value,
      $Res Function(_$CreateOrderFulfillResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderFulfillResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderFulfillResponseImpl implements _CreateOrderFulfillResponse {
  const _$CreateOrderFulfillResponseImpl({@JsonKey(name: "order") this.order});

  factory _$CreateOrderFulfillResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateOrderFulfillResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderFulfillResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderFulfillResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderFulfillResponseImplCopyWith<_$CreateOrderFulfillResponseImpl>
      get copyWith => __$$CreateOrderFulfillResponseImplCopyWithImpl<
          _$CreateOrderFulfillResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderFulfillResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderFulfillResponse
    implements CreateOrderFulfillResponse {
  const factory _CreateOrderFulfillResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$CreateOrderFulfillResponseImpl;

  factory _CreateOrderFulfillResponse.fromJson(Map<String, dynamic> json) =
      _$CreateOrderFulfillResponseImpl.fromJson;
