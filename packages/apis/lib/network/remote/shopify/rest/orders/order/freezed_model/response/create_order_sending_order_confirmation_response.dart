...
part 'create_order_sending_order_confirmation_response.freezed.dart';
part 'create_order_sending_order_confirmation_response.g.dart';

CreateOrderSendingOrderConfirmationResponse
    createOrderSendingOrderConfirmationResponseFromJson(String str) =>
        CreateOrderSendingOrderConfirmationResponse.fromJson(json.decode(str));

String createOrderSendingOrderConfirmationResponseToJson(
        CreateOrderSendingOrderConfirmationResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderSendingOrderConfirmationResponse
    with _$CreateOrderSendingOrderConfirmationResponse {
  const factory CreateOrderSendingOrderConfirmationResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderSendingOrderConfirmationResponse;

  factory CreateOrderSendingOrderConfirmationResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateOrderSendingOrderConfirmationResponseFromJson(json);
}
