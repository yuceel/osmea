...
part of 'get_single_order_response.dart';
...
GetSingleOrderResponse _$GetSingleOrderResponseFromJson(
    Map<String, dynamic> json) {
  return _GetSingleOrderResponse.fromJson(json);
}

/// @nodoc
mixin _$GetSingleOrderResponse {
  @JsonKey(name: "order")
  Order? get order => throw _privateConstructorUsedError;

  /// Serializes this GetSingleOrderResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of GetSingleOrderResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $GetSingleOrderResponseCopyWith<GetSingleOrderResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetSingleOrderResponseCopyWith<$Res> {
  factory $GetSingleOrderResponseCopyWith(GetSingleOrderResponse value,
          $Res Function(GetSingleOrderResponse) then) =
      _$GetSingleOrderResponseCopyWithImpl<$Res, GetSingleOrderResponse>;
  @useResult
...
/// @nodoc
class _$GetSingleOrderResponseCopyWithImpl<$Res,
        $Val extends GetSingleOrderResponse>
    implements $GetSingleOrderResponseCopyWith<$Res> {
  _$GetSingleOrderResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetSingleOrderResponseImplCopyWith<$Res>
    implements $GetSingleOrderResponseCopyWith<$Res> {
  factory _$$GetSingleOrderResponseImplCopyWith(
          _$GetSingleOrderResponseImpl value,
          $Res Function(_$GetSingleOrderResponseImpl) then) =
      __$$GetSingleOrderResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "order") Order? order});
...
/// @nodoc
class __$$GetSingleOrderResponseImplCopyWithImpl<$Res>
    extends _$GetSingleOrderResponseCopyWithImpl<$Res,
        _$GetSingleOrderResponseImpl>
    implements _$$GetSingleOrderResponseImplCopyWith<$Res> {
  __$$GetSingleOrderResponseImplCopyWithImpl(
      _$GetSingleOrderResponseImpl _value,
      $Res Function(_$GetSingleOrderResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetSingleOrderResponseImpl(
      order: freezed == order
          ? _value.order
          : order // ignore: cast_nullable_to_non_nullable
              as Order?,
...
/// @nodoc
@JsonSerializable()
class _$GetSingleOrderResponseImpl implements _GetSingleOrderResponse {
  const _$GetSingleOrderResponseImpl({@JsonKey(name: "order") this.order});

  factory _$GetSingleOrderResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$GetSingleOrderResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'GetSingleOrderResponse(order: $order)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetSingleOrderResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetSingleOrderResponseImplCopyWith<_$GetSingleOrderResponseImpl>
      get copyWith => __$$GetSingleOrderResponseImplCopyWithImpl<
          _$GetSingleOrderResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetSingleOrderResponseImplToJson(
      this,
    );
  }
}

abstract class _GetSingleOrderResponse implements GetSingleOrderResponse {
  const factory _GetSingleOrderResponse(
          {@JsonKey(name: "order") final Order? order}) =
      _$GetSingleOrderResponseImpl;

  factory _GetSingleOrderResponse.fromJson(Map<String, dynamic> json) =
      _$GetSingleOrderResponseImpl.fromJson;
