...
CreateDraftOrderResponse _$CreateDraftOrderResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateDraftOrderResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateDraftOrderResponse {
  @JsonKey(name: "draft_order")
  DraftOrder? get draftOrder => throw _privateConstructorUsedError;

  /// Serializes this CreateDraftOrderResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateDraftOrderResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateDraftOrderResponseCopyWith<CreateDraftOrderResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateDraftOrderResponseCopyWith<$Res> {
  factory $CreateDraftOrderResponseCopyWith(CreateDraftOrderResponse value,
          $Res Function(CreateDraftOrderResponse) then) =
      _$CreateDraftOrderResponseCopyWithImpl<$Res, CreateDraftOrderResponse>;
  @useResult
...
/// @nodoc
class _$CreateDraftOrderResponseCopyWithImpl<$Res,
        $Val extends CreateDraftOrderResponse>
    implements $CreateDraftOrderResponseCopyWith<$Res> {
  _$CreateDraftOrderResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateDraftOrderResponseImplCopyWith<$Res>
    implements $CreateDraftOrderResponseCopyWith<$Res> {
  factory _$$CreateDraftOrderResponseImplCopyWith(
          _$CreateDraftOrderResponseImpl value,
          $Res Function(_$CreateDraftOrderResponseImpl) then) =
      __$$CreateDraftOrderResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "draft_order") DraftOrder? draftOrder});
...
/// @nodoc
class __$$CreateDraftOrderResponseImplCopyWithImpl<$Res>
    extends _$CreateDraftOrderResponseCopyWithImpl<$Res,
        _$CreateDraftOrderResponseImpl>
    implements _$$CreateDraftOrderResponseImplCopyWith<$Res> {
  __$$CreateDraftOrderResponseImplCopyWithImpl(
      _$CreateDraftOrderResponseImpl _value,
      $Res Function(_$CreateDraftOrderResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateDraftOrderResponseImpl(
      draftOrder: freezed == draftOrder
          ? _value.draftOrder
          : draftOrder // ignore: cast_nullable_to_non_nullable
              as DraftOrder?,
...
/// @nodoc
@JsonSerializable()
class _$CreateDraftOrderResponseImpl implements _CreateDraftOrderResponse {
  const _$CreateDraftOrderResponseImpl(
      {@JsonKey(name: "draft_order") this.draftOrder});

  factory _$CreateDraftOrderResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateDraftOrderResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateDraftOrderResponse(draftOrder: $draftOrder)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateDraftOrderResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateDraftOrderResponseImplCopyWith<_$CreateDraftOrderResponseImpl>
      get copyWith => __$$CreateDraftOrderResponseImplCopyWithImpl<
          _$CreateDraftOrderResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateDraftOrderResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateDraftOrderResponse implements CreateDraftOrderResponse {
  const factory _CreateDraftOrderResponse(
          {@JsonKey(name: "draft_order") final DraftOrder? draftOrder}) =
      _$CreateDraftOrderResponseImpl;

  factory _CreateDraftOrderResponse.fromJson(Map<String, dynamic> json) =
      _$CreateDraftOrderResponseImpl.fromJson;
