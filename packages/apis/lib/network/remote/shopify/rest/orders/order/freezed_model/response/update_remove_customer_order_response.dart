...
part 'update_remove_customer_order_response.freezed.dart';
part 'update_remove_customer_order_response.g.dart';

UpdateRemoveCustomerOrderResponse updateRemoveCustomerOrderResponseFromJson(
        String str) =>
    UpdateRemoveCustomerOrderResponse.fromJson(json.decode(str));

String updateRemoveCustomerOrderResponseToJson(
        UpdateRemoveCustomerOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateRemoveCustomerOrderResponse
    with _$UpdateRemoveCustomerOrderResponse {
  const factory UpdateRemoveCustomerOrderResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateRemoveCustomerOrderResponse;

  factory UpdateRemoveCustomerOrderResponse.fromJson(
          Map<String, dynamic> json) =>
      _$UpdateRemoveCustomerOrderResponseFromJson(json);
}
