...
part of 'retrieves_a_single_response_model.dart';
...
RetrievesASingleResponseModel _$RetrievesASingleResponseModelFromJson(
    Map<String, dynamic> json) {
  return _RetrievesASingleResponseModel.fromJson(json);
}

/// @nodoc
mixin _$RetrievesASingleResponseModel {
...
/// @nodoc
abstract class $RetrievesASingleResponseModelCopyWith<$Res> {
  factory $RetrievesASingleResponseModelCopyWith(
          RetrievesASingleResponseModel value,
          $Res Function(RetrievesASingleResponseModel) then) =
      _$RetrievesASingleResponseModelCopyWithImpl<$Res,
          RetrievesASingleResponseModel>;
  @useResult
...
/// @nodoc
class _$RetrievesASingleResponseModelCopyWithImpl<$Res,
        $Val extends RetrievesASingleResponseModel>
    implements $RetrievesASingleResponseModelCopyWith<$Res> {
  _$RetrievesASingleResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrievesASingleResponseModelImplCopyWith<$Res>
    implements $RetrievesASingleResponseModelCopyWith<$Res> {
  factory _$$RetrievesASingleResponseModelImplCopyWith(
          _$RetrievesASingleResponseModelImpl value,
          $Res Function(_$RetrievesASingleResponseModelImpl) then) =
      __$$RetrievesASingleResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "marketing_event") MarketingEvent? marketingEvent});
...
/// @nodoc
class __$$RetrievesASingleResponseModelImplCopyWithImpl<$Res>
    extends _$RetrievesASingleResponseModelCopyWithImpl<$Res,
        _$RetrievesASingleResponseModelImpl>
    implements _$$RetrievesASingleResponseModelImplCopyWith<$Res> {
  __$$RetrievesASingleResponseModelImplCopyWithImpl(
      _$RetrievesASingleResponseModelImpl _value,
  ...
  $Res call({
    ...
    return _then(_$RetrievesASingleResponseModelImpl(
      marketingEvent: freezed == marketingEvent
          ? _value.marketingEvent
          : marketingEvent // ignore: cast_nullable_to_non_nullable
              as MarketingEvent?,
...
/// @nodoc
@JsonSerializable()
class _$RetrievesASingleResponseModelImpl
    implements _RetrievesASingleResponseModel {
  const _$RetrievesASingleResponseModelImpl(
      {@JsonKey(name: "marketing_event") this.marketingEvent});

  factory _$RetrievesASingleResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrievesASingleResponseModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrievesASingleResponseModel(marketingEvent: $marketingEvent)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrievesASingleResponseModelImpl &&
  ...
  _$$RetrievesASingleResponseModelImplCopyWith<
          _$RetrievesASingleResponseModelImpl>
      get copyWith => __$$RetrievesASingleResponseModelImplCopyWithImpl<
          _$RetrievesASingleResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrievesASingleResponseModelImplToJson(
      this,
    );
  }
}

abstract class _RetrievesASingleResponseModel
    implements RetrievesASingleResponseModel {
  const factory _RetrievesASingleResponseModel(
          {@JsonKey(name: "marketing_event")
          final MarketingEvent? marketingEvent}) =
      _$RetrievesASingleResponseModelImpl;

  factory _RetrievesASingleResponseModel.fromJson(Map<String, dynamic> json) =
      _$RetrievesASingleResponseModelImpl.fromJson;
