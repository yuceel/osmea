...
CreateSmartCollectionRequest _$CreateSmartCollectionRequestFromJson(
    Map<String, dynamic> json) {
  return _CreateSmartCollectionRequest.fromJson(json);
}

/// @nodoc
mixin _$CreateSmartCollectionRequest {
  @JsonKey(name: "smart_collection")
  SmartCollection? get smartCollection => throw _privateConstructorUsedError;

  /// Serializes this CreateSmartCollectionRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateSmartCollectionRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateSmartCollectionRequestCopyWith<CreateSmartCollectionRequest>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateSmartCollectionRequestCopyWith<$Res> {
  factory $CreateSmartCollectionRequestCopyWith(
          CreateSmartCollectionRequest value,
          $Res Function(CreateSmartCollectionRequest) then) =
      _$CreateSmartCollectionRequestCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateSmartCollectionRequestCopyWithImpl<$Res,
        $Val extends CreateSmartCollectionRequest>
    implements $CreateSmartCollectionRequestCopyWith<$Res> {
  _$CreateSmartCollectionRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateSmartCollectionRequestImplCopyWith<$Res>
    implements $CreateSmartCollectionRequestCopyWith<$Res> {
  factory _$$CreateSmartCollectionRequestImplCopyWith(
          _$CreateSmartCollectionRequestImpl value,
          $Res Function(_$CreateSmartCollectionRequestImpl) then) =
      __$$CreateSmartCollectionRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "smart_collection") SmartCollection? smartCollection});
...
/// @nodoc
class __$$CreateSmartCollectionRequestImplCopyWithImpl<$Res>
    extends _$CreateSmartCollectionRequestCopyWithImpl<$Res,
        _$CreateSmartCollectionRequestImpl>
    implements _$$CreateSmartCollectionRequestImplCopyWith<$Res> {
  __$$CreateSmartCollectionRequestImplCopyWithImpl(
      _$CreateSmartCollectionRequestImpl _value,
      $Res Function(_$CreateSmartCollectionRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateSmartCollectionRequestImpl(
      smartCollection: freezed == smartCollection
          ? _value.smartCollection
          : smartCollection // ignore: cast_nullable_to_non_nullable
              as SmartCollection?,
...
/// @nodoc
@JsonSerializable()
class _$CreateSmartCollectionRequestImpl
    implements _CreateSmartCollectionRequest {
  const _$CreateSmartCollectionRequestImpl(
      {@JsonKey(name: "smart_collection") this.smartCollection});

  factory _$CreateSmartCollectionRequestImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateSmartCollectionRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateSmartCollectionRequest(smartCollection: $smartCollection)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateSmartCollectionRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateSmartCollectionRequestImplCopyWith<
          _$CreateSmartCollectionRequestImpl>
      get copyWith => __$$CreateSmartCollectionRequestImplCopyWithImpl<
          _$CreateSmartCollectionRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateSmartCollectionRequestImplToJson(
      this,
    );
  }
}

abstract class _CreateSmartCollectionRequest
    implements CreateSmartCollectionRequest {
  const factory _CreateSmartCollectionRequest(
          {@JsonKey(name: "smart_collection")
          final SmartCollection? smartCollection}) =
      _$CreateSmartCollectionRequestImpl;

  factory _CreateSmartCollectionRequest.fromJson(Map<String, dynamic> json) =
      _$CreateSmartCollectionRequestImpl.fromJson;
...
class _$SmartCollectionImpl implements _SmartCollection {
  ...
  @override
  String toString() {
    return 'SmartCollection(id: $id, handle: $handle, title: $title, updatedAt: $updatedAt, bodyHtml: $bodyHtml, publishedAt: $publishedAt, sortOrder: $sortOrder, templateSuffix: $templateSuffix, disjunctive: $disjunctive, rules: $rules, publishedScope: $publishedScope, adminGraphqlApiId: $adminGraphqlApiId)';
  }
