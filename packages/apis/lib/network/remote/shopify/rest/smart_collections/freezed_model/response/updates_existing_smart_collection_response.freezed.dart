...
UpdatesExistingSmartCollectionResponse
    _$UpdatesExistingSmartCollectionResponseFromJson(
        Map<String, dynamic> json) {
  return _UpdatesExistingSmartCollectionResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdatesExistingSmartCollectionResponse {
  @JsonKey(name: "smart_collection")
  SmartCollection? get smartCollection => throw _privateConstructorUsedError;

  /// Serializes this UpdatesExistingSmartCollectionResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdatesExistingSmartCollectionResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdatesExistingSmartCollectionResponseCopyWith<
          UpdatesExistingSmartCollectionResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdatesExistingSmartCollectionResponseCopyWith<$Res> {
  factory $UpdatesExistingSmartCollectionResponseCopyWith(
          UpdatesExistingSmartCollectionResponse value,
          $Res Function(UpdatesExistingSmartCollectionResponse) then) =
      _$UpdatesExistingSmartCollectionResponseCopyWithImpl<$Res,
          UpdatesExistingSmartCollectionResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdatesExistingSmartCollectionResponseCopyWithImpl<$Res,
        $Val extends UpdatesExistingSmartCollectionResponse>
    implements $UpdatesExistingSmartCollectionResponseCopyWith<$Res> {
  _$UpdatesExistingSmartCollectionResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdatesExistingSmartCollectionResponseImplCopyWith<$Res>
    implements $UpdatesExistingSmartCollectionResponseCopyWith<$Res> {
  factory _$$UpdatesExistingSmartCollectionResponseImplCopyWith(
          _$UpdatesExistingSmartCollectionResponseImpl value,
          $Res Function(_$UpdatesExistingSmartCollectionResponseImpl) then) =
      __$$UpdatesExistingSmartCollectionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "smart_collection") SmartCollection? smartCollection});
...
/// @nodoc
class __$$UpdatesExistingSmartCollectionResponseImplCopyWithImpl<$Res>
    extends _$UpdatesExistingSmartCollectionResponseCopyWithImpl<$Res,
        _$UpdatesExistingSmartCollectionResponseImpl>
    implements _$$UpdatesExistingSmartCollectionResponseImplCopyWith<$Res> {
  __$$UpdatesExistingSmartCollectionResponseImplCopyWithImpl(
      _$UpdatesExistingSmartCollectionResponseImpl _value,
      $Res Function(_$UpdatesExistingSmartCollectionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdatesExistingSmartCollectionResponseImpl(
      smartCollection: freezed == smartCollection
          ? _value.smartCollection
          : smartCollection // ignore: cast_nullable_to_non_nullable
              as SmartCollection?,
...
/// @nodoc
@JsonSerializable()
class _$UpdatesExistingSmartCollectionResponseImpl
    implements _UpdatesExistingSmartCollectionResponse {
  const _$UpdatesExistingSmartCollectionResponseImpl(
      {@JsonKey(name: "smart_collection") this.smartCollection});

  factory _$UpdatesExistingSmartCollectionResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdatesExistingSmartCollectionResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdatesExistingSmartCollectionResponse(smartCollection: $smartCollection)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdatesExistingSmartCollectionResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdatesExistingSmartCollectionResponseImplCopyWith<
          _$UpdatesExistingSmartCollectionResponseImpl>
      get copyWith =>
          __$$UpdatesExistingSmartCollectionResponseImplCopyWithImpl<
              _$UpdatesExistingSmartCollectionResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdatesExistingSmartCollectionResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdatesExistingSmartCollectionResponse
    implements UpdatesExistingSmartCollectionResponse {
  const factory _UpdatesExistingSmartCollectionResponse(
          {@JsonKey(name: "smart_collection")
          final SmartCollection? smartCollection}) =
      _$UpdatesExistingSmartCollectionResponseImpl;

  factory _UpdatesExistingSmartCollectionResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdatesExistingSmartCollectionResponseImpl.fromJson;
...
class _$SmartCollectionImpl implements _SmartCollection {
  ...
  @override
  String toString() {
    return 'SmartCollection(bodyHtml: $bodyHtml, sortOrder: $sortOrder, title: $title, disjunctive: $disjunctive, templateSuffix: $templateSuffix, handle: $handle, id: $id, updatedAt: $updatedAt, publishedAt: $publishedAt, rules: $rules, publishedScope: $publishedScope, adminGraphqlApiId: $adminGraphqlApiId)';
  }
