...
//
//     final retrievesASingleResponseModel = retrievesASingleResponseModelFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieves_a_single_response_model.freezed.dart';
part 'retrieves_a_single_response_model.g.dart';

RetrievesASingleResponseModel retrievesASingleResponseModelFromJson(
        String str) =>
    RetrievesASingleResponseModel.fromJson(json.decode(str));

String retrievesASingleResponseModelToJson(
        RetrievesASingleResponseModel data) =>
    json.encode(data.toJson());

@freezed
class RetrievesASingleResponseModel with _$RetrievesASingleResponseModel {
  const factory RetrievesASingleResponseModel({
    @JsonKey(name: "marketing_event") MarketingEvent? marketingEvent,
  }) = _RetrievesASingleResponseModel;

  factory RetrievesASingleResponseModel.fromJson(Map<String, dynamic> json) =>
      _$RetrievesASingleResponseModelFromJson(json);
}
