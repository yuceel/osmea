...
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/request/creates_marketing_event_request_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/request/updates_a_marketing_event_request_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/creates_marketing_engagements_response_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/creates_marketing_event_response_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/deletes_a_marketing_event_response_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/retrieves_a_count_of_all_response_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/retrieves_a_list_of_all_response_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/retrieves_a_single_response_model.dart';
import 'package:apis/network/remote/shopify/marketing_event/freezed_model/response/updates_a_marketing_event_response_model.dart';
