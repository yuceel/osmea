...
part 'single_product_response.freezed.dart';
...
@freezed
class SingleProductResponse with _$SingleProductResponse {
    const factory SingleProductResponse({
        @JsonKey(name: "product")
        Product? product,
    }) = _SingleProductResponse;
