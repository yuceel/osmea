...
part 'update_email_address_response.freezed.dart';
part 'update_email_address_response.g.dart';

UpdateEmailAddressResponse updateEmailAddressResponseFromJson(String str) =>
    UpdateEmailAddressResponse.fromJson(json.decode(str));

String updateEmailAddressResponseToJson(UpdateEmailAddressResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateEmailAddressResponse with _$UpdateEmailAddressResponse {
  const factory UpdateEmailAddressResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateEmailAddressResponse;
