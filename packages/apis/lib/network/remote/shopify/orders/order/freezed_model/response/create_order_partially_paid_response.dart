...
part 'create_order_partially_paid_response.freezed.dart';
part 'create_order_partially_paid_response.g.dart';

CreateOrderPartiallyPaidResponse createOrderPartiallyPaidResponseFromJson(
        String str) =>
    CreateOrderPartiallyPaidResponse.fromJson(json.decode(str));

String createOrderPartiallyPaidResponseToJson(
        CreateOrderPartiallyPaidResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderPartiallyPaidResponse with _$CreateOrderPartiallyPaidResponse {
  const factory CreateOrderPartiallyPaidResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderPartiallyPaidResponse;

  factory CreateOrderPartiallyPaidResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateOrderPartiallyPaidResponseFromJson(json);
}
