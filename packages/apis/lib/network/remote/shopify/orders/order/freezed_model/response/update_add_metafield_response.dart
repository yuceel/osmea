...
part 'update_add_metafield_response.freezed.dart';
part 'update_add_metafield_response.g.dart';

UpdateAddMetafieldResponse updateAddMetafieldResponseFromJson(String str) =>
    UpdateAddMetafieldResponse.fromJson(json.decode(str));

String updateAddMetafieldResponseToJson(UpdateAddMetafieldResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateAddMetafieldResponse with _$UpdateAddMetafieldResponse {
  const factory UpdateAddMetafieldResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateAddMetafieldResponse;

  factory UpdateAddMetafieldResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateAddMetafieldResponseFromJson(json);
}
