...
part 'update_add_note_response.freezed.dart';
part 'update_add_note_response.g.dart';

UpdateAddNoteResponse updateAddNoteResponseFromJson(String str) =>
    UpdateAddNoteResponse.fromJson(json.decode(str));

String updateAddNoteResponseToJson(UpdateAddNoteResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateAddNoteResponse with _$UpdateAddNoteResponse {
  const factory UpdateAddNoteResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateAddNoteResponse;

  factory UpdateAddNoteResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateAddNoteResponseFromJson(json);
}
