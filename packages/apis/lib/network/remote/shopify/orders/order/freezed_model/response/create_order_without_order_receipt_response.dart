...
part 'create_order_without_order_receipt_response.freezed.dart';
part 'create_order_without_order_receipt_response.g.dart';

CreateOrderWithoutOrderReceiptResponse
    createOrderWithoutOrderReceiptResponseFromJson(String str) =>
        CreateOrderWithoutOrderReceiptResponse.fromJson(json.decode(str));

String createOrderWithoutOrderReceiptResponseToJson(
        CreateOrderWithoutOrderReceiptResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderWithoutOrderReceiptResponse
    with _$CreateOrderWithoutOrderReceiptResponse {
  const factory CreateOrderWithoutOrderReceiptResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderWithoutOrderReceiptResponse;

  factory CreateOrderWithoutOrderReceiptResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateOrderWithoutOrderReceiptResponseFromJson(json);
}
