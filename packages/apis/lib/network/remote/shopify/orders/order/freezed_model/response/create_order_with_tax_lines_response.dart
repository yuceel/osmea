...
part 'create_order_with_tax_lines_response.freezed.dart';
part 'create_order_with_tax_lines_response.g.dart';

CreateOrderWithTaxLinesResponse createOrderWithTaxLinesResponseFromJson(
        String str) =>
    CreateOrderWithTaxLinesResponse.fromJson(json.decode(str));

String createOrderWithTaxLinesResponseToJson(
        CreateOrderWithTaxLinesResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderWithTaxLinesResponse with _$CreateOrderWithTaxLinesResponse {
  const factory CreateOrderWithTaxLinesResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderWithTaxLinesResponse;

  factory CreateOrderWithTaxLinesResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateOrderWithTaxLinesResponseFromJson(json);
}
