...
part 'get_orders_authorized_response.freezed.dart';
part 'get_orders_authorized_response.g.dart';

GetOrdersAuthorizedResponse getOrdersAuthorizedResponseFromJson(String str) =>
    GetOrdersAuthorizedResponse.fromJson(json.decode(str));

String getOrdersAuthorizedResponseToJson(GetOrdersAuthorizedResponse data) =>
    json.encode(data.toJson());

@freezed
class GetOrdersAuthorizedResponse with _$GetOrdersAuthorizedResponse {
  const factory GetOrdersAuthorizedResponse({
    @JsonKey(name: "orders") List<Order>? orders,
  }) = _GetOrdersAuthorizedResponse;

  factory GetOrdersAuthorizedResponse.fromJson(Map<String, dynamic> json) =>
      _$GetOrdersAuthorizedResponseFromJson(json);
}
