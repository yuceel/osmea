...
part 'get_list_order_response.freezed.dart';
part 'get_list_order_response.g.dart';

GetListOrderResponse getListOrderResponseFromJson(String str) =>
    GetListOrderResponse.fromJson(json.decode(str));

String getListOrderResponseToJson(GetListOrderResponse data) =>
...
class GetListOrderResponse with _$GetListOrderResponse {
  ...
  factory GetListOrderResponse.fromJson(Map<String, dynamic> json) =>
