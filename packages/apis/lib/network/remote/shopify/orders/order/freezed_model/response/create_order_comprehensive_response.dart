...
part 'create_order_comprehensive_response.freezed.dart';
part 'create_order_comprehensive_response.g.dart';

CreateOrderComprehensiveResponse createOrderComprehensiveResponseFromJson(
        String str) =>
    CreateOrderComprehensiveResponse.fromJson(json.decode(str));

String createOrderComprehensiveResponseToJson(
        CreateOrderComprehensiveResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderComprehensiveResponse with _$CreateOrderComprehensiveResponse {
  const factory CreateOrderComprehensiveResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderComprehensiveResponse;

  factory CreateOrderComprehensiveResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateOrderComprehensiveResponseFromJson(json);
}
