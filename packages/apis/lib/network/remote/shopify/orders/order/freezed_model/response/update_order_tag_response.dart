...
part 'update_order_tag_response.freezed.dart';
part 'update_order_tag_response.g.dart';

UpdateOrderTagResponse updateOrderTagResponseFromJson(String str) =>
    UpdateOrderTagResponse.fromJson(json.decode(str));

String updateOrderTagResponseToJson(UpdateOrderTagResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateOrderTagResponse with _$UpdateOrderTagResponse {
  const factory UpdateOrderTagResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateOrderTagResponse;

  factory UpdateOrderTagResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateOrderTagResponseFromJson(json);
}
