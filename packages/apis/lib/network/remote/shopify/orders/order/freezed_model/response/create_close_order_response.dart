...
part 'create_close_order_response.freezed.dart';
part 'create_close_order_response.g.dart';

CreateCloseOrderResponse createCloseOrderResponseFromJson(String str) =>
    CreateCloseOrderResponse.fromJson(json.decode(str));

String createCloseOrderResponseToJson(CreateCloseOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateCloseOrderResponse with _$CreateCloseOrderResponse {
  const factory CreateCloseOrderResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateCloseOrderResponse;

  factory CreateCloseOrderResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateCloseOrderResponseFromJson(json);
}
