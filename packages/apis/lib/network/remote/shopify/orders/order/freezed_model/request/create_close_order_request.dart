...
part 'create_close_order_request.freezed.dart';
part 'create_close_order_request.g.dart';

CreateCloseOrderRequest createCloseOrderRequestFromJson(String str) =>
    CreateCloseOrderRequest.fromJson(json.decode(str));

String createCloseOrderRequestToJson(CreateCloseOrderRequest data) =>
    json.encode(data.toJson());

@freezed
class CreateCloseOrderRequest with _$CreateCloseOrderRequest {
  const factory CreateCloseOrderRequest({
    @JsonKey(name: "order") Order? order,
  }) = _CreateCloseOrderRequest;

  factory CreateCloseOrderRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateCloseOrderRequestFromJson(json);
}
