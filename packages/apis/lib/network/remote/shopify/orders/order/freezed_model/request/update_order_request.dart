...
UpdateOrderRequest updateOrderRequestFromJson(String str) =>
    UpdateOrderRequest.fromJson(json.decode(str));

String updateOrderRequestToJson(UpdateOrderRequest data) =>
