import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_cancel_order_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_close_order_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_comprehensive_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_fulfill_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_partially_paid_request.dart';
...
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_sending_order_confirmation_request.dart';
...
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_with_product_id_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_with_tax_lines_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_order_without_order_receipt_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/create_reopen_order_request.dart';
...
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/update_order_tag_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/update_add_note_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/update_phone_number_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/update_add_metafield_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/update_email_address_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_cancel_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_close_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_comprehensive_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_fulfill_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_partially_paid_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_risk_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_sending_order_confirmation_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_with_pending_customer_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_with_product_id_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_with_tax_lines_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_order_without_order_receipt_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/create_reopen_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/get_count_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/get_list_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/get_list_order_risks_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/get_order_after_timestamp_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/get_orders_with_properties_response.dart';
...
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_change_whether_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_order_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_order_risk_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_note_attributes_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_shipping_address_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_order_tag_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_add_note_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_phone_number_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_add_metafield_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_email_address_response.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/request/update_remove_customer_order_request.dart';
import 'package:apis/network/remote/shopify/orders/order/freezed_model/response/update_remove_customer_order_response.dart';
