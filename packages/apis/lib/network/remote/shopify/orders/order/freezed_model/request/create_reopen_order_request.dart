...
part 'create_reopen_order_request.freezed.dart';
part 'create_reopen_order_request.g.dart';

CreateReopenOrderRequest createReopenOrderRequestFromJson(String str) =>
    CreateReopenOrderRequest.fromJson(json.decode(str));

String createReopenOrderRequestToJson(CreateReopenOrderRequest data) =>
    json.encode(data.toJson());

@freezed
class CreateReopenOrderRequest with _$CreateReopenOrderRequest {
  const factory CreateReopenOrderRequest({
    @JsonKey(name: "order") Order? order,
  }) = _CreateReopenOrderRequest;

  factory CreateReopenOrderRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateReopenOrderRequestFromJson(json);
}
