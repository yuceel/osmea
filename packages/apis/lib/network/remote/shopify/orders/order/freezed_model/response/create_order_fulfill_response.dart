...
part 'create_order_fulfill_response.freezed.dart';
part 'create_order_fulfill_response.g.dart';

CreateOrderFulfillResponse createOrderFulfillResponseFromJson(String str) =>
    CreateOrderFulfillResponse.fromJson(json.decode(str));

String createOrderFulfillResponseToJson(CreateOrderFulfillResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateOrderFulfillResponse with _$CreateOrderFulfillResponse {
  const factory CreateOrderFulfillResponse({
    @JsonKey(name: "order") Order? order,
  }) = _CreateOrderFulfillResponse;

  factory CreateOrderFulfillResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateOrderFulfillResponseFromJson(json);
}
