...
part 'get_single_order_response.freezed.dart';
part 'get_single_order_response.g.dart';

GetSingleOrderResponse getSingleOrderResponseFromJson(String str) =>
    GetSingleOrderResponse.fromJson(json.decode(str));

String getSingleOrderResponseToJson(GetSingleOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class GetSingleOrderResponse with _$GetSingleOrderResponse {
  const factory GetSingleOrderResponse({
    @JsonKey(name: "order") Order? order,
  }) = _GetSingleOrderResponse;

  factory GetSingleOrderResponse.fromJson(Map<String, dynamic> json) =>
      _$GetSingleOrderResponseFromJson(json);
}
