...
part 'create_cancel_order_response.freezed.dart';
part 'create_cancel_order_response.g.dart';

CreateCancelOrderResponse createCancelOrderResponseFromJson(String str) =>
    CreateCancelOrderResponse.fromJson(json.decode(str));

String createCancelOrderResponseToJson(CreateCancelOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateCancelOrderResponse with _$CreateCancelOrderResponse {
  const factory CreateCancelOrderResponse({
    @JsonKey(name: "order") Order? order,
    @JsonKey(name: "notice") String? notice,
  }) = _CreateCancelOrderResponse;

  factory CreateCancelOrderResponse.fromJson(Map<String, dynamic> json) =>
      _$CreateCancelOrderResponseFromJson(json);
}
