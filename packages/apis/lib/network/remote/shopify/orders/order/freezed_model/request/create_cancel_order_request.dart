...
part 'create_cancel_order_request.freezed.dart';
part 'create_cancel_order_request.g.dart';

CreateCancelOrderRequest createCancelOrderRequestFromJson(String str) =>
    CreateCancelOrderRequest.fromJson(json.decode(str));

String createCancelOrderRequestToJson(CreateCancelOrderRequest data) =>
    json.encode(data.toJson());

@freezed
class CreateCancelOrderRequest with _$CreateCancelOrderRequest {
  const factory CreateCancelOrderRequest({
    @JsonKey(name: "order") Order? order,
    @JsonKey(name: "error") String? error,
  }) = _CreateCancelOrderRequest;

  factory CreateCancelOrderRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateCancelOrderRequestFromJson(json);
}
