...
part 'create_draft_order_simple_product_variant_response.freezed.dart';
part 'create_draft_order_simple_product_variant_response.g.dart';

CreateDraftOrderSimpleProductVariantResponse
    createDraftOrderSimpleProductVariantResponseFromJson(String str) =>
        CreateDraftOrderSimpleProductVariantResponse.fromJson(json.decode(str));

String createDraftOrderSimpleProductVariantResponseToJson(
        CreateDraftOrderSimpleProductVariantResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateDraftOrderSimpleProductVariantResponse
    with _$CreateDraftOrderSimpleProductVariantResponse {
  const factory CreateDraftOrderSimpleProductVariantResponse({
    @JsonKey(name: "draft_order") DraftOrder? draftOrder,
  }) = _CreateDraftOrderSimpleProductVariantResponse;

  factory CreateDraftOrderSimpleProductVariantResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateDraftOrderSimpleProductVariantResponseFromJson(json);
}
