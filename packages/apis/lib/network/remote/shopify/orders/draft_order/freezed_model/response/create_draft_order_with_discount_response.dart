...
part 'create_draft_order_with_discount_response.freezed.dart';
part 'create_draft_order_with_discount_response.g.dart';

CreateDraftOrderWithDiscountResponse
    createDraftOrderWithDiscountResponseFromJson(String str) =>
        CreateDraftOrderWithDiscountResponse.fromJson(json.decode(str));

String createDraftOrderWithDiscountResponseToJson(
        CreateDraftOrderWithDiscountResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateDraftOrderWithDiscountResponse
    with _$CreateDraftOrderWithDiscountResponse {
  const factory CreateDraftOrderWithDiscountResponse({
    @JsonKey(name: "draft_order") DraftOrder? draftOrder,
  }) = _CreateDraftOrderWithDiscountResponse;

  factory CreateDraftOrderWithDiscountResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateDraftOrderWithDiscountResponseFromJson(json);
}
