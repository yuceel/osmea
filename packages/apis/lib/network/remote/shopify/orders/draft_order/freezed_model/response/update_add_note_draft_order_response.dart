...
part 'update_add_note_draft_order_response.freezed.dart';
part 'update_add_note_draft_order_response.g.dart';

UpdateAddNoteDraftOrderResponse updateAddNoteDraftOrderResponseFromJson(
        String str) =>
    UpdateAddNoteDraftOrderResponse.fromJson(json.decode(str));

String updateAddNoteDraftOrderResponseToJson(
        UpdateAddNoteDraftOrderResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateAddNoteDraftOrderResponse with _$UpdateAddNoteDraftOrderResponse {
  const factory UpdateAddNoteDraftOrderResponse({
    @JsonKey(name: "draft_order") DraftOrder? draftOrder,
  }) = _UpdateAddNoteDraftOrderResponse;

  factory UpdateAddNoteDraftOrderResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateAddNoteDraftOrderResponseFromJson(json);
}
