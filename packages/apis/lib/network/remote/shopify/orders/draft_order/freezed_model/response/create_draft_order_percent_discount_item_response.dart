...
part 'create_draft_order_percent_discount_item_response.freezed.dart';
part 'create_draft_order_percent_discount_item_response.g.dart';

CreateDraftOrderPercentDiscountItemResponse
    createDraftOrderPercentDiscountItemResponseFromJson(String str) =>
        CreateDraftOrderPercentDiscountItemResponse.fromJson(json.decode(str));

String createDraftOrderPercentDiscountItemResponseToJson(
        CreateDraftOrderPercentDiscountItemResponse data) =>
    json.encode(data.toJson());

@freezed
class CreateDraftOrderPercentDiscountItemResponse
    with _$CreateDraftOrderPercentDiscountItemResponse {
  const factory CreateDraftOrderPercentDiscountItemResponse({
    @JsonKey(name: "draft_order") DraftOrder? draftOrder,
  }) = _CreateDraftOrderPercentDiscountItemResponse;

  factory CreateDraftOrderPercentDiscountItemResponse.fromJson(
          Map<String, dynamic> json) =>
      _$CreateDraftOrderPercentDiscountItemResponseFromJson(json);
}
