...
part 'get_draft_order_list_response.freezed.dart';
part 'get_draft_order_list_response.g.dart';

GetDraftOrderListResponse getDraftOrderListResponseFromJson(String str) =>
    GetDraftOrderListResponse.fromJson(json.decode(str));

String getDraftOrderListResponseToJson(GetDraftOrderListResponse data) =>
    json.encode(data.toJson());

@freezed
class GetDraftOrderListResponse with _$GetDraftOrderListResponse {
  const factory GetDraftOrderListResponse({
    @JsonKey(name: "draft_orders") List<DraftOrder>? draftOrders,
  }) = _GetDraftOrderListResponse;

  factory GetDraftOrderListResponse.fromJson(Map<String, dynamic> json) =>
      _$GetDraftOrderListResponseFromJson(json);
}
