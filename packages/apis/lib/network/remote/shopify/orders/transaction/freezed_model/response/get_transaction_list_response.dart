...
part 'get_transaction_list_response.freezed.dart';
part 'get_transaction_list_response.g.dart';

GetTransactionListResponse getTransactionListResponseFromJson(String str) =>
    GetTransactionListResponse.fromJson(json.decode(str));

String getTransactionListResponseToJson(GetTransactionListResponse data) =>
    json.encode(data.toJson());

@freezed
class GetTransactionListResponse with _$GetTransactionListResponse {
  const factory GetTransactionListResponse({
    @JsonKey(name: "transactions") List<Transaction>? transactions,
  }) = _GetTransactionListResponse;

  factory GetTransactionListResponse.fromJson(Map<String, dynamic> json) =>
      _$GetTransactionListResponseFromJson(json);
}
