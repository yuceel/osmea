...
part 'update_shipping_address_response.freezed.dart';
part 'update_shipping_address_response.g.dart';

UpdateShippingAddressResponse updateShippingAddressResponseFromJson(
        String str) =>
    UpdateShippingAddressResponse.fromJson(json.decode(str));

String updateShippingAddressResponseToJson(
        UpdateShippingAddressResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateShippingAddressResponse with _$UpdateShippingAddressResponse {
  const factory UpdateShippingAddressResponse({
    @JsonKey(name: "order") Order? order,
  }) = _UpdateShippingAddressResponse;

  factory UpdateShippingAddressResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateShippingAddressResponseFromJson(json);
}
