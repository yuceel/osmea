...
part of 'list_tax_rates_response.dart';
...
ListTaxRatesResponse _$ListTaxRatesResponseFromJson(Map<String, dynamic> json) {
  return _ListTaxRatesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListTaxRatesResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(name: "class")
  String? get listTaxRatesResponseClass => throw _privateConstructorUsedError;
  ...
  /// Serializes this ListTaxRatesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListTaxRatesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListTaxRatesResponseCopyWith<ListTaxRatesResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListTaxRatesResponseCopyWith<$Res> {
  factory $ListTaxRatesResponseCopyWith(ListTaxRatesResponse value,
          $Res Function(ListTaxRatesResponse) then) =
      _$ListTaxRatesResponseCopyWithImpl<$Res, ListTaxRatesResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "class") String? listTaxRatesResponseClass,
...
/// @nodoc
class _$ListTaxRatesResponseCopyWithImpl<$Res,
        $Val extends ListTaxRatesResponse>
    implements $ListTaxRatesResponseCopyWith<$Res> {
  _$ListTaxRatesResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? listTaxRatesResponseClass = freezed,
    ...
    return _then(_value.copyWith(
      ...
      order: freezed == order
          ...
          : order // ignore: cast_nullable_to_non_nullable
              as int?,
      listTaxRatesResponseClass: freezed == listTaxRatesResponseClass
          ? _value.listTaxRatesResponseClass
          : listTaxRatesResponseClass // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$ListTaxRatesResponseImplCopyWith<$Res>
    implements $ListTaxRatesResponseCopyWith<$Res> {
  factory _$$ListTaxRatesResponseImplCopyWith(_$ListTaxRatesResponseImpl value,
          $Res Function(_$ListTaxRatesResponseImpl) then) =
      __$$ListTaxRatesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListTaxRatesResponseImplCopyWithImpl<$Res>
    extends _$ListTaxRatesResponseCopyWithImpl<$Res, _$ListTaxRatesResponseImpl>
    implements _$$ListTaxRatesResponseImplCopyWith<$Res> {
  __$$ListTaxRatesResponseImplCopyWithImpl(_$ListTaxRatesResponseImpl _value,
      $Res Function(_$ListTaxRatesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListTaxRatesResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListTaxRatesResponseImpl implements _ListTaxRatesResponse {
  const _$ListTaxRatesResponseImpl(
      ...
      @JsonKey(name: "class") this.listTaxRatesResponseClass,
  ...
  factory _$ListTaxRatesResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListTaxRatesResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "class")
  final String? listTaxRatesResponseClass;
  ...
  @override
  String toString() {
    return 'ListTaxRatesResponse(id: $id, country: $country, state: $state, postcode: $postcode, city: $city, rate: $rate, name: $name, priority: $priority, compound: $compound, shipping: $shipping, order: $order, listTaxRatesResponseClass: $listTaxRatesResponseClass, postcodes: $postcodes, cities: $cities, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListTaxRatesResponseImpl &&
            ...
            (identical(other.listTaxRatesResponseClass,
                    listTaxRatesResponseClass) ||
                other.listTaxRatesResponseClass == listTaxRatesResponseClass) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListTaxRatesResponseImplCopyWith<_$ListTaxRatesResponseImpl>
      get copyWith =>
          __$$ListTaxRatesResponseImplCopyWithImpl<_$ListTaxRatesResponseImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListTaxRatesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListTaxRatesResponse implements ListTaxRatesResponse {
  const factory _ListTaxRatesResponse(
          ...
          @JsonKey(name: "class") final String? listTaxRatesResponseClass,
          @JsonKey(name: "postcodes") final List<String>? postcodes,
          @JsonKey(name: "cities") final List<String>? cities,
          @JsonKey(name: "_links") final Links? links}) =
      _$ListTaxRatesResponseImpl;

  factory _ListTaxRatesResponse.fromJson(Map<String, dynamic> json) =
      _$ListTaxRatesResponseImpl.fromJson;
  ...
  @override
  @JsonKey(name: "class")
  String? get listTaxRatesResponseClass;
  @override
  @JsonKey(name: "postcodes")
  List<String>? get postcodes;
  @override
