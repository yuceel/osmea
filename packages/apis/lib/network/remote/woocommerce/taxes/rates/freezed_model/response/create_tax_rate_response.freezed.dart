...
part of 'create_tax_rate_response.dart';
...
CreateTaxRateResponse _$CreateTaxRateResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateTaxRateResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateTaxRateResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(name: "class")
  String? get createTaxRateResponseClass => throw _privateConstructorUsedError;
  ...
  /// Serializes this CreateTaxRateResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateTaxRateResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateTaxRateResponseCopyWith<CreateTaxRateResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateTaxRateResponseCopyWith<$Res> {
  factory $CreateTaxRateResponseCopyWith(CreateTaxRateResponse value,
          $Res Function(CreateTaxRateResponse) then) =
      _$CreateTaxRateResponseCopyWithImpl<$Res, CreateTaxRateResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "class") String? createTaxRateResponseClass,
...
/// @nodoc
class _$CreateTaxRateResponseCopyWithImpl<$Res,
        $Val extends CreateTaxRateResponse>
    implements $CreateTaxRateResponseCopyWith<$Res> {
  _$CreateTaxRateResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? createTaxRateResponseClass = freezed,
    ...
    return _then(_value.copyWith(
      ...
      order: freezed == order
          ...
          : order // ignore: cast_nullable_to_non_nullable
              as int?,
      createTaxRateResponseClass: freezed == createTaxRateResponseClass
          ? _value.createTaxRateResponseClass
          : createTaxRateResponseClass // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$CreateTaxRateResponseImplCopyWith<$Res>
    implements $CreateTaxRateResponseCopyWith<$Res> {
  factory _$$CreateTaxRateResponseImplCopyWith(
          _$CreateTaxRateResponseImpl value,
          $Res Function(_$CreateTaxRateResponseImpl) then) =
      __$$CreateTaxRateResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateTaxRateResponseImplCopyWithImpl<$Res>
    extends _$CreateTaxRateResponseCopyWithImpl<$Res,
        _$CreateTaxRateResponseImpl>
    implements _$$CreateTaxRateResponseImplCopyWith<$Res> {
  __$$CreateTaxRateResponseImplCopyWithImpl(_$CreateTaxRateResponseImpl _value,
      $Res Function(_$CreateTaxRateResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateTaxRateResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateTaxRateResponseImpl implements _CreateTaxRateResponse {
  const _$CreateTaxRateResponseImpl(
      ...
      @JsonKey(name: "class") this.createTaxRateResponseClass,
  ...
  factory _$CreateTaxRateResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateTaxRateResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "class")
  final String? createTaxRateResponseClass;
  ...
  @override
  String toString() {
    return 'CreateTaxRateResponse(id: $id, country: $country, state: $state, postcode: $postcode, city: $city, rate: $rate, name: $name, priority: $priority, compound: $compound, shipping: $shipping, order: $order, createTaxRateResponseClass: $createTaxRateResponseClass, postcodes: $postcodes, cities: $cities, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateTaxRateResponseImpl &&
            ...
            (identical(other.createTaxRateResponseClass,
                    createTaxRateResponseClass) ||
                other.createTaxRateResponseClass ==
                    createTaxRateResponseClass) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateTaxRateResponseImplCopyWith<_$CreateTaxRateResponseImpl>
      get copyWith => __$$CreateTaxRateResponseImplCopyWithImpl<
          _$CreateTaxRateResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateTaxRateResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateTaxRateResponse implements CreateTaxRateResponse {
  const factory _CreateTaxRateResponse(
          ...
          @JsonKey(name: "class") final String? createTaxRateResponseClass,
          @JsonKey(name: "postcodes") final List<String>? postcodes,
          @JsonKey(name: "cities") final List<String>? cities,
          @JsonKey(name: "_links") final Links? links}) =
      _$CreateTaxRateResponseImpl;

  factory _CreateTaxRateResponse.fromJson(Map<String, dynamic> json) =
      _$CreateTaxRateResponseImpl.fromJson;
  ...
  @override
  @JsonKey(name: "class")
  String? get createTaxRateResponseClass;
  @override
  @JsonKey(name: "postcodes")
  List<String>? get postcodes;
  @override
