...
_$ListTaxRatesResponseImpl _$$ListTaxRatesResponseImplFromJson(
    ...
    _$ListTaxRatesResponseImpl(
      ...
      listTaxRatesResponseClass: json['class'] as String?,
...
Map<String, dynamic> _$$ListTaxRatesResponseImplToJson(
        _$ListTaxRatesResponseImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.listTaxRatesResponseClass case final value?) 'class': value,
