...
UpdateTaxRateResponse _$UpdateTaxRateResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateTaxRateResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateTaxRateResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(name: "class")
  String? get updateTaxRateResponseClass => throw _privateConstructorUsedError;
  ...
  /// Serializes this UpdateTaxRateResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateTaxRateResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateTaxRateResponseCopyWith<UpdateTaxRateResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateTaxRateResponseCopyWith<$Res> {
  factory $UpdateTaxRateResponseCopyWith(UpdateTaxRateResponse value,
          $Res Function(UpdateTaxRateResponse) then) =
      _$UpdateTaxRateResponseCopyWithImpl<$Res, UpdateTaxRateResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "class") String? updateTaxRateResponseClass,
...
/// @nodoc
class _$UpdateTaxRateResponseCopyWithImpl<$Res,
        $Val extends UpdateTaxRateResponse>
    implements $UpdateTaxRateResponseCopyWith<$Res> {
  _$UpdateTaxRateResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? updateTaxRateResponseClass = freezed,
    ...
    return _then(_value.copyWith(
      ...
      order: freezed == order
          ...
          : order // ignore: cast_nullable_to_non_nullable
              as int?,
      updateTaxRateResponseClass: freezed == updateTaxRateResponseClass
          ? _value.updateTaxRateResponseClass
          : updateTaxRateResponseClass // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$UpdateTaxRateResponseImplCopyWith<$Res>
    implements $UpdateTaxRateResponseCopyWith<$Res> {
  factory _$$UpdateTaxRateResponseImplCopyWith(
          _$UpdateTaxRateResponseImpl value,
          $Res Function(_$UpdateTaxRateResponseImpl) then) =
      __$$UpdateTaxRateResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateTaxRateResponseImplCopyWithImpl<$Res>
    extends _$UpdateTaxRateResponseCopyWithImpl<$Res,
        _$UpdateTaxRateResponseImpl>
    implements _$$UpdateTaxRateResponseImplCopyWith<$Res> {
  __$$UpdateTaxRateResponseImplCopyWithImpl(_$UpdateTaxRateResponseImpl _value,
      $Res Function(_$UpdateTaxRateResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateTaxRateResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateTaxRateResponseImpl implements _UpdateTaxRateResponse {
  const _$UpdateTaxRateResponseImpl(
      ...
      @JsonKey(name: "class") this.updateTaxRateResponseClass,
  ...
  factory _$UpdateTaxRateResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateTaxRateResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "class")
  final String? updateTaxRateResponseClass;
  ...
  @override
  String toString() {
    return 'UpdateTaxRateResponse(id: $id, country: $country, state: $state, postcode: $postcode, city: $city, rate: $rate, name: $name, priority: $priority, compound: $compound, shipping: $shipping, order: $order, updateTaxRateResponseClass: $updateTaxRateResponseClass, postcodes: $postcodes, cities: $cities, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateTaxRateResponseImpl &&
            ...
            (identical(other.updateTaxRateResponseClass,
                    updateTaxRateResponseClass) ||
                other.updateTaxRateResponseClass ==
                    updateTaxRateResponseClass) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateTaxRateResponseImplCopyWith<_$UpdateTaxRateResponseImpl>
      get copyWith => __$$UpdateTaxRateResponseImplCopyWithImpl<
          _$UpdateTaxRateResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateTaxRateResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateTaxRateResponse implements UpdateTaxRateResponse {
  const factory _UpdateTaxRateResponse(
          ...
          @JsonKey(name: "class") final String? updateTaxRateResponseClass,
          @JsonKey(name: "postcodes") final List<String>? postcodes,
          @JsonKey(name: "cities") final List<String>? cities,
          @JsonKey(name: "_links") final Links? links}) =
      _$UpdateTaxRateResponseImpl;

  factory _UpdateTaxRateResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateTaxRateResponseImpl.fromJson;
  ...
  @override
  @JsonKey(name: "class")
  String? get updateTaxRateResponseClass;
  @override
  @JsonKey(name: "postcodes")
  List<String>? get postcodes;
  @override
