...
_$RetrieveTaxRateResponseImpl _$$RetrieveTaxRateResponseImplFromJson(
    ...
    _$RetrieveTaxRateResponseImpl(
      ...
      retrieveTaxRateResponseClass: json['class'] as String?,
...
Map<String, dynamic> _$$RetrieveTaxRateResponseImplToJson(
        _$RetrieveTaxRateResponseImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.retrieveTaxRateResponseClass case final value?)
        'class': value,
