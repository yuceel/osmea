...
part of 'retrieve_tax_rate_response.dart';
...
RetrieveTaxRateResponse _$RetrieveTaxRateResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveTaxRateResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveTaxRateResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(name: "class")
  String? get retrieveTaxRateResponseClass =>
  ...
  /// Serializes this RetrieveTaxRateResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveTaxRateResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveTaxRateResponseCopyWith<RetrieveTaxRateResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveTaxRateResponseCopyWith<$Res> {
  factory $RetrieveTaxRateResponseCopyWith(RetrieveTaxRateResponse value,
          $Res Function(RetrieveTaxRateResponse) then) =
      _$RetrieveTaxRateResponseCopyWithImpl<$Res, RetrieveTaxRateResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "class") String? retrieveTaxRateResponseClass,
...
/// @nodoc
class _$RetrieveTaxRateResponseCopyWithImpl<$Res,
        $Val extends RetrieveTaxRateResponse>
    implements $RetrieveTaxRateResponseCopyWith<$Res> {
  _$RetrieveTaxRateResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? retrieveTaxRateResponseClass = freezed,
    ...
    return _then(_value.copyWith(
      ...
      order: freezed == order
          ...
          : order // ignore: cast_nullable_to_non_nullable
              as int?,
      retrieveTaxRateResponseClass: freezed == retrieveTaxRateResponseClass
          ? _value.retrieveTaxRateResponseClass
          : retrieveTaxRateResponseClass // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$RetrieveTaxRateResponseImplCopyWith<$Res>
    implements $RetrieveTaxRateResponseCopyWith<$Res> {
  factory _$$RetrieveTaxRateResponseImplCopyWith(
          _$RetrieveTaxRateResponseImpl value,
          $Res Function(_$RetrieveTaxRateResponseImpl) then) =
      __$$RetrieveTaxRateResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveTaxRateResponseImplCopyWithImpl<$Res>
    extends _$RetrieveTaxRateResponseCopyWithImpl<$Res,
        _$RetrieveTaxRateResponseImpl>
    implements _$$RetrieveTaxRateResponseImplCopyWith<$Res> {
  __$$RetrieveTaxRateResponseImplCopyWithImpl(
      _$RetrieveTaxRateResponseImpl _value,
      $Res Function(_$RetrieveTaxRateResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveTaxRateResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveTaxRateResponseImpl implements _RetrieveTaxRateResponse {
  const _$RetrieveTaxRateResponseImpl(
      ...
      @JsonKey(name: "class") this.retrieveTaxRateResponseClass,
  ...
  factory _$RetrieveTaxRateResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveTaxRateResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "class")
  final String? retrieveTaxRateResponseClass;
  ...
  @override
  String toString() {
    return 'RetrieveTaxRateResponse(id: $id, country: $country, state: $state, postcode: $postcode, city: $city, rate: $rate, name: $name, priority: $priority, compound: $compound, shipping: $shipping, order: $order, retrieveTaxRateResponseClass: $retrieveTaxRateResponseClass, postcodes: $postcodes, cities: $cities, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveTaxRateResponseImpl &&
            ...
            (identical(other.retrieveTaxRateResponseClass,
                    retrieveTaxRateResponseClass) ||
                other.retrieveTaxRateResponseClass ==
                    retrieveTaxRateResponseClass) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveTaxRateResponseImplCopyWith<_$RetrieveTaxRateResponseImpl>
      get copyWith => __$$RetrieveTaxRateResponseImplCopyWithImpl<
          _$RetrieveTaxRateResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveTaxRateResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveTaxRateResponse implements RetrieveTaxRateResponse {
  const factory _RetrieveTaxRateResponse(
          ...
          @JsonKey(name: "class") final String? retrieveTaxRateResponseClass,
          @JsonKey(name: "postcodes") final List<String>? postcodes,
          @JsonKey(name: "cities") final List<String>? cities,
          @JsonKey(name: "_links") final Links? links}) =
      _$RetrieveTaxRateResponseImpl;

  factory _RetrieveTaxRateResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveTaxRateResponseImpl.fromJson;
