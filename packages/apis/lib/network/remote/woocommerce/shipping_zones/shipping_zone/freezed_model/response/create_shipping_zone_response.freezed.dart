...
part of 'create_shipping_zone_response.dart';
...
CreateShippingZoneResponse _$CreateShippingZoneResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateShippingZoneResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateShippingZoneResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateShippingZoneResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateShippingZoneResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateShippingZoneResponseCopyWith<CreateShippingZoneResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateShippingZoneResponseCopyWith<$Res> {
  factory $CreateShippingZoneResponseCopyWith(CreateShippingZoneResponse value,
          $Res Function(CreateShippingZoneResponse) then) =
      _$CreateShippingZoneResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateShippingZoneResponseCopyWithImpl<$Res,
        $Val extends CreateShippingZoneResponse>
    implements $CreateShippingZoneResponseCopyWith<$Res> {
  _$CreateShippingZoneResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateShippingZoneResponseImplCopyWith<$Res>
    implements $CreateShippingZoneResponseCopyWith<$Res> {
  factory _$$CreateShippingZoneResponseImplCopyWith(
          _$CreateShippingZoneResponseImpl value,
          $Res Function(_$CreateShippingZoneResponseImpl) then) =
      __$$CreateShippingZoneResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateShippingZoneResponseImplCopyWithImpl<$Res>
    extends _$CreateShippingZoneResponseCopyWithImpl<$Res,
        _$CreateShippingZoneResponseImpl>
    implements _$$CreateShippingZoneResponseImplCopyWith<$Res> {
  __$$CreateShippingZoneResponseImplCopyWithImpl(
      _$CreateShippingZoneResponseImpl _value,
      $Res Function(_$CreateShippingZoneResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateShippingZoneResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateShippingZoneResponseImpl implements _CreateShippingZoneResponse {
  const _$CreateShippingZoneResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "order") this.order,
      @JsonKey(name: "_links") this.links});

  factory _$CreateShippingZoneResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateShippingZoneResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateShippingZoneResponse(id: $id, name: $name, order: $order, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateShippingZoneResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateShippingZoneResponseImplCopyWith<_$CreateShippingZoneResponseImpl>
      get copyWith => __$$CreateShippingZoneResponseImplCopyWithImpl<
          _$CreateShippingZoneResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateShippingZoneResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateShippingZoneResponse
    implements CreateShippingZoneResponse {
  const factory _CreateShippingZoneResponse(
  ...
  factory _CreateShippingZoneResponse.fromJson(Map<String, dynamic> json) =
      _$CreateShippingZoneResponseImpl.fromJson;
