...
part of 'list_all_shipping_zones_response.dart';
...
ListAllShippingZonesResponse _$ListAllShippingZonesResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllShippingZonesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllShippingZonesResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllShippingZonesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllShippingZonesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllShippingZonesResponseCopyWith<ListAllShippingZonesResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllShippingZonesResponseCopyWith<$Res> {
  factory $ListAllShippingZonesResponseCopyWith(
          ListAllShippingZonesResponse value,
          $Res Function(ListAllShippingZonesResponse) then) =
      _$ListAllShippingZonesResponseCopyWithImpl<$Res,
          ListAllShippingZonesResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllShippingZonesResponseCopyWithImpl<$Res,
        $Val extends ListAllShippingZonesResponse>
    implements $ListAllShippingZonesResponseCopyWith<$Res> {
  _$ListAllShippingZonesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllShippingZonesResponseImplCopyWith<$Res>
    implements $ListAllShippingZonesResponseCopyWith<$Res> {
  factory _$$ListAllShippingZonesResponseImplCopyWith(
          _$ListAllShippingZonesResponseImpl value,
          $Res Function(_$ListAllShippingZonesResponseImpl) then) =
      __$$ListAllShippingZonesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllShippingZonesResponseImplCopyWithImpl<$Res>
    extends _$ListAllShippingZonesResponseCopyWithImpl<$Res,
        _$ListAllShippingZonesResponseImpl>
    implements _$$ListAllShippingZonesResponseImplCopyWith<$Res> {
  __$$ListAllShippingZonesResponseImplCopyWithImpl(
      _$ListAllShippingZonesResponseImpl _value,
      $Res Function(_$ListAllShippingZonesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllShippingZonesResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllShippingZonesResponseImpl
    implements _ListAllShippingZonesResponse {
  const _$ListAllShippingZonesResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "order") this.order,
      @JsonKey(name: "_links") this.links});

  factory _$ListAllShippingZonesResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllShippingZonesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllShippingZonesResponse(id: $id, name: $name, order: $order, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllShippingZonesResponseImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, order, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllShippingZonesResponseImplCopyWith<
          _$ListAllShippingZonesResponseImpl>
      get copyWith => __$$ListAllShippingZonesResponseImplCopyWithImpl<
          _$ListAllShippingZonesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllShippingZonesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllShippingZonesResponse
    implements ListAllShippingZonesResponse {
  const factory _ListAllShippingZonesResponse(
  ...
  factory _ListAllShippingZonesResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllShippingZonesResponseImpl.fromJson;
