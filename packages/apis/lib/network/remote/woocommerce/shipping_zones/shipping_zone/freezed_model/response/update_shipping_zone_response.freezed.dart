...
part of 'update_shipping_zone_response.dart';
...
UpdateShippingZoneResponse _$UpdateShippingZoneResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateShippingZoneResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateShippingZoneResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateShippingZoneResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateShippingZoneResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateShippingZoneResponseCopyWith<UpdateShippingZoneResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateShippingZoneResponseCopyWith<$Res> {
  factory $UpdateShippingZoneResponseCopyWith(UpdateShippingZoneResponse value,
          $Res Function(UpdateShippingZoneResponse) then) =
      _$UpdateShippingZoneResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$UpdateShippingZoneResponseCopyWithImpl<$Res,
        $Val extends UpdateShippingZoneResponse>
    implements $UpdateShippingZoneResponseCopyWith<$Res> {
  _$UpdateShippingZoneResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateShippingZoneResponseImplCopyWith<$Res>
    implements $UpdateShippingZoneResponseCopyWith<$Res> {
  factory _$$UpdateShippingZoneResponseImplCopyWith(
          _$UpdateShippingZoneResponseImpl value,
          $Res Function(_$UpdateShippingZoneResponseImpl) then) =
      __$$UpdateShippingZoneResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateShippingZoneResponseImplCopyWithImpl<$Res>
    extends _$UpdateShippingZoneResponseCopyWithImpl<$Res,
        _$UpdateShippingZoneResponseImpl>
    implements _$$UpdateShippingZoneResponseImplCopyWith<$Res> {
  __$$UpdateShippingZoneResponseImplCopyWithImpl(
      _$UpdateShippingZoneResponseImpl _value,
      $Res Function(_$UpdateShippingZoneResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateShippingZoneResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateShippingZoneResponseImpl implements _UpdateShippingZoneResponse {
  const _$UpdateShippingZoneResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "order") this.order,
      @JsonKey(name: "_links") this.links});

  factory _$UpdateShippingZoneResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateShippingZoneResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateShippingZoneResponse(id: $id, name: $name, order: $order, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateShippingZoneResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateShippingZoneResponseImplCopyWith<_$UpdateShippingZoneResponseImpl>
      get copyWith => __$$UpdateShippingZoneResponseImplCopyWithImpl<
          _$UpdateShippingZoneResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateShippingZoneResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateShippingZoneResponse
    implements UpdateShippingZoneResponse {
  const factory _UpdateShippingZoneResponse(
  ...
  factory _UpdateShippingZoneResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateShippingZoneResponseImpl.fromJson;
