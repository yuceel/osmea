...
part of 'delete_shipping_zone_response.dart';
...
DeleteShippingZoneResponse _$DeleteShippingZoneResponseFromJson(
    Map<String, dynamic> json) {
  return _DeleteShippingZoneResponse.fromJson(json);
}

/// @nodoc
mixin _$DeleteShippingZoneResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this DeleteShippingZoneResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DeleteShippingZoneResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DeleteShippingZoneResponseCopyWith<DeleteShippingZoneResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteShippingZoneResponseCopyWith<$Res> {
  factory $DeleteShippingZoneResponseCopyWith(DeleteShippingZoneResponse value,
          $Res Function(DeleteShippingZoneResponse) then) =
      _$DeleteShippingZoneResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$DeleteShippingZoneResponseCopyWithImpl<$Res,
        $Val extends DeleteShippingZoneResponse>
    implements $DeleteShippingZoneResponseCopyWith<$Res> {
  _$DeleteShippingZoneResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DeleteShippingZoneResponseImplCopyWith<$Res>
    implements $DeleteShippingZoneResponseCopyWith<$Res> {
  factory _$$DeleteShippingZoneResponseImplCopyWith(
          _$DeleteShippingZoneResponseImpl value,
          $Res Function(_$DeleteShippingZoneResponseImpl) then) =
      __$$DeleteShippingZoneResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteShippingZoneResponseImplCopyWithImpl<$Res>
    extends _$DeleteShippingZoneResponseCopyWithImpl<$Res,
        _$DeleteShippingZoneResponseImpl>
    implements _$$DeleteShippingZoneResponseImplCopyWith<$Res> {
  __$$DeleteShippingZoneResponseImplCopyWithImpl(
      _$DeleteShippingZoneResponseImpl _value,
      $Res Function(_$DeleteShippingZoneResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteShippingZoneResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteShippingZoneResponseImpl implements _DeleteShippingZoneResponse {
  const _$DeleteShippingZoneResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "order") this.order,
      @JsonKey(name: "_links") this.links});

  factory _$DeleteShippingZoneResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$DeleteShippingZoneResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DeleteShippingZoneResponse(id: $id, name: $name, order: $order, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteShippingZoneResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteShippingZoneResponseImplCopyWith<_$DeleteShippingZoneResponseImpl>
      get copyWith => __$$DeleteShippingZoneResponseImplCopyWithImpl<
          _$DeleteShippingZoneResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteShippingZoneResponseImplToJson(
      this,
    );
  }
}

abstract class _DeleteShippingZoneResponse
    implements DeleteShippingZoneResponse {
  const factory _DeleteShippingZoneResponse(
  ...
  factory _DeleteShippingZoneResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteShippingZoneResponseImpl.fromJson;
