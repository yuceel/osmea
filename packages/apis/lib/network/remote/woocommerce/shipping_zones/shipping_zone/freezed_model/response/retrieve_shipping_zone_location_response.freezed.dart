...
RetrieveShippingZoneLocationResponse
    _$RetrieveShippingZoneLocationResponseFromJson(Map<String, dynamic> json) {
  return _RetrieveShippingZoneLocationResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveShippingZoneLocationResponse {
  @JsonKey(name: "code")
  ...
  /// Serializes this RetrieveShippingZoneLocationResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveShippingZoneLocationResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveShippingZoneLocationResponseCopyWith<
          RetrieveShippingZoneLocationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveShippingZoneLocationResponseCopyWith<$Res> {
  factory $RetrieveShippingZoneLocationResponseCopyWith(
          RetrieveShippingZoneLocationResponse value,
          $Res Function(RetrieveShippingZoneLocationResponse) then) =
      _$RetrieveShippingZoneLocationResponseCopyWithImpl<$Res,
          RetrieveShippingZoneLocationResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveShippingZoneLocationResponseCopyWithImpl<$Res,
        $Val extends RetrieveShippingZoneLocationResponse>
    implements $RetrieveShippingZoneLocationResponseCopyWith<$Res> {
  _$RetrieveShippingZoneLocationResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveShippingZoneLocationResponseImplCopyWith<$Res>
    implements $RetrieveShippingZoneLocationResponseCopyWith<$Res> {
  factory _$$RetrieveShippingZoneLocationResponseImplCopyWith(
          _$RetrieveShippingZoneLocationResponseImpl value,
          $Res Function(_$RetrieveShippingZoneLocationResponseImpl) then) =
      __$$RetrieveShippingZoneLocationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$RetrieveShippingZoneLocationResponseImplCopyWithImpl<$Res>
    extends _$RetrieveShippingZoneLocationResponseCopyWithImpl<$Res,
        _$RetrieveShippingZoneLocationResponseImpl>
    implements _$$RetrieveShippingZoneLocationResponseImplCopyWith<$Res> {
  __$$RetrieveShippingZoneLocationResponseImplCopyWithImpl(
      _$RetrieveShippingZoneLocationResponseImpl _value,
      $Res Function(_$RetrieveShippingZoneLocationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveShippingZoneLocationResponseImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveShippingZoneLocationResponseImpl
    implements _RetrieveShippingZoneLocationResponse {
  const _$RetrieveShippingZoneLocationResponseImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "type") this.type,
      @JsonKey(name: "_links") this.links});

  factory _$RetrieveShippingZoneLocationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveShippingZoneLocationResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveShippingZoneLocationResponse(code: $code, type: $type, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveShippingZoneLocationResponseImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, code, type, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveShippingZoneLocationResponseImplCopyWith<
          _$RetrieveShippingZoneLocationResponseImpl>
      get copyWith => __$$RetrieveShippingZoneLocationResponseImplCopyWithImpl<
          _$RetrieveShippingZoneLocationResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveShippingZoneLocationResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveShippingZoneLocationResponse
    implements RetrieveShippingZoneLocationResponse {
  const factory _RetrieveShippingZoneLocationResponse(
          {@JsonKey(name: "code") final String? code,
          @JsonKey(name: "type") final String? type,
          @JsonKey(name: "_links") final Links? links}) =
      _$RetrieveShippingZoneLocationResponseImpl;

  factory _RetrieveShippingZoneLocationResponse.fromJson(
          Map<String, dynamic> json) =
      _$RetrieveShippingZoneLocationResponseImpl.fromJson;
...
mixin _$Links {
  ...
  @JsonKey(name: "describedby")
  List<Collection>? get describedby => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      collection: freezed == collection
          ...
          : collection // ignore: cast_nullable_to_non_nullable
              as List<Collection>?,
      describedby: freezed == describedby
          ? _value.describedby
          : describedby // ignore: cast_nullable_to_non_nullable
              as List<Collection>?,
    ) as $Val);
  }
}
...
class _$LinksImpl implements _Links {
  const _$LinksImpl(
      ...
      @JsonKey(name: "describedby") final List<Collection>? describedby})
      : _self = self,
  ...
  final List<Collection>? _describedby;
  @override
  @JsonKey(name: "describedby")
  List<Collection>? get describedby {
    final value = _describedby;
    if (value == null) return null;
    if (_describedby is EqualUnmodifiableListView) return _describedby;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._describedby, _describedby));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_describedby));
