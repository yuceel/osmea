...
part of 'retrieve_shipping_zone_response.dart';
...
RetrieveShippingZoneResponse _$RetrieveShippingZoneResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveShippingZoneResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveShippingZoneResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveShippingZoneResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveShippingZoneResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveShippingZoneResponseCopyWith<RetrieveShippingZoneResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveShippingZoneResponseCopyWith<$Res> {
  factory $RetrieveShippingZoneResponseCopyWith(
          RetrieveShippingZoneResponse value,
          $Res Function(RetrieveShippingZoneResponse) then) =
      _$RetrieveShippingZoneResponseCopyWithImpl<$Res,
          RetrieveShippingZoneResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveShippingZoneResponseCopyWithImpl<$Res,
        $Val extends RetrieveShippingZoneResponse>
    implements $RetrieveShippingZoneResponseCopyWith<$Res> {
  _$RetrieveShippingZoneResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveShippingZoneResponseImplCopyWith<$Res>
    implements $RetrieveShippingZoneResponseCopyWith<$Res> {
  factory _$$RetrieveShippingZoneResponseImplCopyWith(
          _$RetrieveShippingZoneResponseImpl value,
          $Res Function(_$RetrieveShippingZoneResponseImpl) then) =
      __$$RetrieveShippingZoneResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveShippingZoneResponseImplCopyWithImpl<$Res>
    extends _$RetrieveShippingZoneResponseCopyWithImpl<$Res,
        _$RetrieveShippingZoneResponseImpl>
    implements _$$RetrieveShippingZoneResponseImplCopyWith<$Res> {
  __$$RetrieveShippingZoneResponseImplCopyWithImpl(
      _$RetrieveShippingZoneResponseImpl _value,
      $Res Function(_$RetrieveShippingZoneResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveShippingZoneResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveShippingZoneResponseImpl
    implements _RetrieveShippingZoneResponse {
  const _$RetrieveShippingZoneResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "order") this.order,
      @JsonKey(name: "_links") this.links});

  factory _$RetrieveShippingZoneResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveShippingZoneResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveShippingZoneResponse(id: $id, name: $name, order: $order, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveShippingZoneResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveShippingZoneResponseImplCopyWith<
          _$RetrieveShippingZoneResponseImpl>
      get copyWith => __$$RetrieveShippingZoneResponseImplCopyWithImpl<
          _$RetrieveShippingZoneResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveShippingZoneResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveShippingZoneResponse
    implements RetrieveShippingZoneResponse {
  const factory _RetrieveShippingZoneResponse(
  ...
  factory _RetrieveShippingZoneResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveShippingZoneResponseImpl.fromJson;
