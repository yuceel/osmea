...
//
//     final deleteShippingMethodFromShippingZoneResponse = deleteShippingMethodFromShippingZoneResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'delete_shipping_method_from_shipping_zone_response.freezed.dart';
part 'delete_shipping_method_from_shipping_zone_response.g.dart';

DeleteShippingMethodFromShippingZoneResponse
    deleteShippingMethodFromShippingZoneResponseFromJson(String str) =>
        DeleteShippingMethodFromShippingZoneResponse.fromJson(json.decode(str));

String deleteShippingMethodFromShippingZoneResponseToJson(
        DeleteShippingMethodFromShippingZoneResponse data) =>
    json.encode(data.toJson());

@freezed
class DeleteShippingMethodFromShippingZoneResponse
    with _$DeleteShippingMethodFromShippingZoneResponse {
  const factory DeleteShippingMethodFromShippingZoneResponse({
  ...
  }) = _DeleteShippingMethodFromShippingZoneResponse;

  factory DeleteShippingMethodFromShippingZoneResponse.fromJson(
          Map<String, dynamic> json) =>
      _$DeleteShippingMethodFromShippingZoneResponseFromJson(json);
}
