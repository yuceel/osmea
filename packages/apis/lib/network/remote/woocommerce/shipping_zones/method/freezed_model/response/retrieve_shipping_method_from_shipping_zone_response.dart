...
//
//     final retrieveShippingMethodFromShippingZoneResponse = retrieveShippingMethodFromShippingZoneResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_shipping_method_from_shipping_zone_response.freezed.dart';
part 'retrieve_shipping_method_from_shipping_zone_response.g.dart';

RetrieveShippingMethodFromShippingZoneResponse
    retrieveShippingMethodFromShippingZoneResponseFromJson(String str) =>
        RetrieveShippingMethodFromShippingZoneResponse.fromJson(
            json.decode(str));

String retrieveShippingMethodFromShippingZoneResponseToJson(
        RetrieveShippingMethodFromShippingZoneResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveShippingMethodFromShippingZoneResponse
    with _$RetrieveShippingMethodFromShippingZoneResponse {
  const factory RetrieveShippingMethodFromShippingZoneResponse({
  ...
  }) = _RetrieveShippingMethodFromShippingZoneResponse;

  factory RetrieveShippingMethodFromShippingZoneResponse.fromJson(
          Map<String, dynamic> json) =>
      _$RetrieveShippingMethodFromShippingZoneResponseFromJson(json);
}
