...
//
//     final updateShippingMethodFromShippingZoneResponse = updateShippingMethodFromShippingZoneResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'update_shipping_method_from_shipping_zone_response.freezed.dart';
part 'update_shipping_method_from_shipping_zone_response.g.dart';

UpdateShippingMethodFromShippingZoneResponse
    updateShippingMethodFromShippingZoneResponseFromJson(String str) =>
        UpdateShippingMethodFromShippingZoneResponse.fromJson(json.decode(str));

String updateShippingMethodFromShippingZoneResponseToJson(
        UpdateShippingMethodFromShippingZoneResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateShippingMethodFromShippingZoneResponse
    with _$UpdateShippingMethodFromShippingZoneResponse {
  const factory UpdateShippingMethodFromShippingZoneResponse({
  ...
  }) = _UpdateShippingMethodFromShippingZoneResponse;

  factory UpdateShippingMethodFromShippingZoneResponse.fromJson(
          Map<String, dynamic> json) =>
      _$UpdateShippingMethodFromShippingZoneResponseFromJson(json);
}
