...
BatchUpdateCustomersResponse _$BatchUpdateCustomersResponseFromJson(
    Map<String, dynamic> json) {
  return _BatchUpdateCustomersResponse.fromJson(json);
}

/// @nodoc
mixin _$BatchUpdateCustomersResponse {
  @JsonKey(name: "create")
  ...
  /// Serializes this BatchUpdateCustomersResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BatchUpdateCustomersResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BatchUpdateCustomersResponseCopyWith<BatchUpdateCustomersResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BatchUpdateCustomersResponseCopyWith<$Res> {
  factory $BatchUpdateCustomersResponseCopyWith(
          BatchUpdateCustomersResponse value,
          $Res Function(BatchUpdateCustomersResponse) then) =
      _$BatchUpdateCustomersResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$BatchUpdateCustomersResponseCopyWithImpl<$Res,
        $Val extends BatchUpdateCustomersResponse>
    implements $BatchUpdateCustomersResponseCopyWith<$Res> {
  _$BatchUpdateCustomersResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BatchUpdateCustomersResponseImplCopyWith<$Res>
    implements $BatchUpdateCustomersResponseCopyWith<$Res> {
  factory _$$BatchUpdateCustomersResponseImplCopyWith(
          _$BatchUpdateCustomersResponseImpl value,
          $Res Function(_$BatchUpdateCustomersResponseImpl) then) =
      __$$BatchUpdateCustomersResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "create") List<Create>? create,
...
/// @nodoc
class __$$BatchUpdateCustomersResponseImplCopyWithImpl<$Res>
    extends _$BatchUpdateCustomersResponseCopyWithImpl<$Res,
        _$BatchUpdateCustomersResponseImpl>
    implements _$$BatchUpdateCustomersResponseImplCopyWith<$Res> {
  __$$BatchUpdateCustomersResponseImplCopyWithImpl(
      _$BatchUpdateCustomersResponseImpl _value,
      $Res Function(_$BatchUpdateCustomersResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BatchUpdateCustomersResponseImpl(
      create: freezed == create
          ? _value._create
          : create // ignore: cast_nullable_to_non_nullable
              as List<Create>?,
...
/// @nodoc
@JsonSerializable()
class _$BatchUpdateCustomersResponseImpl
    implements _BatchUpdateCustomersResponse {
  const _$BatchUpdateCustomersResponseImpl(
  ...
  factory _$BatchUpdateCustomersResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$BatchUpdateCustomersResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BatchUpdateCustomersResponse(create: $create, update: $update, delete: $delete)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BatchUpdateCustomersResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BatchUpdateCustomersResponseImplCopyWith<
          _$BatchUpdateCustomersResponseImpl>
      get copyWith => __$$BatchUpdateCustomersResponseImplCopyWithImpl<
          _$BatchUpdateCustomersResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BatchUpdateCustomersResponseImplToJson(
      this,
    );
  }
}

abstract class _BatchUpdateCustomersResponse
    implements BatchUpdateCustomersResponse {
  const factory _BatchUpdateCustomersResponse(
          {@JsonKey(name: "create") final List<Create>? create,
          @JsonKey(name: "update") final List<Delete>? update,
          @JsonKey(name: "delete") final List<Delete>? delete}) =
      _$BatchUpdateCustomersResponseImpl;

  factory _BatchUpdateCustomersResponse.fromJson(Map<String, dynamic> json) =
      _$BatchUpdateCustomersResponseImpl.fromJson;
