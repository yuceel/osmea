...
part of 'retrieve_customer_response.dart';
...
RetrieveCustomerResponse _$RetrieveCustomerResponseFromJson(
  ...
  return _RetrieveCustomerResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveCustomerResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveCustomerResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveCustomerResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveCustomerResponseCopyWith<RetrieveCustomerResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveCustomerResponseCopyWith<$Res> {
  factory $RetrieveCustomerResponseCopyWith(RetrieveCustomerResponse value,
          $Res Function(RetrieveCustomerResponse) then) =
      _$RetrieveCustomerResponseCopyWithImpl<$Res, RetrieveCustomerResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveCustomerResponseCopyWithImpl<$Res,
        $Val extends RetrieveCustomerResponse>
    implements $RetrieveCustomerResponseCopyWith<$Res> {
  _$RetrieveCustomerResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveCustomerResponseImplCopyWith<$Res>
    implements $RetrieveCustomerResponseCopyWith<$Res> {
  factory _$$RetrieveCustomerResponseImplCopyWith(
          _$RetrieveCustomerResponseImpl value,
          $Res Function(_$RetrieveCustomerResponseImpl) then) =
      __$$RetrieveCustomerResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveCustomerResponseImplCopyWithImpl<$Res>
    extends _$RetrieveCustomerResponseCopyWithImpl<$Res,
        _$RetrieveCustomerResponseImpl>
    implements _$$RetrieveCustomerResponseImplCopyWith<$Res> {
  __$$RetrieveCustomerResponseImplCopyWithImpl(
      _$RetrieveCustomerResponseImpl _value,
      $Res Function(_$RetrieveCustomerResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveCustomerResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveCustomerResponseImpl implements _RetrieveCustomerResponse {
  const _$RetrieveCustomerResponseImpl(
  ...
  factory _$RetrieveCustomerResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveCustomerResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveCustomerResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveCustomerResponseImplCopyWith<_$RetrieveCustomerResponseImpl>
      get copyWith => __$$RetrieveCustomerResponseImplCopyWithImpl<
          _$RetrieveCustomerResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveCustomerResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveCustomerResponse implements RetrieveCustomerResponse {
  const factory _RetrieveCustomerResponse(
  ...
  factory _RetrieveCustomerResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveCustomerResponseImpl.fromJson;
