...
class _$UpdateCustomerRequestImpl implements _UpdateCustomerRequest {
  ...
  @override
  String toString() {
    return 'UpdateCustomerRequest(email: $email, firstName: $firstName, lastName: $lastName, username: $username, password: $password, billing: $billing, shipping: $shipping, metaData: $metaData)';
  }
