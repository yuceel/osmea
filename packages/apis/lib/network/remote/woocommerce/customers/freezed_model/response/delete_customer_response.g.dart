...
_$DeleteCustomerResponseImpl _$$DeleteCustomerResponseImplFromJson(
...
Map<String, dynamic> _$$DeleteCustomerResponseImplToJson(
        _$DeleteCustomerResponseImpl instance) =>
    <String, dynamic>{
