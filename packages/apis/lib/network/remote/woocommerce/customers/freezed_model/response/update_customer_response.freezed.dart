...
mixin _$UpdateCustomerResponse {
  ...
  /// Serializes this UpdateCustomerResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateCustomerResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateCustomerResponseCopyWith<UpdateCustomerResponse> get copyWith =>
...
/// @nodoc
abstract class _$$UpdateCustomerResponseImplCopyWith<$Res>
    implements $UpdateCustomerResponseCopyWith<$Res> {
  factory _$$UpdateCustomerResponseImplCopyWith(
          _$UpdateCustomerResponseImpl value,
          $Res Function(_$UpdateCustomerResponseImpl) then) =
      __$$UpdateCustomerResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateCustomerResponseImplCopyWithImpl<$Res>
    extends _$UpdateCustomerResponseCopyWithImpl<$Res,
        _$UpdateCustomerResponseImpl>
    implements _$$UpdateCustomerResponseImplCopyWith<$Res> {
  __$$UpdateCustomerResponseImplCopyWithImpl(
      _$UpdateCustomerResponseImpl _value,
      $Res Function(_$UpdateCustomerResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateCustomerResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateCustomerResponseImpl implements _UpdateCustomerResponse {
  const _$UpdateCustomerResponseImpl(
  ...
  factory _$UpdateCustomerResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateCustomerResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateCustomerResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateCustomerResponseImplCopyWith<_$UpdateCustomerResponseImpl>
      get copyWith => __$$UpdateCustomerResponseImplCopyWithImpl<
          _$UpdateCustomerResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateCustomerResponseImplToJson(
      this,
    );
  }
}
...
abstract class _UpdateCustomerResponse implements UpdateCustomerResponse {
  const factory _UpdateCustomerResponse(
  ...
  factory _UpdateCustomerResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateCustomerResponseImpl.fromJson;
