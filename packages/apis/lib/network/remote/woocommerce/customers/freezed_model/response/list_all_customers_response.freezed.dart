...
ListAllCustomersResponse _$ListAllCustomersResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllCustomersResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllCustomersResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllCustomersResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllCustomersResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllCustomersResponseCopyWith<ListAllCustomersResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllCustomersResponseCopyWith<$Res> {
  factory $ListAllCustomersResponseCopyWith(ListAllCustomersResponse value,
          $Res Function(ListAllCustomersResponse) then) =
      _$ListAllCustomersResponseCopyWithImpl<$Res, ListAllCustomersResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllCustomersResponseCopyWithImpl<$Res,
        $Val extends ListAllCustomersResponse>
    implements $ListAllCustomersResponseCopyWith<$Res> {
  _$ListAllCustomersResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllCustomersResponseImplCopyWith<$Res>
    implements $ListAllCustomersResponseCopyWith<$Res> {
  factory _$$ListAllCustomersResponseImplCopyWith(
          _$ListAllCustomersResponseImpl value,
          $Res Function(_$ListAllCustomersResponseImpl) then) =
      __$$ListAllCustomersResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllCustomersResponseImplCopyWithImpl<$Res>
    extends _$ListAllCustomersResponseCopyWithImpl<$Res,
        _$ListAllCustomersResponseImpl>
    implements _$$ListAllCustomersResponseImplCopyWith<$Res> {
  __$$ListAllCustomersResponseImplCopyWithImpl(
      _$ListAllCustomersResponseImpl _value,
      $Res Function(_$ListAllCustomersResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllCustomersResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllCustomersResponseImpl implements _ListAllCustomersResponse {
  const _$ListAllCustomersResponseImpl(
  ...
  factory _$ListAllCustomersResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllCustomersResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllCustomersResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllCustomersResponseImplCopyWith<_$ListAllCustomersResponseImpl>
      get copyWith => __$$ListAllCustomersResponseImplCopyWithImpl<
          _$ListAllCustomersResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllCustomersResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllCustomersResponse implements ListAllCustomersResponse {
  const factory _ListAllCustomersResponse(
  ...
  factory _ListAllCustomersResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllCustomersResponseImpl.fromJson;
