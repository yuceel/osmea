...
CreateCustomerResponse _$CreateCustomerResponseFromJson(
  ...
  return _CreateCustomerResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCustomerResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateCustomerResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCustomerResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCustomerResponseCopyWith<CreateCustomerResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCustomerResponseCopyWith<$Res> {
  factory $CreateCustomerResponseCopyWith(CreateCustomerResponse value,
          $Res Function(CreateCustomerResponse) then) =
      _$CreateCustomerResponseCopyWithImpl<$Res, CreateCustomerResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateCustomerResponseCopyWithImpl<$Res,
        $Val extends CreateCustomerResponse>
    implements $CreateCustomerResponseCopyWith<$Res> {
  _$CreateCustomerResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCustomerResponseImplCopyWith<$Res>
    implements $CreateCustomerResponseCopyWith<$Res> {
  factory _$$CreateCustomerResponseImplCopyWith(
          _$CreateCustomerResponseImpl value,
          $Res Function(_$CreateCustomerResponseImpl) then) =
      __$$CreateCustomerResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateCustomerResponseImplCopyWithImpl<$Res>
    extends _$CreateCustomerResponseCopyWithImpl<$Res,
        _$CreateCustomerResponseImpl>
    implements _$$CreateCustomerResponseImplCopyWith<$Res> {
  __$$CreateCustomerResponseImplCopyWithImpl(
      _$CreateCustomerResponseImpl _value,
      $Res Function(_$CreateCustomerResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCustomerResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCustomerResponseImpl implements _CreateCustomerResponse {
  const _$CreateCustomerResponseImpl(
  ...
  factory _$CreateCustomerResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateCustomerResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCustomerResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCustomerResponseImplCopyWith<_$CreateCustomerResponseImpl>
      get copyWith => __$$CreateCustomerResponseImplCopyWithImpl<
          _$CreateCustomerResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCustomerResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateCustomerResponse implements CreateCustomerResponse {
  const factory _CreateCustomerResponse(
  ...
  factory _CreateCustomerResponse.fromJson(Map<String, dynamic> json) =
      _$CreateCustomerResponseImpl.fromJson;
