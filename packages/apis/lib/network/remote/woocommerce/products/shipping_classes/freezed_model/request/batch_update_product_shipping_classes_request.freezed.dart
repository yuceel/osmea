...
BatchUpdateProductShippingClassesRequest
    _$BatchUpdateProductShippingClassesRequestFromJson(
        Map<String, dynamic> json) {
  return _BatchUpdateProductShippingClassesRequest.fromJson(json);
}

/// @nodoc
mixin _$BatchUpdateProductShippingClassesRequest {
  @JsonKey(name: "create")
  ...
  /// Serializes this BatchUpdateProductShippingClassesRequest to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BatchUpdateProductShippingClassesRequest
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BatchUpdateProductShippingClassesRequestCopyWith<
          BatchUpdateProductShippingClassesRequest>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BatchUpdateProductShippingClassesRequestCopyWith<$Res> {
  factory $BatchUpdateProductShippingClassesRequestCopyWith(
          BatchUpdateProductShippingClassesRequest value,
          $Res Function(BatchUpdateProductShippingClassesRequest) then) =
      _$BatchUpdateProductShippingClassesRequestCopyWithImpl<$Res,
          BatchUpdateProductShippingClassesRequest>;
  @useResult
  $Res call(
...
/// @nodoc
class _$BatchUpdateProductShippingClassesRequestCopyWithImpl<$Res,
        $Val extends BatchUpdateProductShippingClassesRequest>
    implements $BatchUpdateProductShippingClassesRequestCopyWith<$Res> {
  _$BatchUpdateProductShippingClassesRequestCopyWithImpl(
...
/// @nodoc
abstract class _$$BatchUpdateProductShippingClassesRequestImplCopyWith<$Res>
    implements $BatchUpdateProductShippingClassesRequestCopyWith<$Res> {
  factory _$$BatchUpdateProductShippingClassesRequestImplCopyWith(
          _$BatchUpdateProductShippingClassesRequestImpl value,
          $Res Function(_$BatchUpdateProductShippingClassesRequestImpl) then) =
      __$$BatchUpdateProductShippingClassesRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "create") List<Create>? create,
...
/// @nodoc
class __$$BatchUpdateProductShippingClassesRequestImplCopyWithImpl<$Res>
    extends _$BatchUpdateProductShippingClassesRequestCopyWithImpl<$Res,
        _$BatchUpdateProductShippingClassesRequestImpl>
    implements _$$BatchUpdateProductShippingClassesRequestImplCopyWith<$Res> {
  __$$BatchUpdateProductShippingClassesRequestImplCopyWithImpl(
      _$BatchUpdateProductShippingClassesRequestImpl _value,
      $Res Function(_$BatchUpdateProductShippingClassesRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BatchUpdateProductShippingClassesRequestImpl(
      create: freezed == create
          ? _value._create
          : create // ignore: cast_nullable_to_non_nullable
              as List<Create>?,
...
/// @nodoc
@JsonSerializable()
class _$BatchUpdateProductShippingClassesRequestImpl
    implements _BatchUpdateProductShippingClassesRequest {
  const _$BatchUpdateProductShippingClassesRequestImpl(
  ...
  factory _$BatchUpdateProductShippingClassesRequestImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$BatchUpdateProductShippingClassesRequestImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BatchUpdateProductShippingClassesRequest(create: $create, update: $update, delete: $delete)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BatchUpdateProductShippingClassesRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BatchUpdateProductShippingClassesRequestImplCopyWith<
          _$BatchUpdateProductShippingClassesRequestImpl>
      get copyWith =>
          __$$BatchUpdateProductShippingClassesRequestImplCopyWithImpl<
              _$BatchUpdateProductShippingClassesRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BatchUpdateProductShippingClassesRequestImplToJson(
      this,
    );
  }
}

abstract class _BatchUpdateProductShippingClassesRequest
    implements BatchUpdateProductShippingClassesRequest {
  const factory _BatchUpdateProductShippingClassesRequest(
          {@JsonKey(name: "create") final List<Create>? create,
          @JsonKey(name: "update") final List<Update>? update,
          @JsonKey(name: "delete") final List<int>? delete}) =
      _$BatchUpdateProductShippingClassesRequestImpl;

  factory _BatchUpdateProductShippingClassesRequest.fromJson(
          Map<String, dynamic> json) =
      _$BatchUpdateProductShippingClassesRequestImpl.fromJson;
