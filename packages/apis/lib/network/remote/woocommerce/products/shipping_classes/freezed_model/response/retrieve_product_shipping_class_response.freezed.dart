...
part of 'retrieve_product_shipping_class_response.dart';
...
RetrieveProductShippingClassResponse
    _$RetrieveProductShippingClassResponseFromJson(Map<String, dynamic> json) {
  return _RetrieveProductShippingClassResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductShippingClassResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveProductShippingClassResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveProductShippingClassResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveProductShippingClassResponseCopyWith<
          RetrieveProductShippingClassResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductShippingClassResponseCopyWith<$Res> {
  factory $RetrieveProductShippingClassResponseCopyWith(
          RetrieveProductShippingClassResponse value,
          $Res Function(RetrieveProductShippingClassResponse) then) =
      _$RetrieveProductShippingClassResponseCopyWithImpl<$Res,
          RetrieveProductShippingClassResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductShippingClassResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductShippingClassResponse>
    implements $RetrieveProductShippingClassResponseCopyWith<$Res> {
  _$RetrieveProductShippingClassResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductShippingClassResponseImplCopyWith<$Res>
    implements $RetrieveProductShippingClassResponseCopyWith<$Res> {
  factory _$$RetrieveProductShippingClassResponseImplCopyWith(
          _$RetrieveProductShippingClassResponseImpl value,
          $Res Function(_$RetrieveProductShippingClassResponseImpl) then) =
      __$$RetrieveProductShippingClassResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductShippingClassResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductShippingClassResponseCopyWithImpl<$Res,
        _$RetrieveProductShippingClassResponseImpl>
    implements _$$RetrieveProductShippingClassResponseImplCopyWith<$Res> {
  __$$RetrieveProductShippingClassResponseImplCopyWithImpl(
      _$RetrieveProductShippingClassResponseImpl _value,
      $Res Function(_$RetrieveProductShippingClassResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductShippingClassResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductShippingClassResponseImpl
    implements _RetrieveProductShippingClassResponse {
  const _$RetrieveProductShippingClassResponseImpl(
  ...
  factory _$RetrieveProductShippingClassResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductShippingClassResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveProductShippingClassResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductShippingClassResponseImpl &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, slug, description, count, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductShippingClassResponseImplCopyWith<
          _$RetrieveProductShippingClassResponseImpl>
      get copyWith => __$$RetrieveProductShippingClassResponseImplCopyWithImpl<
          _$RetrieveProductShippingClassResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductShippingClassResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductShippingClassResponse
    implements RetrieveProductShippingClassResponse {
  const factory _RetrieveProductShippingClassResponse(
  ...
  factory _RetrieveProductShippingClassResponse.fromJson(
          Map<String, dynamic> json) =
      _$RetrieveProductShippingClassResponseImpl.fromJson;
