...
part of 'list_all_product_shipping_classes_response.dart';
...
ListAllProductShippingClasses _$ListAllProductShippingClassesFromJson(
    Map<String, dynamic> json) {
  return _ListAllProductShippingClasses.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductShippingClasses {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductShippingClasses to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductShippingClasses
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductShippingClassesCopyWith<ListAllProductShippingClasses>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductShippingClassesCopyWith<$Res> {
  factory $ListAllProductShippingClassesCopyWith(
          ListAllProductShippingClasses value,
          $Res Function(ListAllProductShippingClasses) then) =
      _$ListAllProductShippingClassesCopyWithImpl<$Res,
          ListAllProductShippingClasses>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductShippingClassesCopyWithImpl<$Res,
        $Val extends ListAllProductShippingClasses>
    implements $ListAllProductShippingClassesCopyWith<$Res> {
  _$ListAllProductShippingClassesCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductShippingClassesImplCopyWith<$Res>
    implements $ListAllProductShippingClassesCopyWith<$Res> {
  factory _$$ListAllProductShippingClassesImplCopyWith(
          _$ListAllProductShippingClassesImpl value,
          $Res Function(_$ListAllProductShippingClassesImpl) then) =
      __$$ListAllProductShippingClassesImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductShippingClassesImplCopyWithImpl<$Res>
    extends _$ListAllProductShippingClassesCopyWithImpl<$Res,
        _$ListAllProductShippingClassesImpl>
    implements _$$ListAllProductShippingClassesImplCopyWith<$Res> {
  __$$ListAllProductShippingClassesImplCopyWithImpl(
      _$ListAllProductShippingClassesImpl _value,
      $Res Function(_$ListAllProductShippingClassesImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductShippingClassesImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductShippingClassesImpl
    implements _ListAllProductShippingClasses {
  const _$ListAllProductShippingClassesImpl(
  ...
  factory _$ListAllProductShippingClassesImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllProductShippingClassesImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllProductShippingClasses(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductShippingClassesImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductShippingClassesImplCopyWith<
          _$ListAllProductShippingClassesImpl>
      get copyWith => __$$ListAllProductShippingClassesImplCopyWithImpl<
          _$ListAllProductShippingClassesImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductShippingClassesImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductShippingClasses
    implements ListAllProductShippingClasses {
  const factory _ListAllProductShippingClasses(
  ...
  factory _ListAllProductShippingClasses.fromJson(Map<String, dynamic> json) =
      _$ListAllProductShippingClassesImpl.fromJson;
