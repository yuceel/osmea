...
part of 'create_product_shipping_class_response.dart';
...
CreateProductShippingClassResponse _$CreateProductShippingClassResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateProductShippingClassResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductShippingClassResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductShippingClassResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductShippingClassResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductShippingClassResponseCopyWith<
          CreateProductShippingClassResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductShippingClassResponseCopyWith<$Res> {
  factory $CreateProductShippingClassResponseCopyWith(
          CreateProductShippingClassResponse value,
          $Res Function(CreateProductShippingClassResponse) then) =
      _$CreateProductShippingClassResponseCopyWithImpl<$Res,
          CreateProductShippingClassResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateProductShippingClassResponseCopyWithImpl<$Res,
        $Val extends CreateProductShippingClassResponse>
    implements $CreateProductShippingClassResponseCopyWith<$Res> {
  _$CreateProductShippingClassResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductShippingClassResponseImplCopyWith<$Res>
    implements $CreateProductShippingClassResponseCopyWith<$Res> {
  factory _$$CreateProductShippingClassResponseImplCopyWith(
          _$CreateProductShippingClassResponseImpl value,
          $Res Function(_$CreateProductShippingClassResponseImpl) then) =
      __$$CreateProductShippingClassResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductShippingClassResponseImplCopyWithImpl<$Res>
    extends _$CreateProductShippingClassResponseCopyWithImpl<$Res,
        _$CreateProductShippingClassResponseImpl>
    implements _$$CreateProductShippingClassResponseImplCopyWith<$Res> {
  __$$CreateProductShippingClassResponseImplCopyWithImpl(
      _$CreateProductShippingClassResponseImpl _value,
      $Res Function(_$CreateProductShippingClassResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductShippingClassResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductShippingClassResponseImpl
    implements _CreateProductShippingClassResponse {
  const _$CreateProductShippingClassResponseImpl(
  ...
  factory _$CreateProductShippingClassResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateProductShippingClassResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateProductShippingClassResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductShippingClassResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductShippingClassResponseImplCopyWith<
          _$CreateProductShippingClassResponseImpl>
      get copyWith => __$$CreateProductShippingClassResponseImplCopyWithImpl<
          _$CreateProductShippingClassResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductShippingClassResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductShippingClassResponse
    implements CreateProductShippingClassResponse {
  const factory _CreateProductShippingClassResponse(
  ...
  factory _CreateProductShippingClassResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateProductShippingClassResponseImpl.fromJson;
