...
part of 'update_product_shipping_class_response.dart';
...
UpdateProductShippingClassResponse _$UpdateProductShippingClassResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductShippingClassResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductShippingClassResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateProductShippingClassResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductShippingClassResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductShippingClassResponseCopyWith<
          UpdateProductShippingClassResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductShippingClassResponseCopyWith<$Res> {
  factory $UpdateProductShippingClassResponseCopyWith(
          UpdateProductShippingClassResponse value,
          $Res Function(UpdateProductShippingClassResponse) then) =
      _$UpdateProductShippingClassResponseCopyWithImpl<$Res,
          UpdateProductShippingClassResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateProductShippingClassResponseCopyWithImpl<$Res,
        $Val extends UpdateProductShippingClassResponse>
    implements $UpdateProductShippingClassResponseCopyWith<$Res> {
  _$UpdateProductShippingClassResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductShippingClassResponseImplCopyWith<$Res>
    implements $UpdateProductShippingClassResponseCopyWith<$Res> {
  factory _$$UpdateProductShippingClassResponseImplCopyWith(
          _$UpdateProductShippingClassResponseImpl value,
          $Res Function(_$UpdateProductShippingClassResponseImpl) then) =
      __$$UpdateProductShippingClassResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductShippingClassResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductShippingClassResponseCopyWithImpl<$Res,
        _$UpdateProductShippingClassResponseImpl>
    implements _$$UpdateProductShippingClassResponseImplCopyWith<$Res> {
  __$$UpdateProductShippingClassResponseImplCopyWithImpl(
      _$UpdateProductShippingClassResponseImpl _value,
      $Res Function(_$UpdateProductShippingClassResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductShippingClassResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductShippingClassResponseImpl
    implements _UpdateProductShippingClassResponse {
  const _$UpdateProductShippingClassResponseImpl(
  ...
  factory _$UpdateProductShippingClassResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductShippingClassResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductShippingClassResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductShippingClassResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductShippingClassResponseImplCopyWith<
          _$UpdateProductShippingClassResponseImpl>
      get copyWith => __$$UpdateProductShippingClassResponseImplCopyWithImpl<
          _$UpdateProductShippingClassResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductShippingClassResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductShippingClassResponse
    implements UpdateProductShippingClassResponse {
  const factory _UpdateProductShippingClassResponse(
  ...
  factory _UpdateProductShippingClassResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdateProductShippingClassResponseImpl.fromJson;
