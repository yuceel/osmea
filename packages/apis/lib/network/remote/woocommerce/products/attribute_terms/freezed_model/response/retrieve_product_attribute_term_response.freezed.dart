...
part of 'retrieve_product_attribute_term_response.dart';
...
RetrieveProductAttributeTermResponse
    _$RetrieveProductAttributeTermResponseFromJson(Map<String, dynamic> json) {
  return _RetrieveProductAttributeTermResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductAttributeTermResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveProductAttributeTermResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveProductAttributeTermResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveProductAttributeTermResponseCopyWith<
          RetrieveProductAttributeTermResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductAttributeTermResponseCopyWith<$Res> {
  factory $RetrieveProductAttributeTermResponseCopyWith(
          RetrieveProductAttributeTermResponse value,
          $Res Function(RetrieveProductAttributeTermResponse) then) =
      _$RetrieveProductAttributeTermResponseCopyWithImpl<$Res,
          RetrieveProductAttributeTermResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductAttributeTermResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductAttributeTermResponse>
    implements $RetrieveProductAttributeTermResponseCopyWith<$Res> {
  _$RetrieveProductAttributeTermResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductAttributeTermResponseImplCopyWith<$Res>
    implements $RetrieveProductAttributeTermResponseCopyWith<$Res> {
  factory _$$RetrieveProductAttributeTermResponseImplCopyWith(
          _$RetrieveProductAttributeTermResponseImpl value,
          $Res Function(_$RetrieveProductAttributeTermResponseImpl) then) =
      __$$RetrieveProductAttributeTermResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductAttributeTermResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductAttributeTermResponseCopyWithImpl<$Res,
        _$RetrieveProductAttributeTermResponseImpl>
    implements _$$RetrieveProductAttributeTermResponseImplCopyWith<$Res> {
  __$$RetrieveProductAttributeTermResponseImplCopyWithImpl(
      _$RetrieveProductAttributeTermResponseImpl _value,
      $Res Function(_$RetrieveProductAttributeTermResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductAttributeTermResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductAttributeTermResponseImpl
    implements _RetrieveProductAttributeTermResponse {
  const _$RetrieveProductAttributeTermResponseImpl(
  ...
  factory _$RetrieveProductAttributeTermResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductAttributeTermResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveProductAttributeTermResponse(id: $id, name: $name, slug: $slug, description: $description, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductAttributeTermResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductAttributeTermResponseImplCopyWith<
          _$RetrieveProductAttributeTermResponseImpl>
      get copyWith => __$$RetrieveProductAttributeTermResponseImplCopyWithImpl<
          _$RetrieveProductAttributeTermResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductAttributeTermResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductAttributeTermResponse
    implements RetrieveProductAttributeTermResponse {
  const factory _RetrieveProductAttributeTermResponse(
  ...
  factory _RetrieveProductAttributeTermResponse.fromJson(
          Map<String, dynamic> json) =
      _$RetrieveProductAttributeTermResponseImpl.fromJson;
