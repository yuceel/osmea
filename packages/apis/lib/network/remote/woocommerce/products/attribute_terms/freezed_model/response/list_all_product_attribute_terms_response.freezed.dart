...
part of 'list_all_product_attribute_terms_response.dart';
...
ListAllProductAttributeTermsResponse
    _$ListAllProductAttributeTermsResponseFromJson(Map<String, dynamic> json) {
  return _ListAllProductAttributeTermsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductAttributeTermsResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductAttributeTermsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductAttributeTermsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductAttributeTermsResponseCopyWith<
          ListAllProductAttributeTermsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductAttributeTermsResponseCopyWith<$Res> {
  factory $ListAllProductAttributeTermsResponseCopyWith(
          ListAllProductAttributeTermsResponse value,
          $Res Function(ListAllProductAttributeTermsResponse) then) =
      _$ListAllProductAttributeTermsResponseCopyWithImpl<$Res,
          ListAllProductAttributeTermsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductAttributeTermsResponseCopyWithImpl<$Res,
        $Val extends ListAllProductAttributeTermsResponse>
    implements $ListAllProductAttributeTermsResponseCopyWith<$Res> {
  _$ListAllProductAttributeTermsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductAttributeTermsResponseImplCopyWith<$Res>
    implements $ListAllProductAttributeTermsResponseCopyWith<$Res> {
  factory _$$ListAllProductAttributeTermsResponseImplCopyWith(
          _$ListAllProductAttributeTermsResponseImpl value,
          $Res Function(_$ListAllProductAttributeTermsResponseImpl) then) =
      __$$ListAllProductAttributeTermsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductAttributeTermsResponseImplCopyWithImpl<$Res>
    extends _$ListAllProductAttributeTermsResponseCopyWithImpl<$Res,
        _$ListAllProductAttributeTermsResponseImpl>
    implements _$$ListAllProductAttributeTermsResponseImplCopyWith<$Res> {
  __$$ListAllProductAttributeTermsResponseImplCopyWithImpl(
      _$ListAllProductAttributeTermsResponseImpl _value,
      $Res Function(_$ListAllProductAttributeTermsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductAttributeTermsResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductAttributeTermsResponseImpl
    implements _ListAllProductAttributeTermsResponse {
  const _$ListAllProductAttributeTermsResponseImpl(
  ...
  factory _$ListAllProductAttributeTermsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllProductAttributeTermsResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllProductAttributeTermsResponse(id: $id, name: $name, slug: $slug, description: $description, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductAttributeTermsResponseImpl &&
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, slug, description, menuOrder, count, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductAttributeTermsResponseImplCopyWith<
          _$ListAllProductAttributeTermsResponseImpl>
      get copyWith => __$$ListAllProductAttributeTermsResponseImplCopyWithImpl<
          _$ListAllProductAttributeTermsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductAttributeTermsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductAttributeTermsResponse
    implements ListAllProductAttributeTermsResponse {
  const factory _ListAllProductAttributeTermsResponse(
  ...
  factory _ListAllProductAttributeTermsResponse.fromJson(
          Map<String, dynamic> json) =
      _$ListAllProductAttributeTermsResponseImpl.fromJson;
