...
part of 'update_product_attribute_term_response.dart';
...
UpdateProductAttributeTermResponse _$UpdateProductAttributeTermResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductAttributeTermResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductAttributeTermResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateProductAttributeTermResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductAttributeTermResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductAttributeTermResponseCopyWith<
          UpdateProductAttributeTermResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductAttributeTermResponseCopyWith<$Res> {
  factory $UpdateProductAttributeTermResponseCopyWith(
          UpdateProductAttributeTermResponse value,
          $Res Function(UpdateProductAttributeTermResponse) then) =
      _$UpdateProductAttributeTermResponseCopyWithImpl<$Res,
          UpdateProductAttributeTermResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateProductAttributeTermResponseCopyWithImpl<$Res,
        $Val extends UpdateProductAttributeTermResponse>
    implements $UpdateProductAttributeTermResponseCopyWith<$Res> {
  _$UpdateProductAttributeTermResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductAttributeTermResponseImplCopyWith<$Res>
    implements $UpdateProductAttributeTermResponseCopyWith<$Res> {
  factory _$$UpdateProductAttributeTermResponseImplCopyWith(
          _$UpdateProductAttributeTermResponseImpl value,
          $Res Function(_$UpdateProductAttributeTermResponseImpl) then) =
      __$$UpdateProductAttributeTermResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductAttributeTermResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductAttributeTermResponseCopyWithImpl<$Res,
        _$UpdateProductAttributeTermResponseImpl>
    implements _$$UpdateProductAttributeTermResponseImplCopyWith<$Res> {
  __$$UpdateProductAttributeTermResponseImplCopyWithImpl(
      _$UpdateProductAttributeTermResponseImpl _value,
      $Res Function(_$UpdateProductAttributeTermResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductAttributeTermResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductAttributeTermResponseImpl
    implements _UpdateProductAttributeTermResponse {
  const _$UpdateProductAttributeTermResponseImpl(
  ...
  factory _$UpdateProductAttributeTermResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductAttributeTermResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductAttributeTermResponse(id: $id, name: $name, slug: $slug, description: $description, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductAttributeTermResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductAttributeTermResponseImplCopyWith<
          _$UpdateProductAttributeTermResponseImpl>
      get copyWith => __$$UpdateProductAttributeTermResponseImplCopyWithImpl<
          _$UpdateProductAttributeTermResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductAttributeTermResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductAttributeTermResponse
    implements UpdateProductAttributeTermResponse {
  const factory _UpdateProductAttributeTermResponse(
  ...
  factory _UpdateProductAttributeTermResponse.fromJson(
          Map<String, dynamic> json) =
      _$UpdateProductAttributeTermResponseImpl.fromJson;
