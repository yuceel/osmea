...
part of 'create_product_attribute_term_response.dart';
...
CreateProductAttributeTermResponse _$CreateProductAttributeTermResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateProductAttributeTermResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductAttributeTermResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductAttributeTermResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductAttributeTermResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductAttributeTermResponseCopyWith<
          CreateProductAttributeTermResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductAttributeTermResponseCopyWith<$Res> {
  factory $CreateProductAttributeTermResponseCopyWith(
          CreateProductAttributeTermResponse value,
          $Res Function(CreateProductAttributeTermResponse) then) =
      _$CreateProductAttributeTermResponseCopyWithImpl<$Res,
          CreateProductAttributeTermResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateProductAttributeTermResponseCopyWithImpl<$Res,
        $Val extends CreateProductAttributeTermResponse>
    implements $CreateProductAttributeTermResponseCopyWith<$Res> {
  _$CreateProductAttributeTermResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductAttributeTermResponseImplCopyWith<$Res>
    implements $CreateProductAttributeTermResponseCopyWith<$Res> {
  factory _$$CreateProductAttributeTermResponseImplCopyWith(
          _$CreateProductAttributeTermResponseImpl value,
          $Res Function(_$CreateProductAttributeTermResponseImpl) then) =
      __$$CreateProductAttributeTermResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductAttributeTermResponseImplCopyWithImpl<$Res>
    extends _$CreateProductAttributeTermResponseCopyWithImpl<$Res,
        _$CreateProductAttributeTermResponseImpl>
    implements _$$CreateProductAttributeTermResponseImplCopyWith<$Res> {
  __$$CreateProductAttributeTermResponseImplCopyWithImpl(
      _$CreateProductAttributeTermResponseImpl _value,
      $Res Function(_$CreateProductAttributeTermResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductAttributeTermResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductAttributeTermResponseImpl
    implements _CreateProductAttributeTermResponse {
  const _$CreateProductAttributeTermResponseImpl(
  ...
  factory _$CreateProductAttributeTermResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateProductAttributeTermResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateProductAttributeTermResponse(id: $id, name: $name, slug: $slug, description: $description, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductAttributeTermResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductAttributeTermResponseImplCopyWith<
          _$CreateProductAttributeTermResponseImpl>
      get copyWith => __$$CreateProductAttributeTermResponseImplCopyWithImpl<
          _$CreateProductAttributeTermResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductAttributeTermResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductAttributeTermResponse
    implements CreateProductAttributeTermResponse {
  const factory _CreateProductAttributeTermResponse(
  ...
  factory _CreateProductAttributeTermResponse.fromJson(
          Map<String, dynamic> json) =
      _$CreateProductAttributeTermResponseImpl.fromJson;
