...
CreateProductTagResponse _$CreateProductTagResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateProductTagResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductTagResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductTagResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductTagResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductTagResponseCopyWith<CreateProductTagResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductTagResponseCopyWith<$Res> {
  factory $CreateProductTagResponseCopyWith(CreateProductTagResponse value,
          $Res Function(CreateProductTagResponse) then) =
      _$CreateProductTagResponseCopyWithImpl<$Res, CreateProductTagResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateProductTagResponseCopyWithImpl<$Res,
        $Val extends CreateProductTagResponse>
    implements $CreateProductTagResponseCopyWith<$Res> {
  _$CreateProductTagResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductTagResponseImplCopyWith<$Res>
    implements $CreateProductTagResponseCopyWith<$Res> {
  factory _$$CreateProductTagResponseImplCopyWith(
          _$CreateProductTagResponseImpl value,
          $Res Function(_$CreateProductTagResponseImpl) then) =
      __$$CreateProductTagResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductTagResponseImplCopyWithImpl<$Res>
    extends _$CreateProductTagResponseCopyWithImpl<$Res,
        _$CreateProductTagResponseImpl>
    implements _$$CreateProductTagResponseImplCopyWith<$Res> {
  __$$CreateProductTagResponseImplCopyWithImpl(
      _$CreateProductTagResponseImpl _value,
      $Res Function(_$CreateProductTagResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductTagResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductTagResponseImpl implements _CreateProductTagResponse {
  const _$CreateProductTagResponseImpl(
  ...
  factory _$CreateProductTagResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateProductTagResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateProductTagResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductTagResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductTagResponseImplCopyWith<_$CreateProductTagResponseImpl>
      get copyWith => __$$CreateProductTagResponseImplCopyWithImpl<
          _$CreateProductTagResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductTagResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductTagResponse implements CreateProductTagResponse {
  const factory _CreateProductTagResponse(
  ...
  factory _CreateProductTagResponse.fromJson(Map<String, dynamic> json) =
      _$CreateProductTagResponseImpl.fromJson;
