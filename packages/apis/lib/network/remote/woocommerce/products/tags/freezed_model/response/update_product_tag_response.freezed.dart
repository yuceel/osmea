...
part of 'update_product_tag_response.dart';
...
UpdateProductTagResponse _$UpdateProductTagResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductTagResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductTagResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateProductTagResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductTagResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductTagResponseCopyWith<UpdateProductTagResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductTagResponseCopyWith<$Res> {
  factory $UpdateProductTagResponseCopyWith(UpdateProductTagResponse value,
          $Res Function(UpdateProductTagResponse) then) =
      _$UpdateProductTagResponseCopyWithImpl<$Res, UpdateProductTagResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateProductTagResponseCopyWithImpl<$Res,
        $Val extends UpdateProductTagResponse>
    implements $UpdateProductTagResponseCopyWith<$Res> {
  _$UpdateProductTagResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductTagResponseImplCopyWith<$Res>
    implements $UpdateProductTagResponseCopyWith<$Res> {
  factory _$$UpdateProductTagResponseImplCopyWith(
          _$UpdateProductTagResponseImpl value,
          $Res Function(_$UpdateProductTagResponseImpl) then) =
      __$$UpdateProductTagResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductTagResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductTagResponseCopyWithImpl<$Res,
        _$UpdateProductTagResponseImpl>
    implements _$$UpdateProductTagResponseImplCopyWith<$Res> {
  __$$UpdateProductTagResponseImplCopyWithImpl(
      _$UpdateProductTagResponseImpl _value,
      $Res Function(_$UpdateProductTagResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductTagResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductTagResponseImpl implements _UpdateProductTagResponse {
  const _$UpdateProductTagResponseImpl(
  ...
  factory _$UpdateProductTagResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateProductTagResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductTagResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductTagResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductTagResponseImplCopyWith<_$UpdateProductTagResponseImpl>
      get copyWith => __$$UpdateProductTagResponseImplCopyWithImpl<
          _$UpdateProductTagResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductTagResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductTagResponse implements UpdateProductTagResponse {
  const factory _UpdateProductTagResponse(
  ...
  factory _UpdateProductTagResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductTagResponseImpl.fromJson;
