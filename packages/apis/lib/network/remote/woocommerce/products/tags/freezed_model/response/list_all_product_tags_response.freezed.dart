...
part of 'list_all_product_tags_response.dart';
...
ListAllProductTagsResponse _$ListAllProductTagsResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllProductTagsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductTagsResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductTagsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductTagsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductTagsResponseCopyWith<ListAllProductTagsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductTagsResponseCopyWith<$Res> {
  factory $ListAllProductTagsResponseCopyWith(ListAllProductTagsResponse value,
          $Res Function(ListAllProductTagsResponse) then) =
      _$ListAllProductTagsResponseCopyWithImpl<$Res,
          ListAllProductTagsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductTagsResponseCopyWithImpl<$Res,
        $Val extends ListAllProductTagsResponse>
    implements $ListAllProductTagsResponseCopyWith<$Res> {
  _$ListAllProductTagsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductTagsResponseImplCopyWith<$Res>
    implements $ListAllProductTagsResponseCopyWith<$Res> {
  factory _$$ListAllProductTagsResponseImplCopyWith(
          _$ListAllProductTagsResponseImpl value,
          $Res Function(_$ListAllProductTagsResponseImpl) then) =
      __$$ListAllProductTagsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductTagsResponseImplCopyWithImpl<$Res>
    extends _$ListAllProductTagsResponseCopyWithImpl<$Res,
        _$ListAllProductTagsResponseImpl>
    implements _$$ListAllProductTagsResponseImplCopyWith<$Res> {
  __$$ListAllProductTagsResponseImplCopyWithImpl(
      _$ListAllProductTagsResponseImpl _value,
      $Res Function(_$ListAllProductTagsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductTagsResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductTagsResponseImpl implements _ListAllProductTagsResponse {
  const _$ListAllProductTagsResponseImpl(
  ...
  factory _$ListAllProductTagsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllProductTagsResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllProductTagsResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductTagsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductTagsResponseImplCopyWith<_$ListAllProductTagsResponseImpl>
      get copyWith => __$$ListAllProductTagsResponseImplCopyWithImpl<
          _$ListAllProductTagsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductTagsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductTagsResponse
    implements ListAllProductTagsResponse {
  const factory _ListAllProductTagsResponse(
  ...
  factory _ListAllProductTagsResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllProductTagsResponseImpl.fromJson;
