...
BatchUpdateProductTagsResponse _$BatchUpdateProductTagsResponseFromJson(
    Map<String, dynamic> json) {
  return _BatchUpdateProductTagsResponse.fromJson(json);
}

/// @nodoc
mixin _$BatchUpdateProductTagsResponse {
  @JsonKey(name: "create")
  ...
  /// Serializes this BatchUpdateProductTagsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BatchUpdateProductTagsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BatchUpdateProductTagsResponseCopyWith<BatchUpdateProductTagsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BatchUpdateProductTagsResponseCopyWith<$Res> {
  factory $BatchUpdateProductTagsResponseCopyWith(
          BatchUpdateProductTagsResponse value,
          $Res Function(BatchUpdateProductTagsResponse) then) =
      _$BatchUpdateProductTagsResponseCopyWithImpl<$Res,
          BatchUpdateProductTagsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$BatchUpdateProductTagsResponseCopyWithImpl<$Res,
        $Val extends BatchUpdateProductTagsResponse>
    implements $BatchUpdateProductTagsResponseCopyWith<$Res> {
  _$BatchUpdateProductTagsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BatchUpdateProductTagsResponseImplCopyWith<$Res>
    implements $BatchUpdateProductTagsResponseCopyWith<$Res> {
  factory _$$BatchUpdateProductTagsResponseImplCopyWith(
          _$BatchUpdateProductTagsResponseImpl value,
          $Res Function(_$BatchUpdateProductTagsResponseImpl) then) =
      __$$BatchUpdateProductTagsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "create") List<Create>? create,
...
/// @nodoc
class __$$BatchUpdateProductTagsResponseImplCopyWithImpl<$Res>
    extends _$BatchUpdateProductTagsResponseCopyWithImpl<$Res,
        _$BatchUpdateProductTagsResponseImpl>
    implements _$$BatchUpdateProductTagsResponseImplCopyWith<$Res> {
  __$$BatchUpdateProductTagsResponseImplCopyWithImpl(
      _$BatchUpdateProductTagsResponseImpl _value,
      $Res Function(_$BatchUpdateProductTagsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BatchUpdateProductTagsResponseImpl(
      create: freezed == create
          ? _value._create
          : create // ignore: cast_nullable_to_non_nullable
              as List<Create>?,
...
/// @nodoc
@JsonSerializable()
class _$BatchUpdateProductTagsResponseImpl
    implements _BatchUpdateProductTagsResponse {
  const _$BatchUpdateProductTagsResponseImpl(
  ...
  factory _$BatchUpdateProductTagsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$BatchUpdateProductTagsResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BatchUpdateProductTagsResponse(create: $create, update: $update, delete: $delete)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BatchUpdateProductTagsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BatchUpdateProductTagsResponseImplCopyWith<
          _$BatchUpdateProductTagsResponseImpl>
      get copyWith => __$$BatchUpdateProductTagsResponseImplCopyWithImpl<
          _$BatchUpdateProductTagsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BatchUpdateProductTagsResponseImplToJson(
      this,
    );
  }
}

abstract class _BatchUpdateProductTagsResponse
    implements BatchUpdateProductTagsResponse {
  const factory _BatchUpdateProductTagsResponse(
          {@JsonKey(name: "create") final List<Create>? create,
          @JsonKey(name: "update") final List<Delete>? update,
          @JsonKey(name: "delete") final List<Delete>? delete}) =
      _$BatchUpdateProductTagsResponseImpl;

  factory _BatchUpdateProductTagsResponse.fromJson(Map<String, dynamic> json) =
      _$BatchUpdateProductTagsResponseImpl.fromJson;
...
class _$CreateImpl implements _Create {
  ...
  @override
  String toString() {
    return 'Create(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
