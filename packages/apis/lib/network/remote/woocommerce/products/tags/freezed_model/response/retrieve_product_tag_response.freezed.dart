...
part of 'retrieve_product_tag_response.dart';
...
RetrieveProductTagResponse _$RetrieveProductTagResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveProductTagResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductTagResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveProductTagResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveProductTagResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveProductTagResponseCopyWith<RetrieveProductTagResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductTagResponseCopyWith<$Res> {
  factory $RetrieveProductTagResponseCopyWith(RetrieveProductTagResponse value,
          $Res Function(RetrieveProductTagResponse) then) =
      _$RetrieveProductTagResponseCopyWithImpl<$Res,
          RetrieveProductTagResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductTagResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductTagResponse>
    implements $RetrieveProductTagResponseCopyWith<$Res> {
  _$RetrieveProductTagResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductTagResponseImplCopyWith<$Res>
    implements $RetrieveProductTagResponseCopyWith<$Res> {
  factory _$$RetrieveProductTagResponseImplCopyWith(
          _$RetrieveProductTagResponseImpl value,
          $Res Function(_$RetrieveProductTagResponseImpl) then) =
      __$$RetrieveProductTagResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductTagResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductTagResponseCopyWithImpl<$Res,
        _$RetrieveProductTagResponseImpl>
    implements _$$RetrieveProductTagResponseImplCopyWith<$Res> {
  __$$RetrieveProductTagResponseImplCopyWithImpl(
      _$RetrieveProductTagResponseImpl _value,
      $Res Function(_$RetrieveProductTagResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductTagResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductTagResponseImpl implements _RetrieveProductTagResponse {
  const _$RetrieveProductTagResponseImpl(
  ...
  factory _$RetrieveProductTagResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductTagResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveProductTagResponse(id: $id, name: $name, slug: $slug, description: $description, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductTagResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductTagResponseImplCopyWith<_$RetrieveProductTagResponseImpl>
      get copyWith => __$$RetrieveProductTagResponseImplCopyWithImpl<
          _$RetrieveProductTagResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductTagResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductTagResponse
    implements RetrieveProductTagResponse {
  const factory _RetrieveProductTagResponse(
  ...
  factory _RetrieveProductTagResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveProductTagResponseImpl.fromJson;
