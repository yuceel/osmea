...
_$CreateProductAttributeResponseImpl
    _$$CreateProductAttributeResponseImplFromJson(Map<String, dynamic> json) =>
        _$CreateProductAttributeResponseImpl(
...
Map<String, dynamic> _$$CreateProductAttributeResponseImplToJson(
        _$CreateProductAttributeResponseImpl instance) =>
    <String, dynamic>{
