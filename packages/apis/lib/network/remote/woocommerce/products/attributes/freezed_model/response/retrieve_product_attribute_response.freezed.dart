...
part of 'retrieve_product_attribute_response.dart';
...
RetrieveProductAttributeResponse _$RetrieveProductAttributeResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveProductAttributeResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductAttributeResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveProductAttributeResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveProductAttributeResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveProductAttributeResponseCopyWith<RetrieveProductAttributeResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductAttributeResponseCopyWith<$Res> {
  factory $RetrieveProductAttributeResponseCopyWith(
          RetrieveProductAttributeResponse value,
          $Res Function(RetrieveProductAttributeResponse) then) =
      _$RetrieveProductAttributeResponseCopyWithImpl<$Res,
          RetrieveProductAttributeResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductAttributeResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductAttributeResponse>
    implements $RetrieveProductAttributeResponseCopyWith<$Res> {
  _$RetrieveProductAttributeResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductAttributeResponseImplCopyWith<$Res>
    implements $RetrieveProductAttributeResponseCopyWith<$Res> {
  factory _$$RetrieveProductAttributeResponseImplCopyWith(
          _$RetrieveProductAttributeResponseImpl value,
          $Res Function(_$RetrieveProductAttributeResponseImpl) then) =
      __$$RetrieveProductAttributeResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductAttributeResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductAttributeResponseCopyWithImpl<$Res,
        _$RetrieveProductAttributeResponseImpl>
    implements _$$RetrieveProductAttributeResponseImplCopyWith<$Res> {
  __$$RetrieveProductAttributeResponseImplCopyWithImpl(
      _$RetrieveProductAttributeResponseImpl _value,
      $Res Function(_$RetrieveProductAttributeResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductAttributeResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductAttributeResponseImpl
    implements _RetrieveProductAttributeResponse {
  const _$RetrieveProductAttributeResponseImpl(
  ...
  factory _$RetrieveProductAttributeResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductAttributeResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveProductAttributeResponse(id: $id, name: $name, slug: $slug, type: $type, orderBy: $orderBy, hasArchives: $hasArchives, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductAttributeResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductAttributeResponseImplCopyWith<
          _$RetrieveProductAttributeResponseImpl>
      get copyWith => __$$RetrieveProductAttributeResponseImplCopyWithImpl<
          _$RetrieveProductAttributeResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductAttributeResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductAttributeResponse
    implements RetrieveProductAttributeResponse {
  const factory _RetrieveProductAttributeResponse(
  ...
  factory _RetrieveProductAttributeResponse.fromJson(
          Map<String, dynamic> json) =
      _$RetrieveProductAttributeResponseImpl.fromJson;
