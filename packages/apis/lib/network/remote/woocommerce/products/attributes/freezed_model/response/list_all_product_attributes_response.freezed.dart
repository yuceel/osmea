...
part of 'list_all_product_attributes_response.dart';
...
ListAllProductAttributesResponse _$ListAllProductAttributesResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllProductAttributesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductAttributesResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductAttributesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductAttributesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductAttributesResponseCopyWith<ListAllProductAttributesResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductAttributesResponseCopyWith<$Res> {
  factory $ListAllProductAttributesResponseCopyWith(
          ListAllProductAttributesResponse value,
          $Res Function(ListAllProductAttributesResponse) then) =
      _$ListAllProductAttributesResponseCopyWithImpl<$Res,
          ListAllProductAttributesResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductAttributesResponseCopyWithImpl<$Res,
        $Val extends ListAllProductAttributesResponse>
    implements $ListAllProductAttributesResponseCopyWith<$Res> {
  _$ListAllProductAttributesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductAttributesResponseImplCopyWith<$Res>
    implements $ListAllProductAttributesResponseCopyWith<$Res> {
  factory _$$ListAllProductAttributesResponseImplCopyWith(
          _$ListAllProductAttributesResponseImpl value,
          $Res Function(_$ListAllProductAttributesResponseImpl) then) =
      __$$ListAllProductAttributesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductAttributesResponseImplCopyWithImpl<$Res>
    extends _$ListAllProductAttributesResponseCopyWithImpl<$Res,
        _$ListAllProductAttributesResponseImpl>
    implements _$$ListAllProductAttributesResponseImplCopyWith<$Res> {
  __$$ListAllProductAttributesResponseImplCopyWithImpl(
      _$ListAllProductAttributesResponseImpl _value,
      $Res Function(_$ListAllProductAttributesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductAttributesResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductAttributesResponseImpl
    implements _ListAllProductAttributesResponse {
  const _$ListAllProductAttributesResponseImpl(
  ...
  factory _$ListAllProductAttributesResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllProductAttributesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllProductAttributesResponse(id: $id, name: $name, slug: $slug, type: $type, orderBy: $orderBy, hasArchives: $hasArchives, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductAttributesResponseImpl &&
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, slug, type, orderBy, hasArchives, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductAttributesResponseImplCopyWith<
          _$ListAllProductAttributesResponseImpl>
      get copyWith => __$$ListAllProductAttributesResponseImplCopyWithImpl<
          _$ListAllProductAttributesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductAttributesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductAttributesResponse
    implements ListAllProductAttributesResponse {
  const factory _ListAllProductAttributesResponse(
  ...
  factory _ListAllProductAttributesResponse.fromJson(
          Map<String, dynamic> json) =
      _$ListAllProductAttributesResponseImpl.fromJson;
