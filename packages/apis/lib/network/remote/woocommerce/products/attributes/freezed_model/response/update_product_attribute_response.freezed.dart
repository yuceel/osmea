...
part of 'update_product_attribute_response.dart';
...
UpdateProductAttributeResponse _$UpdateProductAttributeResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductAttributeResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductAttributeResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateProductAttributeResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductAttributeResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductAttributeResponseCopyWith<UpdateProductAttributeResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductAttributeResponseCopyWith<$Res> {
  factory $UpdateProductAttributeResponseCopyWith(
          UpdateProductAttributeResponse value,
          $Res Function(UpdateProductAttributeResponse) then) =
      _$UpdateProductAttributeResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$UpdateProductAttributeResponseCopyWithImpl<$Res,
        $Val extends UpdateProductAttributeResponse>
    implements $UpdateProductAttributeResponseCopyWith<$Res> {
  _$UpdateProductAttributeResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductAttributeResponseImplCopyWith<$Res>
    implements $UpdateProductAttributeResponseCopyWith<$Res> {
  factory _$$UpdateProductAttributeResponseImplCopyWith(
          _$UpdateProductAttributeResponseImpl value,
          $Res Function(_$UpdateProductAttributeResponseImpl) then) =
      __$$UpdateProductAttributeResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductAttributeResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductAttributeResponseCopyWithImpl<$Res,
        _$UpdateProductAttributeResponseImpl>
    implements _$$UpdateProductAttributeResponseImplCopyWith<$Res> {
  __$$UpdateProductAttributeResponseImplCopyWithImpl(
      _$UpdateProductAttributeResponseImpl _value,
      $Res Function(_$UpdateProductAttributeResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductAttributeResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductAttributeResponseImpl
    implements _UpdateProductAttributeResponse {
  const _$UpdateProductAttributeResponseImpl(
  ...
  factory _$UpdateProductAttributeResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductAttributeResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductAttributeResponse(id: $id, name: $name, slug: $slug, type: $type, orderBy: $orderBy, hasArchives: $hasArchives, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductAttributeResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductAttributeResponseImplCopyWith<
          _$UpdateProductAttributeResponseImpl>
      get copyWith => __$$UpdateProductAttributeResponseImplCopyWithImpl<
          _$UpdateProductAttributeResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductAttributeResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductAttributeResponse
    implements UpdateProductAttributeResponse {
  const factory _UpdateProductAttributeResponse(
  ...
  factory _UpdateProductAttributeResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductAttributeResponseImpl.fromJson;
