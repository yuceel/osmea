...
part of 'create_product_attribute_response.dart';
...
CreateProductAttributeResponse _$CreateProductAttributeResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateProductAttributeResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductAttributeResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductAttributeResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductAttributeResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductAttributeResponseCopyWith<CreateProductAttributeResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductAttributeResponseCopyWith<$Res> {
  factory $CreateProductAttributeResponseCopyWith(
          CreateProductAttributeResponse value,
          $Res Function(CreateProductAttributeResponse) then) =
      _$CreateProductAttributeResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateProductAttributeResponseCopyWithImpl<$Res,
        $Val extends CreateProductAttributeResponse>
    implements $CreateProductAttributeResponseCopyWith<$Res> {
  _$CreateProductAttributeResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductAttributeResponseImplCopyWith<$Res>
    implements $CreateProductAttributeResponseCopyWith<$Res> {
  factory _$$CreateProductAttributeResponseImplCopyWith(
          _$CreateProductAttributeResponseImpl value,
          $Res Function(_$CreateProductAttributeResponseImpl) then) =
      __$$CreateProductAttributeResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductAttributeResponseImplCopyWithImpl<$Res>
    extends _$CreateProductAttributeResponseCopyWithImpl<$Res,
        _$CreateProductAttributeResponseImpl>
    implements _$$CreateProductAttributeResponseImplCopyWith<$Res> {
  __$$CreateProductAttributeResponseImplCopyWithImpl(
      _$CreateProductAttributeResponseImpl _value,
      $Res Function(_$CreateProductAttributeResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductAttributeResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductAttributeResponseImpl
    implements _CreateProductAttributeResponse {
  const _$CreateProductAttributeResponseImpl(
  ...
  factory _$CreateProductAttributeResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateProductAttributeResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateProductAttributeResponse(id: $id, name: $name, slug: $slug, type: $type, orderBy: $orderBy, hasArchives: $hasArchives, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductAttributeResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductAttributeResponseImplCopyWith<
          _$CreateProductAttributeResponseImpl>
      get copyWith => __$$CreateProductAttributeResponseImplCopyWithImpl<
          _$CreateProductAttributeResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductAttributeResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductAttributeResponse
    implements CreateProductAttributeResponse {
  const factory _CreateProductAttributeResponse(
  ...
  factory _CreateProductAttributeResponse.fromJson(Map<String, dynamic> json) =
      _$CreateProductAttributeResponseImpl.fromJson;
