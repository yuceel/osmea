...
CreateProductReviewResponse _$CreateProductReviewResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateProductReviewResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductReviewResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductReviewResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductReviewResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductReviewResponseCopyWith<CreateProductReviewResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductReviewResponseCopyWith<$Res> {
  factory $CreateProductReviewResponseCopyWith(
          CreateProductReviewResponse value,
          $Res Function(CreateProductReviewResponse) then) =
      _$CreateProductReviewResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateProductReviewResponseCopyWithImpl<$Res,
        $Val extends CreateProductReviewResponse>
    implements $CreateProductReviewResponseCopyWith<$Res> {
  _$CreateProductReviewResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductReviewResponseImplCopyWith<$Res>
    implements $CreateProductReviewResponseCopyWith<$Res> {
  factory _$$CreateProductReviewResponseImplCopyWith(
          _$CreateProductReviewResponseImpl value,
          $Res Function(_$CreateProductReviewResponseImpl) then) =
      __$$CreateProductReviewResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductReviewResponseImplCopyWithImpl<$Res>
    extends _$CreateProductReviewResponseCopyWithImpl<$Res,
        _$CreateProductReviewResponseImpl>
    implements _$$CreateProductReviewResponseImplCopyWith<$Res> {
  __$$CreateProductReviewResponseImplCopyWithImpl(
      _$CreateProductReviewResponseImpl _value,
      $Res Function(_$CreateProductReviewResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductReviewResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductReviewResponseImpl
    implements _CreateProductReviewResponse {
  const _$CreateProductReviewResponseImpl(
  ...
  factory _$CreateProductReviewResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateProductReviewResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductReviewResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductReviewResponseImplCopyWith<_$CreateProductReviewResponseImpl>
      get copyWith => __$$CreateProductReviewResponseImplCopyWithImpl<
          _$CreateProductReviewResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductReviewResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductReviewResponse
    implements CreateProductReviewResponse {
  const factory _CreateProductReviewResponse(
  ...
  factory _CreateProductReviewResponse.fromJson(Map<String, dynamic> json) =
      _$CreateProductReviewResponseImpl.fromJson;
