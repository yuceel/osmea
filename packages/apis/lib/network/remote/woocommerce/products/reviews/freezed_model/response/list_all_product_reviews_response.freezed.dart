...
part of 'list_all_product_reviews_response.dart';
...
ListProductReviewsResponse _$ListProductReviewsResponseFromJson(
    Map<String, dynamic> json) {
  return _ListProductReviewsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListProductReviewsResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListProductReviewsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListProductReviewsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListProductReviewsResponseCopyWith<ListProductReviewsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListProductReviewsResponseCopyWith<$Res> {
  factory $ListProductReviewsResponseCopyWith(ListProductReviewsResponse value,
          $Res Function(ListProductReviewsResponse) then) =
      _$ListProductReviewsResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$ListProductReviewsResponseCopyWithImpl<$Res,
        $Val extends ListProductReviewsResponse>
    implements $ListProductReviewsResponseCopyWith<$Res> {
  _$ListProductReviewsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListProductReviewsResponseImplCopyWith<$Res>
    implements $ListProductReviewsResponseCopyWith<$Res> {
  factory _$$ListProductReviewsResponseImplCopyWith(
          _$ListProductReviewsResponseImpl value,
          $Res Function(_$ListProductReviewsResponseImpl) then) =
      __$$ListProductReviewsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListProductReviewsResponseImplCopyWithImpl<$Res>
    extends _$ListProductReviewsResponseCopyWithImpl<$Res,
        _$ListProductReviewsResponseImpl>
    implements _$$ListProductReviewsResponseImplCopyWith<$Res> {
  __$$ListProductReviewsResponseImplCopyWithImpl(
      _$ListProductReviewsResponseImpl _value,
      $Res Function(_$ListProductReviewsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListProductReviewsResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListProductReviewsResponseImpl implements _ListProductReviewsResponse {
  const _$ListProductReviewsResponseImpl(
  ...
  factory _$ListProductReviewsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListProductReviewsResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListProductReviewsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListProductReviewsResponseImplCopyWith<_$ListProductReviewsResponseImpl>
      get copyWith => __$$ListProductReviewsResponseImplCopyWithImpl<
          _$ListProductReviewsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListProductReviewsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListProductReviewsResponse
    implements ListProductReviewsResponse {
  const factory _ListProductReviewsResponse(
  ...
  factory _ListProductReviewsResponse.fromJson(Map<String, dynamic> json) =
      _$ListProductReviewsResponseImpl.fromJson;
