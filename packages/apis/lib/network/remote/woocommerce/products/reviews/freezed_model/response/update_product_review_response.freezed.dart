...
part of 'update_product_review_response.dart';
...
UpdateProductReviewResponse _$UpdateProductReviewResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductReviewResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductReviewResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateProductReviewResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductReviewResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductReviewResponseCopyWith<UpdateProductReviewResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductReviewResponseCopyWith<$Res> {
  factory $UpdateProductReviewResponseCopyWith(
          UpdateProductReviewResponse value,
          $Res Function(UpdateProductReviewResponse) then) =
      _$UpdateProductReviewResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$UpdateProductReviewResponseCopyWithImpl<$Res,
        $Val extends UpdateProductReviewResponse>
    implements $UpdateProductReviewResponseCopyWith<$Res> {
  _$UpdateProductReviewResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductReviewResponseImplCopyWith<$Res>
    implements $UpdateProductReviewResponseCopyWith<$Res> {
  factory _$$UpdateProductReviewResponseImplCopyWith(
          _$UpdateProductReviewResponseImpl value,
          $Res Function(_$UpdateProductReviewResponseImpl) then) =
      __$$UpdateProductReviewResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductReviewResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductReviewResponseCopyWithImpl<$Res,
        _$UpdateProductReviewResponseImpl>
    implements _$$UpdateProductReviewResponseImplCopyWith<$Res> {
  __$$UpdateProductReviewResponseImplCopyWithImpl(
      _$UpdateProductReviewResponseImpl _value,
      $Res Function(_$UpdateProductReviewResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductReviewResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductReviewResponseImpl
    implements _UpdateProductReviewResponse {
  const _$UpdateProductReviewResponseImpl(
  ...
  factory _$UpdateProductReviewResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductReviewResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductReviewResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductReviewResponseImplCopyWith<_$UpdateProductReviewResponseImpl>
      get copyWith => __$$UpdateProductReviewResponseImplCopyWithImpl<
          _$UpdateProductReviewResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductReviewResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductReviewResponse
    implements UpdateProductReviewResponse {
  const factory _UpdateProductReviewResponse(
  ...
  factory _UpdateProductReviewResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductReviewResponseImpl.fromJson;
