...
BatchUpdateProductReviewsResponse _$BatchUpdateProductReviewsResponseFromJson(
    Map<String, dynamic> json) {
  return _BatchUpdateProductReviewsResponse.fromJson(json);
}

/// @nodoc
mixin _$BatchUpdateProductReviewsResponse {
  @JsonKey(name: "create")
  ...
  /// Serializes this BatchUpdateProductReviewsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of BatchUpdateProductReviewsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BatchUpdateProductReviewsResponseCopyWith<BatchUpdateProductReviewsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BatchUpdateProductReviewsResponseCopyWith<$Res> {
  factory $BatchUpdateProductReviewsResponseCopyWith(
          BatchUpdateProductReviewsResponse value,
          $Res Function(BatchUpdateProductReviewsResponse) then) =
      _$BatchUpdateProductReviewsResponseCopyWithImpl<$Res,
          BatchUpdateProductReviewsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$BatchUpdateProductReviewsResponseCopyWithImpl<$Res,
        $Val extends BatchUpdateProductReviewsResponse>
    implements $BatchUpdateProductReviewsResponseCopyWith<$Res> {
  _$BatchUpdateProductReviewsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BatchUpdateProductReviewsResponseImplCopyWith<$Res>
    implements $BatchUpdateProductReviewsResponseCopyWith<$Res> {
  factory _$$BatchUpdateProductReviewsResponseImplCopyWith(
          _$BatchUpdateProductReviewsResponseImpl value,
          $Res Function(_$BatchUpdateProductReviewsResponseImpl) then) =
      __$$BatchUpdateProductReviewsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "create") List<Create>? create,
...
/// @nodoc
class __$$BatchUpdateProductReviewsResponseImplCopyWithImpl<$Res>
    extends _$BatchUpdateProductReviewsResponseCopyWithImpl<$Res,
        _$BatchUpdateProductReviewsResponseImpl>
    implements _$$BatchUpdateProductReviewsResponseImplCopyWith<$Res> {
  __$$BatchUpdateProductReviewsResponseImplCopyWithImpl(
      _$BatchUpdateProductReviewsResponseImpl _value,
      $Res Function(_$BatchUpdateProductReviewsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$BatchUpdateProductReviewsResponseImpl(
      create: freezed == create
          ? _value._create
          : create // ignore: cast_nullable_to_non_nullable
              as List<Create>?,
...
/// @nodoc
@JsonSerializable()
class _$BatchUpdateProductReviewsResponseImpl
    implements _BatchUpdateProductReviewsResponse {
  const _$BatchUpdateProductReviewsResponseImpl(
  ...
  factory _$BatchUpdateProductReviewsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$BatchUpdateProductReviewsResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'BatchUpdateProductReviewsResponse(create: $create, update: $update, delete: $delete)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BatchUpdateProductReviewsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BatchUpdateProductReviewsResponseImplCopyWith<
          _$BatchUpdateProductReviewsResponseImpl>
      get copyWith => __$$BatchUpdateProductReviewsResponseImplCopyWithImpl<
          _$BatchUpdateProductReviewsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BatchUpdateProductReviewsResponseImplToJson(
      this,
    );
  }
}

abstract class _BatchUpdateProductReviewsResponse
    implements BatchUpdateProductReviewsResponse {
  const factory _BatchUpdateProductReviewsResponse(
          {@JsonKey(name: "create") final List<Create>? create,
          @JsonKey(name: "update") final List<Create>? update,
          @JsonKey(name: "delete") final List<Create>? delete}) =
      _$BatchUpdateProductReviewsResponseImpl;

  factory _BatchUpdateProductReviewsResponse.fromJson(
          Map<String, dynamic> json) =
      _$BatchUpdateProductReviewsResponseImpl.fromJson;
