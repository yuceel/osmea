...
part of 'update_product_category_response.dart';
...
UpdateProductCategoryResponse _$UpdateProductCategoryResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductCategoryResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductCategoryResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateProductCategoryResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductCategoryResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateProductCategoryResponseCopyWith<UpdateProductCategoryResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductCategoryResponseCopyWith<$Res> {
  factory $UpdateProductCategoryResponseCopyWith(
          UpdateProductCategoryResponse value,
          $Res Function(UpdateProductCategoryResponse) then) =
      _$UpdateProductCategoryResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$UpdateProductCategoryResponseCopyWithImpl<$Res,
        $Val extends UpdateProductCategoryResponse>
    implements $UpdateProductCategoryResponseCopyWith<$Res> {
  _$UpdateProductCategoryResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductCategoryResponseImplCopyWith<$Res>
    implements $UpdateProductCategoryResponseCopyWith<$Res> {
  factory _$$UpdateProductCategoryResponseImplCopyWith(
          _$UpdateProductCategoryResponseImpl value,
          $Res Function(_$UpdateProductCategoryResponseImpl) then) =
      __$$UpdateProductCategoryResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductCategoryResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductCategoryResponseCopyWithImpl<$Res,
        _$UpdateProductCategoryResponseImpl>
    implements _$$UpdateProductCategoryResponseImplCopyWith<$Res> {
  __$$UpdateProductCategoryResponseImplCopyWithImpl(
      _$UpdateProductCategoryResponseImpl _value,
      $Res Function(_$UpdateProductCategoryResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductCategoryResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductCategoryResponseImpl
    implements _UpdateProductCategoryResponse {
  const _$UpdateProductCategoryResponseImpl(
  ...
  factory _$UpdateProductCategoryResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductCategoryResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateProductCategoryResponse(id: $id, name: $name, slug: $slug, parent: $parent, description: $description, display: $display, image: $image, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductCategoryResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductCategoryResponseImplCopyWith<
          _$UpdateProductCategoryResponseImpl>
      get copyWith => __$$UpdateProductCategoryResponseImplCopyWithImpl<
          _$UpdateProductCategoryResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductCategoryResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductCategoryResponse
    implements UpdateProductCategoryResponse {
  const factory _UpdateProductCategoryResponse(
  ...
  factory _UpdateProductCategoryResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductCategoryResponseImpl.fromJson;
