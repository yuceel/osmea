...
_$DeleteProductCategoryResponseImpl
    _$$DeleteProductCategoryResponseImplFromJson(Map<String, dynamic> json) =>
        _$DeleteProductCategoryResponseImpl(
...
Map<String, dynamic> _$$DeleteProductCategoryResponseImplToJson(
        _$DeleteProductCategoryResponseImpl instance) =>
    <String, dynamic>{
