...
_$RetrieveProductCategoryResponseImpl
    _$$RetrieveProductCategoryResponseImplFromJson(Map<String, dynamic> json) =>
        _$RetrieveProductCategoryResponseImpl(
...
Map<String, dynamic> _$$RetrieveProductCategoryResponseImplToJson(
        _$RetrieveProductCategoryResponseImpl instance) =>
    <String, dynamic>{
