...
part of 'list_all_product_categories_response.dart';
...
ListAllProductCategoriesResponse _$ListAllProductCategoriesResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllProductCategoriesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductCategoriesResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductCategoriesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductCategoriesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductCategoriesResponseCopyWith<ListAllProductCategoriesResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductCategoriesResponseCopyWith<$Res> {
  factory $ListAllProductCategoriesResponseCopyWith(
          ListAllProductCategoriesResponse value,
          $Res Function(ListAllProductCategoriesResponse) then) =
      _$ListAllProductCategoriesResponseCopyWithImpl<$Res,
          ListAllProductCategoriesResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductCategoriesResponseCopyWithImpl<$Res,
        $Val extends ListAllProductCategoriesResponse>
    implements $ListAllProductCategoriesResponseCopyWith<$Res> {
  _$ListAllProductCategoriesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductCategoriesResponseImplCopyWith<$Res>
    implements $ListAllProductCategoriesResponseCopyWith<$Res> {
  factory _$$ListAllProductCategoriesResponseImplCopyWith(
          _$ListAllProductCategoriesResponseImpl value,
          $Res Function(_$ListAllProductCategoriesResponseImpl) then) =
      __$$ListAllProductCategoriesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductCategoriesResponseImplCopyWithImpl<$Res>
    extends _$ListAllProductCategoriesResponseCopyWithImpl<$Res,
        _$ListAllProductCategoriesResponseImpl>
    implements _$$ListAllProductCategoriesResponseImplCopyWith<$Res> {
  __$$ListAllProductCategoriesResponseImplCopyWithImpl(
      _$ListAllProductCategoriesResponseImpl _value,
      $Res Function(_$ListAllProductCategoriesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductCategoriesResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductCategoriesResponseImpl
    implements _ListAllProductCategoriesResponse {
  const _$ListAllProductCategoriesResponseImpl(
  ...
  factory _$ListAllProductCategoriesResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllProductCategoriesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllProductCategoriesResponse(id: $id, name: $name, slug: $slug, parent: $parent, description: $description, display: $display, image: $image, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductCategoriesResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductCategoriesResponseImplCopyWith<
          _$ListAllProductCategoriesResponseImpl>
      get copyWith => __$$ListAllProductCategoriesResponseImplCopyWithImpl<
          _$ListAllProductCategoriesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductCategoriesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductCategoriesResponse
    implements ListAllProductCategoriesResponse {
  const factory _ListAllProductCategoriesResponse(
  ...
  factory _ListAllProductCategoriesResponse.fromJson(
          Map<String, dynamic> json) =
      _$ListAllProductCategoriesResponseImpl.fromJson;
