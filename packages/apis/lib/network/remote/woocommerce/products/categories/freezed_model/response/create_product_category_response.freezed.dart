...
part of 'create_product_category_response.dart';
...
CreateProductCategoryResponse _$CreateProductCategoryResponseFromJson(
  ...
  return _CreateProductCategoryResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductCategoryResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductCategoryResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductCategoryResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductCategoryResponseCopyWith<CreateProductCategoryResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductCategoryResponseCopyWith<$Res> {
  factory $CreateProductCategoryResponseCopyWith(
          CreateProductCategoryResponse value,
          $Res Function(CreateProductCategoryResponse) then) =
      _$CreateProductCategoryResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateProductCategoryResponseCopyWithImpl<$Res,
        $Val extends CreateProductCategoryResponse>
    implements $CreateProductCategoryResponseCopyWith<$Res> {
  _$CreateProductCategoryResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductCategoryResponseImplCopyWith<$Res>
    implements $CreateProductCategoryResponseCopyWith<$Res> {
  factory _$$CreateProductCategoryResponseImplCopyWith(
          _$CreateProductCategoryResponseImpl value,
          $Res Function(_$CreateProductCategoryResponseImpl) then) =
      __$$CreateProductCategoryResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductCategoryResponseImplCopyWithImpl<$Res>
    extends _$CreateProductCategoryResponseCopyWithImpl<$Res,
        _$CreateProductCategoryResponseImpl>
    implements _$$CreateProductCategoryResponseImplCopyWith<$Res> {
  __$$CreateProductCategoryResponseImplCopyWithImpl(
      _$CreateProductCategoryResponseImpl _value,
      $Res Function(_$CreateProductCategoryResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductCategoryResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductCategoryResponseImpl
    implements _CreateProductCategoryResponse {
  const _$CreateProductCategoryResponseImpl(
  ...
  factory _$CreateProductCategoryResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateProductCategoryResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateProductCategoryResponse(id: $id, name: $name, slug: $slug, parent: $parent, description: $description, display: $display, image: $image, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductCategoryResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductCategoryResponseImplCopyWith<
          _$CreateProductCategoryResponseImpl>
      get copyWith => __$$CreateProductCategoryResponseImplCopyWithImpl<
          _$CreateProductCategoryResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductCategoryResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductCategoryResponse
    implements CreateProductCategoryResponse {
  const factory _CreateProductCategoryResponse(
  ...
  factory _CreateProductCategoryResponse.fromJson(Map<String, dynamic> json) =
      _$CreateProductCategoryResponseImpl.fromJson;
