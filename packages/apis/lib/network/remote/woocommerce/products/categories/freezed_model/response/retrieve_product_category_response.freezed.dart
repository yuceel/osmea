...
part of 'retrieve_product_category_response.dart';
...
RetrieveProductCategoryResponse _$RetrieveProductCategoryResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveProductCategoryResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductCategoryResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveProductCategoryResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveProductCategoryResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveProductCategoryResponseCopyWith<RetrieveProductCategoryResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductCategoryResponseCopyWith<$Res> {
  factory $RetrieveProductCategoryResponseCopyWith(
          RetrieveProductCategoryResponse value,
          $Res Function(RetrieveProductCategoryResponse) then) =
      _$RetrieveProductCategoryResponseCopyWithImpl<$Res,
          RetrieveProductCategoryResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductCategoryResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductCategoryResponse>
    implements $RetrieveProductCategoryResponseCopyWith<$Res> {
  _$RetrieveProductCategoryResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductCategoryResponseImplCopyWith<$Res>
    implements $RetrieveProductCategoryResponseCopyWith<$Res> {
  factory _$$RetrieveProductCategoryResponseImplCopyWith(
          _$RetrieveProductCategoryResponseImpl value,
          $Res Function(_$RetrieveProductCategoryResponseImpl) then) =
      __$$RetrieveProductCategoryResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductCategoryResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductCategoryResponseCopyWithImpl<$Res,
        _$RetrieveProductCategoryResponseImpl>
    implements _$$RetrieveProductCategoryResponseImplCopyWith<$Res> {
  __$$RetrieveProductCategoryResponseImplCopyWithImpl(
      _$RetrieveProductCategoryResponseImpl _value,
      $Res Function(_$RetrieveProductCategoryResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductCategoryResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductCategoryResponseImpl
    implements _RetrieveProductCategoryResponse {
  const _$RetrieveProductCategoryResponseImpl(
  ...
  factory _$RetrieveProductCategoryResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductCategoryResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveProductCategoryResponse(id: $id, name: $name, slug: $slug, parent: $parent, description: $description, display: $display, image: $image, menuOrder: $menuOrder, count: $count, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductCategoryResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductCategoryResponseImplCopyWith<
          _$RetrieveProductCategoryResponseImpl>
      get copyWith => __$$RetrieveProductCategoryResponseImplCopyWithImpl<
          _$RetrieveProductCategoryResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductCategoryResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductCategoryResponse
    implements RetrieveProductCategoryResponse {
  const factory _RetrieveProductCategoryResponse(
  ...
  factory _RetrieveProductCategoryResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveProductCategoryResponseImpl.fromJson;
