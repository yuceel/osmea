...
part of 'retrieve_product_variation_response.dart';
...
RetrieveProductVariationResponse _$RetrieveProductVariationResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveProductVariationResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductVariationResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveProductVariationResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveProductVariationResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveProductVariationResponseCopyWith<RetrieveProductVariationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductVariationResponseCopyWith<$Res> {
  factory $RetrieveProductVariationResponseCopyWith(
          RetrieveProductVariationResponse value,
          $Res Function(RetrieveProductVariationResponse) then) =
      _$RetrieveProductVariationResponseCopyWithImpl<$Res,
          RetrieveProductVariationResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductVariationResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductVariationResponse>
    implements $RetrieveProductVariationResponseCopyWith<$Res> {
  _$RetrieveProductVariationResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductVariationResponseImplCopyWith<$Res>
    implements $RetrieveProductVariationResponseCopyWith<$Res> {
  factory _$$RetrieveProductVariationResponseImplCopyWith(
          _$RetrieveProductVariationResponseImpl value,
          $Res Function(_$RetrieveProductVariationResponseImpl) then) =
      __$$RetrieveProductVariationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductVariationResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductVariationResponseCopyWithImpl<$Res,
        _$RetrieveProductVariationResponseImpl>
    implements _$$RetrieveProductVariationResponseImplCopyWith<$Res> {
  __$$RetrieveProductVariationResponseImplCopyWithImpl(
      _$RetrieveProductVariationResponseImpl _value,
      $Res Function(_$RetrieveProductVariationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductVariationResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductVariationResponseImpl
    implements _RetrieveProductVariationResponse {
  const _$RetrieveProductVariationResponseImpl(
  ...
  factory _$RetrieveProductVariationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveProductVariationResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductVariationResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductVariationResponseImplCopyWith<
          _$RetrieveProductVariationResponseImpl>
      get copyWith => __$$RetrieveProductVariationResponseImplCopyWithImpl<
          _$RetrieveProductVariationResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductVariationResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductVariationResponse
    implements RetrieveProductVariationResponse {
  const factory _RetrieveProductVariationResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$RetrieveProductVariationResponseImpl;

  factory _RetrieveProductVariationResponse.fromJson(
          Map<String, dynamic> json) =
      _$RetrieveProductVariationResponseImpl.fromJson;
