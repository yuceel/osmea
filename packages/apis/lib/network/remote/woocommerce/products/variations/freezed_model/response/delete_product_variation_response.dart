...
//
//     final deleteProductVariationResponse = deleteProductVariationResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'delete_product_variation_response.freezed.dart';
part 'delete_product_variation_response.g.dart';

DeleteProductVariationResponse deleteProductVariationResponseFromJson(
        String str) =>
    DeleteProductVariationResponse.fromJson(json.decode(str));

String deleteProductVariationResponseToJson(
        DeleteProductVariationResponse data) =>
    json.encode(data.toJson());

@freezed
class DeleteProductVariationResponse with _$DeleteProductVariationResponse {
  const factory DeleteProductVariationResponse({
  ...
  }) = _DeleteProductVariationResponse;

  factory DeleteProductVariationResponse.fromJson(Map<String, dynamic> json) =>
      _$DeleteProductVariationResponseFromJson(json);
}
