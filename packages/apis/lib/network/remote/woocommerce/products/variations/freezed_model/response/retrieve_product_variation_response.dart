...
//
//     final retrieveProductVariationResponse = retrieveProductVariationResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_product_variation_response.freezed.dart';
part 'retrieve_product_variation_response.g.dart';

RetrieveProductVariationResponse retrieveProductVariationResponseFromJson(
        String str) =>
    RetrieveProductVariationResponse.fromJson(json.decode(str));

String retrieveProductVariationResponseToJson(
        RetrieveProductVariationResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveProductVariationResponse with _$RetrieveProductVariationResponse {
  const factory RetrieveProductVariationResponse({
  ...
  }) = _RetrieveProductVariationResponse;

  factory RetrieveProductVariationResponse.fromJson(
          Map<String, dynamic> json) =>
      _$RetrieveProductVariationResponseFromJson(json);
}
