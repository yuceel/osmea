...
CreateProductVariationResponse _$CreateProductVariationResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateProductVariationResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateProductVariationResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateProductVariationResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateProductVariationResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateProductVariationResponseCopyWith<CreateProductVariationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateProductVariationResponseCopyWith<$Res> {
  factory $CreateProductVariationResponseCopyWith(
          CreateProductVariationResponse value,
          $Res Function(CreateProductVariationResponse) then) =
      _$CreateProductVariationResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$CreateProductVariationResponseCopyWithImpl<$Res,
        $Val extends CreateProductVariationResponse>
    implements $CreateProductVariationResponseCopyWith<$Res> {
  _$CreateProductVariationResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateProductVariationResponseImplCopyWith<$Res>
    implements $CreateProductVariationResponseCopyWith<$Res> {
  factory _$$CreateProductVariationResponseImplCopyWith(
          _$CreateProductVariationResponseImpl value,
          $Res Function(_$CreateProductVariationResponseImpl) then) =
      __$$CreateProductVariationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateProductVariationResponseImplCopyWithImpl<$Res>
    extends _$CreateProductVariationResponseCopyWithImpl<$Res,
        _$CreateProductVariationResponseImpl>
    implements _$$CreateProductVariationResponseImplCopyWith<$Res> {
  __$$CreateProductVariationResponseImplCopyWithImpl(
      _$CreateProductVariationResponseImpl _value,
      $Res Function(_$CreateProductVariationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateProductVariationResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateProductVariationResponseImpl
    implements _CreateProductVariationResponse {
  const _$CreateProductVariationResponseImpl(
  ...
  factory _$CreateProductVariationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CreateProductVariationResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateProductVariationResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateProductVariationResponseImplCopyWith<
          _$CreateProductVariationResponseImpl>
      get copyWith => __$$CreateProductVariationResponseImplCopyWithImpl<
          _$CreateProductVariationResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateProductVariationResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateProductVariationResponse
    implements CreateProductVariationResponse {
  const factory _CreateProductVariationResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$CreateProductVariationResponseImpl;

  factory _CreateProductVariationResponse.fromJson(Map<String, dynamic> json) =
      _$CreateProductVariationResponseImpl.fromJson;
