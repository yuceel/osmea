...
part of 'delete_product_variation_response.dart';
...
DeleteProductVariationResponse _$DeleteProductVariationResponseFromJson(
    Map<String, dynamic> json) {
  return _DeleteProductVariationResponse.fromJson(json);
}

/// @nodoc
mixin _$DeleteProductVariationResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this DeleteProductVariationResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DeleteProductVariationResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DeleteProductVariationResponseCopyWith<DeleteProductVariationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteProductVariationResponseCopyWith<$Res> {
  factory $DeleteProductVariationResponseCopyWith(
          DeleteProductVariationResponse value,
          $Res Function(DeleteProductVariationResponse) then) =
      _$DeleteProductVariationResponseCopyWithImpl<$Res,
...
/// @nodoc
class _$DeleteProductVariationResponseCopyWithImpl<$Res,
        $Val extends DeleteProductVariationResponse>
    implements $DeleteProductVariationResponseCopyWith<$Res> {
  _$DeleteProductVariationResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DeleteProductVariationResponseImplCopyWith<$Res>
    implements $DeleteProductVariationResponseCopyWith<$Res> {
  factory _$$DeleteProductVariationResponseImplCopyWith(
          _$DeleteProductVariationResponseImpl value,
          $Res Function(_$DeleteProductVariationResponseImpl) then) =
      __$$DeleteProductVariationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteProductVariationResponseImplCopyWithImpl<$Res>
    extends _$DeleteProductVariationResponseCopyWithImpl<$Res,
        _$DeleteProductVariationResponseImpl>
    implements _$$DeleteProductVariationResponseImplCopyWith<$Res> {
  __$$DeleteProductVariationResponseImplCopyWithImpl(
      _$DeleteProductVariationResponseImpl _value,
      $Res Function(_$DeleteProductVariationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteProductVariationResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteProductVariationResponseImpl
    implements _DeleteProductVariationResponse {
  const _$DeleteProductVariationResponseImpl(
  ...
  factory _$DeleteProductVariationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$DeleteProductVariationResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteProductVariationResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteProductVariationResponseImplCopyWith<
          _$DeleteProductVariationResponseImpl>
      get copyWith => __$$DeleteProductVariationResponseImplCopyWithImpl<
          _$DeleteProductVariationResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteProductVariationResponseImplToJson(
      this,
    );
  }
}

abstract class _DeleteProductVariationResponse
    implements DeleteProductVariationResponse {
  const factory _DeleteProductVariationResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$DeleteProductVariationResponseImpl;

  factory _DeleteProductVariationResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteProductVariationResponseImpl.fromJson;
