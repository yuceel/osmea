...
//
//     final updateProductVariationResponse = updateProductVariationResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'update_product_variation_response.freezed.dart';
part 'update_product_variation_response.g.dart';

UpdateProductVariationResponse updateProductVariationResponseFromJson(
        String str) =>
    UpdateProductVariationResponse.fromJson(json.decode(str));

String updateProductVariationResponseToJson(
        UpdateProductVariationResponse data) =>
    json.encode(data.toJson());

@freezed
class UpdateProductVariationResponse with _$UpdateProductVariationResponse {
  const factory UpdateProductVariationResponse({
  ...
  }) = _UpdateProductVariationResponse;

  factory UpdateProductVariationResponse.fromJson(Map<String, dynamic> json) =>
      _$UpdateProductVariationResponseFromJson(json);
}
