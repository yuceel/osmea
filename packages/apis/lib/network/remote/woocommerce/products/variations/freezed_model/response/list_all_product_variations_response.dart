...
//
//     final listAllProductVariationsResponse = listAllProductVariationsResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'list_all_product_variations_response.freezed.dart';
part 'list_all_product_variations_response.g.dart';

List<ListAllProductVariationsResponse> listAllProductVariationsResponseFromJson(
        String str) =>
    List<ListAllProductVariationsResponse>.from(json
        .decode(str)
        .map((x) => ListAllProductVariationsResponse.fromJson(x)));

String listAllProductVariationsResponseToJson(
        List<ListAllProductVariationsResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

@freezed
class ListAllProductVariationsResponse with _$ListAllProductVariationsResponse {
  const factory ListAllProductVariationsResponse({
  ...
  }) = _ListAllProductVariationsResponse;

  factory ListAllProductVariationsResponse.fromJson(
          Map<String, dynamic> json) =>
      _$ListAllProductVariationsResponseFromJson(json);
}
