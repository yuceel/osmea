...
part of 'list_all_product_variations_response.dart';
...
ListAllProductVariationsResponse _$ListAllProductVariationsResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllProductVariationsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductVariationsResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductVariationsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductVariationsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductVariationsResponseCopyWith<ListAllProductVariationsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductVariationsResponseCopyWith<$Res> {
  factory $ListAllProductVariationsResponseCopyWith(
          ListAllProductVariationsResponse value,
          $Res Function(ListAllProductVariationsResponse) then) =
      _$ListAllProductVariationsResponseCopyWithImpl<$Res,
          ListAllProductVariationsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductVariationsResponseCopyWithImpl<$Res,
        $Val extends ListAllProductVariationsResponse>
    implements $ListAllProductVariationsResponseCopyWith<$Res> {
  _$ListAllProductVariationsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductVariationsResponseImplCopyWith<$Res>
    implements $ListAllProductVariationsResponseCopyWith<$Res> {
  factory _$$ListAllProductVariationsResponseImplCopyWith(
          _$ListAllProductVariationsResponseImpl value,
          $Res Function(_$ListAllProductVariationsResponseImpl) then) =
      __$$ListAllProductVariationsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductVariationsResponseImplCopyWithImpl<$Res>
    extends _$ListAllProductVariationsResponseCopyWithImpl<$Res,
        _$ListAllProductVariationsResponseImpl>
    implements _$$ListAllProductVariationsResponseImplCopyWith<$Res> {
  __$$ListAllProductVariationsResponseImplCopyWithImpl(
      _$ListAllProductVariationsResponseImpl _value,
      $Res Function(_$ListAllProductVariationsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductVariationsResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductVariationsResponseImpl
    implements _ListAllProductVariationsResponse {
  const _$ListAllProductVariationsResponseImpl(
  ...
  factory _$ListAllProductVariationsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllProductVariationsResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductVariationsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductVariationsResponseImplCopyWith<
          _$ListAllProductVariationsResponseImpl>
      get copyWith => __$$ListAllProductVariationsResponseImplCopyWithImpl<
          _$ListAllProductVariationsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductVariationsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductVariationsResponse
    implements ListAllProductVariationsResponse {
  const factory _ListAllProductVariationsResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$ListAllProductVariationsResponseImpl;

  factory _ListAllProductVariationsResponse.fromJson(
          Map<String, dynamic> json) =
      _$ListAllProductVariationsResponseImpl.fromJson;
