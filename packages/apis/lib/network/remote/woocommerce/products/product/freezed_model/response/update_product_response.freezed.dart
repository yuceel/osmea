...
mixin _$UpdateProductResponse {
  ...
  String? get permalinkTemplate => throw _privateConstructorUsedError;
  @JsonKey(name: "generated_slug")
  String? get generatedSlug => throw _privateConstructorUsedError;
  @JsonKey(name: "_links")
  Links? get links => throw _privateConstructorUsedError;

  /// Serializes this UpdateProductResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateProductResponse
    ...
    return _then(_value.copyWith(
      ...
      globalUniqueId: freezed == globalUniqueId
          ...
          : globalUniqueId // ignore: cast_nullable_to_non_nullable
              as String?,
      permalinkTemplate: freezed == permalinkTemplate
          ? _value.permalinkTemplate
          : permalinkTemplate // ignore: cast_nullable_to_non_nullable
              as String?,
      generatedSlug: freezed == generatedSlug
          ? _value.generatedSlug
          : generatedSlug // ignore: cast_nullable_to_non_nullable
              as String?,
      links: freezed == links
          ? _value.links
...
/// @nodoc
abstract class _$$UpdateProductResponseImplCopyWith<$Res>
    implements $UpdateProductResponseCopyWith<$Res> {
  factory _$$UpdateProductResponseImplCopyWith(
          _$UpdateProductResponseImpl value,
          $Res Function(_$UpdateProductResponseImpl) then) =
      __$$UpdateProductResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductResponseCopyWithImpl<$Res,
        _$UpdateProductResponseImpl>
    implements _$$UpdateProductResponseImplCopyWith<$Res> {
  __$$UpdateProductResponseImplCopyWithImpl(_$UpdateProductResponseImpl _value,
      $Res Function(_$UpdateProductResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductResponseImpl implements _UpdateProductResponse {
  const _$UpdateProductResponseImpl(
      ...
      @JsonKey(name: "permalink_template") this.permalinkTemplate,
      @JsonKey(name: "generated_slug") this.generatedSlug,
  ...
  factory _$UpdateProductResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateProductResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductResponseImpl &&
            ...
            (identical(other.permalinkTemplate, permalinkTemplate) || other.permalinkTemplate == permalinkTemplate) &&
            (identical(other.generatedSlug, generatedSlug) || other.generatedSlug == generatedSlug) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductResponseImplCopyWith<_$UpdateProductResponseImpl>
      get copyWith => __$$UpdateProductResponseImplCopyWithImpl<
          _$UpdateProductResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductResponseImplToJson(
      this,
    );
  }
}
...
abstract class _UpdateProductResponse implements UpdateProductResponse {
  const factory _UpdateProductResponse(
      ...
      @JsonKey(name: "permalink_template") final String? permalinkTemplate,
      @JsonKey(name: "generated_slug") final String? generatedSlug,
      @JsonKey(name: "_links")
      final Links? links}) = _$UpdateProductResponseImpl;

  factory _UpdateProductResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductResponseImpl.fromJson;
