...
mixin _$DeleteProductResponse {
  ...
  /// Serializes this DeleteProductResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DeleteProductResponse
...
/// @nodoc
abstract class _$$DeleteProductResponseImplCopyWith<$Res>
    implements $DeleteProductResponseCopyWith<$Res> {
  factory _$$DeleteProductResponseImplCopyWith(
          _$DeleteProductResponseImpl value,
          $Res Function(_$DeleteProductResponseImpl) then) =
      __$$DeleteProductResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteProductResponseImplCopyWithImpl<$Res>
    extends _$DeleteProductResponseCopyWithImpl<$Res,
        _$DeleteProductResponseImpl>
    implements _$$DeleteProductResponseImplCopyWith<$Res> {
  __$$DeleteProductResponseImplCopyWithImpl(_$DeleteProductResponseImpl _value,
      $Res Function(_$DeleteProductResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteProductResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteProductResponseImpl implements _DeleteProductResponse {
  const _$DeleteProductResponseImpl(
  ...
  factory _$DeleteProductResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DeleteProductResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteProductResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteProductResponseImplCopyWith<_$DeleteProductResponseImpl>
      get copyWith => __$$DeleteProductResponseImplCopyWithImpl<
          _$DeleteProductResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteProductResponseImplToJson(
      this,
    );
  }
}
...
abstract class _DeleteProductResponse implements DeleteProductResponse {
  const factory _DeleteProductResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$DeleteProductResponseImpl;

  factory _DeleteProductResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteProductResponseImpl.fromJson;
