...
_$UpdateProductResponseImpl _$$UpdateProductResponseImplFromJson(
...
Map<String, dynamic> _$$UpdateProductResponseImplToJson(
        _$UpdateProductResponseImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.permalinkTemplate case final value?)
        'permalink_template': value,
      if (instance.generatedSlug case final value?) 'generated_slug': value,
