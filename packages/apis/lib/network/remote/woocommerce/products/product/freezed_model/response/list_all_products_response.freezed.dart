...
ListAllProductsResponse _$ListAllProductsResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllProductsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllProductsResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllProductsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllProductsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllProductsResponseCopyWith<ListAllProductsResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllProductsResponseCopyWith<$Res> {
  factory $ListAllProductsResponseCopyWith(ListAllProductsResponse value,
          $Res Function(ListAllProductsResponse) then) =
      _$ListAllProductsResponseCopyWithImpl<$Res, ListAllProductsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllProductsResponseCopyWithImpl<$Res,
        $Val extends ListAllProductsResponse>
    implements $ListAllProductsResponseCopyWith<$Res> {
  _$ListAllProductsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllProductsResponseImplCopyWith<$Res>
    implements $ListAllProductsResponseCopyWith<$Res> {
  factory _$$ListAllProductsResponseImplCopyWith(
          _$ListAllProductsResponseImpl value,
          $Res Function(_$ListAllProductsResponseImpl) then) =
      __$$ListAllProductsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllProductsResponseImplCopyWithImpl<$Res>
    extends _$ListAllProductsResponseCopyWithImpl<$Res,
        _$ListAllProductsResponseImpl>
    implements _$$ListAllProductsResponseImplCopyWith<$Res> {
  __$$ListAllProductsResponseImplCopyWithImpl(
      _$ListAllProductsResponseImpl _value,
      $Res Function(_$ListAllProductsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllProductsResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllProductsResponseImpl implements _ListAllProductsResponse {
  const _$ListAllProductsResponseImpl(
  ...
  factory _$ListAllProductsResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllProductsResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllProductsResponseImpl &&
            ...
            (identical(other.postPassword, postPassword) || other.postPassword == postPassword) &&
            (identical(other.globalUniqueId, globalUniqueId) || other.globalUniqueId == globalUniqueId) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllProductsResponseImplCopyWith<_$ListAllProductsResponseImpl>
      get copyWith => __$$ListAllProductsResponseImplCopyWithImpl<
          _$ListAllProductsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllProductsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllProductsResponse implements ListAllProductsResponse {
  const factory _ListAllProductsResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$ListAllProductsResponseImpl;

  factory _ListAllProductsResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllProductsResponseImpl.fromJson;
