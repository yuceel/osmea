...
part of 'list_all_shipping_methods_response.dart';
...
ListAllShippingMethodsResponse _$ListAllShippingMethodsResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllShippingMethodsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllShippingMethodsResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllShippingMethodsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllShippingMethodsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllShippingMethodsResponseCopyWith<ListAllShippingMethodsResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllShippingMethodsResponseCopyWith<$Res> {
  factory $ListAllShippingMethodsResponseCopyWith(
          ListAllShippingMethodsResponse value,
          $Res Function(ListAllShippingMethodsResponse) then) =
      _$ListAllShippingMethodsResponseCopyWithImpl<$Res,
          ListAllShippingMethodsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllShippingMethodsResponseCopyWithImpl<$Res,
        $Val extends ListAllShippingMethodsResponse>
    implements $ListAllShippingMethodsResponseCopyWith<$Res> {
  _$ListAllShippingMethodsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllShippingMethodsResponseImplCopyWith<$Res>
    implements $ListAllShippingMethodsResponseCopyWith<$Res> {
  factory _$$ListAllShippingMethodsResponseImplCopyWith(
          _$ListAllShippingMethodsResponseImpl value,
          $Res Function(_$ListAllShippingMethodsResponseImpl) then) =
      __$$ListAllShippingMethodsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") String? id,
...
/// @nodoc
class __$$ListAllShippingMethodsResponseImplCopyWithImpl<$Res>
    extends _$ListAllShippingMethodsResponseCopyWithImpl<$Res,
        _$ListAllShippingMethodsResponseImpl>
    implements _$$ListAllShippingMethodsResponseImplCopyWith<$Res> {
  __$$ListAllShippingMethodsResponseImplCopyWithImpl(
      _$ListAllShippingMethodsResponseImpl _value,
      $Res Function(_$ListAllShippingMethodsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllShippingMethodsResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllShippingMethodsResponseImpl
    implements _ListAllShippingMethodsResponse {
  const _$ListAllShippingMethodsResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "title") this.title,
      @JsonKey(name: "description") this.description,
      @JsonKey(name: "_links") this.links});

  factory _$ListAllShippingMethodsResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListAllShippingMethodsResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllShippingMethodsResponse(id: $id, title: $title, description: $description, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllShippingMethodsResponseImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, description, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllShippingMethodsResponseImplCopyWith<
          _$ListAllShippingMethodsResponseImpl>
      get copyWith => __$$ListAllShippingMethodsResponseImplCopyWithImpl<
          _$ListAllShippingMethodsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllShippingMethodsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllShippingMethodsResponse
    implements ListAllShippingMethodsResponse {
  const factory _ListAllShippingMethodsResponse(
  ...
  factory _ListAllShippingMethodsResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllShippingMethodsResponseImpl.fromJson;
