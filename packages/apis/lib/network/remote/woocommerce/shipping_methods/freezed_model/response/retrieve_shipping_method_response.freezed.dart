...
part of 'retrieve_shipping_method_response.dart';
...
RetrieveShippingMethodResponse _$RetrieveShippingMethodResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveShippingMethodResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveShippingMethodResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveShippingMethodResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveShippingMethodResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveShippingMethodResponseCopyWith<RetrieveShippingMethodResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveShippingMethodResponseCopyWith<$Res> {
  factory $RetrieveShippingMethodResponseCopyWith(
          RetrieveShippingMethodResponse value,
          $Res Function(RetrieveShippingMethodResponse) then) =
      _$RetrieveShippingMethodResponseCopyWithImpl<$Res,
          RetrieveShippingMethodResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveShippingMethodResponseCopyWithImpl<$Res,
        $Val extends RetrieveShippingMethodResponse>
    implements $RetrieveShippingMethodResponseCopyWith<$Res> {
  _$RetrieveShippingMethodResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveShippingMethodResponseImplCopyWith<$Res>
    implements $RetrieveShippingMethodResponseCopyWith<$Res> {
  factory _$$RetrieveShippingMethodResponseImplCopyWith(
          _$RetrieveShippingMethodResponseImpl value,
          $Res Function(_$RetrieveShippingMethodResponseImpl) then) =
      __$$RetrieveShippingMethodResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") String? id,
...
/// @nodoc
class __$$RetrieveShippingMethodResponseImplCopyWithImpl<$Res>
    extends _$RetrieveShippingMethodResponseCopyWithImpl<$Res,
        _$RetrieveShippingMethodResponseImpl>
    implements _$$RetrieveShippingMethodResponseImplCopyWith<$Res> {
  __$$RetrieveShippingMethodResponseImplCopyWithImpl(
      _$RetrieveShippingMethodResponseImpl _value,
      $Res Function(_$RetrieveShippingMethodResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveShippingMethodResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveShippingMethodResponseImpl
    implements _RetrieveShippingMethodResponse {
  const _$RetrieveShippingMethodResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "title") this.title,
      @JsonKey(name: "description") this.description,
      @JsonKey(name: "_links") this.links});

  factory _$RetrieveShippingMethodResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveShippingMethodResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveShippingMethodResponse(id: $id, title: $title, description: $description, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveShippingMethodResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveShippingMethodResponseImplCopyWith<
          _$RetrieveShippingMethodResponseImpl>
      get copyWith => __$$RetrieveShippingMethodResponseImplCopyWithImpl<
          _$RetrieveShippingMethodResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveShippingMethodResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveShippingMethodResponse
    implements RetrieveShippingMethodResponse {
  const factory _RetrieveShippingMethodResponse(
  ...
  factory _RetrieveShippingMethodResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveShippingMethodResponseImpl.fromJson;
