...
part of 'list_all_data_response.dart';
...
ListAllDataResponse _$ListAllDataResponseFromJson(Map<String, dynamic> json) {
  return _ListAllDataResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllDataResponse {
  @JsonKey(name: "slug")
  ...
  /// Serializes this ListAllDataResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllDataResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllDataResponseCopyWith<ListAllDataResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllDataResponseCopyWith<$Res> {
  factory $ListAllDataResponseCopyWith(
          ListAllDataResponse value, $Res Function(ListAllDataResponse) then) =
      _$ListAllDataResponseCopyWithImpl<$Res, ListAllDataResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllDataResponseCopyWithImpl<$Res, $Val extends ListAllDataResponse>
    implements $ListAllDataResponseCopyWith<$Res> {
  _$ListAllDataResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllDataResponseImplCopyWith<$Res>
    implements $ListAllDataResponseCopyWith<$Res> {
  factory _$$ListAllDataResponseImplCopyWith(_$ListAllDataResponseImpl value,
          $Res Function(_$ListAllDataResponseImpl) then) =
      __$$ListAllDataResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "slug") String? slug,
...
/// @nodoc
class __$$ListAllDataResponseImplCopyWithImpl<$Res>
    extends _$ListAllDataResponseCopyWithImpl<$Res, _$ListAllDataResponseImpl>
    implements _$$ListAllDataResponseImplCopyWith<$Res> {
  __$$ListAllDataResponseImplCopyWithImpl(_$ListAllDataResponseImpl _value,
      $Res Function(_$ListAllDataResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllDataResponseImpl(
      slug: freezed == slug
          ? _value.slug
          : slug // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllDataResponseImpl implements _ListAllDataResponse {
  const _$ListAllDataResponseImpl(
      {@JsonKey(name: "slug") this.slug,
      @JsonKey(name: "description") this.description,
      @JsonKey(name: "_links") this.links});

  factory _$ListAllDataResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllDataResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllDataResponse(slug: $slug, description: $description, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllDataResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllDataResponseImplCopyWith<_$ListAllDataResponseImpl> get copyWith =>
      __$$ListAllDataResponseImplCopyWithImpl<_$ListAllDataResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllDataResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllDataResponse implements ListAllDataResponse {
  const factory _ListAllDataResponse(
      {@JsonKey(name: "slug") final String? slug,
      @JsonKey(name: "description") final String? description,
      @JsonKey(name: "_links") final Links? links}) = _$ListAllDataResponseImpl;

  factory _ListAllDataResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllDataResponseImpl.fromJson;
