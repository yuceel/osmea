...
ListAllContinentsResponse _$ListAllContinentsResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllContinentsResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllContinentsResponse {
  @JsonKey(name: "code")
  ...
  /// Serializes this ListAllContinentsResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllContinentsResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllContinentsResponseCopyWith<ListAllContinentsResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllContinentsResponseCopyWith<$Res> {
  factory $ListAllContinentsResponseCopyWith(ListAllContinentsResponse value,
          $Res Function(ListAllContinentsResponse) then) =
      _$ListAllContinentsResponseCopyWithImpl<$Res, ListAllContinentsResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllContinentsResponseCopyWithImpl<$Res,
        $Val extends ListAllContinentsResponse>
    implements $ListAllContinentsResponseCopyWith<$Res> {
  _$ListAllContinentsResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllContinentsResponseImplCopyWith<$Res>
    implements $ListAllContinentsResponseCopyWith<$Res> {
  factory _$$ListAllContinentsResponseImplCopyWith(
          _$ListAllContinentsResponseImpl value,
          $Res Function(_$ListAllContinentsResponseImpl) then) =
      __$$ListAllContinentsResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$ListAllContinentsResponseImplCopyWithImpl<$Res>
    extends _$ListAllContinentsResponseCopyWithImpl<$Res,
        _$ListAllContinentsResponseImpl>
    implements _$$ListAllContinentsResponseImplCopyWith<$Res> {
  __$$ListAllContinentsResponseImplCopyWithImpl(
      _$ListAllContinentsResponseImpl _value,
      $Res Function(_$ListAllContinentsResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllContinentsResponseImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllContinentsResponseImpl implements _ListAllContinentsResponse {
  const _$ListAllContinentsResponseImpl(
  ...
  factory _$ListAllContinentsResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllContinentsResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllContinentsResponse(code: $code, name: $name, countries: $countries, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllContinentsResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllContinentsResponseImplCopyWith<_$ListAllContinentsResponseImpl>
      get copyWith => __$$ListAllContinentsResponseImplCopyWithImpl<
          _$ListAllContinentsResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllContinentsResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllContinentsResponse implements ListAllContinentsResponse {
  const factory _ListAllContinentsResponse(
  ...
  factory _ListAllContinentsResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllContinentsResponseImpl.fromJson;
...
class _$StateImpl implements _State {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(code), name);
