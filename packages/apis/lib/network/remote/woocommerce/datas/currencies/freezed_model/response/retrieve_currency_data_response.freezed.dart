...
part of 'retrieve_currency_data_response.dart';
...
RetrieveCurrencyDataResponse _$RetrieveCurrencyDataResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveCurrencyDataResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveCurrencyDataResponse {
  @JsonKey(name: "code")
  ...
  /// Serializes this RetrieveCurrencyDataResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveCurrencyDataResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveCurrencyDataResponseCopyWith<RetrieveCurrencyDataResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveCurrencyDataResponseCopyWith<$Res> {
  factory $RetrieveCurrencyDataResponseCopyWith(
          RetrieveCurrencyDataResponse value,
          $Res Function(RetrieveCurrencyDataResponse) then) =
      _$RetrieveCurrencyDataResponseCopyWithImpl<$Res,
          RetrieveCurrencyDataResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveCurrencyDataResponseCopyWithImpl<$Res,
        $Val extends RetrieveCurrencyDataResponse>
    implements $RetrieveCurrencyDataResponseCopyWith<$Res> {
  _$RetrieveCurrencyDataResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveCurrencyDataResponseImplCopyWith<$Res>
    implements $RetrieveCurrencyDataResponseCopyWith<$Res> {
  factory _$$RetrieveCurrencyDataResponseImplCopyWith(
          _$RetrieveCurrencyDataResponseImpl value,
          $Res Function(_$RetrieveCurrencyDataResponseImpl) then) =
      __$$RetrieveCurrencyDataResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$RetrieveCurrencyDataResponseImplCopyWithImpl<$Res>
    extends _$RetrieveCurrencyDataResponseCopyWithImpl<$Res,
        _$RetrieveCurrencyDataResponseImpl>
    implements _$$RetrieveCurrencyDataResponseImplCopyWith<$Res> {
  __$$RetrieveCurrencyDataResponseImplCopyWithImpl(
      _$RetrieveCurrencyDataResponseImpl _value,
      $Res Function(_$RetrieveCurrencyDataResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveCurrencyDataResponseImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveCurrencyDataResponseImpl
    implements _RetrieveCurrencyDataResponse {
  const _$RetrieveCurrencyDataResponseImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "symbol") this.symbol,
      @JsonKey(name: "_links") this.links});

  factory _$RetrieveCurrencyDataResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveCurrencyDataResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveCurrencyDataResponse(code: $code, name: $name, symbol: $symbol, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveCurrencyDataResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveCurrencyDataResponseImplCopyWith<
          _$RetrieveCurrencyDataResponseImpl>
      get copyWith => __$$RetrieveCurrencyDataResponseImplCopyWithImpl<
          _$RetrieveCurrencyDataResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveCurrencyDataResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveCurrencyDataResponse
    implements RetrieveCurrencyDataResponse {
  const factory _RetrieveCurrencyDataResponse(
  ...
  factory _RetrieveCurrencyDataResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveCurrencyDataResponseImpl.fromJson;
