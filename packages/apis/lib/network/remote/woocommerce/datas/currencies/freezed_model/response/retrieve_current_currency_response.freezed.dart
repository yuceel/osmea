...
part of 'retrieve_current_currency_response.dart';
...
RetrieveCurrentCurrencyResponse _$RetrieveCurrentCurrencyResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveCurrentCurrencyResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveCurrentCurrencyResponse {
  @JsonKey(name: "code")
  ...
  /// Serializes this RetrieveCurrentCurrencyResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveCurrentCurrencyResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveCurrentCurrencyResponseCopyWith<RetrieveCurrentCurrencyResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveCurrentCurrencyResponseCopyWith<$Res> {
  factory $RetrieveCurrentCurrencyResponseCopyWith(
          RetrieveCurrentCurrencyResponse value,
          $Res Function(RetrieveCurrentCurrencyResponse) then) =
      _$RetrieveCurrentCurrencyResponseCopyWithImpl<$Res,
          RetrieveCurrentCurrencyResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveCurrentCurrencyResponseCopyWithImpl<$Res,
        $Val extends RetrieveCurrentCurrencyResponse>
    implements $RetrieveCurrentCurrencyResponseCopyWith<$Res> {
  _$RetrieveCurrentCurrencyResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveCurrentCurrencyResponseImplCopyWith<$Res>
    implements $RetrieveCurrentCurrencyResponseCopyWith<$Res> {
  factory _$$RetrieveCurrentCurrencyResponseImplCopyWith(
          _$RetrieveCurrentCurrencyResponseImpl value,
          $Res Function(_$RetrieveCurrentCurrencyResponseImpl) then) =
      __$$RetrieveCurrentCurrencyResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$RetrieveCurrentCurrencyResponseImplCopyWithImpl<$Res>
    extends _$RetrieveCurrentCurrencyResponseCopyWithImpl<$Res,
        _$RetrieveCurrentCurrencyResponseImpl>
    implements _$$RetrieveCurrentCurrencyResponseImplCopyWith<$Res> {
  __$$RetrieveCurrentCurrencyResponseImplCopyWithImpl(
      _$RetrieveCurrentCurrencyResponseImpl _value,
      $Res Function(_$RetrieveCurrentCurrencyResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveCurrentCurrencyResponseImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveCurrentCurrencyResponseImpl
    implements _RetrieveCurrentCurrencyResponse {
  const _$RetrieveCurrentCurrencyResponseImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "symbol") this.symbol,
      @JsonKey(name: "_links") this.links});

  factory _$RetrieveCurrentCurrencyResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveCurrentCurrencyResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveCurrentCurrencyResponse(code: $code, name: $name, symbol: $symbol, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveCurrentCurrencyResponseImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, code, name, symbol, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveCurrentCurrencyResponseImplCopyWith<
          _$RetrieveCurrentCurrencyResponseImpl>
      get copyWith => __$$RetrieveCurrentCurrencyResponseImplCopyWithImpl<
          _$RetrieveCurrentCurrencyResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveCurrentCurrencyResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveCurrentCurrencyResponse
    implements RetrieveCurrentCurrencyResponse {
  const factory _RetrieveCurrentCurrencyResponse(
  ...
  factory _RetrieveCurrentCurrencyResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveCurrentCurrencyResponseImpl.fromJson;
