...
part of 'list_all_currencies_response.dart';
...
ListAllCurrenciesResponse _$ListAllCurrenciesResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllCurrenciesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllCurrenciesResponse {
  @JsonKey(name: "code")
  ...
  /// Serializes this ListAllCurrenciesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllCurrenciesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllCurrenciesResponseCopyWith<ListAllCurrenciesResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllCurrenciesResponseCopyWith<$Res> {
  factory $ListAllCurrenciesResponseCopyWith(ListAllCurrenciesResponse value,
          $Res Function(ListAllCurrenciesResponse) then) =
      _$ListAllCurrenciesResponseCopyWithImpl<$Res, ListAllCurrenciesResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllCurrenciesResponseCopyWithImpl<$Res,
        $Val extends ListAllCurrenciesResponse>
    implements $ListAllCurrenciesResponseCopyWith<$Res> {
  _$ListAllCurrenciesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllCurrenciesResponseImplCopyWith<$Res>
    implements $ListAllCurrenciesResponseCopyWith<$Res> {
  factory _$$ListAllCurrenciesResponseImplCopyWith(
          _$ListAllCurrenciesResponseImpl value,
          $Res Function(_$ListAllCurrenciesResponseImpl) then) =
      __$$ListAllCurrenciesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$ListAllCurrenciesResponseImplCopyWithImpl<$Res>
    extends _$ListAllCurrenciesResponseCopyWithImpl<$Res,
        _$ListAllCurrenciesResponseImpl>
    implements _$$ListAllCurrenciesResponseImplCopyWith<$Res> {
  __$$ListAllCurrenciesResponseImplCopyWithImpl(
      _$ListAllCurrenciesResponseImpl _value,
      $Res Function(_$ListAllCurrenciesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllCurrenciesResponseImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllCurrenciesResponseImpl implements _ListAllCurrenciesResponse {
  const _$ListAllCurrenciesResponseImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "symbol") this.symbol,
      @JsonKey(name: "_links") this.links});

  factory _$ListAllCurrenciesResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllCurrenciesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllCurrenciesResponse(code: $code, name: $name, symbol: $symbol, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllCurrenciesResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllCurrenciesResponseImplCopyWith<_$ListAllCurrenciesResponseImpl>
      get copyWith => __$$ListAllCurrenciesResponseImplCopyWithImpl<
          _$ListAllCurrenciesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllCurrenciesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllCurrenciesResponse implements ListAllCurrenciesResponse {
  const factory _ListAllCurrenciesResponse(
  ...
  factory _ListAllCurrenciesResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllCurrenciesResponseImpl.fromJson;
