...
part of 'retrieve_country_response.dart';
...
RetrieveCountryResponse _$RetrieveCountryResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveCountryResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveCountryResponse {
  @JsonKey(name: "code")
  String? get code => throw _privateConstructorUsedError;
  @JsonKey(name: "name")
  String? get name => throw _privateConstructorUsedError;
  @JsonKey(name: "states")
  List<dynamic>? get states => throw _privateConstructorUsedError;
  @JsonKey(name: "_links")
  Links? get links => throw _privateConstructorUsedError;

  /// Serializes this RetrieveCountryResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveCountryResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveCountryResponseCopyWith<RetrieveCountryResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveCountryResponseCopyWith<$Res> {
  factory $RetrieveCountryResponseCopyWith(RetrieveCountryResponse value,
          $Res Function(RetrieveCountryResponse) then) =
      _$RetrieveCountryResponseCopyWithImpl<$Res, RetrieveCountryResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveCountryResponseCopyWithImpl<$Res,
        $Val extends RetrieveCountryResponse>
    implements $RetrieveCountryResponseCopyWith<$Res> {
  _$RetrieveCountryResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveCountryResponseImplCopyWith<$Res>
    implements $RetrieveCountryResponseCopyWith<$Res> {
  factory _$$RetrieveCountryResponseImplCopyWith(
          _$RetrieveCountryResponseImpl value,
          $Res Function(_$RetrieveCountryResponseImpl) then) =
      __$$RetrieveCountryResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "code") String? code,
...
/// @nodoc
class __$$RetrieveCountryResponseImplCopyWithImpl<$Res>
    extends _$RetrieveCountryResponseCopyWithImpl<$Res,
        _$RetrieveCountryResponseImpl>
    implements _$$RetrieveCountryResponseImplCopyWith<$Res> {
  __$$RetrieveCountryResponseImplCopyWithImpl(
      _$RetrieveCountryResponseImpl _value,
      $Res Function(_$RetrieveCountryResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveCountryResponseImpl(
      code: freezed == code
          ? _value.code
          : code // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveCountryResponseImpl implements _RetrieveCountryResponse {
  const _$RetrieveCountryResponseImpl(
      {@JsonKey(name: "code") this.code,
      @JsonKey(name: "name") this.name,
      @JsonKey(name: "states") final List<dynamic>? states,
      @JsonKey(name: "_links") this.links})
      : _states = states;

  factory _$RetrieveCountryResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveCountryResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveCountryResponse(code: $code, name: $name, states: $states, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveCountryResponseImpl &&
  ...
  int get hashCode => Object.hash(runtimeType, code, name,
      const DeepCollectionEquality().hash(_states), links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveCountryResponseImplCopyWith<_$RetrieveCountryResponseImpl>
      get copyWith => __$$RetrieveCountryResponseImplCopyWithImpl<
          _$RetrieveCountryResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveCountryResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveCountryResponse implements RetrieveCountryResponse {
  const factory _RetrieveCountryResponse(
  ...
  factory _RetrieveCountryResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveCountryResponseImpl.fromJson;
