...
abstract class _DeleteOrderResponse implements DeleteOrderResponse {
  const factory _DeleteOrderResponse(
      ...
      @JsonKey(name: "_links") final Links? links}) = _$DeleteOrderResponseImpl;
