...
RetrieveOrderResponse _$RetrieveOrderResponseFromJson(
  ...
  return _RetrieveOrderResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveOrderResponse {
  ...
  /// Serializes this RetrieveOrderResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveOrderResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveOrderResponseCopyWith<RetrieveOrderResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveOrderResponseCopyWith<$Res> {
  factory $RetrieveOrderResponseCopyWith(RetrieveOrderResponse value,
          $Res Function(RetrieveOrderResponse) then) =
      _$RetrieveOrderResponseCopyWithImpl<$Res, RetrieveOrderResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveOrderResponseCopyWithImpl<$Res,
        $Val extends RetrieveOrderResponse>
    implements $RetrieveOrderResponseCopyWith<$Res> {
  _$RetrieveOrderResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveOrderResponseImplCopyWith<$Res>
    implements $RetrieveOrderResponseCopyWith<$Res> {
  factory _$$RetrieveOrderResponseImplCopyWith(
          _$RetrieveOrderResponseImpl value,
          $Res Function(_$RetrieveOrderResponseImpl) then) =
      __$$RetrieveOrderResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@StringToIntConverter() @JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveOrderResponseImplCopyWithImpl<$Res>
    extends _$RetrieveOrderResponseCopyWithImpl<$Res,
        _$RetrieveOrderResponseImpl>
    implements _$$RetrieveOrderResponseImplCopyWith<$Res> {
  __$$RetrieveOrderResponseImplCopyWithImpl(_$RetrieveOrderResponseImpl _value,
      $Res Function(_$RetrieveOrderResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveOrderResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveOrderResponseImpl implements _RetrieveOrderResponse {
  const _$RetrieveOrderResponseImpl(
      {@StringToIntConverter() @JsonKey(name: "id") this.id,
      @StringToIntConverter() @JsonKey(name: "parent_id") this.parentId,
      ...
      @StringToIntConverter() @JsonKey(name: "customer_id") this.customerId,
  ...
  factory _$RetrieveOrderResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveOrderResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveOrderResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveOrderResponseImplCopyWith<_$RetrieveOrderResponseImpl>
      get copyWith => __$$RetrieveOrderResponseImplCopyWithImpl<
          _$RetrieveOrderResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveOrderResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveOrderResponse implements RetrieveOrderResponse {
  const factory _RetrieveOrderResponse(
      {@StringToIntConverter() @JsonKey(name: "id") final int? id,
      @StringToIntConverter() @JsonKey(name: "parent_id") final int? parentId,
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$RetrieveOrderResponseImpl;

  factory _RetrieveOrderResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveOrderResponseImpl.fromJson;
...
class _$LineItemImpl implements _LineItem {
  const _$LineItemImpl(
      ...
      @StringToIntConverter() @JsonKey(name: "product_id") this.productId,
      @StringToIntConverter() @JsonKey(name: "variation_id") this.variationId,
      @StringToIntConverter() @JsonKey(name: "quantity") this.quantity,
      ...
      @StringToIntConverter() @JsonKey(name: "price") this.price,
...
abstract class _LineItem implements LineItem {
  const factory _LineItem(
      ...
      @StringToIntConverter() @JsonKey(name: "product_id") final int? productId,
      @StringToIntConverter()
      @JsonKey(name: "variation_id")
      final int? variationId,
      @StringToIntConverter() @JsonKey(name: "quantity") final int? quantity,
      ...
      @StringToIntConverter() @JsonKey(name: "price") final int? price,
