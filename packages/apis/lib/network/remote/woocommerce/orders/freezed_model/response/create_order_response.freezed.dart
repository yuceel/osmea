...
abstract class _CreateOrderResponse implements CreateOrderResponse {
  const factory _CreateOrderResponse(
      ...
      @JsonKey(name: "_links") final Links? links}) = _$CreateOrderResponseImpl;
...
abstract class $ImageCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "id") String? id, @JsonKey(name: "src") String? src});
}
