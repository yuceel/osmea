...
part of 'create_order_note_response.dart';
...
CreateOrderNoteResponse _$CreateOrderNoteResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateOrderNoteResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateOrderNoteResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateOrderNoteResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateOrderNoteResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateOrderNoteResponseCopyWith<CreateOrderNoteResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateOrderNoteResponseCopyWith<$Res> {
  factory $CreateOrderNoteResponseCopyWith(CreateOrderNoteResponse value,
          $Res Function(CreateOrderNoteResponse) then) =
      _$CreateOrderNoteResponseCopyWithImpl<$Res, CreateOrderNoteResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateOrderNoteResponseCopyWithImpl<$Res,
        $Val extends CreateOrderNoteResponse>
    implements $CreateOrderNoteResponseCopyWith<$Res> {
  _$CreateOrderNoteResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateOrderNoteResponseImplCopyWith<$Res>
    implements $CreateOrderNoteResponseCopyWith<$Res> {
  factory _$$CreateOrderNoteResponseImplCopyWith(
          _$CreateOrderNoteResponseImpl value,
          $Res Function(_$CreateOrderNoteResponseImpl) then) =
      __$$CreateOrderNoteResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateOrderNoteResponseImplCopyWithImpl<$Res>
    extends _$CreateOrderNoteResponseCopyWithImpl<$Res,
        _$CreateOrderNoteResponseImpl>
    implements _$$CreateOrderNoteResponseImplCopyWith<$Res> {
  __$$CreateOrderNoteResponseImplCopyWithImpl(
      _$CreateOrderNoteResponseImpl _value,
      $Res Function(_$CreateOrderNoteResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateOrderNoteResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateOrderNoteResponseImpl implements _CreateOrderNoteResponse {
  const _$CreateOrderNoteResponseImpl(
  ...
  factory _$CreateOrderNoteResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateOrderNoteResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateOrderNoteResponse(id: $id, author: $author, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, note: $note, customerNote: $customerNote, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateOrderNoteResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateOrderNoteResponseImplCopyWith<_$CreateOrderNoteResponseImpl>
      get copyWith => __$$CreateOrderNoteResponseImplCopyWithImpl<
          _$CreateOrderNoteResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateOrderNoteResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateOrderNoteResponse implements CreateOrderNoteResponse {
  const factory _CreateOrderNoteResponse(
  ...
  factory _CreateOrderNoteResponse.fromJson(Map<String, dynamic> json) =
      _$CreateOrderNoteResponseImpl.fromJson;
