...
part of 'delete_order_note_response.dart';
...
DeleteOrderNoteResponse _$DeleteOrderNoteResponseFromJson(
    Map<String, dynamic> json) {
  return _DeleteOrderNoteResponse.fromJson(json);
}

/// @nodoc
mixin _$DeleteOrderNoteResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this DeleteOrderNoteResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DeleteOrderNoteResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DeleteOrderNoteResponseCopyWith<DeleteOrderNoteResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteOrderNoteResponseCopyWith<$Res> {
  factory $DeleteOrderNoteResponseCopyWith(DeleteOrderNoteResponse value,
          $Res Function(DeleteOrderNoteResponse) then) =
      _$DeleteOrderNoteResponseCopyWithImpl<$Res, DeleteOrderNoteResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DeleteOrderNoteResponseCopyWithImpl<$Res,
        $Val extends DeleteOrderNoteResponse>
    implements $DeleteOrderNoteResponseCopyWith<$Res> {
  _$DeleteOrderNoteResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DeleteOrderNoteResponseImplCopyWith<$Res>
    implements $DeleteOrderNoteResponseCopyWith<$Res> {
  factory _$$DeleteOrderNoteResponseImplCopyWith(
          _$DeleteOrderNoteResponseImpl value,
          $Res Function(_$DeleteOrderNoteResponseImpl) then) =
      __$$DeleteOrderNoteResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteOrderNoteResponseImplCopyWithImpl<$Res>
    extends _$DeleteOrderNoteResponseCopyWithImpl<$Res,
        _$DeleteOrderNoteResponseImpl>
    implements _$$DeleteOrderNoteResponseImplCopyWith<$Res> {
  __$$DeleteOrderNoteResponseImplCopyWithImpl(
      _$DeleteOrderNoteResponseImpl _value,
      $Res Function(_$DeleteOrderNoteResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteOrderNoteResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteOrderNoteResponseImpl implements _DeleteOrderNoteResponse {
  const _$DeleteOrderNoteResponseImpl(
  ...
  factory _$DeleteOrderNoteResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DeleteOrderNoteResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DeleteOrderNoteResponse(id: $id, author: $author, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, note: $note, customerNote: $customerNote, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteOrderNoteResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteOrderNoteResponseImplCopyWith<_$DeleteOrderNoteResponseImpl>
      get copyWith => __$$DeleteOrderNoteResponseImplCopyWithImpl<
          _$DeleteOrderNoteResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteOrderNoteResponseImplToJson(
      this,
    );
  }
}

abstract class _DeleteOrderNoteResponse implements DeleteOrderNoteResponse {
  const factory _DeleteOrderNoteResponse(
  ...
  factory _DeleteOrderNoteResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteOrderNoteResponseImpl.fromJson;
