...
ListAllOrderNotesResponse _$ListAllOrderNotesResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllOrderNotesResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllOrderNotesResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this ListAllOrderNotesResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllOrderNotesResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllOrderNotesResponseCopyWith<ListAllOrderNotesResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllOrderNotesResponseCopyWith<$Res> {
  factory $ListAllOrderNotesResponseCopyWith(ListAllOrderNotesResponse value,
          $Res Function(ListAllOrderNotesResponse) then) =
      _$ListAllOrderNotesResponseCopyWithImpl<$Res, ListAllOrderNotesResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllOrderNotesResponseCopyWithImpl<$Res,
        $Val extends ListAllOrderNotesResponse>
    implements $ListAllOrderNotesResponseCopyWith<$Res> {
  _$ListAllOrderNotesResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllOrderNotesResponseImplCopyWith<$Res>
    implements $ListAllOrderNotesResponseCopyWith<$Res> {
  factory _$$ListAllOrderNotesResponseImplCopyWith(
          _$ListAllOrderNotesResponseImpl value,
          $Res Function(_$ListAllOrderNotesResponseImpl) then) =
      __$$ListAllOrderNotesResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllOrderNotesResponseImplCopyWithImpl<$Res>
    extends _$ListAllOrderNotesResponseCopyWithImpl<$Res,
        _$ListAllOrderNotesResponseImpl>
    implements _$$ListAllOrderNotesResponseImplCopyWith<$Res> {
  __$$ListAllOrderNotesResponseImplCopyWithImpl(
      _$ListAllOrderNotesResponseImpl _value,
      $Res Function(_$ListAllOrderNotesResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllOrderNotesResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllOrderNotesResponseImpl implements _ListAllOrderNotesResponse {
  const _$ListAllOrderNotesResponseImpl(
  ...
  factory _$ListAllOrderNotesResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllOrderNotesResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllOrderNotesResponse(id: $id, author: $author, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, note: $note, customerNote: $customerNote, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllOrderNotesResponseImpl &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, author, dateCreated,
      dateCreatedGmt, note, customerNote, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllOrderNotesResponseImplCopyWith<_$ListAllOrderNotesResponseImpl>
      get copyWith => __$$ListAllOrderNotesResponseImplCopyWithImpl<
          _$ListAllOrderNotesResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllOrderNotesResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllOrderNotesResponse implements ListAllOrderNotesResponse {
  const factory _ListAllOrderNotesResponse(
  ...
  factory _ListAllOrderNotesResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllOrderNotesResponseImpl.fromJson;
