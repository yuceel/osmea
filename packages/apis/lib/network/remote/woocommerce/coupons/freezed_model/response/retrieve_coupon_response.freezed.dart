...
part of 'retrieve_coupon_response.dart';
...
RetrieveCouponResponse _$RetrieveCouponResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveCouponResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveCouponResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveCouponResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveCouponResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveCouponResponseCopyWith<RetrieveCouponResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveCouponResponseCopyWith<$Res> {
  factory $RetrieveCouponResponseCopyWith(RetrieveCouponResponse value,
          $Res Function(RetrieveCouponResponse) then) =
      _$RetrieveCouponResponseCopyWithImpl<$Res, RetrieveCouponResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveCouponResponseCopyWithImpl<$Res,
        $Val extends RetrieveCouponResponse>
    implements $RetrieveCouponResponseCopyWith<$Res> {
  _$RetrieveCouponResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveCouponResponseImplCopyWith<$Res>
    implements $RetrieveCouponResponseCopyWith<$Res> {
  factory _$$RetrieveCouponResponseImplCopyWith(
          _$RetrieveCouponResponseImpl value,
          $Res Function(_$RetrieveCouponResponseImpl) then) =
      __$$RetrieveCouponResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveCouponResponseImplCopyWithImpl<$Res>
    extends _$RetrieveCouponResponseCopyWithImpl<$Res,
        _$RetrieveCouponResponseImpl>
    implements _$$RetrieveCouponResponseImplCopyWith<$Res> {
  __$$RetrieveCouponResponseImplCopyWithImpl(
      _$RetrieveCouponResponseImpl _value,
      $Res Function(_$RetrieveCouponResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveCouponResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveCouponResponseImpl implements _RetrieveCouponResponse {
  const _$RetrieveCouponResponseImpl(
  ...
  factory _$RetrieveCouponResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveCouponResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveCouponResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveCouponResponseImplCopyWith<_$RetrieveCouponResponseImpl>
      get copyWith => __$$RetrieveCouponResponseImplCopyWithImpl<
          _$RetrieveCouponResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveCouponResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveCouponResponse implements RetrieveCouponResponse {
  const factory _RetrieveCouponResponse(
      ...
      @JsonKey(name: "meta_data") final List<MetaDatum>? metaData,
      @JsonKey(name: "_links")
      final Links? links}) = _$RetrieveCouponResponseImpl;

  factory _RetrieveCouponResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveCouponResponseImpl.fromJson;
