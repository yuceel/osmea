...
//
//     final retrieveCouponResponse = retrieveCouponResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_coupon_response.freezed.dart';
part 'retrieve_coupon_response.g.dart';

RetrieveCouponResponse retrieveCouponResponseFromJson(String str) =>
    RetrieveCouponResponse.fromJson(json.decode(str));

String retrieveCouponResponseToJson(RetrieveCouponResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrieveCouponResponse with _$RetrieveCouponResponse {
  const factory RetrieveCouponResponse({
  ...
  }) = _RetrieveCouponResponse;

  factory RetrieveCouponResponse.fromJson(Map<String, dynamic> json) =>
      _$RetrieveCouponResponseFromJson(json);
}
