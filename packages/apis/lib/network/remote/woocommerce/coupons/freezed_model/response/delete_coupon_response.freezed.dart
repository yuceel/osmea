...
DeleteCouponResponse _$DeleteCouponResponseFromJson(Map<String, dynamic> json) {
  return _DeleteCouponResponse.fromJson(json);
}

/// @nodoc
mixin _$DeleteCouponResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this DeleteCouponResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DeleteCouponResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DeleteCouponResponseCopyWith<DeleteCouponResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteCouponResponseCopyWith<$Res> {
  factory $DeleteCouponResponseCopyWith(DeleteCouponResponse value,
          $Res Function(DeleteCouponResponse) then) =
      _$DeleteCouponResponseCopyWithImpl<$Res, DeleteCouponResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DeleteCouponResponseCopyWithImpl<$Res,
        $Val extends DeleteCouponResponse>
    implements $DeleteCouponResponseCopyWith<$Res> {
  _$DeleteCouponResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DeleteCouponResponseImplCopyWith<$Res>
    implements $DeleteCouponResponseCopyWith<$Res> {
  factory _$$DeleteCouponResponseImplCopyWith(_$DeleteCouponResponseImpl value,
          $Res Function(_$DeleteCouponResponseImpl) then) =
      __$$DeleteCouponResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteCouponResponseImplCopyWithImpl<$Res>
    extends _$DeleteCouponResponseCopyWithImpl<$Res, _$DeleteCouponResponseImpl>
    implements _$$DeleteCouponResponseImplCopyWith<$Res> {
  __$$DeleteCouponResponseImplCopyWithImpl(_$DeleteCouponResponseImpl _value,
      $Res Function(_$DeleteCouponResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteCouponResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteCouponResponseImpl implements _DeleteCouponResponse {
  const _$DeleteCouponResponseImpl(
  ...
  factory _$DeleteCouponResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DeleteCouponResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteCouponResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteCouponResponseImplCopyWith<_$DeleteCouponResponseImpl>
      get copyWith =>
          __$$DeleteCouponResponseImplCopyWithImpl<_$DeleteCouponResponseImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteCouponResponseImplToJson(
      this,
    );
  }
}

abstract class _DeleteCouponResponse implements DeleteCouponResponse {
  const factory _DeleteCouponResponse(
      ...
      @JsonKey(name: "meta_data") final List<dynamic>? metaData,
      @JsonKey(name: "_links")
      final Links? links}) = _$DeleteCouponResponseImpl;

  factory _DeleteCouponResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteCouponResponseImpl.fromJson;
