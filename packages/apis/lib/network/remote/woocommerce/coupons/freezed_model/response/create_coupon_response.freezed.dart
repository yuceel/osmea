...
CreateCouponResponse _$CreateCouponResponseFromJson(Map<String, dynamic> json) {
  return _CreateCouponResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateCouponResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateCouponResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateCouponResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateCouponResponseCopyWith<CreateCouponResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateCouponResponseCopyWith<$Res> {
  factory $CreateCouponResponseCopyWith(CreateCouponResponse value,
          $Res Function(CreateCouponResponse) then) =
      _$CreateCouponResponseCopyWithImpl<$Res, CreateCouponResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateCouponResponseCopyWithImpl<$Res,
        $Val extends CreateCouponResponse>
    implements $CreateCouponResponseCopyWith<$Res> {
  _$CreateCouponResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateCouponResponseImplCopyWith<$Res>
    implements $CreateCouponResponseCopyWith<$Res> {
  factory _$$CreateCouponResponseImplCopyWith(_$CreateCouponResponseImpl value,
          $Res Function(_$CreateCouponResponseImpl) then) =
      __$$CreateCouponResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateCouponResponseImplCopyWithImpl<$Res>
    extends _$CreateCouponResponseCopyWithImpl<$Res, _$CreateCouponResponseImpl>
    implements _$$CreateCouponResponseImplCopyWith<$Res> {
  __$$CreateCouponResponseImplCopyWithImpl(_$CreateCouponResponseImpl _value,
      $Res Function(_$CreateCouponResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateCouponResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateCouponResponseImpl implements _CreateCouponResponse {
  const _$CreateCouponResponseImpl(
  ...
  factory _$CreateCouponResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateCouponResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateCouponResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateCouponResponseImplCopyWith<_$CreateCouponResponseImpl>
      get copyWith =>
          __$$CreateCouponResponseImplCopyWithImpl<_$CreateCouponResponseImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateCouponResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateCouponResponse implements CreateCouponResponse {
  const factory _CreateCouponResponse(
      ...
      @JsonKey(name: "meta_data") final List<MetaDatum>? metaData,
      @JsonKey(name: "_links")
      final Links? links}) = _$CreateCouponResponseImpl;

  factory _CreateCouponResponse.fromJson(Map<String, dynamic> json) =
      _$CreateCouponResponseImpl.fromJson;
