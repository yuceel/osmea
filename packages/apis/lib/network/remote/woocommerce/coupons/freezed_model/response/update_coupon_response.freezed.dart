...
part of 'update_coupon_response.dart';
...
UpdateCouponResponse _$UpdateCouponResponseFromJson(Map<String, dynamic> json) {
  return _UpdateCouponResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateCouponResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this UpdateCouponResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateCouponResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateCouponResponseCopyWith<UpdateCouponResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateCouponResponseCopyWith<$Res> {
  factory $UpdateCouponResponseCopyWith(UpdateCouponResponse value,
          $Res Function(UpdateCouponResponse) then) =
      _$UpdateCouponResponseCopyWithImpl<$Res, UpdateCouponResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateCouponResponseCopyWithImpl<$Res,
        $Val extends UpdateCouponResponse>
    implements $UpdateCouponResponseCopyWith<$Res> {
  _$UpdateCouponResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateCouponResponseImplCopyWith<$Res>
    implements $UpdateCouponResponseCopyWith<$Res> {
  factory _$$UpdateCouponResponseImplCopyWith(_$UpdateCouponResponseImpl value,
          $Res Function(_$UpdateCouponResponseImpl) then) =
      __$$UpdateCouponResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateCouponResponseImplCopyWithImpl<$Res>
    extends _$UpdateCouponResponseCopyWithImpl<$Res, _$UpdateCouponResponseImpl>
    implements _$$UpdateCouponResponseImplCopyWith<$Res> {
  __$$UpdateCouponResponseImplCopyWithImpl(_$UpdateCouponResponseImpl _value,
      $Res Function(_$UpdateCouponResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateCouponResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateCouponResponseImpl implements _UpdateCouponResponse {
  const _$UpdateCouponResponseImpl(
  ...
  factory _$UpdateCouponResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$UpdateCouponResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateCouponResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateCouponResponseImplCopyWith<_$UpdateCouponResponseImpl>
      get copyWith =>
          __$$UpdateCouponResponseImplCopyWithImpl<_$UpdateCouponResponseImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateCouponResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateCouponResponse implements UpdateCouponResponse {
  const factory _UpdateCouponResponse(
      ...
      @JsonKey(name: "meta_data") final List<MetaDatum>? metaData,
      @JsonKey(name: "_links")
      final Links? links}) = _$UpdateCouponResponseImpl;

  factory _UpdateCouponResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateCouponResponseImpl.fromJson;
