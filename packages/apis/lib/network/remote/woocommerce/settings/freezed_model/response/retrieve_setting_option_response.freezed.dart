...
part of 'retrieve_setting_option_response.dart';
...
RetrieveSettingOptionResponse _$RetrieveSettingOptionResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveSettingOptionResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveSettingOptionResponse {
  @JsonKey(name: "id")
  ...
  String? get retrieveSettingOptionResponseDefault =>
  ...
  /// Serializes this RetrieveSettingOptionResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveSettingOptionResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveSettingOptionResponseCopyWith<RetrieveSettingOptionResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveSettingOptionResponseCopyWith<$Res> {
  factory $RetrieveSettingOptionResponseCopyWith(
          RetrieveSettingOptionResponse value,
          $Res Function(RetrieveSettingOptionResponse) then) =
      _$RetrieveSettingOptionResponseCopyWithImpl<$Res,
          RetrieveSettingOptionResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "default") String? retrieveSettingOptionResponseDefault,
...
/// @nodoc
class _$RetrieveSettingOptionResponseCopyWithImpl<$Res,
        $Val extends RetrieveSettingOptionResponse>
    implements $RetrieveSettingOptionResponseCopyWith<$Res> {
  _$RetrieveSettingOptionResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? type = freezed,
    Object? retrieveSettingOptionResponseDefault = freezed,
    Object? tip = freezed,
    ...
    return _then(_value.copyWith(
      ...
      type: freezed == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as String?,
      retrieveSettingOptionResponseDefault: freezed ==
              retrieveSettingOptionResponseDefault
          ? _value.retrieveSettingOptionResponseDefault
          : retrieveSettingOptionResponseDefault // ignore: cast_nullable_to_non_nullable
              as String?,
      tip: freezed == tip
          ? _value.tip
...
/// @nodoc
abstract class _$$RetrieveSettingOptionResponseImplCopyWith<$Res>
    implements $RetrieveSettingOptionResponseCopyWith<$Res> {
  factory _$$RetrieveSettingOptionResponseImplCopyWith(
          _$RetrieveSettingOptionResponseImpl value,
          $Res Function(_$RetrieveSettingOptionResponseImpl) then) =
      __$$RetrieveSettingOptionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") String? id,
...
/// @nodoc
class __$$RetrieveSettingOptionResponseImplCopyWithImpl<$Res>
    extends _$RetrieveSettingOptionResponseCopyWithImpl<$Res,
        _$RetrieveSettingOptionResponseImpl>
    implements _$$RetrieveSettingOptionResponseImplCopyWith<$Res> {
  __$$RetrieveSettingOptionResponseImplCopyWithImpl(
      _$RetrieveSettingOptionResponseImpl _value,
      $Res Function(_$RetrieveSettingOptionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveSettingOptionResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveSettingOptionResponseImpl
    implements _RetrieveSettingOptionResponse {
  const _$RetrieveSettingOptionResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "label") this.label,
      @JsonKey(name: "description") this.description,
      @JsonKey(name: "type") this.type,
      @JsonKey(name: "default") this.retrieveSettingOptionResponseDefault,
      @JsonKey(name: "tip") this.tip,
      @JsonKey(name: "value") this.value,
      @JsonKey(name: "group_id") this.groupId,
      @JsonKey(name: "_links") this.links});

  factory _$RetrieveSettingOptionResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrieveSettingOptionResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "default")
  final String? retrieveSettingOptionResponseDefault;
  @override
  @JsonKey(name: "tip")
  final String? tip;
  @override
  ...
  @override
  String toString() {
    return 'RetrieveSettingOptionResponse(id: $id, label: $label, description: $description, type: $type, retrieveSettingOptionResponseDefault: $retrieveSettingOptionResponseDefault, tip: $tip, value: $value, groupId: $groupId, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveSettingOptionResponseImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.label, label) || other.label == label) &&
            (identical(other.description, description) ||
                other.description == description) &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.retrieveSettingOptionResponseDefault,
                    retrieveSettingOptionResponseDefault) ||
                other.retrieveSettingOptionResponseDefault ==
                    retrieveSettingOptionResponseDefault) &&
  ...
  int get hashCode => Object.hash(runtimeType, id, label, description, type,
      retrieveSettingOptionResponseDefault, tip, value, groupId, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveSettingOptionResponseImplCopyWith<
          _$RetrieveSettingOptionResponseImpl>
      get copyWith => __$$RetrieveSettingOptionResponseImplCopyWithImpl<
          _$RetrieveSettingOptionResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveSettingOptionResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveSettingOptionResponse
    implements RetrieveSettingOptionResponse {
  const factory _RetrieveSettingOptionResponse(
  ...
  factory _RetrieveSettingOptionResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveSettingOptionResponseImpl.fromJson;
