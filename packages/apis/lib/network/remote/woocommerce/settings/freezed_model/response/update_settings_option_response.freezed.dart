...
UpdateSettingsOptionResponse _$UpdateSettingsOptionResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateSettingsOptionResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateSettingsOptionResponse {
  @JsonKey(name: "id")
  ...
  String? get updateSettingsOptionResponseDefault =>
  ...
  /// Serializes this UpdateSettingsOptionResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UpdateSettingsOptionResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UpdateSettingsOptionResponseCopyWith<UpdateSettingsOptionResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateSettingsOptionResponseCopyWith<$Res> {
  factory $UpdateSettingsOptionResponseCopyWith(
          UpdateSettingsOptionResponse value,
          $Res Function(UpdateSettingsOptionResponse) then) =
      _$UpdateSettingsOptionResponseCopyWithImpl<$Res,
          UpdateSettingsOptionResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "default") String? updateSettingsOptionResponseDefault,
...
/// @nodoc
class _$UpdateSettingsOptionResponseCopyWithImpl<$Res,
        $Val extends UpdateSettingsOptionResponse>
    implements $UpdateSettingsOptionResponseCopyWith<$Res> {
  _$UpdateSettingsOptionResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? type = freezed,
    Object? updateSettingsOptionResponseDefault = freezed,
    Object? tip = freezed,
    ...
    return _then(_value.copyWith(
      ...
      type: freezed == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as String?,
      updateSettingsOptionResponseDefault: freezed ==
              updateSettingsOptionResponseDefault
          ? _value.updateSettingsOptionResponseDefault
          : updateSettingsOptionResponseDefault // ignore: cast_nullable_to_non_nullable
              as String?,
      tip: freezed == tip
          ? _value.tip
...
/// @nodoc
abstract class _$$UpdateSettingsOptionResponseImplCopyWith<$Res>
    implements $UpdateSettingsOptionResponseCopyWith<$Res> {
  factory _$$UpdateSettingsOptionResponseImplCopyWith(
          _$UpdateSettingsOptionResponseImpl value,
          $Res Function(_$UpdateSettingsOptionResponseImpl) then) =
      __$$UpdateSettingsOptionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") String? id,
...
/// @nodoc
class __$$UpdateSettingsOptionResponseImplCopyWithImpl<$Res>
    extends _$UpdateSettingsOptionResponseCopyWithImpl<$Res,
        _$UpdateSettingsOptionResponseImpl>
    implements _$$UpdateSettingsOptionResponseImplCopyWith<$Res> {
  __$$UpdateSettingsOptionResponseImplCopyWithImpl(
      _$UpdateSettingsOptionResponseImpl _value,
      $Res Function(_$UpdateSettingsOptionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateSettingsOptionResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateSettingsOptionResponseImpl
    implements _UpdateSettingsOptionResponse {
  const _$UpdateSettingsOptionResponseImpl(
      {@JsonKey(name: "id") this.id,
      @JsonKey(name: "label") this.label,
      @JsonKey(name: "description") this.description,
      @JsonKey(name: "type") this.type,
      @JsonKey(name: "default") this.updateSettingsOptionResponseDefault,
      @JsonKey(name: "tip") this.tip,
      @JsonKey(name: "value") this.value,
      @JsonKey(name: "group_id") this.groupId,
      @JsonKey(name: "_links") this.links});

  factory _$UpdateSettingsOptionResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateSettingsOptionResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "default")
  final String? updateSettingsOptionResponseDefault;
  @override
  @JsonKey(name: "tip")
  final String? tip;
  @override
  ...
  @override
  String toString() {
    return 'UpdateSettingsOptionResponse(id: $id, label: $label, description: $description, type: $type, updateSettingsOptionResponseDefault: $updateSettingsOptionResponseDefault, tip: $tip, value: $value, groupId: $groupId, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateSettingsOptionResponseImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.label, label) || other.label == label) &&
            (identical(other.description, description) ||
                other.description == description) &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.updateSettingsOptionResponseDefault,
                    updateSettingsOptionResponseDefault) ||
                other.updateSettingsOptionResponseDefault ==
                    updateSettingsOptionResponseDefault) &&
  ...
  int get hashCode => Object.hash(runtimeType, id, label, description, type,
      updateSettingsOptionResponseDefault, tip, value, groupId, links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateSettingsOptionResponseImplCopyWith<
          _$UpdateSettingsOptionResponseImpl>
      get copyWith => __$$UpdateSettingsOptionResponseImplCopyWithImpl<
          _$UpdateSettingsOptionResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateSettingsOptionResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateSettingsOptionResponse
    implements UpdateSettingsOptionResponse {
  const factory _UpdateSettingsOptionResponse(
  ...
  factory _UpdateSettingsOptionResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateSettingsOptionResponseImpl.fromJson;
