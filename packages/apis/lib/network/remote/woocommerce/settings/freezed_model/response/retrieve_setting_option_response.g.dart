...
_$RetrieveSettingOptionResponseImpl
    _$$RetrieveSettingOptionResponseImplFromJson(Map<String, dynamic> json) =>
        _$RetrieveSettingOptionResponseImpl(
          id: json['id'] as String?,
          label: json['label'] as String?,
          description: json['description'] as String?,
          type: json['type'] as String?,
          retrieveSettingOptionResponseDefault: json['default'] as String?,
...
Map<String, dynamic> _$$RetrieveSettingOptionResponseImplToJson(
        _$RetrieveSettingOptionResponseImpl instance) =>
    <String, dynamic>{
      if (instance.id case final value?) 'id': value,
      if (instance.label case final value?) 'label': value,
      if (instance.description case final value?) 'description': value,
      if (instance.type case final value?) 'type': value,
      if (instance.retrieveSettingOptionResponseDefault case final value?)
        'default': value,
