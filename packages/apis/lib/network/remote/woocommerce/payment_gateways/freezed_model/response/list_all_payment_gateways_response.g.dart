...
Map<String, dynamic> _$$SettingsImplToJson(_$SettingsImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.instructions?.toJson() case final value?)
        'instructions': value,
      if (instance.enableForMethods?.toJson() case final value?)
        'enable_for_methods': value,
      if (instance.enableForVirtual?.toJson() case final value?)
        'enable_for_virtual': value,
    };
...
Map<String, dynamic> _$$EnableForMethodsImplToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.enableForMethodsDefault case final value?) 'default': value,
...
Map<String, dynamic> _$$PaymentGatewayOptionsImplToJson(
    ...
    <String, dynamic>{
      if (instance.fixedPrice?.toJson() case final value?) 'Fixed Price': value,
      if (instance.freeShipping?.toJson() case final value?)
        'Free Shipping': value,
      if (instance.storePickup?.toJson() case final value?)
        'Store Pickup': value,
    };
...
Map<String, dynamic> _$$FreeShippingImplToJson(_$FreeShippingImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.freeShipping1 case final value?) 'free_shipping:1': value,
    };
...
Map<String, dynamic> _$$FixedPriceImplToJson(_$FixedPriceImpl instance) =>
    <String, dynamic>{
      if (instance.flatRate case final value?) 'flat_rate': value,
      if (instance.flatRate2 case final value?) 'flat_rate:2': value,
    };
...
Map<String, dynamic> _$$EnableForVirtualImplToJson(
    ...
    <String, dynamic>{
      ...
      if (instance.type case final value?) 'type': value,
      if (instance.value case final value?) 'value': value,
      if (instance.enableForVirtualDefault case final value?) 'default': value,
      if (instance.tip case final value?) 'tip': value,
      if (instance.placeholder case final value?) 'placeholder': value,
    };
