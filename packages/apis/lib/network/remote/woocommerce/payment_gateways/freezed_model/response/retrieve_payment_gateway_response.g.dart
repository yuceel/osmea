...
_$RetrievePaymentGatewayResponseImpl
    _$$RetrievePaymentGatewayResponseImplFromJson(Map<String, dynamic> json) =>
        _$RetrievePaymentGatewayResponseImpl(
...
Map<String, dynamic> _$$RetrievePaymentGatewayResponseImplToJson(
        _$RetrievePaymentGatewayResponseImpl instance) =>
    <String, dynamic>{
