...
part of 'retrieve_payment_gateway_response.dart';
...
RetrievePaymentGatewayResponse _$RetrievePaymentGatewayResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrievePaymentGatewayResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrievePaymentGatewayResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrievePaymentGatewayResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrievePaymentGatewayResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrievePaymentGatewayResponseCopyWith<RetrievePaymentGatewayResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrievePaymentGatewayResponseCopyWith<$Res> {
  factory $RetrievePaymentGatewayResponseCopyWith(
          RetrievePaymentGatewayResponse value,
          $Res Function(RetrievePaymentGatewayResponse) then) =
      _$RetrievePaymentGatewayResponseCopyWithImpl<$Res,
          RetrievePaymentGatewayResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrievePaymentGatewayResponseCopyWithImpl<$Res,
        $Val extends RetrievePaymentGatewayResponse>
    implements $RetrievePaymentGatewayResponseCopyWith<$Res> {
  _$RetrievePaymentGatewayResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrievePaymentGatewayResponseImplCopyWith<$Res>
    implements $RetrievePaymentGatewayResponseCopyWith<$Res> {
  factory _$$RetrievePaymentGatewayResponseImplCopyWith(
          _$RetrievePaymentGatewayResponseImpl value,
          $Res Function(_$RetrievePaymentGatewayResponseImpl) then) =
      __$$RetrievePaymentGatewayResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") String? id,
...
/// @nodoc
class __$$RetrievePaymentGatewayResponseImplCopyWithImpl<$Res>
    extends _$RetrievePaymentGatewayResponseCopyWithImpl<$Res,
        _$RetrievePaymentGatewayResponseImpl>
    implements _$$RetrievePaymentGatewayResponseImplCopyWith<$Res> {
  __$$RetrievePaymentGatewayResponseImplCopyWithImpl(
      _$RetrievePaymentGatewayResponseImpl _value,
      $Res Function(_$RetrievePaymentGatewayResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrievePaymentGatewayResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$RetrievePaymentGatewayResponseImpl
    implements _RetrievePaymentGatewayResponse {
  const _$RetrievePaymentGatewayResponseImpl(
  ...
  factory _$RetrievePaymentGatewayResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$RetrievePaymentGatewayResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrievePaymentGatewayResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrievePaymentGatewayResponseImplCopyWith<
          _$RetrievePaymentGatewayResponseImpl>
      get copyWith => __$$RetrievePaymentGatewayResponseImplCopyWithImpl<
          _$RetrievePaymentGatewayResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrievePaymentGatewayResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrievePaymentGatewayResponse
    implements RetrievePaymentGatewayResponse {
  const factory _RetrievePaymentGatewayResponse(
  ...
  factory _RetrievePaymentGatewayResponse.fromJson(Map<String, dynamic> json) =
      _$RetrievePaymentGatewayResponseImpl.fromJson;
