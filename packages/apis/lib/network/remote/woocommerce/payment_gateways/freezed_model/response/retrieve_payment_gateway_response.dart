...
//
//     final retrievePaymentGatewayResponse = retrievePaymentGatewayResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'retrieve_payment_gateway_response.freezed.dart';
part 'retrieve_payment_gateway_response.g.dart';

RetrievePaymentGatewayResponse retrievePaymentGatewayResponseFromJson(
        String str) =>
    RetrievePaymentGatewayResponse.fromJson(json.decode(str));

String retrievePaymentGatewayResponseToJson(
        RetrievePaymentGatewayResponse data) =>
    json.encode(data.toJson());

@freezed
class RetrievePaymentGatewayResponse with _$RetrievePaymentGatewayResponse {
  const factory RetrievePaymentGatewayResponse({
  ...
  }) = _RetrievePaymentGatewayResponse;

  factory RetrievePaymentGatewayResponse.fromJson(Map<String, dynamic> json) =>
      _$RetrievePaymentGatewayResponseFromJson(json);
}
