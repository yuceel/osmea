...
part of 'list_all_webhooks_response.dart';
...
ListAllWebhooksResponse _$ListAllWebhooksResponseFromJson(
    Map<String, dynamic> json) {
  return _ListAllWebhooksResponse.fromJson(json);
}

/// @nodoc
mixin _$ListAllWebhooksResponse {
  @JsonKey(name: "id")
  ...
  dynamic get dateModifiedGmt => throw _privateConstructorUsedError;
  @JsonKey(name: "_links")
  Links? get links => throw _privateConstructorUsedError;

  /// Serializes this ListAllWebhooksResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of ListAllWebhooksResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ListAllWebhooksResponseCopyWith<ListAllWebhooksResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListAllWebhooksResponseCopyWith<$Res> {
  factory $ListAllWebhooksResponseCopyWith(ListAllWebhooksResponse value,
          $Res Function(ListAllWebhooksResponse) then) =
      _$ListAllWebhooksResponseCopyWithImpl<$Res, ListAllWebhooksResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListAllWebhooksResponseCopyWithImpl<$Res,
        $Val extends ListAllWebhooksResponse>
    implements $ListAllWebhooksResponseCopyWith<$Res> {
  _$ListAllWebhooksResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListAllWebhooksResponseImplCopyWith<$Res>
    implements $ListAllWebhooksResponseCopyWith<$Res> {
  factory _$$ListAllWebhooksResponseImplCopyWith(
          _$ListAllWebhooksResponseImpl value,
          $Res Function(_$ListAllWebhooksResponseImpl) then) =
      __$$ListAllWebhooksResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$ListAllWebhooksResponseImplCopyWithImpl<$Res>
    extends _$ListAllWebhooksResponseCopyWithImpl<$Res,
        _$ListAllWebhooksResponseImpl>
    implements _$$ListAllWebhooksResponseImplCopyWith<$Res> {
  __$$ListAllWebhooksResponseImplCopyWithImpl(
      _$ListAllWebhooksResponseImpl _value,
      $Res Function(_$ListAllWebhooksResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListAllWebhooksResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListAllWebhooksResponseImpl implements _ListAllWebhooksResponse {
  const _$ListAllWebhooksResponseImpl(
  ...
  factory _$ListAllWebhooksResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ListAllWebhooksResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ListAllWebhooksResponse(id: $id, name: $name, status: $status, topic: $topic, resource: $resource, event: $event, hooks: $hooks, deliveryUrl: $deliveryUrl, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, dateModified: $dateModified, dateModifiedGmt: $dateModifiedGmt, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListAllWebhooksResponseImpl &&
            ...
            const DeepCollectionEquality()
                .equals(other.dateModifiedGmt, dateModifiedGmt) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(dateModifiedGmt),
      links);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListAllWebhooksResponseImplCopyWith<_$ListAllWebhooksResponseImpl>
      get copyWith => __$$ListAllWebhooksResponseImplCopyWithImpl<
          _$ListAllWebhooksResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListAllWebhooksResponseImplToJson(
      this,
    );
  }
}

abstract class _ListAllWebhooksResponse implements ListAllWebhooksResponse {
  const factory _ListAllWebhooksResponse(
          ...
          @JsonKey(name: "date_modified") final dynamic dateModified,
          @JsonKey(name: "date_modified_gmt") final dynamic dateModifiedGmt,
          @JsonKey(name: "_links") final Links? links}) =
      _$ListAllWebhooksResponseImpl;

  factory _ListAllWebhooksResponse.fromJson(Map<String, dynamic> json) =
      _$ListAllWebhooksResponseImpl.fromJson;
