...
part of 'delete_webhook_response.dart';
...
DeleteWebhookResponse _$DeleteWebhookResponseFromJson(
    Map<String, dynamic> json) {
  return _DeleteWebhookResponse.fromJson(json);
}

/// @nodoc
mixin _$DeleteWebhookResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this DeleteWebhookResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DeleteWebhookResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DeleteWebhookResponseCopyWith<DeleteWebhookResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteWebhookResponseCopyWith<$Res> {
  factory $DeleteWebhookResponseCopyWith(DeleteWebhookResponse value,
          $Res Function(DeleteWebhookResponse) then) =
      _$DeleteWebhookResponseCopyWithImpl<$Res, DeleteWebhookResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DeleteWebhookResponseCopyWithImpl<$Res,
        $Val extends DeleteWebhookResponse>
    implements $DeleteWebhookResponseCopyWith<$Res> {
  _$DeleteWebhookResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DeleteWebhookResponseImplCopyWith<$Res>
    implements $DeleteWebhookResponseCopyWith<$Res> {
  factory _$$DeleteWebhookResponseImplCopyWith(
          _$DeleteWebhookResponseImpl value,
          $Res Function(_$DeleteWebhookResponseImpl) then) =
      __$$DeleteWebhookResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteWebhookResponseImplCopyWithImpl<$Res>
    extends _$DeleteWebhookResponseCopyWithImpl<$Res,
        _$DeleteWebhookResponseImpl>
    implements _$$DeleteWebhookResponseImplCopyWith<$Res> {
  __$$DeleteWebhookResponseImplCopyWithImpl(_$DeleteWebhookResponseImpl _value,
      $Res Function(_$DeleteWebhookResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteWebhookResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteWebhookResponseImpl implements _DeleteWebhookResponse {
  const _$DeleteWebhookResponseImpl(
  ...
  factory _$DeleteWebhookResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DeleteWebhookResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DeleteWebhookResponse(id: $id, name: $name, status: $status, topic: $topic, resource: $resource, event: $event, hooks: $hooks, deliveryUrl: $deliveryUrl, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, dateModified: $dateModified, dateModifiedGmt: $dateModifiedGmt, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteWebhookResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteWebhookResponseImplCopyWith<_$DeleteWebhookResponseImpl>
      get copyWith => __$$DeleteWebhookResponseImplCopyWithImpl<
          _$DeleteWebhookResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteWebhookResponseImplToJson(
      this,
    );
  }
}

abstract class _DeleteWebhookResponse implements DeleteWebhookResponse {
  const factory _DeleteWebhookResponse(
  ...
  factory _DeleteWebhookResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteWebhookResponseImpl.fromJson;
