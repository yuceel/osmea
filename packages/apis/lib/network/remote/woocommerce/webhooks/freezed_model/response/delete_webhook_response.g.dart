...
_$DeleteWebhookResponseImpl _$$DeleteWebhookResponseImplFromJson(
...
Map<String, dynamic> _$$DeleteWebhookResponseImplToJson(
        _$DeleteWebhookResponseImpl instance) =>
    <String, dynamic>{
