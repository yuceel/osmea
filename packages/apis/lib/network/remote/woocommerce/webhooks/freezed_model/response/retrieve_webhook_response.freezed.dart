...
part of 'retrieve_webhook_response.dart';
...
RetrieveWebhookResponse _$RetrieveWebhookResponseFromJson(
    Map<String, dynamic> json) {
  return _RetrieveWebhookResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveWebhookResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this RetrieveWebhookResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RetrieveWebhookResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RetrieveWebhookResponseCopyWith<RetrieveWebhookResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveWebhookResponseCopyWith<$Res> {
  factory $RetrieveWebhookResponseCopyWith(RetrieveWebhookResponse value,
          $Res Function(RetrieveWebhookResponse) then) =
      _$RetrieveWebhookResponseCopyWithImpl<$Res, RetrieveWebhookResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveWebhookResponseCopyWithImpl<$Res,
        $Val extends RetrieveWebhookResponse>
    implements $RetrieveWebhookResponseCopyWith<$Res> {
  _$RetrieveWebhookResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveWebhookResponseImplCopyWith<$Res>
    implements $RetrieveWebhookResponseCopyWith<$Res> {
  factory _$$RetrieveWebhookResponseImplCopyWith(
          _$RetrieveWebhookResponseImpl value,
          $Res Function(_$RetrieveWebhookResponseImpl) then) =
      __$$RetrieveWebhookResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveWebhookResponseImplCopyWithImpl<$Res>
    extends _$RetrieveWebhookResponseCopyWithImpl<$Res,
        _$RetrieveWebhookResponseImpl>
    implements _$$RetrieveWebhookResponseImplCopyWith<$Res> {
  __$$RetrieveWebhookResponseImplCopyWithImpl(
      _$RetrieveWebhookResponseImpl _value,
      $Res Function(_$RetrieveWebhookResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveWebhookResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveWebhookResponseImpl implements _RetrieveWebhookResponse {
  const _$RetrieveWebhookResponseImpl(
  ...
  factory _$RetrieveWebhookResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveWebhookResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RetrieveWebhookResponse(id: $id, name: $name, status: $status, topic: $topic, resource: $resource, event: $event, hooks: $hooks, deliveryUrl: $deliveryUrl, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, dateModified: $dateModified, dateModifiedGmt: $dateModifiedGmt, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveWebhookResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveWebhookResponseImplCopyWith<_$RetrieveWebhookResponseImpl>
      get copyWith => __$$RetrieveWebhookResponseImplCopyWithImpl<
          _$RetrieveWebhookResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveWebhookResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveWebhookResponse implements RetrieveWebhookResponse {
  const factory _RetrieveWebhookResponse(
  ...
  factory _RetrieveWebhookResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveWebhookResponseImpl.fromJson;
