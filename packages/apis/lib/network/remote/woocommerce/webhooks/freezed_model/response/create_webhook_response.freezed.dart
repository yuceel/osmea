...
part of 'create_webhook_response.dart';
...
CreateWebhookResponse _$CreateWebhookResponseFromJson(
    Map<String, dynamic> json) {
  return _CreateWebhookResponse.fromJson(json);
}

/// @nodoc
mixin _$CreateWebhookResponse {
  @JsonKey(name: "id")
  ...
  /// Serializes this CreateWebhookResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of CreateWebhookResponse
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $CreateWebhookResponseCopyWith<CreateWebhookResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreateWebhookResponseCopyWith<$Res> {
  factory $CreateWebhookResponseCopyWith(CreateWebhookResponse value,
          $Res Function(CreateWebhookResponse) then) =
      _$CreateWebhookResponseCopyWithImpl<$Res, CreateWebhookResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$CreateWebhookResponseCopyWithImpl<$Res,
        $Val extends CreateWebhookResponse>
    implements $CreateWebhookResponseCopyWith<$Res> {
  _$CreateWebhookResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CreateWebhookResponseImplCopyWith<$Res>
    implements $CreateWebhookResponseCopyWith<$Res> {
  factory _$$CreateWebhookResponseImplCopyWith(
          _$CreateWebhookResponseImpl value,
          $Res Function(_$CreateWebhookResponseImpl) then) =
      __$$CreateWebhookResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$CreateWebhookResponseImplCopyWithImpl<$Res>
    extends _$CreateWebhookResponseCopyWithImpl<$Res,
        _$CreateWebhookResponseImpl>
    implements _$$CreateWebhookResponseImplCopyWith<$Res> {
  __$$CreateWebhookResponseImplCopyWithImpl(_$CreateWebhookResponseImpl _value,
      $Res Function(_$CreateWebhookResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CreateWebhookResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$CreateWebhookResponseImpl implements _CreateWebhookResponse {
  const _$CreateWebhookResponseImpl(
  ...
  factory _$CreateWebhookResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$CreateWebhookResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'CreateWebhookResponse(id: $id, name: $name, status: $status, topic: $topic, resource: $resource, event: $event, hooks: $hooks, deliveryUrl: $deliveryUrl, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, dateModified: $dateModified, dateModifiedGmt: $dateModifiedGmt, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CreateWebhookResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CreateWebhookResponseImplCopyWith<_$CreateWebhookResponseImpl>
      get copyWith => __$$CreateWebhookResponseImplCopyWithImpl<
          _$CreateWebhookResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CreateWebhookResponseImplToJson(
      this,
    );
  }
}

abstract class _CreateWebhookResponse implements CreateWebhookResponse {
  const factory _CreateWebhookResponse(
  ...
  factory _CreateWebhookResponse.fromJson(Map<String, dynamic> json) =
      _$CreateWebhookResponseImpl.fromJson;
