  ...
  Future<Map<String, dynamic>> handleRequest(
    ...
    if (method == 'PUT') {
      try {
        ...
        if ((option1 == null || option1.isEmpty) && (price == null || price.isEmpty)) {
          return {
            "status": "error",
            "message": "At least one of option1 (title) or price must be provided",
            "timestamp": DateTime.now().toIso8601String(),
          };
        }
        ...
        return {
          "status": "error",
          "message": "Failed to update variant title and price: ${e.toString()}",
          "timestamp": DateTime.now().toIso8601String(),
        };
      }
    }
    ...
    return {
      "status": "error",
      "message": "Only PUT method is supported for updating variant title and price",
      "timestamp": DateTime.now().toIso8601String(),
    };
  }
