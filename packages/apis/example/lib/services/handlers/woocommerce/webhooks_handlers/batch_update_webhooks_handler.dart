  ...
  Map<String, List<ApiField>> get requiredFields => {
        'PATCH': [
          const ApiField(
            ...
            hint: 'Create operations in format: name:topic:delivery_url:status,name2:topic2:url2:status2',
            isRequired: false,
          ),
          const ApiField(
            name: 'update_operations',
            label: 'Update Operations',
            hint: 'Update operations in format: id:status:delivery_url,id2:status2:url2',
            isRequired: false,
          ),
          const ApiField(
