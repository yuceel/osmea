...
class BatchUpdateProductAttributesHandler implements ApiRequestHandler {
  ...
  Future<Map<String, dynamic>> handleRequest(
    ...
    if (method != 'PATCH') {
      return {
        "status": "error",
        "message": "Method $method not supported for Batch Update Product Attributes API",
    ...
    try {
      ...
      final response = await GetIt.I<ProductAttributesService>().batchUpdateProductAttributes(
  ...
  Map<String, List<ApiField>> get requiredFields => {
        'PATCH': [
          const ApiField(
            ...
            hint: 'Create operations in format: name:slug:type:orderby:hasarchives,name2:slug2:type2:orderby2:hasarchives2',
            isRequired: false,
          ),
          const ApiField(
            name: 'update_operations',
            label: 'Update Operations',
            hint: 'Update operations in format: id:name:slug:type:orderby:hasarchives,id2:name2:slug2:type2:orderby2:hasarchives2',
            isRequired: false,
          ),
          const ApiField(
