...
class RetrieveListOfRecurringApplicationChargesHandler implements ApiRequestHandler {
  ...
  Future<Map<String, dynamic>> _handleFieldFiltering(String fields, String? sinceId) async {
    ...
    try {
      ...
      debugPrint('✅ Successfully retrieved and filtered ${filteredCharges.length} recurring application charges. Fields: ${requestedFields.join(', ')}');
      ...
      return {
        ...
        "message": "Recurring application charges successfully retrieved with filtered fields",
        "timestamp": DateTime.now().toIso8601String(),
      };
    } catch (e) {
      ...
      return {
        "status": "error",
        "message": "Failed to retrieve recurring application charges with field filtering: ${e.toString()}",
        "timestamp": DateTime.now().toIso8601String(),
      };
    }
  }
