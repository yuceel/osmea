  ...
  Future<Map<String, dynamic>> handleRequest(
    ...
    try {
      ...
      if (params.containsKey('customerId') &&
        ...
        print('🔍 DEBUG: Found customerId in "first" field: "$customerId"');
      } else {
        customerId = '';
      ...
      print('🔍 DEBUG: ===== CUSTOMER UPDATE HANDLER DEBUG =====');
      ...
      print('🔍 DEBUG: customerId extracted: "$customerId"');
      ...
      if (customerId.isEmpty || customerId.trim().isEmpty) {
        ...
        print('🔍 DEBUG: customerId.trim(): "${customerId.trim()}"');
      ...
      if (customerId.isNotEmpty &&
        ...
        print('🔍 DEBUG: Customer ID format validation failed');
        // For now, allow non-GraphQL format IDs and let Shopify handle validation
        print('🔍 DEBUG: Allowing non-GraphQL format ID: $customerId');
      }
      ...
      print('🔍 DEBUG: Proceeding with update - Shopify will validate fields');
