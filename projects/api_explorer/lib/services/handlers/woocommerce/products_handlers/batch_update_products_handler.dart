  ...
  Map<String, List<ApiField>> get requiredFields => {
        'PATCH': [
          const ApiField(
            ...
            hint:
                'Create operations in format: name:type:price:description,name2:type2:price2:description2',
            isRequired: false,
          ),
          const ApiField(
            ...
            hint:
                'Update operations in format: id:name:type:description,id2:name2:type2:description2',
            isRequired: false,
          ),
          const ApiField(
