...
class InfoChipWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bgColor =
        backgroundColor ?? OsmeaColors.silver.withValues(alpha: 0.3);
    final txtColor = textColor ?? OsmeaColors.pewter;
    final valueColor = textColor ?? OsmeaColors.nordicBlue;
    final brdColor = borderColor ?? OsmeaColors.silver;
